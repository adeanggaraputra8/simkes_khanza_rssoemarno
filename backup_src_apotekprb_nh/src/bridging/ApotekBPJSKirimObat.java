...
import modifikasi.BPJSCekSEPKUNJUNGAN;
...
public final class ApotekBPJSKirimObat extends javax.swing.JDialog {
    ...
    private BPJSCekSEPKUNJUNGAN cekkunjungan=new BPJSCekSEPKUNJUNGAN();
...
//            NORESEPAKTIF=koneksiDB.NORESEPAKTIF();
    ...
    private void initComponents() {
        ...
        BtnCekKunjungan = new widget.Button();
        ...
        TanggalPelayanan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-02-2025" }));
        ...
        FormInput.add(NoSEP);
        NoSEP.setBounds(70, 70, 200, 23);

        jLabel18.setText("No.Kunj/SEP :");
        ...
        BtnCekKunjungan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        BtnCekKunjungan.setMnemonic('3');
        BtnCekKunjungan.setText("Cek Kunjungan");
        BtnCekKunjungan.setToolTipText("Alt+3");
        BtnCekKunjungan.setName("BtnCekKunjungan"); // NOI18N
        BtnCekKunjungan.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnCekKunjungan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnCekKunjunganActionPerformed(evt);
            }
        });
...
private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
    if(TNoRw.getText().trim().equals("")){
        ...
        Valid.textKosong(NoSEP,"Nomor Sep/Kunjungan");                                      
...
//                                    + "\"TGLSJP\": \"" + Valid.SetTgl(DTPTgl.getSelectedItem()+"")+" "+Jam.getText()+ "\","+
    ...
    private void BtnCekKunjunganActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCekKunjunganActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        cekkunjungan.tampil(NoSEP.getText());
        KdDPJP.setText(cekkunjungan.kodedokter);
        NmDPJP.setText(cekkunjungan.namadokter);
        NoKartu.setText(cekkunjungan.nokartu);
        //KdPoli.setText(cekkunjungan.ko);
        NmPoli.setText(cekkunjungan.poli);
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_BtnCekKunjunganActionPerformed
    ...
    */
    ...
    private widget.Button BtnCekKunjungan;
