...
public final class DlgResepObat extends javax.swing.JDialog {
    ...
    public DlgCaridokter3 dokter2=new DlgCaridokter3(null,false);
    ...
    private void initComponents() {
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-02-2025 12:46:53" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-02-2025 12:46:53" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        }else if(KdDokter.getText().trim().equals("")||NmDokter.getText().trim().equals("")||KdDokter.getText().trim().equals("-")){
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
       if(akses.getkode().equals("Admin Utama")){
        if(tabMode.getRowCount()==0){
          ...
          JOptionPane.showMessageDialog(null,"Maaf, silahkan hubungkan administrator untuk menghapus!!!!");   
       }
