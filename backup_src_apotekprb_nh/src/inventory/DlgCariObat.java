...
import modifikasi.DlgCaridokter3;
import modifikasi.DlgPasienPRB;
import modifikasi.DlgRiwayatResep;
...
public final class DlgCariObat extends javax.swing.JDialog {
    ...
    private String signa1="1",signa2="1",nokunjungan="",kdObatSK="",requestJson="",URL="",otorisasi,sql="",aktifpcare="no",no_batchcari="", tgl_kadaluarsacari="", no_fakturcari="", aktifkanbatch="no",kodedokter="",namadokter="",noresep="",bangsal="",bangsaldefault=Sequel.cariIsi("select set_lokasi.kd_bangsal from set_lokasi limit 1"),tampilkan_ppnobat_ralan="",
                   Suspen_Piutang_Obat_Ralan="",Obat_Ralan="",HPP_Obat_Rawat_Jalan="",Persediaan_Obat_Rawat_Jalan="",hppfarmasi="",VALIDASIULANGBERIOBAT="",DEPOAKTIFOBAT="",utc="",BASENOREG="",URUTNOREG="";
    ...
    private DlgPasienPRB pasien=new DlgPasienPRB(null,false);
    private DlgCaridokter3 faskes=new DlgCaridokter3(null,false);
    DlgRiwayatResep resep=new DlgRiwayatResep(null,false);
    ...
    public DlgCariObat(java.awt.Frame parent, boolean modal) {
          ...
          pasien.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                    if(pasien.getTable().getSelectedRow()!= -1){                   
                        TNoRMPRB.setText(pasien.getTable().getValueAt(pasien.getTable().getSelectedRow(),1).toString());
                        TNmPasienPRB.setText(pasien.getTable().getValueAt(pasien.getTable().getSelectedRow(),2).toString());
                    }     
         ...
         faskes.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                    if(faskes.getTable().getSelectedRow()!= -1){                   
                        TKdFaskesPRB.setText(faskes.getTable().getValueAt(faskes.getTable().getSelectedRow(),0).toString());
                        TNmFaskes.setText(faskes.getTable().getValueAt(faskes.getTable().getSelectedRow(),1).toString());
                    }     
        ...
        faskes.getTable().addKeyListener(new KeyListener() {
          ...
          resep.addWindowListener(new WindowListener() {
            ...
            @Override
            public void windowClosed(WindowEvent e) {
                    if(resep.getTable().getSelectedRow()!= -1){                   
                        tampilobat2(resep.getTable().getValueAt(resep.getTable().getSelectedRow(),0).toString());
                    }     
                    BtnCariResep.requestFocus();
            }
            @Override
            public void windowIconified(WindowEvent e) {}
            @Override
        ...
        resep.getTable().addKeyListener(new KeyListener() {
            @Override
            public void keyTyped(KeyEvent e) {}
            @Override
            public void keyPressed(KeyEvent e) {
    ...
    private void initComponents() {
        ...
        TKdFaskesPRB = new widget.TextBox();
        ...
        LTotalItem = new widget.Label();
        jLabel13 = new widget.Label();
        BtnPasein = new widget.Button();
        BtnCariResep = new widget.Button();
        BtnObatOtomatis = new widget.Button();
        ...
        internalFrame7.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Cari Pasien & Faskes PRB ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        BtnCloseIn6.setBounds(220, 210, 100, 30);
        ...
        BtnSimpanPRB.setBounds(120, 210, 100, 30);

        jLabel18.setText("Nama Faskes :");
        jLabel18.setName("jLabel18"); // NOI18N
        internalFrame7.add(jLabel18);
        jLabel18.setBounds(160, 70, 90, 20);
        ...
        TNmPasienPRB.setBounds(260, 30, 220, 30);
        ...
        internalFrame7.add(TNmFaskes);
        TNmFaskes.setBounds(330, 70, 150, 30);

        jLabel19.setText("Nama Pasien :");
        jLabel19.setName("jLabel19"); // NOI18N
        internalFrame7.add(jLabel19);
        jLabel19.setBounds(160, 30, 90, 23);

        BtnCariFaskes.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/plus_16.png"))); // NOI18N
        BtnCariFaskes.setMnemonic('3');
        BtnCariFaskes.setText("Pilih Peresep");
        BtnCariFaskes.setToolTipText("Alt+3");
        BtnCariFaskes.setName("BtnCariFaskes"); // NOI18N
        BtnCariFaskes.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnCariFaskes.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnCariFaskesActionPerformed(evt);
            }
        });
        internalFrame7.add(BtnCariFaskes);
        BtnCariFaskes.setBounds(490, 70, 120, 23);

        BtnCariPasien.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/plus_16.png"))); // NOI18N
        BtnCariPasien.setMnemonic('3');
        BtnCariPasien.setText("Pilih Pasien");
        BtnCariPasien.setToolTipText("Alt+3");
        BtnCariPasien.setName("BtnCariPasien"); // NOI18N
        BtnCariPasien.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnCariPasien.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnCariPasienActionPerformed(evt);
            }
        });
        internalFrame7.add(BtnCariPasien);
        BtnCariPasien.setBounds(490, 30, 110, 23);

        jLabel9.setText("Tgl. Pasien Datang :");
        jLabel9.setName("jLabel9"); // NOI18N
        internalFrame7.add(jLabel9);
        jLabel9.setBounds(110, 130, 100, 23);

        DTPReg.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-02-2025" }));
        ...
        internalFrame7.add(DTPReg);
        DTPReg.setBounds(210, 130, 90, 23);

        TKdFaskesPRB.setName("TKdFaskesPRB"); // NOI18N
        internalFrame7.add(TKdFaskesPRB);
        TKdFaskesPRB.setBounds(260, 70, 70, 30);
        ...
        LTotalItem.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        LTotalItem.setText("0");
        LTotalItem.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        LTotalItem.setName("LTotalItem"); // NOI18N
        LTotalItem.setPreferredSize(new java.awt.Dimension(80, 23));
        FormInput.add(LTotalItem);
        LTotalItem.setBounds(760, 28, 140, 50);

        jLabel13.setText("Total Per Item :");
        jLabel13.setName("jLabel13"); // NOI18N
        jLabel13.setPreferredSize(new java.awt.Dimension(45, 23));
        FormInput.add(jLabel13);
        jLabel13.setBounds(675, 40, 80, 23);

        BtnPasein.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnPasein.setMnemonic('2');
        BtnPasein.setText("Cari Pasien");
        BtnPasein.setToolTipText("Alt+2");
        BtnPasein.setName("BtnPasein"); // NOI18N
        BtnPasein.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnPasein.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPaseinActionPerformed(evt);
            }
        });
        FormInput.add(BtnPasein);
        BtnPasein.setBounds(680, 10, 110, 23);

        BtnCariResep.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/011.png"))); // NOI18N
        BtnCariResep.setMnemonic('4');
        BtnCariResep.setText("Riwayat Resep");
        BtnCariResep.setToolTipText("Alt+4");
        BtnCariResep.setName("BtnCariResep"); // NOI18N
        BtnCariResep.setPreferredSize(new java.awt.Dimension(28, 23));
        ...
        FormInput.add(BtnCariResep);
        BtnCariResep.setBounds(700, 70, 130, 23);

        BtnObatOtomatis.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        BtnObatOtomatis.setMnemonic('3');
        BtnObatOtomatis.setText("Ambil Obat Otomatis");
        BtnObatOtomatis.setToolTipText("Alt+3");
        BtnObatOtomatis.setName("BtnObatOtomatis"); // NOI18N
        BtnObatOtomatis.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnObatOtomatis.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnObatOtomatisActionPerformed(evt);
            }
        });
        FormInput.add(BtnObatOtomatis);
        BtnObatOtomatis.setBounds(830, 70, 140, 23);
                    ...
                    if(sukses==true){
                        if(ChkNoResep.isSelected()==true){
                            ...
                            if(!namadokter.equals("")){
                                resep.setNoRm(TNoRw.getText(),DTPTgl.getDate(),DTPTgl.getDate(),cmbJam.getSelectedItem().toString(),cmbMnt.getSelectedItem().toString(),cmbDtk.getSelectedItem().toString(),TKdFaskesPRB.getText(),TNmFaskes.getText(),"ralan");
                            }else if(namadokter.equals("-")){
...
private void JeniskelasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_JeniskelasKeyPressed
    ...
    private void BtnSimpanPRBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanPRBActionPerformed
        if(TNoRMPRB.getText().equals("")||TNmPasienPRB.getText().equals("")){
            Valid.textKosong(TNoRMPRB,"Pasien");
        }else if (TKdFaskesPRB.getText().equals("")||TNmFaskes.getText().equals("")){
            Valid.textKosong(TKdFaskesPRB,"Faskes");
        }else {
                if(Sequel.menyimpantf2("reg_periksa","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",19,
                        new String[]{TNoReg.getText(),TNoRwPRB.getText(),Valid.SetTgl(DTPReg.getSelectedItem()+""),cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem(),
                            TKdFaskesPRB.getText(),TNoRMPRB.getText(),"PRB","-","-","-","0","Sudah",
                            "-","Ralan","BPJ","0","Th","Sudah Bayar","Baru"})==true){
                    TNoRw.setText(TNoRwPRB.getText());
                    LblNoRawat.setText(TNoRwPRB.getText());
                    TNoRM.setText(TNoRMPRB.getText());
                    TPasien.setText(TNmPasienPRB.getText());
                    WindowPRB.dispose();
                    TNmPasienPRB.setText("");
                    TNoRMPRB.setText("");
                }
        }
    ...
    private void DTPRegKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DTPRegKeyPressed
        Valid.pindah(evt,TNoRw,BtnSimpanPRB);
    ...
    private void BtnPaseinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPaseinActionPerformed
            WindowPRB.setSize(615,257);
            isNumber();
            TNmFaskes.setText("");
            TKdFaskesPRB.setText("");
            TNoRMPRB.setText("");
            TNmPasienPRB.setText("");
            WindowPRB.setLocationRelativeTo(internalFrame1);
            WindowPRB.setVisible(true);
    }//GEN-LAST:event_BtnPaseinActionPerformed

    private void BtnCariResepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariResepActionPerformed
        if(TNoRM.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda cari pasien terkebih dahulu...");
            TCari.requestFocus();
        }else{  
                resep.isCek();
                resep.setRM(TNoRw.getText(),TNoRM.getText(),TKdFaskesPRB.getText(),Sequel.cariIsi("select kd_pj from reg_periksa where no_rawat=?",TNoRw.getText()),"ralan");
                resep.tampil();
                resep.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
                resep.setLocationRelativeTo(internalFrame1);
                resep.setVisible(true);
    ...
    private void BtnObatOtomatisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnObatOtomatisActionPerformed
        if(TNoRM.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda cari pasien terkebih dahulu...");
            TCari.requestFocus();
        }else{            
                tampilobat2(Sequel.cariIsi("select resep_obat.no_resep from resep_obat INNER JOIN reg_periksa on reg_periksa.no_rawat=resep_obat.no_rawat WHERE reg_periksa.no_rkm_medis='"+TNoRM.getText()+"' order by resep_obat.tgl_perawatan DESC LIMIT 1"));
            }
    }//GEN-LAST:event_BtnObatOtomatisActionPerformed
    ...
    */
    ...
    private widget.Button BtnObatOtomatis;
    private widget.Button BtnPasein;
    ...
    private widget.Label LTotalItem;
    ...
    private widget.TextBox TKdFaskesPRB;
            ...
            if(kenaikan>0){
                ...
                if(aktifkanbatch.equals("yes")){
                    ...
                    psobat=koneksi.prepareStatement(
                        ...
                        "databarang.kode_sat,databarang.karyawan,databarang.ralan,"+
                        "databarang.beliluar,databarang.letak_barang,databarang.utama,"+
                        "industrifarmasi.nama_industri,databarang.h_beli,detail_pemberian_obat.jml,databarang."+hppfarmasi+" as dasar, "+
                        "aturan_pakai.aturan,kategori_barang.nama as kategori,golongan_barang.nama as golongan  "+
                        " from databarang inner join jenis inner join golongan_barang inner join kategori_barang "+
                        " inner join industrifarmasi inner join aturan_pakai INNER JOIN resep_obat INNER JOIN detail_pemberian_obat on databarang.kdjns=jenis.kdjns  "+
                        " and industrifarmasi.kode_industri=databarang.kode_industri "+
                        ...
                        " where resep_obat.no_resep=? and databarang.status='1' GROUP BY aturan_pakai.kode_brng order by databarang.nama_brng");
                    try{
                        psobat.setString(1,no_resep);
                        rsobat=psobat.executeQuery();
                        while(rsobat.next()){
                            ...
                            if(rsobat.getDouble("jml")>sisacari){
                                ...
                                if(Jeniskelas.getSelectedItem().equals("Karyawan")){
                                    tabModeobat.addRow(new Object[] {false,sisacari,rsobat.getString("kode_brng"),rsobat.getString("nama_brng"),
                                       rsobat.getString("kode_sat"),rsobat.getString("letak_barang"),Valid.roundUp(rsobat.getDouble("karyawan"),100),
                                       rsobat.getString("nama"),0,0,sisacari,rsobat.getString("aturan"),rsobat.getString("nama_industri"),
                                       rsobat.getDouble("dasar"),rsobat.getString("kategori"),rsobat.getString("golongan"),"","",""
                                    });
                                }else if(Jeniskelas.getSelectedItem().equals("Rawat Jalan")){
                                    tabModeobat.addRow(new Object[] {false,sisacari,rsobat.getString("kode_brng"),rsobat.getString("nama_brng"),
        ...
        if(nmgudang.getText().trim().equals("")){
            ...
            if(tbObat.getSelectedRow()!= -1){
                ...
                if(!tbObat.getValueAt(row,1).toString().equals("")){
                    ...
                    LTotalItem.setText(Valid.SetAngka(Double.parseDouble(tbObat.getValueAt(row,1).toString()) * Double.parseDouble(tbObat.getValueAt(row,6).toString())));
                }
            }
        }
...
//            }
        ...
        if(Kd2.getText().equals("")){
            Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(reg_periksa.no_rawat,6),signed)),0) from reg_periksa where reg_periksa.tgl_registrasi='"+Valid.SetTgl(DTPReg.getSelectedItem()+"")+"' ",dateformat.format(DTPReg.getDate())+"/",6,TNoRwPRB);           
        }            
    }
