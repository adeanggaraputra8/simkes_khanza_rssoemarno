...
public class DlgRiwayatResep extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgRiwayatResep(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        Object[] row={"No.Resep","Tgl.Resep","Jam Resep","No.Rawat","No.RM","Pasien","Peresep","Kode Dokter"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Daftar Resep Sebelumnya ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRiwayatResep dialog = new DlgRiwayatResep(new javax.swing.JFrame(), true);
        ...
        try{  
            if(ChkTanggal.isSelected()==true){
                ps=koneksi.prepareStatement("select resep_obat.no_resep,resep_obat.tgl_peresepan,resep_obat.jam_peresepan,"+
                    ...
                    " resep_obat.tgl_peresepan between ? and ? and pasien.no_rkm_medis=? order by resep_obat.tgl_perawatan desc");
            }else{
                ps=koneksi.prepareStatement("select resep_obat.no_resep,resep_obat.tgl_peresepan,resep_obat.jam_peresepan,"+
                    " resep_obat.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,resep_obat.kd_dokter,dokter.nm_dokter, "+
                    " if(resep_obat.tgl_perawatan='0000-00-00','Belum Terlayani','Sudah Terlayani') as status,resep_obat.status as status_asal "+
                    " from resep_obat inner join reg_periksa inner join pasien inner join dokter on resep_obat.no_rawat=reg_periksa.no_rawat  "+
                    " and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and resep_obat.kd_dokter=dokter.kd_dokter where "+
                    " pasien.no_rkm_medis=? order by resep_obat.tgl_perawatan desc limit 3");
            }
            try{
                if(ChkTanggal.isSelected()==true){
                ...
                while(rs.next()){
                    ...
                    ps2=koneksi.prepareStatement("select d.kode_brng,d.nama_brng,dpo.jml,d.kode_sat,ap.aturan from detail_pemberian_obat dpo inner join databarang d on "+
                        "dpo.kode_brng=d.kode_brng INNER JOIN aturan_pakai ap on ap.no_rawat=dpo.no_rawat where dpo.no_rawat=? GROUP BY d.kode_brng order by d.kode_brng ");
                    try {
                        ps2.setString(1,rs.getString("no_rawat"));
                        rs2=ps2.executeQuery();
                        while(rs2.next()){
                            tabMode.addRow(new String[]{
                                "",rs2.getString("jml"),rs2.getString("kode_sat"),rs2.getString("aturan"),rs2.getString("kode_brng"),rs2.getString("nama_brng"),"",""
                            });
                        }
                    } catch (Exception e) {
...
//        DlgCariObat resep=new DlgCariObat(null,false);
