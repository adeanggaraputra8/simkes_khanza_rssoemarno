...
public class DlgInpuPRB1 extends javax.swing.JDialog {
    ...
    private DlgFasilitasKesehatan faskes=new DlgFasilitasKesehatan(null,false);
     ...
     * @param parent
     * @param modal */
    public DlgInpuPRB1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
            ...
            public void windowClosed(WindowEvent e) {
                if(akses.getform().equals("DlgPiutang")){
                    if(faskes.getTable().getSelectedRow()!= -1){                   
                        catatan.setText(faskes.getTable().getValueAt(faskes.getTable().getSelectedRow(),0).toString());
                    }  
    ...
    private void initComponents() {
        ...
        catatan.setBounds(89, 40, 130, 23);
        ...
        BtnFaskes.setMnemonic('1');
        BtnFaskes.setToolTipText("Alt+1");
        ...
        panelisi3.add(BtnFaskes);
        BtnFaskes.setBounds(220, 40, 28, 23);

        keterangan.setEditable(false);
        keterangan.setText("OBAT PRB");
        ...
        keterangan.setBounds(250, 40, 80, 23);
...
*/
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        if(NoNota.getText().trim().equals("")){
        ...
        }else if(catatan.getText().trim().equals("")&&(keterangan.getText().trim().equals(""))){
            Valid.textKosong(catatan,"Nama Faskes/dr.Keluarga");
            ...
            if (reply == JOptionPane.YES_OPTION) {
                ...
                if(Sequel.menyimpantf2("piutang","'"+NoNota.getText()+"','"+Valid.SetTgl(Tgl.getSelectedItem()+"")+"','"+kdptg.getText()+"','"+kdmem.getText()+
                        "','"+nmmem.getText()+"','"+catatan.getText()+"-"+keterangan.getText()+"','"+Jenisjual.getSelectedItem()+"','0','0','"+ttl+
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgInpuPRB1 dialog = new DlgInpuPRB1(new javax.swing.JFrame(), true);
