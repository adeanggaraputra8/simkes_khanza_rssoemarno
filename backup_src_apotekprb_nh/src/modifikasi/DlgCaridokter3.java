 ...
 * @author dosen
 */
public class DlgCaridokter3 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCaridokter3(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        try {
            ps=koneksi.prepareStatement("select kd_dokter, nm_dokter "+
                " from dokter where status='1' and  kd_dokter like ? or "+
                " status='1' and nm_dokter like ? order by nm_dokter");
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Pereesep ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Valid.textKosong(TNm,"nama peresep");
        }else{
              try { 
                ...
                Sequel.menyimpanignore("pegawai","'0','"+TKd.getText()+"','"+TNm.getText()+"','LAKI-LAKI',"+
                        "'-','-','-','-','-','-','-','-','-','-','-','0','-','1900-01-01','-','-','1900-01-01','<1','-','T','-','AKTIF','0','0','0','1900-01-01','0','0','pages/pegawai/photo/','-'");        
                Sequel.menyimpan2("dokter","'"+TKd.getText()+"','"+
                        TNm.getText()+"','L','-','1900-01-01','-','ISLAM','-','0','BELUM MENIKAH','-','-','0','2'","Kode Dokter");
                Sequel.Commit();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCaridokter3 dialog = new DlgCaridokter3(new javax.swing.JFrame(), true);
    ...
    public void emptTeks() {
        ...
        TCari.setText("");
        TKd.requestFocus();
        Valid.autoNomer("dokter","LR",4,TKd);
        TKd.requestFocus();
    }
