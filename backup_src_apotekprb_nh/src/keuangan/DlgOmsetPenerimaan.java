...
public final class DlgOmsetPenerimaan extends javax.swing.JDialog {
    ...
    private double rawatjalan=0,rawatinap=0,jualbebas=0,pemasukanlain=0,deposit=0,bayarpiutang=0,hitung=0,ttlpendapatan=0,ttlreal=0,ttlselisih=0,realpagi=0,inputpagi=0,realsore=0,inputsore=0,ttlinputan=0,selisihpagi=0,selisihsore=0;
    ...
    public DlgOmsetPenerimaan(java.awt.Frame parent, boolean modal) {
        ...
        tabmodeclosing=new DefaultTableModel(null,new Object[]{"Tanggal","Real Penjualan Pagi","Inputan Penjualan Pagi","Real Penjualan Sore","Inputan Penjualan Sore","Total Real (pagi+sore)","Total Input (pagi+sore)","Selisih real - inputan (pagi)","selisih real-inputan (malam)","Total Selisih"}){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
              Class[] types = new Class[] {
    ...
    private void initComponents() {
        ...
        Lhasilrealinputan = new javax.swing.JLabel();
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-03-2024" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-03-2024" }));
        ...
        jLabel13.setText("Rawat Jalan BPJS :");
        ...
        jLabel17.setText("Real - Inputan :");
        jLabel17.setName("jLabel17"); // NOI18N
        jLabel17.setPreferredSize(new java.awt.Dimension(80, 23));
        panelGlass9.add(jLabel17);
        jLabel17.setBounds(760, 10, 100, 23);

        Lhasilrealinputan.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        Lhasilrealinputan.setForeground(new java.awt.Color(50, 50, 50));
        Lhasilrealinputan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        Lhasilrealinputan.setText("0");
        Lhasilrealinputan.setName("Lhasilrealinputan"); // NOI18N
        Lhasilrealinputan.setPreferredSize(new java.awt.Dimension(180, 23));
        panelGlass9.add(Lhasilrealinputan);
        Lhasilrealinputan.setBounds(870, 10, 150, 23);
...
//        }
    ...
    */
    ...
    private javax.swing.JLabel Lhasilrealinputan;
    ...
    public void tampil(){
        ...
        try{    
            ...
            realpagi=0;inputpagi=0;realsore=0;inputsore=0;ttlreal=0;ttlinputan=0;selisihpagi=0;selisihsore=0;ttlselisih=0;
            
            ps2=koneksi.prepareStatement("SELECT tgl_closing FROM md_closing_pu WHERE tgl_closing BETWEEN ? AND ? group by tgl_closing ");
                
            try {
                ps2.setString(1,Valid.SetTgl(DTPCari1.getSelectedItem().toString()+""));
                ps2.setString(2,Valid.SetTgl(DTPCari2.getSelectedItem().toString()+""));
                
                rs2=ps2.executeQuery();
                while(rs2.next()){
            ps1=koneksi.prepareStatement(
                    " SELECT inputan_pagi.tgl_jual,shif_pagi.real_pagi,inputan_pagi.totalpagi,shif_sore.real_sore,inputan_sore.totalsore,shif_pagi.real_pagi+shif_sore.real_sore as total_real,inputan_pagi.totalpagi+inputan_sore.totalsore as totalinputan,shif_pagi.real_pagi-inputan_pagi.totalpagi as selisih_pagi,shif_sore.real_sore-inputan_sore.totalsore as selisih_sore, shif_pagi.real_pagi+shif_sore.real_sore-inputan_pagi.totalpagi-inputan_sore.totalsore as total_selisih FROM (SELECT mcp.tgl_closing,mcp.real as real_pagi FROM md_closing_pu mcp WHERE mcp.tgl_closing BETWEEN '"+rs2.getString(1)+"' and '"+rs2.getString(1)+"' AND mcp.shif_jaga='Pagi') shif_pagi INNER JOIN (SELECT SUBSTRING(penjualan.tgl_jual, 1,10) as tgl_jual,SUM(detailjual.total) as totalpagi FROM penjualan INNER JOIN detailjual on detailjual.nota_jual=penjualan.nota_jual WHERE penjualan.tgl_jual BETWEEN '"+rs2.getString(1)+" 00:00:00' AND '"+rs2.getString(1)+" 14:00:00' ) inputan_pagi ON (shif_pagi.tgl_closing=inputan_pagi.tgl_jual) INNER JOIN (SELECT mcp.tgl_closing,mcp.real as real_sore FROM md_closing_pu mcp WHERE mcp.tgl_closing BETWEEN '"+rs2.getString(1)+"' and '"+rs2.getString(1)+"' AND mcp.shif_jaga='Sore') shif_sore on (shif_sore.tgl_closing=shif_pagi.tgl_closing) INNER JOIN ( SELECT SUBSTRING(penjualan.tgl_jual, 1,10) as tgl_jual,SUM(detailjual.total) as totalsore FROM penjualan INNER JOIN detailjual on detailjual.nota_jual=penjualan.nota_jual WHERE penjualan.tgl_jual BETWEEN '"+rs2.getString(1)+" 14:00:01' AND '"+rs2.getString(1)+" 23:59:59' ) inputan_sore ON (inputan_sore.tgl_jual=shif_sore.tgl_closing)");
               try {
...
//                ps1.setString(3,Valid.SetTgl(DTPCari1.getSelectedItem().toString()+"")+" 00:00:00");
//                ps1.setString(4,Valid.SetTgl(DTPCari2.getSelectedItem().toString()+"")+" 14:00:00");
//                ps1.setString(5,Valid.SetTgl(DTPCari1.getSelectedItem().toString()+""));
//                ps1.setString(6,Valid.SetTgl(DTPCari2.getSelectedItem().toString()+""));
//                ps1.setString(7,Valid.SetTgl(DTPCari1.getSelectedItem().toString()+"")+" 14:00:01");
//                ps1.setString(8,Valid.SetTgl(DTPCari2.getSelectedItem().toString()+"")+" 23:59:59");

                rs1=ps1.executeQuery();
 //               rs1.beforeFirst();
                while(rs1.next()){
                    tabmodeclosing.addRow(new Object[]{
                        rs2.getString(1),rs1.getDouble(2),rs1.getDouble(3),rs1.getDouble(4),rs1.getDouble(5),rs1.getDouble(6),rs1.getDouble(7),rs1.getDouble(8),rs1.getDouble(9),rs1.getDouble(10)
                    });
                     realpagi=realpagi+rs1.getDouble(2);
                     inputpagi=inputpagi+rs1.getDouble(3);
                     realsore=realsore+rs1.getDouble(4);
                     inputsore=inputsore+rs1.getDouble(5);
                     ttlreal=ttlreal+rs1.getDouble(6);
                     ttlinputan=ttlinputan+rs1.getDouble(7);
                     selisihpagi=selisihpagi+rs1.getDouble(8);
                     selisihsore=selisihsore+rs1.getDouble(9);
                     ttlselisih=ttlselisih+rs1.getDouble(10);
           ...
           tabmodeclosing.addRow(new Object[]{"Total >>",realpagi,inputpagi,realsore,inputsore,ttlreal,ttlinputan,selisihpagi,selisihsore,ttlselisih});
            
        LCountTotal.setText(Valid.SetAngka(rawatjalan+rawatinap+jualbebas+pemasukanlain+deposit+bayarpiutang));
        Lhasilrealinputan.setText(Valid.SetAngka(ttlselisih));
        }catch(Exception e){
