...
public class DlgSOAPPerawatan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        nmpnj3.setPreferredSize(new java.awt.Dimension(100, 24));
        panelisi1.add(nmpnj3);
    ...
    private void prosesCari() {
        ...
        try {
            ...
            ps=koneksi.prepareStatement(
                ...
                "reg_periksa.status_lanjut from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join penjab on penjab.kd_pj=reg_periksa.kd_pj where "+
                "reg_periksa.tgl_registrasi between ? and ? and penjab.png_jawab like ? "+(TCari.getText().trim().equals("")?"":
            ...
            try {
                ...
                ps.setString(3,"%"+nmpnj3.getText().trim()+"%");
