...
public class PCareDataPemberianObat extends javax.swing.JDialog {
    ...
    private String aktifkanbatch="no",URL="",link="",otorisasi,Suspen_Piutang_Obat_Ranap="",Obat_Ranap="",HPP_Obat_Rawat_Inap="",Persediaan_Obat_Rawat_Inap="",
            Suspen_Piutang_Obat_Ralan="",Obat_Ralan="",HPP_Obat_Rawat_Jalan="",Persediaan_Obat_Rawat_Jalan="",utc="",passpcare=Sequel.cariIsi("select pass from user_pcare where level='Admin' "), userpcare=Sequel.cariIsi("select user from user_pcare where level='Admin' ");
