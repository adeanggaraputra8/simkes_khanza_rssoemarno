...
public final class PCareCekFaskesAlihRawat extends javax.swing.JDialog {
    ...
    private String URL = "",otorisasi,utc="",passpcare=Sequel.cariIsi("select pass from user_pcare where level='Admin' "), userpcare=Sequel.cariIsi("select user from user_pcare where level='Admin' ");;
