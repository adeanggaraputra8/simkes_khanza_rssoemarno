...
public final class DlgRawatJalan extends javax.swing.JDialog {
    private final DefaultTableModel tabModeDr,tabModePr,tabModeDrPr,
            ...
            TabModeTindakan,TabModeTindakan2,TabModeTindakan3,TabModeCatatan,tabModeTambahan,tabModeRiwayat;
    ...
    private PreparedStatement ps,ps2,ps3,ps4,ps5,ps6,pstindakan,psset_tarif,psrekening,pstambahan;
    private ResultSet rs,rstindakan,rsset_tarif,rsrekening,rstambahan;
    private int i=0,z=0,jmlparsial=0,jml=0,index=0,tinggi=0;
    private String aktifkanparsial="no",kode_poli="",kd_pj="",poli_ralan="No",cara_bayar_ralan="No",
            ...
            URL="",requestJson="",kunjungansakit="true",otorisasi,divreg="",kacab="",userpcare="",kdtacc="",namatacc="",alasantacc="",utc="",nokartu="",kdpolitujuan="",sistole="",distole="",heartrate="",nmpolipacre="",sqlpstambahan="select tambahan_biaya.nama_biaya,tambahan_biaya.besar_biaya from tambahan_biaya where tambahan_biaya.no_rawat=?  ";
    ...
    private PCareCekReferensiDokter dokterpcare=new PCareCekReferensiDokter(null,false);
    ...
    public DlgRawatJalan(java.awt.Frame parent, boolean modal) {
        ...
        for (z= 0; z < 8; z++) {
            TableColumn column = tbriwayat.getColumnModel().getColumn(z);
            if(z==0){
                column.setPreferredWidth(65);
            }else if(z==1){
                column.setPreferredWidth(50);
    ...
    private void initComponents() {
        ...
        DlgKirimKunjuanPcare = new javax.swing.JDialog();
        internalFrame9 = new widget.InternalFrame();
        panelBiasa5 = new widget.PanelBiasa();
        BtnSimpanKunjunganPcare = new widget.Button();
        ...
        BtnTambahBiaya = new widget.Button();
        ...
        TRiwayaObatPRB = new widget.TextArea();
        ...
        BtnOdontogramGigi = new widget.Button();
        BtnSbar = new widget.Button();
        BtnValidasiSbarRalan = new widget.Button();
        ...
        DlgKirimKunjuanPcare.setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        DlgKirimKunjuanPcare.setName("DlgKirimKunjuanPcare"); // NOI18N
        DlgKirimKunjuanPcare.setUndecorated(true);
        DlgKirimKunjuanPcare.setResizable(false);

        internalFrame9.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(230, 235, 225)), "::[ Form Kirim Kunjunagn Ke PCare ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 70, 50))); // NOI18N
        ...
        BtnSimpanKunjunganPcare.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Save.png"))); // NOI18N
        BtnSimpanKunjunganPcare.setMnemonic('T');
        BtnSimpanKunjunganPcare.setText("Simpan");
        BtnSimpanKunjunganPcare.setToolTipText("Alt+T");
        BtnSimpanKunjunganPcare.setName("BtnSimpanKunjunganPcare"); // NOI18N
        BtnSimpanKunjunganPcare.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnSimpanKunjunganPcare.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnSimpanKunjunganPcareActionPerformed(evt);
            }
        });
        panelBiasa5.add(BtnSimpanKunjunganPcare);
        BtnSimpanKunjunganPcare.setBounds(80, 150, 100, 30);
        ...
        BtnKeluar5.setBounds(240, 150, 100, 30);

        LabelPoli4.setText("Tanggal kunjungan :");
        LabelPoli4.setName("LabelPoli4"); // NOI18N
        panelBiasa5.add(LabelPoli4);
        LabelPoli4.setBounds(37, 10, 130, 30);
        ...
        panelBiasa5.add(KdSadar);
        KdSadar.setBounds(110, 50, 50, 23);
        ...
        panelBiasa5.add(NmSadar);
        NmSadar.setBounds(160, 50, 180, 23);
        ...
        panelBiasa5.add(BtnKesadaran);
        BtnKesadaran.setBounds(340, 50, 28, 23);

        LabelPoli6.setText("Tenaga Medis :");
        LabelPoli6.setName("LabelPoli6"); // NOI18N
        panelBiasa5.add(LabelPoli6);
        LabelPoli6.setBounds(10, 80, 94, 23);
        ...
        panelBiasa5.add(KdTenagaMedis);
        KdTenagaMedis.setBounds(110, 80, 50, 23);
        ...
        panelBiasa5.add(NmTenagaMedis);
        NmTenagaMedis.setBounds(160, 80, 180, 23);
        ...
        panelBiasa5.add(BtnTenagaMedis);
        BtnTenagaMedis.setBounds(340, 80, 28, 23);

        LabelPoli7.setText("Diagnosa 1 :");
        LabelPoli7.setName("LabelPoli7"); // NOI18N
        panelBiasa5.add(LabelPoli7);
        LabelPoli7.setBounds(10, 110, 94, 23);
        ...
        panelBiasa5.add(KdDiagnosa1);
        KdDiagnosa1.setBounds(110, 110, 50, 23);
        ...
        panelBiasa5.add(NmDiagnosa1);
        NmDiagnosa1.setBounds(160, 110, 180, 23);
        ...
        panelBiasa5.add(TanggalKunjungan);
        TanggalKunjungan.setBounds(180, 10, 90, 30);

        LabelPoli8.setText("Kesadaran :");
        LabelPoli8.setName("LabelPoli8"); // NOI18N
        panelBiasa5.add(LabelPoli8);
        LabelPoli8.setBounds(10, 50, 97, 23);

        internalFrame9.add(panelBiasa5, java.awt.BorderLayout.CENTER);

        DlgKirimKunjuanPcare.getContentPane().add(internalFrame9, java.awt.BorderLayout.CENTER);
        ...
        scrollPane11.setViewportView(tbTambahan);

        internalFrame10.add(scrollPane11, java.awt.BorderLayout.CENTER);
        ...
        internalFrame10.add(panelisi1, java.awt.BorderLayout.PAGE_END);

        WindowTambahanBiaya.getContentPane().add(internalFrame10, java.awt.BorderLayout.CENTER);
        ...
        BtnTambahBiaya.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Money-32x32.png"))); // NOI18N
        BtnTambahBiaya.setMnemonic('B');
        BtnTambahBiaya.setText("Tambahan Biaya");
        BtnTambahBiaya.setToolTipText("Alt+B");
        BtnTambahBiaya.setName("BtnTambahBiaya"); // NOI18N
        BtnTambahBiaya.setPreferredSize(new java.awt.Dimension(150, 30));
        BtnTambahBiaya.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnTambahBiayaActionPerformed(evt);
            }
        });
        BtnTambahBiaya.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnTambahBiayaKeyPressed(evt);
            }
        });
        panelGlass8.add(BtnTambahBiaya);
        ...
        Scroll3.setPreferredSize(new java.awt.Dimension(452, 350));
        ...
        jLabel58.setBounds(910, 80, 150, 23);

        jLabel59.setText("Riwayat Obat PRB :");
        jLabel59.setName("jLabel59"); // NOI18N
        panelGlass12.add(jLabel59);
        jLabel59.setBounds(920, 140, 100, 23);
        ...
        scrollPane5.setBounds(930, 30, 70, 50);
        ...
        panelGlass12.add(scrollPane9);
        scrollPane9.setBounds(930, 100, 80, 38);

        scrollPane10.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane10.setName("scrollPane10"); // NOI18N

        TRiwayaObatPRB.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        TRiwayaObatPRB.setColumns(20);
        TRiwayaObatPRB.setRows(5);
        TRiwayaObatPRB.setName("TRiwayaObatPRB"); // NOI18N
        TRiwayaObatPRB.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TRiwayaObatPRBKeyPressed(evt);
            }
        });
        scrollPane10.setViewportView(TRiwayaObatPRB);

        panelGlass12.add(scrollPane10);
        scrollPane10.setBounds(930, 160, 120, 60);

        jLabel61.setText("Riwayat Penyakit Dahulu :");
        jLabel61.setName("jLabel61"); // NOI18N
        panelGlass12.add(jLabel61);
        jLabel61.setBounds(910, 10, 130, 23);
        ...
        Scroll1.setBounds(1060, 80, 550, 150);
        ...
        BtnOdontogramGigi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnOdontogramGigi.setText("Pemeriksaan Odontogram");
        BtnOdontogramGigi.setFocusPainted(false);
        BtnOdontogramGigi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnOdontogramGigi.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnOdontogramGigi.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnOdontogramGigi.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnOdontogramGigi.setName("BtnOdontogramGigi"); // NOI18N
        BtnOdontogramGigi.setPreferredSize(new java.awt.Dimension(180, 23));
        BtnOdontogramGigi.setRoundRect(false);
        BtnOdontogramGigi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnOdontogramGigiActionPerformed(evt);
            }
        });
        FormMenu.add(BtnOdontogramGigi);

        BtnSbar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnSbar.setText("SBAR Ralan");
        BtnSbar.setFocusPainted(false);
        BtnSbar.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnSbar.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnSbar.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnSbar.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnSbar.setName("BtnSbar"); // NOI18N
        BtnSbar.setPreferredSize(new java.awt.Dimension(180, 23));
        BtnSbar.setRoundRect(false);
        BtnSbar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnSbarActionPerformed(evt);
            }
        });
        FormMenu.add(BtnSbar);

        BtnValidasiSbarRalan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnValidasiSbarRalan.setText("Validasi SBAR Ralan");
        BtnValidasiSbarRalan.setFocusPainted(false);
        BtnValidasiSbarRalan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnValidasiSbarRalan.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnValidasiSbarRalan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnValidasiSbarRalan.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnValidasiSbarRalan.setName("BtnValidasiSbarRalan"); // NOI18N
        BtnValidasiSbarRalan.setPreferredSize(new java.awt.Dimension(180, 23));
        BtnValidasiSbarRalan.setRoundRect(false);
        BtnValidasiSbarRalan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnValidasiSbarRalanActionPerformed(evt);
            }
        });
        FormMenu.add(BtnValidasiSbarRalan);
...
//       if(Sequel.cariInteger("select no_rawat from diagnosa_pasien where no_rawat ='"+TNoRw.getText()+"' ")==0){
//           JOptionPane.showMessageDialog(null, "Silahkan di Input Diagnosa ICD...");
...
//       }
        ...
        try {
            ...
            if(i==JOptionPane.YES_OPTION){
                Sequel.mengedit("reg_periksa","no_rawat=?","stts=?",2,new String[]{"Sudah",TNoRw.getText()});
                if(Sequel.cariInteger("select count(ro.no_rawat) from resep_dokter rd inner join resep_obat ro on ro.no_resep=rd.no_resep  where ro.no_rawat='"+TNoRw.getText()+"' ")>1){
                    Sequel.mengedit("m_status_tracer","no_rawat=?","status=?",2,new String[]{"Dengan Resep",TNoRw.getText()});
                }else{
                    Sequel.mengedit("m_status_tracer","no_rawat=?","status=?",2,new String[]{"Tanpa Resep",TNoRw.getText()});
                } 
            }
        } catch (Exception e) {
        }
...
//                                        SpO2.setText("");TEvaluasi.setText("");
                                     ...
                                     Sequel.meghapus("obat_prb","no_rkm_medis",TNoRM.getText());
                                     Sequel.menyimpan("obat_prb","?,?","Data",2, new String[]{
                                            TNoRM.getText(),TRiwayaObatPRB.getText() 
                                            });
                                     
//                                   Sequel.mengedit("obat_prb","catatan='"+TRiwayaObatPRB.getText()+"'","no_rkm_medis='"+TNoRM.getText()+"'");
                                    tampilPemeriksaan();
                                     //Sequel.menyimpan("m_input_riwayat","'"+TNoRM.getText()+"','"+TRiwayatDulu.getText()+"','"+TRiwayaKeluarga.getText()+"' ","riwayat_dulu='"+TRiwayatDulu.getText()+"',riwayat_keluarga='"+TRiwayaKeluarga.getText()+"'","no_rkm_medis='"+TNoRM.getText()+"'");
...
//                                            SpO2.setText("");TEvaluasi.setText("");
                            ...
                            TCari.requestFocus();
                        }if(CaraBayar.getText().trim().equals("BPJS")){
                            DlgKirimKunjuanPcare.setSize(400,236);
                            DlgKirimKunjuanPcare.setLocationRelativeTo(internalFrame1);
                            DlgKirimKunjuanPcare.setVisible(true);
                            caridatapacer();
                        }else{
                            TabRawat.setSelectedIndex(6);
                        }
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void BtnOdontogramGigiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnOdontogramGigiActionPerformed
      if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{ 
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            DlgOdontogram form=new DlgOdontogram(null,false);
            form.isCek();
            form.emptTeks();
            form.setNoRm(TNoRw.getText(),DTPCari2.getDate());
            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
    ...
    }//GEN-LAST:event_BtnOdontogramGigiActionPerformed

    private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
        isForm();
    }//GEN-LAST:event_ChkInputActionPerformed

    private void TRiwayaObatPRBKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TRiwayaObatPRBKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_TRiwayaObatPRBKeyPressed

    private void BtnKeluar5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKeluar5ActionPerformed
        DlgKirimKunjuanPcare.dispose();
        tampilPemeriksaan();
    }//GEN-LAST:event_BtnKeluar5ActionPerformed

    private void BtnSimpanKunjunganPcareActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanKunjunganPcareActionPerformed
                if(TKeluhan.getText().trim().equals("")){
                    Valid.textKosong(TKeluhan,"Keluhan");
                }else if(TPenilaian.getText().trim().equals("")){
                     Valid.textKosong(TPenilaian,"Assesmen");     
...
//                }else if(TTinggi.getText().trim().equals("")||TTinggi.getText().trim().equals("0")){
//                    Valid.textKosong(TTinggi,"Tinggi Badan");
//                }else if(TBerat.getText().trim().equals("")||TBerat.getText().trim().equals("0")){
//                    Valid.textKosong(TBerat,"Berat Badan");
//                }else if(sistole.trim().equals("")||sistole.trim().equals("0")){
//                   JOptionPane.showMessageDialog(null,"Maaf data tidak sesuai dibagian sistole, konfirm ke pendaftaran...!!");
//                }else if(distole.trim().equals("")||distole.trim().equals("0")){
//                    JOptionPane.showMessageDialog(null,"Maaf data tidak sesuai dibagian diastole, konfirm ke pendaftaran...!!");
//                }else if(TRespirasi.getText().trim().equals("")||TRespirasi.getText().trim().equals("0")){
//                    Valid.textKosong(TRespirasi,"Respiratory Rate");
//                }else if(LingkarPerut.getText().trim().equals("")||LingkarPerut.getText().trim().equals("0")){
//                    Valid.textKosong(LingkarPerut,"Lingkar Perut");
//                }else if(heartrate.trim().equals("")||heartrate.trim().equals("0")){
//                    JOptionPane.showMessageDialog(null,"Maaf data tidak sesuai dibagian heart rate, konfirm ke pendaftaran...!!");
...
//                    Valid.textKosong(BtnKesadaran,"Kesadaran");
    ...
    }//GEN-LAST:event_BtnSimpanKunjunganPcareActionPerformed
    ...
    private void BtnTambahBiayaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTambahBiayaActionPerformed
       if(Sequel.cariRegistrasi(TNoRw.getText())>0){
        JOptionPane.showMessageDialog(rootPane,"Data billing sudah terverifikasi..!!");
    }else{ 
    ...
    }//GEN-LAST:event_BtnTambahBiayaActionPerformed

    private void BtnTambahBiayaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnTambahBiayaKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnTambahBiayaKeyPressed
    ...
    private void BtnValidasiSbarRalanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnValidasiSbarRalanActionPerformed
          if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
    ...
    }//GEN-LAST:event_BtnValidasiSbarRalanActionPerformed
    ...
    */
    ...
    private widget.Button BtnOdontogramGigi;
    ...
    private widget.Button BtnSimpanKunjunganPcare;
    ...
    private widget.Button BtnTambahBiaya;
    ...
    private widget.Button BtnValidasiSbarRalan;
    ...
    private javax.swing.JDialog DlgKirimKunjuanPcare;
    ...
    private widget.TextArea TRiwayaObatPRB;
    ...
    public void SetPj(String KodePj){
        this.kd_pj=KodePj;
        CaraBayar.setText(Sequel.cariIsi("select png_jawab from penjab where kd_pj='"+kd_pj+"'"));
    }
    ...
    private void riwayat() {
        ...
        TRiwayaObatPRB.setText(Sequel.cariIsi("select catatan from obat_prb where no_rkm_medis ='"+TNoRM.getText()+"' "));
    }
   ...
   private void tampilriwayat() {
        Valid.tabelKosong(tabModeRiwayat);
         this.poli=Sequel.cariIsi("select kd_poli from reg_periksa where no_rawat='"+TNoRw.getText()+"' ");
            try{
                ps=koneksi.prepareStatement(
                        ...
                        "reg_periksa.no_rkm_medis=? and reg_periksa.kd_poli=? and pemeriksaan_ralan.nip in (select kd_dokter from dokter) "+
