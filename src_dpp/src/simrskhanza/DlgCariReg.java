...
public final class DlgCariReg extends javax.swing.JDialog {
    ...
    public DlgCariReg(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Biaya Regristrasi","Status","No.Telp","Stts Rawat","Stts Poli","Kode Poli","Kode PJ","No.Kartu","No.NIK"
        }){
    ...
    private void tampil() {
        ...
        try {
            ps=koneksi.prepareStatement("select reg_periksa.no_reg,reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.jam_reg,"+
                ...
                "reg_periksa.kd_poli,reg_periksa.kd_pj,pasien.no_peserta,pasien.no_ktp from reg_periksa inner join dokter on reg_periksa.kd_dokter=dokter.kd_dokter inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
            ...
            try{  
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[] {rs.getString(1),
                                   ...
                                   rs.getString("no_peserta"),rs.getString("no_ktp")
                    });
                }                    
            }catch(Exception e){
