...
public final class MobileJKNFKTPReferensiDokter extends javax.swing.JDialog {
    ...
    private int i=0;
    private ApiAntreanBPJSFKTP api=new ApiAntreanBPJSFKTP();
    ...
    public MobileJKNFKTPReferensiDokter(java.awt.Frame parent, boolean modal) {
        ...
        try {
           // otorisasi=koneksiDB.USERKEYANTREANFKTP()+":"+koneksiDB.PASS()+":095";
            link=koneksiDB.URLANTREANFKTP();
        } catch (Exception e) {
            ...
            if(nameNode.path("message").asText().equals("OK")){
                ...
                if(response.isArray()){
                    ...
                    for(JsonNode list:response){
                        ...
                        headers2.add("X-cons-id",koneksiDB.CONSIDANTREANFKTP());
                        utc=String.valueOf(api.GetUTCdatetimeAsString());
                        ...
                        headers2.add("user_key",koneksiDB.USERKEYANTREANFKTP());
