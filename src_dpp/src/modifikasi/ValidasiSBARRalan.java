...
//    private SimpleDateFormat tanggalNow = new SimpleDateFormat("dd-MM-yyyy");
    ...
    public ValidasiSBARRalan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "A (ASSESSMENT)","R (RECOMENDATION)","Tulis/Ketik (Advis Dokter)","Baca","Konfirmasi"
        }){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Validasi SBAR Rawat Jalan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 13), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        scrollPane1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "S (SITUATION)", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 13))); // NOI18N
        ...
        scrollPane2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "B (BACKGROUND)", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 13))); // NOI18N
        ...
        scrollPane3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "A (ASSESSMENT)", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 13))); // NOI18N
        ...
        scrollPane4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "R (RECOMMENDATION)", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 13))); // NOI18N
        ...
        jLabel94.setBounds(760, 140, 90, 23);
        ...
        jLabel70.setBounds(770, 160, 80, 23);
        ...
        scrollPane12.setBounds(860, 140, 360, 70);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().equals("")||TNoRM.getText().equals("")||TPasien.getText().equals("")){
            ...
            if(Sequel.menyimpantf("validasi_pemeriksaan_sbar","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",15,new String[]{
                    ...
                    KodeDokter1.getText(),KodeDokter.getText(),tanggalNow.format(new Date()),jamNow.format(new Date()),"Validasi",Tulis.getText(),
    ...
    */
        ...
        try{
            if(TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "pemeriksaan_ralan_sbar.background,pemeriksaan_ralan_sbar.assesment,pemeriksaan_ralan_sbar.recommendation,pemeriksaan_ralan_sbar.nip,pegawai.nama, "+ 
                    "pemeriksaan_ralan_sbar.tulis,pemeriksaan_ralan_sbar.baca,pemeriksaan_ralan_sbar.konfirmasi from pasien inner join reg_periksa inner join pemeriksaan_ralan_sbar "+
                    "on pemeriksaan_ralan_sbar.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join pegawai on pemeriksaan_ralan_sbar.nip=pegawai.nik LEFT JOIN validasi_pemeriksaan_sbar ON validasi_pemeriksaan_sbar.no_rawat = pemeriksaan_ralan_sbar.no_rawat AND validasi_pemeriksaan_sbar.tgl_perawatan = pemeriksaan_ralan_sbar.tgl_perawatan AND validasi_pemeriksaan_sbar.jam_rawat = pemeriksaan_ralan_sbar.jam_rawat where "+
                    "pemeriksaan_ralan_sbar.no_rawat like ? and ISNULL(validasi_pemeriksaan_sbar.status_validasi) order by pemeriksaan_ralan_sbar.no_rawat desc");
            }else{
                ps=koneksi.prepareStatement(
                    "select reg_periksa.tgl_registrasi,reg_periksa.status_lanjut,pemeriksaan_ralan_sbar.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
                    "pemeriksaan_ralan_sbar.tgl_perawatan,pemeriksaan_ralan_sbar.jam_rawat,pemeriksaan_ralan_sbar.situation, " +
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("tgl_perawatan"),rs.getString("jam_rawat"),rs.getString("situation"),rs.getString("background"),rs.getString("assesment"),rs.getString("recommendation"),rs.getString("tulis"),
                        rs.getString("baca"),rs.getString("konfirmasi")
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Tulis.setText(tbObat.getValueAt(tbObat.getSelectedRow(),13).toString()); 
            Baca.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),14).toString());
            Konfirmasi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),15).toString());
        }
    }
