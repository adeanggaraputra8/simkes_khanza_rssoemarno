 ...
 * @author dosen
 */
public final class DlgTaskId_belumm extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgTaskId_belumm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void addantrianActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addantrianActionPerformed
        ...
        Sequel.mengedit("antrian_bantu_belum","no_rawat='"+tbJnsPerawatan.getValueAt(i,0).toString()+"'","status='Sudah Valid',tanggal2=tanggal1 + INTERVAL "+Sequel.cariIsi("SELECT FLOOR(RAND()*(1-15+1))+15")+" MINUTE ");
        } 
    ...
    private void task1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_task1ActionPerformed
        for(i=0;i<tbJnsPerawatan.getRowCount();i++){
            try {
             datajam=Sequel.cariIsi("SELECT tanggal1  FROM  antrian_bantu_belum ab  WHERE  no_rawat=? AND  tanggal1 <>'0000-00-00 00:00:00'",tbJnsPerawatan.getValueAt(i,0).toString());
                if(!datajam.equals("")){
                        parsedDate = dateFormat.parse(datajam);
                        try {     
                            headers = new HttpHeaders();
                ...
                Sequel.mengedit("antrian_bantu_belum","no_rawat='"+tbJnsPerawatan.getValueAt(i,0).toString()+"'","status='Sudah Valid',tanggal3=tanggal2 + INTERVAL "+Sequel.cariIsi("SELECT FLOOR(RAND()*(2-8+1))+8")+" MINUTE ");
    ...
    private void task2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_task2ActionPerformed
        for(i=0;i<tbJnsPerawatan.getRowCount();i++){
            try {
             datajam=Sequel.cariIsi("SELECT tanggal2  FROM  antrian_bantu_belum ab  WHERE  no_rawat=? AND  tanggal2 <>'0000-00-00 00:00:00'",tbJnsPerawatan.getValueAt(i,0).toString());
                if(!datajam.equals("")){
                        parsedDate = dateFormat.parse(datajam);
                        try {     
                            headers = new HttpHeaders();
                   ...
                   Sequel.mengedit("antrian_bantu_belum","no_rawat='"+tbJnsPerawatan.getValueAt(i,0).toString()+"'","status='Sudah Valid',tanggal4=tanggal3 + INTERVAL "+Sequel.cariIsi("SELECT FLOOR(RAND()*(15-30+1))+30")+" MINUTE ");
                }
             }catch(Exception e){
            System.out.println("Notifikasi : "+e);
        }
    ...
    private void task3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_task3ActionPerformed
       for(i=0;i<tbJnsPerawatan.getRowCount();i++){
            try {
             datajam=Sequel.cariIsi("SELECT tanggal3  FROM  antrian_bantu_belum ab  WHERE  no_rawat=? AND  tanggal3 <>'0000-00-00 00:00:00'",tbJnsPerawatan.getValueAt(i,0).toString());
                if(!datajam.equals("")){
                        parsedDate = dateFormat.parse(datajam);
                        try {     
                            headers = new HttpHeaders();
                   ...
                   Sequel.mengedit("antrian_bantu_belum","no_rawat='"+tbJnsPerawatan.getValueAt(i,0).toString()+"'","status='Sudah Valid',tanggal5=tanggal4 + INTERVAL "+Sequel.cariIsi("SELECT FLOOR(RAND()*(1-15+1))+15")+" MINUTE ");
                }
             }catch(Exception e){
            System.out.println("Notifikasi : "+e);
        }
    ...
    private void task4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_task4ActionPerformed
         for(i=0;i<tbJnsPerawatan.getRowCount();i++){
            try {
             datajam=Sequel.cariIsi("SELECT tanggal4  FROM  antrian_bantu_belum ab  WHERE  no_rawat=? AND  tanggal4 <>'0000-00-00 00:00:00'",tbJnsPerawatan.getValueAt(i,0).toString());
                if(!datajam.equals("")){
                        parsedDate = dateFormat.parse(datajam);
                        try {     
                            headers = new HttpHeaders();
                  ...
                  Sequel.mengedit("antrian_bantu_belum","no_rawat='"+tbJnsPerawatan.getValueAt(i,0).toString()+"'","status='Sudah Valid',tanggal6=tanggal5 + INTERVAL "+Sequel.cariIsi("SELECT FLOOR(RAND()*(5-30+1))+30")+" MINUTE ");
                }
             }catch(Exception e){
            System.out.println("Notifikasi : "+e);
        }
    ...
    private void task5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_task5ActionPerformed
      for(i=0;i<tbJnsPerawatan.getRowCount();i++){
            try {
             datajam=Sequel.cariIsi("SELECT tanggal5  FROM  antrian_bantu_belum ab  WHERE  no_rawat=? AND  tanggal5 <>'0000-00-00 00:00:00'",tbJnsPerawatan.getValueAt(i,0).toString());
                if(!datajam.equals("")){
                        parsedDate = dateFormat.parse(datajam);
                        try {     
                            headers = new HttpHeaders();
                  ...
                  Sequel.mengedit("antrian_bantu_belum","no_rawat='"+tbJnsPerawatan.getValueAt(i,0).toString()+"'","status='Sudah Valid',tanggal7=tanggal6 + INTERVAL "+Sequel.cariIsi("SELECT FLOOR(RAND()*(1-5+1))+5")+" MINUTE ");    
                }
             }catch(Exception e){
            System.out.println("Notifikasi : "+e);
        }
    ...
    private void task6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_task6ActionPerformed
       for(i=0;i<tbJnsPerawatan.getRowCount();i++){
            try {
             datajam=Sequel.cariIsi("SELECT tanggal6  FROM  antrian_bantu_belum ab  WHERE  no_rawat=? AND  tanggal6 <>'0000-00-00 00:00:00'",tbJnsPerawatan.getValueAt(i,0).toString());
                if(!datajam.equals("")){
                        parsedDate = dateFormat.parse(datajam);
                        try {     
                            headers = new HttpHeaders();
    ...
    private void task7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_task7ActionPerformed
        for(i=0;i<tbJnsPerawatan.getRowCount();i++){
            try {
             datajam=Sequel.cariIsi("SELECT tanggal7  FROM  antrian_bantu_belum ab  WHERE  no_rawat=? AND  tanggal7 <>'0000-00-00 00:00:00'",tbJnsPerawatan.getValueAt(i,0).toString());
                if(!datajam.equals("")){
                        parsedDate = dateFormat.parse(datajam);
                        try {     
                            headers = new HttpHeaders();
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                   " select antrian_bantu_belum.no_rawat,'' as no_reg,'' as tgl_registrasi,'' as kd_dokter,'' as kd_poli,'' as stts_daftar,'' as no_rkm_medis,'' as no_rujukan,'' as no_peserta,'' as no_tlp,'' as no_ktp,antrian_bantu_belum.tanggal1,antrian_bantu_belum.tanggal2,antrian_bantu_belum.tanggal3,antrian_bantu_belum.tanggal4,antrian_bantu_belum.tanggal5,antrian_bantu_belum.tanggal6,antrian_bantu_belum.tanggal7,antrian_bantu_belum.no_sep,'' as jeniskunjungan " +
                   " from antrian_bantu_belum  where " +
                   " antrian_bantu_belum.tanggal1 BETWEEN ? AND ? "+(TCari.getText().equals("")?"":
                   " and antrian_bantu_belum.kd_booking LIKE ? ") +
                   " order by antrian_bantu_belum.tanggal1 asc ");
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("no_rujukan"),rs.getString("no_peserta"),rs.getString("no_tlp"),
                        ...
                        rs.getString("tanggal6"),rs.getString("tanggal7"),rs.getString("no_reg"),rs.getString("no_sep")
                    });
