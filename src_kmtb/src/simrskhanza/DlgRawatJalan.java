...
import modifikasi.DlgOftamonologi;
...
public final class DlgRawatJalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnOftamologi = new widget.Button();
        ...
        BtnOftamologi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnOftamologi.setText("Pemeriksaan Oftamologi");
        BtnOftamologi.setFocusPainted(false);
        BtnOftamologi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnOftamologi.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnOftamologi.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnOftamologi.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnOftamologi.setName("BtnOftamologi"); // NOI18N
        BtnOftamologi.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnOftamologi.setRoundRect(false);
        BtnOftamologi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnOftamologiActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnOftamologi);
        BtnOftamologi.setBounds(920, 10, 140, 23);
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-05-2024" }));
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void BtnOftamologiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnOftamologiActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        DlgOftamonologi perawatan=new DlgOftamonologi(null,false);
        perawatan.setNoRm(TNoRw.getText(),TNoRM.getText(),TPasien.getText(),DTPTgl.getDate());
        perawatan.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
        perawatan.setLocationRelativeTo(internalFrame1);
        perawatan.setAlwaysOnTop(false);
        perawatan.setVisible(true);
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_BtnOftamologiActionPerformed
    ...
    */
    ...
    private widget.Button BtnOftamologi;
