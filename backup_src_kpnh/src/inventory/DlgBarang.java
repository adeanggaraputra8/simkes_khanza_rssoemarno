...
import modifikasi.DlgCariPoliMaping;
import modifikasi.DlgMapingObatPoli;
import modifikasi.DlgMasterKelasTerapi;
import modifikasi.DlgMasterLetak;
...
public class DlgBarang extends javax.swing.JDialog {
    ...
    public DlgMasterLetak letak = new DlgMasterLetak(null, false);
    public DlgMasterKelasTerapi terapi = new DlgMasterKelasTerapi(null, false);
    ...
    private PreparedStatement ps, ps2, ps3, ps4, psdx;
    private ResultSet rs, rs2, rs3, rsdx;
    ...
    private String kdlokasi = "", nmlokasi = "", tanggal = "0000-00-00",qrystok="", dxralan="";
    ...
    public DlgBarang(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,new Object[]{
            ...
            "Kode Golongan","Golongan","Modal","Grosir","Status","Letak Barang","Lasa","Life Saving","High Alert","Retriksi",
            "Kelas Terapi"
        }) {
            @Override
        ...
        grosir.setDocument(new batasInput((byte) 15).getKata(grosir));
        modal1.setDocument(new batasInput((byte) 15).getKata(modal1));
       ...
       letak.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {
            }
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgBarang")) {
                    if (letak.getTable().getSelectedRow() != -1) {
                        //kdgolongan.setText(golongan.getTable().getValueAt(golongan.getTable().getSelectedRow(), 0).toString());
                        tempat.setText(letak.getTable().getValueAt(letak.getTable().getSelectedRow(), 1).toString());
                    }
                }
                BtnLetak.requestFocus();
            }
        ...
        letak.getTable().addKeyListener(new KeyListener() {
            @Override
       ...
       terapi.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {
            }
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgBarang")) {
                    if (terapi.getTable().getSelectedRow() != -1) {
                        //kdgolongan.setText(golongan.getTable().getValueAt(golongan.getTable().getSelectedRow(), 0).toString());
                        K_terapi.setText(terapi.getTable().getValueAt(terapi.getTable().getSelectedRow(), 1).toString());
                    }
                }
                BtnKelasTerapi.requestFocus();
            }
        ...
        terapi.getTable().addKeyListener(new KeyListener() {
            @Override
            public void keyTyped(KeyEvent e) {}
            @Override
            public void keyPressed(KeyEvent e) {
    ...
    private void initComponents() {
        ...
        MnMapingObat = new javax.swing.JMenuItem();
        MnMappingObatLangsung = new javax.swing.JMenuItem();
        ...
        persenralan = new widget.TextBox();
        persenbebas = new widget.TextBox();
        persenkaryawan = new widget.TextBox();
        label41 = new widget.Label();
        modal1 = new widget.TextBox();
        label42 = new widget.Label();
        grosir = new widget.TextBox();
        status_bayar = new widget.ComboBox();
        label43 = new widget.Label();
        label44 = new widget.Label();
        tempat = new widget.TextBox();
        label45 = new widget.Label();
        lasal = new widget.ComboBox();
        label46 = new widget.Label();
        lifesaving = new widget.ComboBox();
        label47 = new widget.Label();
        highalert = new widget.ComboBox();
        scrollPane2 = new widget.ScrollPane();
        TRetriksi = new widget.TextArea();
        label48 = new widget.Label();
        BtnLetak = new widget.Button();
        ...
        MnMapingObat.setBackground(new java.awt.Color(255, 255, 254));
        MnMapingObat.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnMapingObat.setForeground(new java.awt.Color(50, 50, 50));
        MnMapingObat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnMapingObat.setText("Mapinng Obat Poli");
        MnMapingObat.setToolTipText("");
        MnMapingObat.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnMapingObat.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnMapingObat.setName("MnMapingObat"); // NOI18N
        MnMapingObat.setPreferredSize(new java.awt.Dimension(200, 26));
        MnMapingObat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnMapingObatActionPerformed(evt);
            }
        });
        Popup.add(MnMapingObat);

        MnMappingObatLangsung.setBackground(new java.awt.Color(255, 255, 254));
        MnMappingObatLangsung.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnMappingObatLangsung.setForeground(new java.awt.Color(50, 50, 50));
        MnMappingObatLangsung.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnMappingObatLangsung.setText("Mapinng Obat Poli Per Item");
        MnMappingObatLangsung.setToolTipText("");
        MnMappingObatLangsung.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnMappingObatLangsung.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnMappingObatLangsung.setName("MnMappingObatLangsung"); // NOI18N
        MnMappingObatLangsung.setPreferredSize(new java.awt.Dimension(200, 26));
        MnMappingObatLangsung.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnMappingObatLangsungActionPerformed(evt);
            }
        });
        Popup.add(MnMappingObatLangsung);
        ...
        label26.setBounds(258, 282, 110, 23);
        ...
        FormInput.add(ralan);
        ralan.setBounds(117, 282, 100, 23);
        ...
        persenralan.setEditable(false);
        persenralan.setName("persenralan"); // NOI18N
        persenralan.setPreferredSize(new java.awt.Dimension(207, 23));
        persenralan.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseMoved(java.awt.event.MouseEvent evt) {
                persenralanMouseMoved(evt);
            }
        });
        persenralan.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseExited(java.awt.event.MouseEvent evt) {
                persenralanMouseExited(evt);
            }
        });
        persenralan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                persenralanActionPerformed(evt);
            }
        });
        persenralan.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                persenralanKeyPressed(evt);
            }
        });
        FormInput.add(persenralan);
        persenralan.setBounds(215, 282, 45, 23);

        persenbebas.setEditable(false);
        persenbebas.setName("persenbebas"); // NOI18N
        persenbebas.setPreferredSize(new java.awt.Dimension(207, 23));
        persenbebas.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseMoved(java.awt.event.MouseEvent evt) {
                persenbebasMouseMoved(evt);
            }
        });
        persenbebas.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseExited(java.awt.event.MouseEvent evt) {
                persenbebasMouseExited(evt);
            }
        });
        persenbebas.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                persenbebasKeyPressed(evt);
            }
        });
        FormInput.add(persenbebas);
        persenbebas.setBounds(740, 190, 50, 23);

        persenkaryawan.setEditable(false);
        persenkaryawan.setName("persenkaryawan"); // NOI18N
        persenkaryawan.setPreferredSize(new java.awt.Dimension(207, 23));
        persenkaryawan.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseMoved(java.awt.event.MouseEvent evt) {
                persenkaryawanMouseMoved(evt);
            }
        });
        persenkaryawan.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseExited(java.awt.event.MouseEvent evt) {
                persenkaryawanMouseExited(evt);
            }
        });
        persenkaryawan.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                persenkaryawanKeyPressed(evt);
            }
        });
        FormInput.add(persenkaryawan);
        persenkaryawan.setBounds(740, 220, 50, 23);

        label41.setText("Hrg Modal : Rp.");
        label41.setName("label41"); // NOI18N
        label41.setPreferredSize(new java.awt.Dimension(65, 23));
        FormInput.add(label41);
        label41.setBounds(750, 20, 90, 23);

        modal1.setName("modal1"); // NOI18N
        modal1.setPreferredSize(new java.awt.Dimension(207, 23));
        modal1.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseMoved(java.awt.event.MouseEvent evt) {
                modal1MouseMoved(evt);
            }
        });
        modal1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseExited(java.awt.event.MouseEvent evt) {
                modal1MouseExited(evt);
            }
        });
        modal1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                modal1KeyPressed(evt);
            }
        });
        FormInput.add(modal1);
        modal1.setBounds(850, 20, 110, 23);

        label42.setText("Hrg Grosir : Rp.");
        label42.setName("label42"); // NOI18N
        label42.setPreferredSize(new java.awt.Dimension(65, 23));
        FormInput.add(label42);
        label42.setBounds(750, 50, 90, 23);

        grosir.setName("grosir"); // NOI18N
        grosir.setPreferredSize(new java.awt.Dimension(207, 23));
        ...
        grosir.setBounds(850, 50, 110, 23);

        status_bayar.setForeground(new java.awt.Color(50, 70, 50));
        status_bayar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "BPJS", "Reguler" }));
        status_bayar.setName("status_bayar"); // NOI18N
        status_bayar.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                status_bayarItemStateChanged(evt);
            }
        });
        status_bayar.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                status_bayarMouseClicked(evt);
            }
        });
        ...
        status_bayar.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                status_bayarKeyPressed(evt);
            }
        });
        ...
        label44.setBounds(760, 110, 80, 23);

        tempat.setEditable(false);
        tempat.setName("tempat"); // NOI18N
        tempat.setPreferredSize(new java.awt.Dimension(207, 23));
        ...
        tempat.setBounds(840, 110, 190, 23);
        ...
        label45.setBounds(770, 140, 80, 23);
        ...
        lasal.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                lasalItemStateChanged(evt);
            }
        });
        lasal.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lasalMouseClicked(evt);
            }
        });
        lasal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                lasalActionPerformed(evt);
            }
        });
        lasal.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                lasalKeyPressed(evt);
            }
        });
        FormInput.add(lasal);
        lasal.setBounds(850, 140, 90, 23);

        label46.setText(" Life Saving : ");
        label46.setName("label46"); // NOI18N
        label46.setPreferredSize(new java.awt.Dimension(65, 23));
        FormInput.add(label46);
        label46.setBounds(770, 170, 80, 23);

        lifesaving.setForeground(new java.awt.Color(50, 70, 50));
        lifesaving.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "Life Saving" }));
        lifesaving.setName("lifesaving"); // NOI18N
        lifesaving.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                lifesavingItemStateChanged(evt);
            }
        });
        lifesaving.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lifesavingMouseClicked(evt);
            }
        });
        lifesaving.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                lifesavingActionPerformed(evt);
            }
        });
        lifesaving.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                lifesavingKeyPressed(evt);
            }
        });
        FormInput.add(lifesaving);
        lifesaving.setBounds(850, 170, 90, 23);

        label47.setText(" High alert : ");
        label47.setName("label47"); // NOI18N
        label47.setPreferredSize(new java.awt.Dimension(65, 23));
        FormInput.add(label47);
        label47.setBounds(740, 200, 110, 23);

        highalert.setForeground(new java.awt.Color(50, 70, 50));
        highalert.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "High Alert" }));
        highalert.setName("highalert"); // NOI18N
        highalert.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                highalertItemStateChanged(evt);
            }
        });
        highalert.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                highalertMouseClicked(evt);
            }
        });
        ...
        highalert.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                highalertKeyPressed(evt);
            }
        });
        FormInput.add(highalert);
        highalert.setBounds(850, 200, 90, 23);

        scrollPane2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane2.setName("scrollPane2"); // NOI18N

        TRetriksi.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        TRetriksi.setColumns(20);
        TRetriksi.setRows(5);
        TRetriksi.setName("TRetriksi"); // NOI18N
        TRetriksi.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TRetriksiKeyPressed(evt);
            }
        });
        ...
        label48.setBounds(960, 20, 90, 23);

        BtnLetak.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnLetak.setMnemonic('2');
        BtnLetak.setToolTipText("Alt+2");
        BtnLetak.setName("BtnLetak"); // NOI18N
        BtnLetak.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnLetak.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnLetakActionPerformed(evt);
            }
        });
        BtnLetak.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnLetakKeyPressed(evt);
            }
        });
        FormInput.add(BtnLetak);
        BtnLetak.setBounds(1030, 110, 25, 23);

        K_terapi.setEditable(false);
        K_terapi.setName("K_terapi"); // NOI18N
        K_terapi.setPreferredSize(new java.awt.Dimension(207, 23));
        K_terapi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                K_terapiActionPerformed(evt);
            }
        });
        K_terapi.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                K_terapiKeyPressed(evt);
            }
        });
        FormInput.add(K_terapi);
        K_terapi.setBounds(840, 250, 190, 23);

        label49.setText("Kelas Terapi :");
        label49.setName("label49"); // NOI18N
        label49.setPreferredSize(new java.awt.Dimension(65, 23));
        FormInput.add(label49);
        label49.setBounds(740, 250, 80, 23);

        BtnKelasTerapi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnKelasTerapi.setMnemonic('2');
        BtnKelasTerapi.setToolTipText("Alt+2");
        BtnKelasTerapi.setName("BtnKelasTerapi"); // NOI18N
        BtnKelasTerapi.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnKelasTerapi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnKelasTerapiActionPerformed(evt);
            }
        });
        BtnKelasTerapi.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnKelasTerapiKeyPressed(evt);
            }
        });
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (Kd.getText().trim().equals("")) {
        ...
        } else if (modal1.getText().trim().equals("")) {
            Valid.textKosong(modal1, "Harga Modal");
        } else if (grosir.getText().trim().equals("")) {
            Valid.textKosong(grosir, "Harga Obat Grosir");
        } else {
            ...
            Valid.editTable(tabMode, "databarang", "kode_brng", "?", "nama_brng=?,kode_brng=?,kapasitas=?,kode_sat=?,letak_barang=?,"
                    ...
                    + "karyawan=?,expire=?,kode_industri=?,kode_kategori=?,kode_golongan=?,kode_satbesar=?,dasar=?,isi=?,modal=?,grosir=?,status_bayar=?,tempat=?,lasal=?,lifesaving=?,highalert=?,retriksi=?,kelas_terapi=?", 35, new String[]{
                        ...
                        kdkategori.getText(),kdgolongan.getText(),kdsatBesar.getText(),dasar.getText(),Isi.getText(),modal1.getText(),grosir.getText(),
                        status_bayar.getSelectedItem().toString(),tempat.getText(),lasal.getSelectedItem().toString(),lifesaving.getSelectedItem().toString(),highalert.getSelectedItem().toString(),TRetriksi.getText(),K_terapi.getText(),
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Kd.getText().trim().equals("")) {
            ...
            if(Sequel.menyimpantf("databarang", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Kode Barang", 35, new String[]{
                ...
                KdIF.getText(),kdkategori.getText(),kdgolongan.getText(),modal1.getText(),grosir.getText(),
                status_bayar.getSelectedItem().toString(),tempat.getText(),lasal.getSelectedItem().toString(),lifesaving.getSelectedItem().toString(),highalert.getSelectedItem().toString(),TRetriksi.getText(),K_terapi.getText()
                })==true){
                    tampil();
                    emptTeks();
...
private void KapasitasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KapasitasKeyPressed
    ...
    private void DTPExpiredKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DTPExpiredKeyPressed
        Valid.pindah(evt, stok_minimal, modal1);
    ...
    private void persenralanMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_persenralanMouseMoved
        // TODO add your handling code here:
    }//GEN-LAST:event_persenralanMouseMoved

    private void persenralanMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_persenralanMouseExited
        // TODO add your handling code here:
    }//GEN-LAST:event_persenralanMouseExited

    private void persenralanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_persenralanKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_persenralanKeyPressed

    private void persenbebasMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_persenbebasMouseMoved
        // TODO add your handling code here:
    }//GEN-LAST:event_persenbebasMouseMoved

    private void persenbebasMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_persenbebasMouseExited
        // TODO add your handling code here:
    }//GEN-LAST:event_persenbebasMouseExited

    private void persenbebasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_persenbebasKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_persenbebasKeyPressed

    private void persenkaryawanMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_persenkaryawanMouseMoved
        // TODO add your handling code here:
    }//GEN-LAST:event_persenkaryawanMouseMoved

    private void persenkaryawanMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_persenkaryawanMouseExited
        // TODO add your handling code here:
    }//GEN-LAST:event_persenkaryawanMouseExited

    private void persenkaryawanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_persenkaryawanKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_persenkaryawanKeyPressed

    private void persenralanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_persenralanActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_persenralanActionPerformed

    private void modal1MouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_modal1MouseMoved
       if (modal1.getText().equals("0") || modal1.getText().equals("0.0")) {
            modal1.setText("");
        }
    }//GEN-LAST:event_modal1MouseMoved

    private void modal1MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_modal1MouseExited
        if (modal1.getText().equals("")) {
            modal1.setText("0");
        }
    }//GEN-LAST:event_modal1MouseExited

    private void modal1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_modal1KeyPressed
       Valid.pindah(evt, DTPExpired, grosir);
    }//GEN-LAST:event_modal1KeyPressed
    ...
    private void grosirKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_grosirKeyPressed
       Valid.pindah(evt, modal1, KdIF);
    }//GEN-LAST:event_grosirKeyPressed

    private void MnMapingObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnMapingObatActionPerformed
        DlgMapingObatPoli maping=new DlgMapingObatPoli(null, false);
        maping.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
        maping.setLocationRelativeTo(internalFrame1);
        maping.setVisible(true);
    }//GEN-LAST:event_MnMapingObatActionPerformed

    private void status_bayarItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_status_bayarItemStateChanged

    }//GEN-LAST:event_status_bayarItemStateChanged

    private void status_bayarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_status_bayarMouseClicked

    }//GEN-LAST:event_status_bayarMouseClicked
    ...
    private void status_bayarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_status_bayarKeyPressed

    }//GEN-LAST:event_status_bayarKeyPressed
    ...
    private void lasalItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_lasalItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_lasalItemStateChanged

    private void lasalMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lasalMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_lasalMouseClicked

    private void lasalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_lasalActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_lasalActionPerformed

    private void lasalKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_lasalKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_lasalKeyPressed

    private void lifesavingItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_lifesavingItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_lifesavingItemStateChanged

    private void lifesavingMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lifesavingMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_lifesavingMouseClicked

    private void lifesavingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_lifesavingActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_lifesavingActionPerformed

    private void lifesavingKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_lifesavingKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_lifesavingKeyPressed

    private void highalertItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_highalertItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_highalertItemStateChanged

    private void highalertMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_highalertMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_highalertMouseClicked
    ...
    private void highalertKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_highalertKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_highalertKeyPressed

    private void TRetriksiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TRetriksiKeyPressed

    }//GEN-LAST:event_TRetriksiKeyPressed

    private void BtnLetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnLetakActionPerformed
        akses.setform("DlgBarang");
        letak.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
        letak.setLocationRelativeTo(internalFrame1);
        letak.setAlwaysOnTop(false);
        letak.setVisible(true);
    }//GEN-LAST:event_BtnLetakActionPerformed

    private void BtnLetakKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnLetakKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnLetakKeyPressed

    private void K_terapiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_K_terapiActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_K_terapiActionPerformed

    private void K_terapiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_K_terapiKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_K_terapiKeyPressed

    private void BtnKelasTerapiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKelasTerapiActionPerformed
        akses.setform("DlgBarang");
        terapi.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
        terapi.setLocationRelativeTo(internalFrame1);
        terapi.setAlwaysOnTop(false);
        terapi.setVisible(true);
    }//GEN-LAST:event_BtnKelasTerapiActionPerformed

    private void BtnKelasTerapiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnKelasTerapiKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnKelasTerapiKeyPressed

    private void MnMappingObatLangsungActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnMappingObatLangsungActionPerformed
        akses.setform("DlgBarang");
        DlgCariPoliMaping maping=new DlgCariPoliMaping(null, false);
        maping.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
        maping.isCek();
        maping.setBarang(Kd.getText(), Nm.getText());
        maping.setLocationRelativeTo(internalFrame1);
        maping.setVisible(true);
    ...
    private widget.Button BtnKelasTerapi;
    private widget.Button BtnKeluar;
    private widget.Button BtnLetak;
    ...
    private widget.TextBox K_terapi;
    private widget.TextBox Kapasitas;
    private widget.TextBox Kd;
    private widget.TextBox KdIF;
    private widget.Label LCount;
    private widget.TextBox Letak;
    private javax.swing.JMenuItem MnMapingObat;
    private javax.swing.JMenuItem MnMappingObatLangsung;
    ...
    private widget.TextBox persenbebas;
    private widget.TextBox persenkaryawan;
    private widget.TextBox persenralan;
        ...
        if(aktifkanbatch.equals("no")){
            try {
                if(TCari.getText().trim().equals("")){
                    ps = koneksi.prepareStatement(
                            ...
                            + " databarang.status_bayar,databarang.tempat,databarang.lasal,databarang.lifesaving,databarang.highalert,databarang.retriksi,databarang.kelas_terapi "
                            + " from databarang inner join kodesatuan on databarang.kode_sat=kodesatuan.kode_sat "
                            + " inner join kodesatuan as satuanbesar on databarang.kode_satbesar=satuanbesar.kode_sat "
                            + " inner join jenis on databarang.kdjns=jenis.kdjns "
                            + " inner join industrifarmasi on databarang.kode_industri=industrifarmasi.kode_industri "
                ...
                try {
                    ...
                    while (rs.next()) {
                        tabMode.addRow(new Object[]{
                            ...
                            rs.getString("tempat"),
                            rs.getString("lasal"),
                            rs.getString("lifesaving"),
                            rs.getString("highalert"),
                            rs.getString("retriksi"),
                            rs.getString("kelas_terapi")
                        });
                    }
            ...
            try {
                ps = koneksi.prepareStatement(
                    ...
                    + " data_batch.sisa>0 and databarang.lasal like ? or "
                    + " data_batch.sisa>0 and databarang.lifesaving like ? or "
                    + " data_batch.sisa>0 and databarang.highalert like ? or "
                    + " data_batch.sisa>0 and databarang.tempat like ? or "
                    + " data_batch.sisa>0 and databarang.status_bayar like ? or "
                    + " data_batch.sisa>0 and databarang.kelas_terapi like ? or "
                    + " data_batch.sisa>0 and databarang.retriksi like ? "
    ...
    public void emptTeks() {
        ...
        kdgolongan.setText("");
        nmgolongan.setText("");
        status_bayar.setSelectedIndex(0);
        tempat.setText("");
        lasal.setSelectedIndex(0);
        lifesaving.setSelectedIndex(0);
        highalert.setSelectedIndex(0);
        TRetriksi.setText("");
        K_terapi.setText("");
        KdIF.setText("");
        NmIF.setText("");
    ...
    private void getData() {
        ...
        if (row != -1) {
            ...
            status_bayar.setSelectedItem(tbDokter.getValueAt(row, 34).toString());
            tempat.setText(tbDokter.getValueAt(row, 35).toString());
            lasal.setSelectedItem(tbDokter.getValueAt(row, 36).toString());
            lifesaving.setSelectedItem(tbDokter.getValueAt(row, 37).toString());
            highalert.setSelectedItem(tbDokter.getValueAt(row, 38).toString());
            TRetriksi.setText(tbDokter.getValueAt(row, 39).toString());
            K_terapi.setText(tbDokter.getValueAt(row, 40).toString());
...
//                                        karyawan.setText(Double.toString(Valid.roundUp(Double.parseDouble(beli.getText()) + (Double.parseDouble(beli.getText()) * (rs.getDouble("karyawan") / 100)),100)));
                                         persenralan.setText(df7.format((Double.parseDouble(ralan.getText()) - Double.parseDouble(beli.getText())) / Double.parseDouble(beli.getText()) * 100));
                                         persenbebas.setText(df7.format((Double.parseDouble(jualbebas.getText()) - Double.parseDouble(beli.getText())) / Double.parseDouble(beli.getText()) * 100));
                                         persenkaryawan.setText(df7.format((Double.parseDouble(karyawan.getText()) - Double.parseDouble(beli.getText())) / Double.parseDouble(beli.getText()) * 100));
                                    }else{
...
//                                        karyawan.setText(Double.toString(Valid.roundUp(Double.parseDouble(beli.getText()) + (Double.parseDouble(beli.getText()) * (rs.getDouble("karyawan") / 100)),100)));
    ...
    public void isBatch(){
        tabMode = new DefaultTableModel(null,new Object[]{
                ...
                "Kelas Utama/BPJS(Rp)", "Ranap VIP(Rp)", "Ranap VVIP(Rp)", "Beli Luar(Rp)","Jual Bebas(Rp)", "Karyawan(Rp)", 
                "Stok Min", "Kode Jenis", "Nama Jenis","Kadaluwarsa","Kode I.F.","Industri Farmasi","Kode Kategori","Kategori",
                "Kode Golongan","Golongan","No.Batch","No.Faktur","Modal","Grosir","Status","Letak Barang","Lasa","Life Saving","High Alert","Retriksi","Kelas Sediaan"
            }) {
                @Override
                public boolean isCellEditable(int rowIndex, int colIndex) {
                    boolean a = false;
     ...
     private void tampilmapingobat(){
          if(tbDokter.getSelectedRow()!= -1){
            row=tbDokter.getRowCount();
            for(i=0;i<row;i++){
                try{
                    psdx=koneksi.prepareStatement("SELECT mpo.nm_poli FROM maping_obat_poli mpo WHERE mpo.kode_brng=?  ");
                    dxralan="";
                    try {
                        psdx.setString(1,tbDokter.getValueAt(i,1).toString());
                        rsdx=psdx.executeQuery();
                        while(rsdx.next()){
                            dxralan=rsdx.getString("nm_poli")+", "+dxralan;
                        }
                    } catch (Exception e) {
                        System.out.println("Notifikasi : "+e);
                    } finally{
                    ...
                    tbDokter.setValueAt(dxralan,i,9);
                } catch(Exception e){
                    System.out.println("Notifikasi : "+e);
                }
            }
