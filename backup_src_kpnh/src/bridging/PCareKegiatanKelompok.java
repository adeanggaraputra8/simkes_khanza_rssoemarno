...
public final class PCareKegiatanKelompok extends javax.swing.JDialog {
    ...
    private String URL="",link="",requestJson="",otorisasi,utc="",passpcare=Sequel.cariIsi("select pass from user_pcare where level='Admin' "), userpcare=Sequel.cariIsi("select user from user_pcare where level='Admin' ");
