...
public final class PCareCekKartu extends javax.swing.JDialog {
    ...
    private String kdkel="",kdkec="",kdkab="",kdprop="",BASENOREG="",URUTNOREG="",klg="SAUDARA",statuspasien="",pengurutan="",tahun="",bulan="",posisitahun="",awalantahun="",awalanbulan="",
            ...
            tampilkantni=Sequel.cariIsi("select tampilkan_tni_polri from set_tni_polri"),otorisasi,utc="",linkantrian="",respon="",datajam="",
            userpcare=Sequel.cariIsi("select user from user_pcare where level='Admin' "),passpcare=Sequel.cariIsi("select pass from user_pcare where level='Admin' ");
    ...
    public PCareCekKartu(java.awt.Frame parent, boolean modal) {
       ...
       jampraktek.addWindowListener(new WindowListener() {
        ...
        try {
            ...
            linkantrian=koneksiDB.URLANTREANFKTP();
        } catch (Exception e) {
            URUTNOREG="";
            BASENOREG="";
    ...
    private void initComponents() {
        ...
        DTPLahir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-08-2024" }));
        ...
        DTPDaftar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-08-2024" }));
        ...
        FormKelengkapanPasien.add(StatusPasien);
        StatusPasien.setBounds(380, 30, 72, 23);

        jLabel52.setText("Status Pasien :");
        jLabel52.setName("jLabel52"); // NOI18N
        FormKelengkapanPasien.add(jLabel52);
        jLabel52.setBounds(300, 30, 80, 23);
        ...
        TanggalDaftar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-08-2024 03:28:51" }));
        ...
        FormKelengkapanSEP.add(Jampraktek);
        Jampraktek.setBounds(860, 85, 90, 23);

        jLabel53.setText("Jam Praktek:");
        jLabel53.setName("jLabel53"); // NOI18N
        FormKelengkapanSEP.add(jLabel53);
        jLabel53.setBounds(790, 85, 70, 23);
        ...
        FormKelengkapanSEP.add(btnJamPraktek);
        btnJamPraktek.setBounds(950, 85, 28, 23);
        ...
        panelGlass6.add(BtnKirimAntrean);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        }else if(Sequel.cariInteger("select count(no_peserta) from addantrian_fktp where tgl_kunjungan='"+Valid.SetTgl(TanggalDaftar.getSelectedItem().toString().substring(0,10))+"' and no_peserta='"+TNoPeserta.getText()+"' ")==0){
            JOptionPane.showMessageDialog(null,"Simpan Antrean Terlebih dahulu");
        }else{            
            insertPasien();
        }
    ...
    private void BtnHadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHadirActionPerformed
        if(TNoPeserta.getText().trim().equals("")){
            Valid.textKosong(TNoPeserta, "Nomor Kartu");
        }else if (KdPoliTujuan.getText().trim().equals("")||NmPoliTujuan.getText().trim().equals("")){
            Valid.textKosong(KdPoliTujuan, "Kode poli dan Nama Poli");
        }else{

            try {
                datajam=TanggalDaftar.getSelectedItem().toString()+" "+Sequel.cariIsi("select curtime()");
                ...
                requestJson ="{" +
                "\"tanggalperiksa\": \""+Valid.SetTgl(TanggalDaftar.getSelectedItem().toString().substring(0,10))+"\"," +
                ...
                if(nameNode.path("code").asText().equals("200")){
                    Sequel.menyimpan("addantrian_fktp","?,?,?",3,new String[]{TanggalDaftar.getSelectedItem().toString(),NoKartu.getText(),"Hadir"});
            ...
            if(nameNode.path("message").asText().equals("OK")){
                ...
                try {
                    ...
                    if(rs.next()){
                        ...
                        StatusPasien.setSelectedItem(Sequel.cariIsi("select status from status_pasien where no_rm='"+rs.getString("no_rkm_medis")+"' "));
           ...
           // headers.add("X-authorization","Basic "+Base64.encodeBase64String(otorisasi.getBytes()));
            ...
            requestJson ="{" +
                         ...
                         "}";
                           ...
                           // menyimpan log antrol
                           if(nameNode.path("code").asText().equals("200")){
                                Sequel.menyimpan("addantrian_fktp","?,?,?",3,new String[]{Valid.SetTgl(TanggalDaftar.getSelectedItem()+""),TNoPeserta.getText(),nameNode.path("message").asText()+" "+nameNode.path("code").asText()});
                            } else {
                               Sequel.menyimpan("addantrian_fktp","?,?,?",3,new String[]{Valid.SetTgl(TanggalDaftar.getSelectedItem()+""),TNoPeserta.getText(),nameNode.path("message").asText()+" "+nameNode.path("code").asText()});
                           } 
                        } catch (Exception e) {
