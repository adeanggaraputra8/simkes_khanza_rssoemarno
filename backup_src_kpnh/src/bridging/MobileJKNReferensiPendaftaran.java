...
public final class MobileJKNReferensiPendaftaran extends javax.swing.JDialog {
    ...
    public MobileJKNReferensiPendaftaran(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                "No.Rawat","No.RM","Nama Pasien","No.HP","No.Kartu","NIK","Tanggal","Poliklinik","Dokter","No.Antri","Keluhan","Status"
            }){
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                   "SELECT referensi_mobilejkn_bpjs.no_rawat,referensi_mobilejkn_bpjs.norm,pasien.nm_pasien,pasien.no_tlp,referensi_mobilejkn_bpjs.nomorkartu,"+
                   "referensi_mobilejkn_bpjs.nik,referensi_mobilejkn_bpjs.tanggalperiksa,referensi_mobilejkn_bpjs.nm_poli,referensi_mobilejkn_bpjs.nm_dokter,referensi_mobilejkn_bpjs.nomorantrian,"+
                   "referensi_mobilejkn_bpjs.keluhan,referensi_mobilejkn_bpjs.status,referensi_mobilejkn_bpjs.status "+
                   "FROM referensi_mobilejkn_bpjs INNER JOIN pasien ON referensi_mobilejkn_bpjs.norm=pasien.no_rkm_medis "+
                   ...
                   "referensi_mobilejkn_bpjs.status LIKE ?) ")+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("no_tlp"),rs.getString("nomorkartu"),rs.getString("nik"),
                        rs.getString("tanggalperiksa"),rs.getString("nm_poli"),rs.getString("nm_dokter"),
                        rs.getString("nomorantrian"),rs.getString("keluhan"),rs.getString("status")
                    });
                }
            } catch (Exception e) {
