 ...
 * @author perpustakaan
 */
public class DlgRiwayatObatPRB extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgRiwayatObatPRB(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Riwayat Obat PRB ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            Sequel.menyimpan3("obat_prb","?,?",2,new String[]{TNoRM.getText(),TCatatan.getText()},"no_rkm_medis=?","catatan=?",2,new String[]{TCatatan.getText(),TNoRM.getText()});
            BtnKeluarActionPerformed(evt);        
        }  
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
       Sequel.meghapus2("obat_prb","no_rkm_medis",TNoRM.getText());
       BtnKeluarActionPerformed(evt);       
...
private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
    if(TNoRM.getText().trim().equals("")||TPasien.getText().trim().equals("")){
        ...
        Sequel.mengedit2("obat_prb","no_rkm_medis=?","catatan=?",2,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRiwayatObatPRB dialog = new DlgRiwayatObatPRB(new javax.swing.JFrame(), true);
    ...
    public void setNoRm(String norm) {
        TNoRM.setText(norm);  
        isPsien();   
        Sequel.cariIsi("select obat_prb.catatan from obat_prb where obat_prb.no_rkm_medis=?",TCatatan,TNoRM.getText());       
    }
