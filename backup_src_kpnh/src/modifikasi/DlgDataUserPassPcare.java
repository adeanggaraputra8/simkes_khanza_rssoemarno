 ...
 * @author dosen
 */
public class DlgDataUserPassPcare extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgDataUserPassPcare(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        try {
            ps=koneksi.prepareStatement("select user,pass,level from user_pcare order by id_user asc ");
    ...
    private void initComponents() {
        ...
        jLabel4.setBounds(216, 12, 70, 23);
        ...
        TPass.setBounds(290, 12, 130, 23);

        cmbLevel.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Admin", "Dokter" }));
        cmbLevel.setName("cmbLevel"); // NOI18N
        cmbLevel.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                cmbLevelKeyPressed(evt);
            }
        });
        panelGlass7.add(cmbLevel);
        cmbLevel.setBounds(448, 12, 100, 23);
    ...
    private void TUserKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TUserKeyPressed
        Valid.pindah(evt,TCari,TPass);
}//GEN-LAST:event_TUserKeyPressed

    private void TPassKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TPassKeyPressed
        Valid.pindah(evt,TUser,BtnSimpan);
}//GEN-LAST:event_TPassKeyPressed

    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TUser.getText().trim().equals("")){
            Valid.textKosong(TUser,"kode");
        }else if(TPass.getText().trim().equals("")){
            Valid.textKosong(TPass,"nama peresep");
        }else{
              try {
                i=0;
                Sequel.menyimpan2("user_pcare","'"+i+"','"+TUser.getText()+"','"+
                        TPass.getText()+"','"+cmbLevel.getSelectedItem().toString()+"'","User Pcare");
                i++;
                tampil();
                emptTeks();
            } catch (Exception ex) {
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        try {
            Sequel.meghapus("user_pcare","user", TUser.getText());
            tampil();
            emptTeks();
        } catch (Exception ex) {
    ...
    private void cmbLevelKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cmbLevelKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_cmbLevelKeyPressed

    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        try {
            Sequel.mengedit("user_pcare","user='"+tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(),0).toString()+"'","user='"+TUser.getText()+"', pass='"+TPass.getText()+"' ");
            tampil();
            emptTeks();
        } catch (Exception ex) {
            System.out.println("Notifikasi : "+ex);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgDataUserPassPcare dialog = new DlgDataUserPassPcare(new javax.swing.JFrame(), true);
    ...
    private widget.ComboBox cmbLevel;
    ...
    private void getData() {
        if(tbSpesialis.getSelectedRow()!= -1){
            TUser.setText(tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(),0).toString());
            TPass.setText(tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(),1).toString());
            cmbLevel.setSelectedItem(tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(),2).toString());
        }
    }
    ...
    public void isCek(){
        if(akses.getkode().equals("Adimm Utama")){
