 ...
 * @author dosen
 */
public class DlgRiwayatPenyakit extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgRiwayatPenyakit(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{"ID","Riwayat Penyakit"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Riwayat Penyakit ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Nama.getText().trim().equals("")){
            ...
            Sequel.menyimpan("m_riwayat_penyakit","'0','"+Nama.getText()+"'","Riwayat Penyakit");
            tampil();
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Nama.getText().trim().equals("")){
            Valid.textKosong(Nama,"Riwayat Penyakit");
        }else{
            Sequel.meghapus("m_riwayat_penyakit","id",tbkecamatan.getValueAt(tbkecamatan.getSelectedRow(),0).toString());  
            tampil();
            emptTeks();
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRiwayatPenyakit dialog = new DlgRiwayatPenyakit(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select * from m_riwayat_penyakit where nm_penyakit like ? ");
            try {
