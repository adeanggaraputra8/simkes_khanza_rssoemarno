...
public class DlgObatPRB extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgObatPRB(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
            ...
            public void windowClosed(WindowEvent e) {
                if(akses.getform().equals("DlgPiutang")){
                    if(pasien.getTable().getSelectedRow()!= -1){                   
                        kdpasien.setText(pasien.getTable().getValueAt(pasien.getTable().getSelectedRow(),1).toString());
            ...
            public void windowClosed(WindowEvent e) {
                if(akses.getform().equals("DlgPiutang")){
                    if(obat.getTable().getSelectedRow()!= -1){                   
                        kdbar.setText(obat.getTable().getValueAt(obat.getTable().getSelectedRow(),1).toString());                    
                        nmbar.setText(obat.getTable().getValueAt(obat.getTable().getSelectedRow(),2).toString());
                        satuanbar.setText(obat.getTable().getValueAt(obat.getTable().getSelectedRow(),6).toString());
                        HrgBeli.setText(obat.getTable().getValueAt(obat.getTable().getSelectedRow(),10).toString());
                        if(Jenisjual.getSelectedItem().equals("Jual Bebas")){
                               HrgJual.setText(obat.getTable().getValueAt(obat.getTable().getSelectedRow(),20).toString()); 
                        }else if(Jenisjual.getSelectedItem().equals("Karyawan")){
                               HrgJual.setText(obat.getTable().getValueAt(obat.getTable().getSelectedRow(),21).toString()); 
                        }else if(Jenisjual.getSelectedItem().equals("Beli Luar")){
                               HrgJual.setText(obat.getTable().getValueAt(obat.getTable().getSelectedRow(),19).toString()); 
                        }else if(Jenisjual.getSelectedItem().equals("Rawat Jalan")){
                               HrgJual.setText(obat.getTable().getValueAt(obat.getTable().getSelectedRow(),12).toString()); 
                        }else if(Jenisjual.getSelectedItem().equals("Kelas 1")){
                               HrgJual.setText(obat.getTable().getValueAt(obat.getTable().getSelectedRow(),13).toString()); 
                        }else if(Jenisjual.getSelectedItem().equals("Kelas 2")){
                               HrgJual.setText(obat.getTable().getValueAt(obat.getTable().getSelectedRow(),14).toString()); 
                        }else if(Jenisjual.getSelectedItem().equals("Kelas 3")){
                               HrgJual.setText(obat.getTable().getValueAt(obat.getTable().getSelectedRow(),15).toString()); 
                        }else if(Jenisjual.getSelectedItem().equals("Utama")){
                               HrgJual.setText(obat.getTable().getValueAt(obat.getTable().getSelectedRow(),16).toString()); 
                        }else if(Jenisjual.getSelectedItem().equals("VIP")){
                               HrgJual.setText(obat.getTable().getValueAt(obat.getTable().getSelectedRow(),17).toString()); 
                        }else if(Jenisjual.getSelectedItem().equals("VVIP")){
                               HrgJual.setText(obat.getTable().getValueAt(obat.getTable().getSelectedRow(),18).toString()); 
                        }else if(Jenisjual.getSelectedItem().equals("Harga Beli")){
                               HrgJual.setText(obat.getTable().getValueAt(obat.getTable().getSelectedRow(),11).toString()); 
                        } 
                        
                        if(aktifkanbatch.equals("yes")){
                            NoBatch.setText(obat.getTable().getValueAt(obat.getTable().getSelectedRow(),32).toString());
                            NoFaktur.setText(obat.getTable().getValueAt(obat.getTable().getSelectedRow(),33).toString());
                            Stok.setText(Double.toString(Sequel.cariIsiAngka("select stok from gudangbarang where kd_bangsal='"+kdgudang.getText()+"' and kode_brng='"+kdbar.getText()+"' and no_batch='"+NoBatch.getText()+"' and no_faktur='"+NoFaktur.getText()+"'")));
                        }else{
                            Stok.setText(Double.toString(Sequel.cariIsiAngka("select stok from gudangbarang where kd_bangsal='"+kdgudang.getText()+"' and kode_brng='"+kdbar.getText()+"' and no_batch='' and no_faktur=''")));
                        }
        ...
        obat.getTable().addKeyListener(new KeyListener() {
            @Override
            public void keyTyped(KeyEvent e) {}
            @Override
            public void keyPressed(KeyEvent e) {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Input Obat PRB ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        label24.setBounds(680, 10, 70, 23);
        ...
        catatan.setBounds(84, 40, 110, 23);
        ...
        keterangan.setBounds(200, 40, 120, 23);
...
*/
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        if(NoNota.getText().trim().equals("")){
            ...
            Valid.textKosong(catatan,"Nama Faskes");
            ...
            if (reply == JOptionPane.YES_OPTION) {
                ...
                if(Sequel.menyimpantf2("piutang","'"+NoNota.getText()+"','"+Valid.SetTgl(TglJual.getSelectedItem()+"")+"','"+kdptg.getText()+"','"+kdpasien.getText()+
                        "','"+nmpasien.getText()+"','"+catatan.getText()+"-"+keterangan.getText()+"','"+Jenisjual.getSelectedItem()+"','"+ongkir+"','"+uangmuka+"','"+(ttljual+ongkir-uangmuka)+
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgObatPRB dialog = new DlgObatPRB(new javax.swing.JFrame(), true);
