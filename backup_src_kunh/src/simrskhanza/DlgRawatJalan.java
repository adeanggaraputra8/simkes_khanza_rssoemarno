...
import modifikasi.DlgGenekologi;
import modifikasi.DlgObsteri;
...
public final class DlgRawatJalan extends javax.swing.JDialog {
    private final DefaultTableModel tabModeDr,tabModePr,tabModeDrPr,
            ...
            TabModeTindakan,TabModeTindakan2,TabModeTindakan3,TabModeCatatan,tabModeRiwayat;
    ...
    private void initComponents() {
        ...
        BtnObgyn = new widget.Button();
        BtnRiwayat1 = new widget.Button();
        BtnEresep = new widget.Button();
        BtnGenekologi = new widget.Button();
        ...
        jLabel58.setBounds(890, 180, 150, 23);

        jLabel59.setText("Riwayat Penyakit Dahulu :");
        jLabel59.setName("jLabel59"); // NOI18N
        panelGlass12.add(jLabel59);
        jLabel59.setBounds(900, 110, 130, 23);
        ...
        scrollPane5.setBounds(930, 130, 90, 38);
        ...
        scrollPane9.setBounds(930, 200, 90, 38);

        BtnObgyn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/family24.png"))); // NOI18N
        BtnObgyn.setMnemonic('S');
        BtnObgyn.setText("Pemeriksaan Obstertri");
        BtnObgyn.setToolTipText("Alt+S");
        BtnObgyn.setName("BtnObgyn"); // NOI18N
        BtnObgyn.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnObgyn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnObgynActionPerformed(evt);
            }
        });
        BtnObgyn.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnObgynKeyPressed(evt);
            }
        });
        panelGlass12.add(BtnObgyn);
        BtnObgyn.setBounds(900, 10, 190, 30);

        BtnRiwayat1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/LastThreeMonths.png"))); // NOI18N
        BtnRiwayat1.setMnemonic('S');
        BtnRiwayat1.setText("Riwayat");
        BtnRiwayat1.setToolTipText("Alt+S");
        BtnRiwayat1.setName("BtnRiwayat1"); // NOI18N
        BtnRiwayat1.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnRiwayat1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnRiwayat1ActionPerformed(evt);
            }
        });
        BtnRiwayat1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnRiwayat1KeyPressed(evt);
            }
        });
        panelGlass12.add(BtnRiwayat1);
        BtnRiwayat1.setBounds(900, 35, 170, 30);

        BtnEresep.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Vial-Pills.png"))); // NOI18N
        BtnEresep.setMnemonic('S');
        BtnEresep.setText("E-Resep");
        BtnEresep.setToolTipText("Alt+S");
        BtnEresep.setName("BtnEresep"); // NOI18N
        BtnEresep.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnEresep.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnEresepActionPerformed(evt);
            }
        });
        BtnEresep.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnEresepKeyPressed(evt);
            }
        });
        panelGlass12.add(BtnEresep);
        BtnEresep.setBounds(900, 60, 170, 30);

        BtnGenekologi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/female-user-help24.png"))); // NOI18N
        BtnGenekologi.setMnemonic('S');
        BtnGenekologi.setText("Pemeriksaan Genekologi");
        BtnGenekologi.setToolTipText("Alt+S");
        BtnGenekologi.setName("BtnGenekologi"); // NOI18N
        BtnGenekologi.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnGenekologi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnGenekologiActionPerformed(evt);
            }
        });
        BtnGenekologi.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnGenekologiKeyPressed(evt);
            }
        });
        panelGlass12.add(BtnGenekologi);
        BtnGenekologi.setBounds(1070, 10, 190, 30);

        BtnPanggil.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/kanan.png"))); // NOI18N
        BtnPanggil.setMnemonic('S');
        BtnPanggil.setText("Panggil");
        BtnPanggil.setToolTipText("Alt+S");
        ...
        panelGlass12.add(BtnPanggil);
        BtnPanggil.setBounds(1070, 60, 170, 30);
        ...
        Scroll1.setBounds(1050, 100, 560, 140);
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-08-2024" }));
...
//        } catch (Exception e) {
//        }
        String options[]={"Boleh Pulang","Dirujuk"};     
         try {
             i=JOptionPane.showOptionDialog(null,"Pilih Cara Pulang Pasien","Konfirmasi",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE,null,options,null);
            if(i==JOptionPane.YES_OPTION){
                Sequel.mengedit("reg_periksa","no_rawat=?","stts=?",2,new String[]{"Sudah",TNoRw.getText()});
            }else if(i==JOptionPane.NO_OPTION){
                Sequel.mengedit("reg_periksa","no_rawat=?","stts=?",2,new String[]{"Dirujuk",TNoRw.getText()});        
            }
        } catch (Exception e) {
        }
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void BtnObgynActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnObgynActionPerformed
        DlgObsteri obgyn=new DlgObsteri(null,false);
        obgyn.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
        obgyn.setLocationRelativeTo(internalFrame1);
        obgyn.setNoRm(TNoRw.getText(),KdDok.getText());
        obgyn.setVisible(true);
    }//GEN-LAST:event_BtnObgynActionPerformed

    private void BtnObgynKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnObgynKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnObgynKeyPressed
    ...
    private void BtnRiwayat1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnRiwayat1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnRiwayat1KeyPressed

    private void BtnEresepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEresepActionPerformed
      if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{   
    ...
    }//GEN-LAST:event_BtnEresepActionPerformed

    private void BtnEresepKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEresepKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnEresepKeyPressed

    private void BtnGenekologiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGenekologiActionPerformed
        DlgGenekologi obgyn=new DlgGenekologi(null,false);
        obgyn.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
        obgyn.setLocationRelativeTo(internalFrame1);
        obgyn.setNoRm(TNoRw.getText(),KdDok.getText());
        obgyn.setVisible(true);
    }//GEN-LAST:event_BtnGenekologiActionPerformed

    private void BtnGenekologiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnGenekologiKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnGenekologiKeyPressed

    private void BtnPanggilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPanggilActionPerformed
       if(TNoRw.getText().toString().equals("")||TNoRM.getText().toString().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
       }else if(Sequel.cariInteger("select count(kd_dokter) from dokter where kd_dokter='"+akses.getkode()+"' ")==0){
            JOptionPane.showMessageDialog(null,"Maaf, Hanya Akun dokter yg bisa memanggil pasien...!!!!");
       }else{
                Sequel.queryu("delete from antripoli where kd_dokter='"+akses.getkode()+"' and kd_poli='"+kode_poli+"'");
                Sequel.queryu("insert into antripoli values('"+akses.getkode()+"','"+kode_poli+"','1','"+TNoRw.getText()+"')");
    ...
    */
    ...
    private widget.Button BtnEresep;
    private widget.Button BtnGenekologi;
    ...
    private widget.Button BtnObgyn;
    ...
    public void setNoRm(String norwt,Date tgl1,Date tgl2) {
        ...
        if(kode_poli.trim().equals("OBG")){
            BtnObgyn.setVisible(true);
            BtnGenekologi.setVisible(true);
        }else{
            BtnObgyn.setVisible(false);
            BtnGenekologi.setVisible(false);
        }
    }
