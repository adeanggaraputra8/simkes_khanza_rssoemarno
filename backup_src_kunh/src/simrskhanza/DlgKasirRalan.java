...
public final class DlgKasirRalan extends javax.swing.JDialog {
    ...
    private String aktifkanparsial="no",nosep="",kamar_inap_kasir_ralan=Sequel.cariIsi("select set_jam_minimal.kamar_inap_kasir_ralan from set_jam_minimal"),caripenjab="",filter="no",bangsal=Sequel.cariIsi("select set_lokasi.kd_bangsal from set_lokasi limit 1"),nonota="",
    ...
    private void initComponents() {
        ...
        TglSakit1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-08-2023" }));
        ...
        TglSakit2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-08-2023" }));
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-08-2023" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-08-2023" }));
...
private void MnDataPemberianObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDataPemberianObatActionPerformed
    ...
    private void MnResumeRawatJalan1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnResumeRawatJalan1ActionPerformed
        ...
        param.put("pro1",Sequel.cariIsi("SELECT concat(b.kode,' ',a.deskripsi_panjang) FROM icd9 a INNER JOIN prosedur_pasien b ON a.kode=b.kode WHERE b.no_rawat='"+TNoRwCari.getText()+"' and b.prioritas='1'"));
        param.put("pro2",Sequel.cariIsi("SELECT concat(b.kode,' ',a.deskripsi_panjang) FROM icd9 a INNER JOIN prosedur_pasien b ON a.kode=b.kode WHERE b.no_rawat='"+TNoRwCari.getText()+"' and b.prioritas='2'"));
        param.put("pro3",Sequel.cariIsi("SELECT concat(b.kode,' ',a.deskripsi_panjang) FROM icd9 a INNER JOIN prosedur_pasien b ON a.kode=b.kode WHERE b.no_rawat='"+TNoRwCari.getText()+"' and b.prioritas='3'"));
        param.put("pro4",Sequel.cariIsi("SELECT concat(b.kode,' ',a.deskripsi_panjang) FROM icd9 a INNER JOIN prosedur_pasien b ON a.kode=b.kode WHERE b.no_rawat='"+TNoRwCari.getText()+"' and b.prioritas='4'"));
        param.put("pro5",Sequel.cariIsi("SELECT concat(b.kode,' ',a.deskripsi_panjang) FROM icd9 a INNER JOIN prosedur_pasien b ON a.kode=b.kode WHERE b.no_rawat='"+TNoRwCari.getText()+"' and b.prioritas='5'"));
        param.put("pro6",Sequel.cariIsi("SELECT concat(b.kode,' ',a.deskripsi_panjang) FROM icd9 a INNER JOIN prosedur_pasien b ON a.kode=b.kode WHERE b.no_rawat='"+TNoRwCari.getText()+"' and b.prioritas='6'"));
        param.put("pro7",Sequel.cariIsi("SELECT concat(b.kode,' ',a.deskripsi_panjang) FROM icd9 a INNER JOIN prosedur_pasien b ON a.kode=b.kode WHERE b.no_rawat='"+TNoRwCari.getText()+"' and b.prioritas='7'"));
        param.put("pro8",Sequel.cariIsi("SELECT concat(b.kode,' ',a.deskripsi_panjang) FROM icd9 a INNER JOIN prosedur_pasien b ON a.kode=b.kode WHERE b.no_rawat='"+TNoRwCari.getText()+"' and b.prioritas='8'"));
        param.put("ttlobat",Sequel.cariIsi("select if(sum(totalbiaya)='','0',sum(totalbiaya)) from billing where no_rawat='"+TNoRwCari.getText()+"' and status='Obat'"));
        param.put("tarifrs",Sequel.cariIsi("select if(sum(totalbiaya)='','0',sum(totalbiaya)) from billing where no_rawat='"+TNoRwCari.getText()+"' and status in ('Ralan Dokter','Ralan Paramedis','Ralan Dokter Paramedis')"));
        param.put("carapulang",Sequel.cariIsi("SELECT IF(stts='Sudah','Atas Persetujuan Dokter',IF(stts='Dirujuk','Rujuk',IF(stts='Dirawat','MRS',''))) FROM reg_periksa WHERE no_rawat='"+TNoRwCari.getText()+"' "));
        param.put("kontrol",Sequel.cariIsi("SELECT tgl_rencana FROM bridging_surat_kontrol_bpjs WHERE no_sep='"+nosep+"'"));
        Valid.MyReportPDF("rptBridgingResume1.jasper","report",nosep,param);
            ...
            try{
                ...
                while(rskasir.next()){
                    tabModekasir.addRow(new String[] {
                        rskasir.getString(5),rskasir.getString(6)+" ("+rskasir.getString("no_reg")+")",rskasir.getString(7),rskasir.getString(8)+" ("+rskasir.getString("umur")+")",
