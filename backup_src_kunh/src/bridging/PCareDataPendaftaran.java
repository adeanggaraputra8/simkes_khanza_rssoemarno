    ...
    private void ppJadikanKunjunganBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppJadikanKunjunganBtnPrintActionPerformed
        for(i=0;i<tbPendaftaran.getRowCount();i++){
            if(tbPendaftaran.getValueAt(i,20).toString().equals("Terkirim")){
                ...
                if(TinggiBadan.getText().equals("")||TinggiBadan.getText().equals("0")||BeratBadan.getText().equals("")||BeratBadan.getText().equals("0")||Sistole.getText().equals("")||Diastole.getText().equals("")||
                    Keluhan.getText().equals("")||Keluhan.getText().equals("0")||Diastole.getText().equals("")||Diastole.getText().equals("")||Respiratory.getText().equals("")||Respiratory.getText().equals("0")||
...
//                                    "\"heartRate\": "+Heartrate.getText()+"," +
//                                    "\"lingkarPerut\": "+LingkarPerut.getText()+"," +
//                                    "\"kdStatusPulang\": \""+KdStatusPulang.getText()+"\"," +
//                                    "\"tglPulang\": \""+TanggalPulang.getSelectedItem()+"\"," +
//                                    "\"kdDokter\": \""+KdTenagaMedis.getText()+"\"," +
//                                    "\"kdDiag1\": \""+KdDiagnosa1.getText()+"\"," +
//                                    "\"kdDiag2\": "+diagnosa2+"," +
...
//                                    "\"alasanTacc\": null" +
    ...
    public void bodyWithDeleteRequest() throws Exception {
        ...
        try {
            ...
            headers.add("X-authorization","Basic "+Base64.encodeBase64String(otorisasi.getBytes()));
            headers.add("user_key",koneksiDB.USERKEYAPIPCARE());
            root = mapper.readTree(restTemplate.exchange(URL+"/pendaftaran/peserta/"+tbPendaftaran.getValueAt(tbPendaftaran.getSelectedRow(),5).toString()+"/tglDaftar/"+Valid.SetTgl3(tbPendaftaran.getValueAt(tbPendaftaran.getSelectedRow(),1).toString())+"/noUrut/"+tbPendaftaran.getValueAt(tbPendaftaran.getSelectedRow(),19).toString()+"/kdPoli/"+tbPendaftaran.getValueAt(tbPendaftaran.getSelectedRow(),6).toString(), HttpMethod.DELETE,new HttpEntity<String>(requestJson,headers), String.class).getBody());
            nameNode = root.path("metaData");
            System.out.println("code : "+nameNode.path("code").asText());
            System.out.println("message : "+nameNode.path("message").asText());
            if(nameNode.path("code").asText().equals("200")){
