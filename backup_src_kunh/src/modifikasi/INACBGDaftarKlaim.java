...
//                column.setPreferredWidth(120);
    ...
    private void initComponents() {
        ...
        tgl1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "27-12-2022" }));
        ...
        tgl2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "27-12-2022" }));
        ...
        tgl3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "27-12-2022" }));
        ...
        tgl4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "27-12-2022" }));
        ...
        tgl5.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "27-12-2022" }));
        ...
        tgl6.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "27-12-2022" }));
        ...
        tglA.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "27-12-2022" }));
        ...
        tglB.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "27-12-2022" }));
        ...
        try {
            if (!cmbLimit.getSelectedItem().equals("Semuanya")) {
                ps = koneksi.prepareStatement("SELECT enc.no_rawat,esc.payor_cd,enc.no_sep,if(enc.jnspelayanan='1','Inap','Jalan') Rawat,if(esc.jenis_rawat='1',eg.kelas,'') Kelas, "
                        ...
                        + "IF(rp.status_lanjut='Ralan',CONCAT('Inst./Poli ',pl.nm_poli),CONCAT('Rg. ',(SELECT b.nm_bangsal FROM kamar_inap ki INNER JOIN kamar k ON k.kd_kamar=ki.kd_kamar INNER JOIN bangsal b ON b.kd_bangsal=k.kd_bangsal WHERE "
                        + "ki.no_rawat=rp.no_rawat AND ki.stts_pulang<>'Pindah Kamar'))) unit, IFNULL(egc.payor_id,'3') payor_id FROM eklaim_new_claim enc LEFT JOIN eklaim_generate_claim egc ON egc.claim_number=enc.no_sep "
