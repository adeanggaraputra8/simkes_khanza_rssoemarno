 ...
 * @author dosen
 */
public final class DlgMapingObatPoli extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgMapingObatPoli(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "Kode Obat RS","Nama Obat RS","Kode Poli","Nama Poliklinik","Kandungan","Industri Farmasi"}){
        ...
        KdPoli.setDocument(new batasInput((byte)15).getKata(KdPoli)); 
    ...
    private void initComponents() {
        ...
        KdPoli.setBounds(426, 10, 70, 23);

        NmPoli.setEditable(false);
        NmPoli.setName("NmPoli"); // NOI18N
        FormInput.add(NmPoli);
        NmPoli.setBounds(498, 10, 190, 23);
        ...
        btnPoli.setBounds(690, 10, 28, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(kdobat.getText().trim().equals("")||TObat.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("maping_obat_poli","?,?,?","Mapping Obat",3,new String[]{
                kdobat.getText(),KdPoli.getText(),NmPoli.getText()
            })==true){
                tampil();
                emptTeks();
            }                
    ...
    private void BtnSimpanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
        ...
        }else{Valid.pindah(evt,btnPoli, BtnBatal);}
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Sequel.queryu("delete from maping_obat_poli where kode_brng ='"+kdobat.getText()+"' and kd_poli='"+KdPoli.getText()+"' ");
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(kdobat.getText().trim().equals("")||TObat.getText().trim().equals("")){
            ...
            if(tbJnsPerawatan.getSelectedRow()>-1){
                if(Sequel.mengedittf("maping_obat_pcare","kode_brng=?","kode_brng=?,kd_poli=?,nama_poli=?",4,new String[]{
                        kdobat.getText(),KdPoli.getText(),NmPoli.getText(),tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),0).toString()
                    })==true){
                    emptTeks();
                    tampil();
                }
...
private void btnPoliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPoliActionPerformed
    ...
    private void BtnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTambahActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        DlgCariObatMaping barang=new DlgCariObatMaping(null,false);
        barang.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
        barang.setLocationRelativeTo(internalFrame1);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgMapingObatPoli dialog = new DlgMapingObatPoli(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
           ps=koneksi.prepareStatement(
                   "select maping_obat_poli.kode_brng,databarang.nama_brng,maping_obat_poli.kd_poli ,maping_obat_poli.nm_poli,databarang.letak_barang,industrifarmasi.nama_industri  "+
                   "from maping_obat_poli inner join databarang on maping_obat_poli.kode_brng=databarang.kode_brng inner join industrifarmasi on industrifarmasi.kode_industri=databarang.kode_industri where   "+
                   "maping_obat_poli.kode_brng like ? or databarang.nama_brng like ? or databarang.letak_barang like ? or industrifarmasi.nama_industri like ? or maping_obat_poli.kd_poli like ? or maping_obat_poli.nm_poli like ? order by databarang.nama_brng");
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        rs.getString("kode_brng"),rs.getString("nama_brng"),rs.getString("kd_poli"),rs.getString("nm_poli"),rs.getString("letak_barang"),rs.getString("nama_industri")
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
       if(tbJnsPerawatan.getSelectedRow()!= -1){
           ...
           KdPoli.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),2).toString());
           NmPoli.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),3).toString());
        }
    }
