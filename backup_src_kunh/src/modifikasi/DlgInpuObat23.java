...
public class DlgInpuObat23 extends javax.swing.JDialog {
    ...
    private String verifikasi_penjualan_di_kasir="",Penjualan_Obat="",HPP_Obat_Jual_Bebas="",Persediaan_Obat_Jual_Bebas="",
            status="Belum Dibayar",pilihanetiket="",hppfarmasi="",kode_akun_bayar="",tampilkan_ppnobat_ralan="",kodedokter="",namadokter="";
    ...
    private DlgEditBarang obat=new DlgEditBarang(null,false);
    private BPJSDataSEP sep=new BPJSDataSEP(null,false);
    

    /** Creates new form DlgProgramStudi
     * @param parent
     * @param modal */
    public DlgInpuObat23(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        sep.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {}
            @Override
            public void windowClosing(WindowEvent e) {}
            ...
            public void windowClosed(WindowEvent e) {
                if(akses.getform().equals("DlgPiutang")){
                    if(sep.getTable().getSelectedRow()!= -1){                   
                        TSep.setText(sep.getTable().getValueAt(sep.getTable().getSelectedRow(),0).toString());
                    }  
                    BtnCrSep.requestFocus();
                }
            }
            @Override
            public void windowIconified(WindowEvent e) {}
        ...
        sep.getTable().addKeyListener(new KeyListener() {
            @Override
            public void keyTyped(KeyEvent e) {}
            @Override
            public void keyPressed(KeyEvent e) {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pemberian Obat Lainnya ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        label10.setBounds(300, 20, 140, 23);
        ...
        LTotal.setBounds(440, 20, 260, 23);
        ...
        Jenisjual.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Utama", "Rawat Jalan", " " }));
        ...
        Jenisjual.setBounds(310, 10, 90, 23);

        label18.setText("No. SEP :");
        ...
        label12.setBounds(250, 10, 65, 23);
        ...
        label24.setText("Tanggal Input :");
        label24.setName("label24"); // NOI18N
        label24.setPreferredSize(new java.awt.Dimension(70, 23));
        panelisi3.add(label24);
        label24.setBounds(177, 70, 80, 23);

        TSep.setEditable(false);
        TSep.setName("TSep"); // NOI18N
        TSep.setPreferredSize(new java.awt.Dimension(207, 23));
        panelisi3.add(TSep);
        TSep.setBounds(90, 40, 232, 23);

        BtnCrSep.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnCrSep.setMnemonic('1');
        BtnCrSep.setToolTipText("Alt+1");
        BtnCrSep.setName("BtnCrSep"); // NOI18N
        BtnCrSep.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnCrSep.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnCrSepActionPerformed(evt);
            }
        });
        panelisi3.add(BtnCrSep);
        BtnCrSep.setBounds(320, 40, 28, 23);
        ...
        TabRawat.addTab("Input PRB", scrollPane1);
...
*/
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        if(NoNota.getText().trim().equals("")){
        ...
        }else if(TSep.getText().trim().equals("")){
            Valid.textKosong(TSep,"Catatan");
            ...
            if (reply == JOptionPane.YES_OPTION) {
                ...
                if(Sequel.menyimpantf2("piutang","'"+NoNota.getText()+"','"+Valid.SetTgl(Tgl.getSelectedItem()+"")+"','"+kdptg.getText()+"','"+kdmem.getText()+
                        "','"+nmmem.getText()+"','"+catatan.getText()+"','"+Jenisjual.getSelectedItem()+"','0','0','"+ttl+
                        "','Umum','"+Valid.SetTgl(TglTempo.getSelectedItem()+"")+"','"+kdgudang.getText()+"'","No.Nota")==true){
                     Sequel.queryu("update rekap_obat_23 set no_nota='"+NoNota.getText()+"' where no_sep='"+TSep.getText()+"' ");
                    simpan();
                ...
                if(sukses==true){
                    ...
                    Sequel.menyimpan2("tampjurnal","'"+Sequel.cariIsi("select Piutang_Obat from set_akun")+"','PIUTANG OBAT','"+ttl+"','0'","Rekening");    
                    Sequel.menyimpan2("tampjurnal","'"+Sequel.cariIsi("select Kontra_Piutang_Obat from set_akun")+"','PERSEDIAAN','0','"+ttl+"'","Rekening"); 
...
private void BtnGudangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGudangActionPerformed
    ...
    private void TabRawatMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabRawatMouseClicked
        if(TabRawat.getSelectedIndex()==0){
           ...
           JOptionPane.showMessageDialog(null,"Maaf menu ini di nonaktifkan");
    ...
    private void BtnCrSepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCrSepActionPerformed
        akses.setform("DlgPiutang");
        sep.isCek();
        sep.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
        sep.setLocationRelativeTo(internalFrame1);
        sep.setAlwaysOnTop(false);
        sep.setVisible(true);
    }//GEN-LAST:event_BtnCrSepActionPerformed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgInpuObat23 dialog = new DlgInpuObat23(new javax.swing.JFrame(), true);
    ...
    private widget.Button BtnCrSep;
    ...
    public void autoNomor(){
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(piutang.nota_piutang,3),signed)),0) from piutang where piutang.tgl_piutang='"+Valid.SetTgl(Tgl.getSelectedItem()+"")+"' ",
                "PD"+Tgl.getSelectedItem().toString().substring(6,10)+Tgl.getSelectedItem().toString().substring(3,5)+Tgl.getSelectedItem().toString().substring(0,2),3,NoNota);
    }
    ...
    private void simpan() {
        for(i=0;i<tabMode.getRowCount();i++){  
            try {
                if(Valid.SetAngka(tabMode.getValueAt(i,0).toString())>0){
                   if(Sequel.menyimpantf2("detailpiutang","'"+NoNota.getText()+"','"+
                           tabMode.getValueAt(i,1).toString()+"','"+
                           tabMode.getValueAt(i,4).toString()+"','"+
                           tabMode.getValueAt(i,5).toString()+"','"+
                           tabMode.getValueAt(i,15).toString()+"','"+
                           tabMode.getValueAt(i,0).toString()+"','"+
                           tabMode.getValueAt(i,6).toString()+"','"+ //subtotal
                           tabMode.getValueAt(i,7).toString()+"','"+ //dis
                           tabMode.getValueAt(i,8).toString()+"','"+ //besar dis
                           tabMode.getValueAt(i,13).toString()+"','"+
                           tabMode.getValueAt(i,16).toString()+"','"+
                           tabMode.getValueAt(i,17).toString()+"','"+
                           tabMode.getValueAt(i,12).toString()+"'","Transaksi Penjualan")==true){
                        if(verifikasi_penjualan_di_kasir.equals("No")){
                            if(aktifkanbatch.equals("yes")){
                                ...
                                Trackobat.catatRiwayat(tabMode.getValueAt(i,1).toString(),0,Valid.SetAngka(tabMode.getValueAt(i,0).toString()),"Piutang",akses.getkode(),kdgudang.getText(),"Simpan",tabMode.getValueAt(i,16).toString(),tabMode.getValueAt(i,17).toString(),NoNota.getText()+" "+kdmem.getText()+" "+nmmem.getText());
                                ...
                                Trackobat.catatRiwayat(tabMode.getValueAt(i,1).toString(),0,Valid.SetAngka(tabMode.getValueAt(i,0).toString()),"Piutang",akses.getkode(),kdgudang.getText(),"Simpan","","",NoNota.getText()+" "+kdmem.getText()+" "+nmmem.getText());
