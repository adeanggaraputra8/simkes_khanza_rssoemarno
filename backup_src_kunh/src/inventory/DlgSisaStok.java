    ...
    private void prosesCari() {
        ...
        try {
            ...
            ps= koneksi.prepareStatement(
                    ...
                    "jenis.nama like ? and kategori_barang.nama like ? and databarang.status='1' and golongan_barang.nama like ? and (kode_brng like ? or nama_brng like ?) order by kode_brng");
            try {
                ...
                while(rs.next()){
                    ...
                    label9.setText(Valid.SetAngka(totalaset)); 
                }
