...
public final class DlgCariObat extends javax.swing.JDialog {
    ...
    private String signa1="1",signa2="1",nokunjungan="",kdObatSK="",requestJson="",URL="",otorisasi,sql="",aktifpcare="no",no_batchcari="", tgl_kadaluarsacari="", no_fakturcari="", aktifkanbatch="no",kodedokter="",namadokter="",noresep="",bangsal="",bangsaldefault=Sequel.cariIsi("select set_lokasi.kd_bangsal from set_lokasi limit 1"),tampilkan_ppnobat_ralan="",
                   Suspen_Piutang_Obat_Ralan="",Obat_Ralan="",HPP_Obat_Rawat_Jalan="",Persediaan_Obat_Rawat_Jalan="",hppfarmasi="",VALIDASIULANGBERIOBAT="",DEPOAKTIFOBAT="",utc="",nosep="";
    ...
    private void initComponents() {
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-08-2024" }));
        ...
        ChkResepPRB.setText("Centang untuk pasien 23   ");
        ChkResepPRB.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ChkResepPRB.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ChkResepPRB.setName("ChkResepPRB"); // NOI18N
        ChkResepPRB.setOpaque(false);
        ChkResepPRB.setPreferredSize(new java.awt.Dimension(85, 23));
        ChkResepPRB.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                ChkResepPRBItemStateChanged(evt);
            }
        });
        ChkResepPRB.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ChkResepPRBActionPerformed(evt);
            }
        });
        FormInput.add(ChkResepPRB);
        ChkResepPRB.setBounds(700, 10, 150, 23);

        jLabel9.setText("Total Per Item :");
        jLabel9.setName("jLabel9"); // NOI18N
        jLabel9.setPreferredSize(new java.awt.Dimension(45, 23));
        FormInput.add(jLabel9);
        jLabel9.setBounds(675, 40, 80, 23);
        ...
        if(TNoRw.getText().trim().equals("")){
            ...
            if (reply == JOptionPane.YES_OPTION) {
                try {  
                    ...
                    if(sukses==true){
                        if (ChkResepPRB.isSelected()==true){
                             nosep=Sequel.cariIsi("select no_sep from bridging_sep where no_rawat='"+TNoRw.getText()+"' and jnspelayanan='2' ");
                             if(!nosep.toString().equals("")){
                                Sequel.menyimpan("rekap_obat_23","'"+nosep+"','"+TNoRw.getText()+"',''","obat");
                             }
                        }
                    }
...
private void JeniskelasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_JeniskelasKeyPressed
    ...
    private void ChkResepPRBItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_ChkResepPRBItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_ChkResepPRBItemStateChanged

    private void ChkResepPRBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkResepPRBActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ChkResepPRBActionPerformed
    ...
    */
    ...
    private widget.CekBox ChkResepPRB;
    ...
    public void setNoRm(String norwt,String norm,String nama,String tanggal, String jam) {        
        ...
        if (KdPj.getText().trim().equals("BPJ")){
            Jeniskelas.setSelectedIndex(3);
        }else{
            Jeniskelas.setSelectedIndex(0);
        }
        TCari.requestFocus();
    }
