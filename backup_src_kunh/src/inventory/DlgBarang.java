...
public class DlgBarang extends javax.swing.JDialog {
    ...
    public DlgBarang(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,new Object[]{
            ...
            "Kode Golongan","Golongan","Modal","Grosir","Maksimal Peresepan","Retriksi"
        }) {
            @Override
        ...
        jmlh_max.setDocument(new batasInput((byte) 15).getKata(jmlh_max));
        //TRetriksi.setDocument(new batasInput((byte) 100).getKata(TRetriksi));
    ...
    private void initComponents() {
        ...
        jmlh_max.setName("jmlh_max"); // NOI18N
        jmlh_max.setPreferredSize(new java.awt.Dimension(207, 23));
        jmlh_max.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseMoved(java.awt.event.MouseEvent evt) {
                jmlh_maxMouseMoved(evt);
            }
        });
        jmlh_max.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseExited(java.awt.event.MouseEvent evt) {
                jmlh_maxMouseExited(evt);
            }
        });
        jmlh_max.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jmlh_maxKeyPressed(evt);
            }
        });
        FormInput.add(jmlh_max);
        jmlh_max.setBounds(850, 80, 70, 23);

        label43.setText("Jml max. Resep:");
        label43.setName("label43"); // NOI18N
        label43.setPreferredSize(new java.awt.Dimension(65, 23));
        FormInput.add(label43);
        label43.setBounds(750, 80, 90, 23);

        label44.setText("Retriksi :");
        label44.setName("label44"); // NOI18N
        label44.setPreferredSize(new java.awt.Dimension(65, 23));
        FormInput.add(label44);
        label44.setBounds(750, 110, 90, 23);
        ...
        scrollPane2.setBounds(855, 110, 290, 90);
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (Kd.getText().trim().equals("")) {
            ...
            Valid.editTable(tabMode, "databarang", "kode_brng", "?", "nama_brng=?,kode_brng=?,kapasitas=?,kode_sat=?,letak_barang=?,"
                    ...
                    + "karyawan=?,expire=?,kode_industri=?,kode_kategori=?,kode_golongan=?,kode_satbesar=?,dasar=?,isi=?,modal=?,grosir=?,maksimaresep=?,retriksi=?", 30, new String[]{
                        ...
                        kdkategori.getText(),kdgolongan.getText(),kdsatBesar.getText(),dasar.getText(),Isi.getText(),modal1.getText(),grosir.getText(),jmlh_max.getText(),TRetriksi.getText(),
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Kd.getText().trim().equals("")) {
            ...
            if(Sequel.menyimpantf("databarang", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Kode Barang", 30, new String[]{
                ...
                KdIF.getText(),kdkategori.getText(),kdgolongan.getText(),modal1.getText(),grosir.getText(),jmlh_max.getText(),TRetriksi.getText()
                })==true){
                    tampil();
                    emptTeks();
            }
...
private void KapasitasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KapasitasKeyPressed
    ...
    private void grosirKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_grosirKeyPressed
       Valid.pindah(evt, modal1, jmlh_max);
    ...
    private void jmlh_maxMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jmlh_maxMouseMoved
       if (jmlh_max.getText().equals("0")) {
            jmlh_max.setText("");
        }
    }//GEN-LAST:event_jmlh_maxMouseMoved

    private void jmlh_maxMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jmlh_maxMouseExited
        if (jmlh_max.getText().equals("")) {
            jmlh_max.setText("0");
        }
    }//GEN-LAST:event_jmlh_maxMouseExited

    private void jmlh_maxKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jmlh_maxKeyPressed
        Valid.pindah(evt, grosir, TRetriksi);
    }//GEN-LAST:event_jmlh_maxKeyPressed

    private void TRetriksiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TRetriksiKeyPressed
        Valid.pindah2(evt,jmlh_max,KdIF);
    ...
    private widget.TextBox jmlh_max;
        ...
        if(aktifkanbatch.equals("no")){
            try {
                if(TCari.getText().trim().equals("")){
                    ps = koneksi.prepareStatement(
                            ...
                            + " databarang.karyawan,databarang.stokminimal, databarang.kdjns,"
                            + " jenis.nama,kapasitas,databarang.expire,databarang.kode_industri,industrifarmasi.nama_industri, "
                            + " databarang.kode_kategori,kategori_barang.nama as kategori,databarang.kode_golongan,golongan_barang.nama as golongan,databarang.modal,databarang.grosir,databarang.maksimaresep,databarang.retriksi "
                            + " from databarang inner join kodesatuan on databarang.kode_sat=kodesatuan.kode_sat "
                            + " inner join kodesatuan as satuanbesar on databarang.kode_satbesar=satuanbesar.kode_sat "
                            + " inner join jenis on databarang.kdjns=jenis.kdjns "
                            + " inner join industrifarmasi on databarang.kode_industri=industrifarmasi.kode_industri "
            ...
            try {
                ps = koneksi.prepareStatement(
                    ...
                    + " databarang.kode_kategori,kategori_barang.nama as kategori,databarang.kode_golongan,golongan_barang.nama as golongan,data_batch.no_batch,data_batch.no_faktur,databarang.modal,databarang.grosir,databarang.maksimaresep,databarang.retriksi "
    ...
    private void getData() {
        ...
        if (row != -1) {
            ...
            jmlh_max.setText(Double.toString(Double.parseDouble(tbDokter.getValueAt(row, 34).toString())));
            TRetriksi.setText(tbDokter.getValueAt(row,35).toString());
...
//                                        karyawan.setText(Double.toString(Valid.roundUp(Double.parseDouble(beli.getText()) + (Double.parseDouble(beli.getText()) * (rs.getDouble("karyawan") / 100)),100)));
    ...
    public void isBatch(){
        tabMode = new DefaultTableModel(null,new Object[]{
                ...
                "Kelas Utama/BPJS(Rp)", "Ranap VIP(Rp)", "Ranap VVIP(Rp)", "Beli Luar(Rp)","Jual Bebas(Rp)", "Karyawan(Rp)", 
                "Stok Min", "Kode Jenis", "Nama Jenis","Kadaluwarsa","Kode I.F.","Industri Farmasi","Kode Kategori","Kategori",
                "Kode Golongan","Golongan","No.Batch","No.Faktur","Modal","Harga","Maksimal Peresepan","Retriksi"
            }) {
                @Override
                public boolean isCellEditable(int rowIndex, int colIndex) {
                    boolean a = false;
