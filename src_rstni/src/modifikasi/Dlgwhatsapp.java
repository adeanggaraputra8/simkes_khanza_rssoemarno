...
public class Dlgwhatsapp extends javax.swing.JDialog {
    ...
    private String Nohp="",token="",stringbalik="Hallo, Selamat ",respon="", requestJson,requestJson2, TOKEN="", URL="",catat="",rsk="",TNoRW="",nomor="", bacaan="",jamperiksa="",
            isi =
                    "Hallo Sahabat #rs# \n\n" +

                    "*Ny. #nama#*\n\n" +

                    "Hasil USG Anda telah keluar :\n\n" +

                    "🏥 *#rs#*\n" +
                    "🩺 Spesialis : *Poli OBGYN*\n" +
                    "📅 Tanggal : *#tanggal#*\n\n" +

                    "Untuk hasil USG *Si-Dokil GO* telah\n" +
                    "kami kirimkan file pdf nya dibawah\n" +
                    "ini.\n" +

                    "Terimakasih telah mempercayakan\n" +
                    "layanan kesehatan Anda kepada\n" +
                    "#rs# yang\n" +
                    "berkomitmen memberikan\n" +
                    "pelayanan kesehatan cepat dan\n" +
                    "bermutu.";
                ...
                headers.add("Authorization", token);
                 String pesan = TCatatan.getText()
                   ...
                   requestJson2 =
                    "{"
                    + "\"target\":\""+TNoWA.getText()+"\","
                    + "\"message\":\"Hasil USG Ny "+TPasien.getText()+"\","
                    + "\"url\":\""+TUrl1.getText()+"\""
                    + "}";
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    */
    ...
    private void isPsien() {
        String tanggal =Sequel.cariIsi("select date_format(tanggal,'%d-%m-%Y') from hasil_pemeriksaan_usg where no_rawat='"+TNoRW+"' ");
