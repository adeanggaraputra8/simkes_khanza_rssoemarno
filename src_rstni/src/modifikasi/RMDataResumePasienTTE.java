...
import digitalsignature.DlgViewPdfResumeRalan;
 ...
 * @author perpustakaan
 */
public final class RMDataResumePasienTTE extends javax.swing.JDialog {
...
//    private RMCariJumlahObat cariobat=new RMCariJumlahObat(null,false);
    ...
    private String tanggal="",finger="",variabel="",FileName;
    public  DlgDiagnosaPenyakit diagnosa=new DlgDiagnosaPenyakit(null,false);
    
    /** Creates new form DlgRujuk
     * @param parent
     * @param modal */
    public RMDataResumePasienTTE(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        });
    ...
    private void initComponents() {
        ...
        jLabel4.setBounds(10, 70, 240, 23);
        ...
        jLabel25.setBounds(10, 610, 145, 23);
        ...
        DiagnosaSekunder2.setBounds(160, 610, 520, 23);

        jLabel26.setText("Diagnosa Sekunder 3 :");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(10, 640, 145, 23);
        ...
        DiagnosaUtama.setBounds(160, 550, 520, 23);

        jLabel27.setText("Diagnosa Utama :");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(10, 550, 145, 23);
        ...
        DiagnosaSekunder3.setBounds(160, 640, 520, 23);

        jLabel28.setText("Diagnosa Sekunder 4 :");
        jLabel28.setName("jLabel28"); // NOI18N
        FormInput.add(jLabel28);
        jLabel28.setBounds(10, 670, 145, 23);
        ...
        DiagnosaSekunder4.setBounds(160, 670, 520, 23);
        ...
        scrollPane2.setBounds(250, 70, 541, 100);
        ...
        jLabel8.setText("Tanda-Tanda Vital dan Pemeriksaan Fisik:");
        jLabel8.setName("jLabel8"); // NOI18N
        FormInput.add(jLabel8);
        jLabel8.setBounds(10, 180, 240, 23);
        ...
        scrollPane3.setBounds(250, 180, 541, 100);

        jLabel9.setText("Pemeriksaan Penunjang Yang Positif :");
        jLabel9.setName("jLabel9"); // NOI18N
        FormInput.add(jLabel9);
        jLabel9.setBounds(10, 290, 240, 23);
        ...
        scrollPane4.setBounds(250, 290, 541, 110);

        jLabel10.setText("Hasil Laboratorium Yang Positif :");
        jLabel10.setName("jLabel10"); // NOI18N
        FormInput.add(jLabel10);
        jLabel10.setBounds(10, 410, 240, 23);
        ...
        scrollPane5.setBounds(250, 410, 541, 100);

        jLabel11.setText("Obat-obatan Waktu Pulang/Nasihat :");
        jLabel11.setName("jLabel11"); // NOI18N
        FormInput.add(jLabel11);
        jLabel11.setBounds(10, 820, 240, 23);
        ...
        scrollPane6.setBounds(250, 820, 541, 110);

        jLabel29.setText("Diagnosa Akhir :");
        jLabel29.setName("jLabel29"); // NOI18N
        FormInput.add(jLabel29);
        jLabel29.setBounds(10, 520, 97, 23);

        jLabel30.setText("Diagnosa Sekunder 1 :");
        jLabel30.setName("jLabel30"); // NOI18N
        FormInput.add(jLabel30);
        jLabel30.setBounds(10, 580, 145, 23);
        ...
        DiagnosaSekunder1.setBounds(160, 580, 520, 23);

        jLabel31.setText("Kode ICD :");
        jLabel31.setName("jLabel31"); // NOI18N
        FormInput.add(jLabel31);
        jLabel31.setBounds(540, 520, 210, 23);
        ...
        KodeDiagnosaUtama.setBounds(720, 550, 75, 23);
        ...
        KodeDiagnosaSekunder1.setBounds(720, 580, 75, 23);
        ...
        KodeDiagnosaSekunder2.setBounds(720, 610, 75, 23);
        ...
        KodeDiagnosaSekunder3.setBounds(720, 640, 75, 23);
        ...
        KodeDiagnosaSekunder4.setBounds(720, 670, 75, 23);

        jLabel32.setText("Prosedur Utama :");
        jLabel32.setName("jLabel32"); // NOI18N
        FormInput.add(jLabel32);
        jLabel32.setBounds(10, 700, 145, 23);
        ...
        ProsedurUtama.setBounds(160, 700, 520, 23);
        ...
        KodeProsedurUtama.setBounds(720, 700, 75, 23);
        ...
        ProsedurSekunder1.setBounds(160, 730, 520, 23);

        jLabel33.setText("Prosedur Sekunder 1 :");
        jLabel33.setName("jLabel33"); // NOI18N
        FormInput.add(jLabel33);
        jLabel33.setBounds(10, 730, 145, 23);
        ...
        KodeProsedurSekunder1.setBounds(720, 730, 75, 23);

        jLabel34.setText("Prosedur Sekunder 2 :");
        jLabel34.setName("jLabel34"); // NOI18N
        FormInput.add(jLabel34);
        jLabel34.setBounds(10, 760, 145, 23);
        ...
        ProsedurSekunder2.setBounds(160, 760, 520, 23);
        ...
        KodeProsedurSekunder2.setBounds(720, 760, 75, 23);
        ...
        KodeProsedurSekunder3.setBounds(720, 790, 75, 23);
        ...
        ProsedurSekunder3.setBounds(160, 790, 520, 23);

        jLabel35.setText("Prosedur Sekunder 3 :");
        jLabel35.setName("jLabel35"); // NOI18N
        FormInput.add(jLabel35);
        jLabel35.setBounds(10, 790, 145, 23);
        ...
        BtnDokter2.setBounds(220, 310, 28, 23);
        ...
        BtnDokter3.setBounds(210, 440, 28, 23);
        ...
        BtnDokter4.setBounds(220, 840, 28, 23);
        ...
        BtnSimpan1.setBounds(800, 550, 100, 30);
...
//        }
    ...
    private void MnDigitalTTEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDigitalTTEActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            DlgViewPdfResumeRalan berkas=new DlgViewPdfResumeRalan(null,true);
    ...
    private void BtnSimpan1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpan1ActionPerformed
        ...
        diagnosa.isCek();
        diagnosa.setNoRm(TNoRw.getText(),DTPCari1.getDate(),DTPCari2.getDate(),"Ralan");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMDataResumePasienTTE dialog = new RMDataResumePasienTTE(new javax.swing.JFrame(), true);
    ...
    private void isRawat() {
         ...
         if(Sequel.cariInteger("select count(no_rawat) from penilaian_medis_igd where no_rawat='"+TNoRw.getText()+"' ")>0){
            ...
            PemeriksaanPenunjang.setText(Sequel.cariIsi("select penujang from penilaian_medis_ralan_anak where no_rawat=?",TNoRw.getText())); 
            ...
            Obat2an.setText(Sequel.cariIsi("select terapi from penilaian_medis_ralan_geriatri where no_rawat=?",TNoRw.getText())); 
            ...
            PemeriksaanPenunjang.setText(Sequel.cariIsi("select rad from penilaian_medis_ralan_geriatri where no_rawat=?",TNoRw.getText())); 
