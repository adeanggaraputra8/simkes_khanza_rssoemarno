...
public class DlgCariPeriksaLab extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnCetakHasilLab24tte = new javax.swing.JMenuItem();
        ...
        MnCetakHasilLab24tte.setBackground(new java.awt.Color(255, 255, 254));
        MnCetakHasilLab24tte.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnCetakHasilLab24tte.setForeground(new java.awt.Color(50, 50, 50));
        MnCetakHasilLab24tte.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnCetakHasilLab24tte.setText("Model 12 TTE");
        MnCetakHasilLab24tte.setName("MnCetakHasilLab24tte"); // NOI18N
        MnCetakHasilLab24tte.setPreferredSize(new java.awt.Dimension(100, 26));
        MnCetakHasilLab24tte.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnCetakHasilLab24tteActionPerformed(evt);
            }
        });
        MnCetakLab.add(MnCetakHasilLab24tte);
...
private void tbDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbDokterKeyPressed
   if(tabMode.getRowCount()!=0){
    ...
    private void MnCetakHasilLab24tteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakHasilLab24tteActionPerformed
        String data ="";
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data sudah habis...!!!!");
                    ...
                    while(rs.next()){
                        ...
                        try {
                            ...
                            if(rspermintaan.next()){
                                ...
                                param.put("jampermintaan",rspermintaan.getString("jam_permintaan"));
                                param.put("klinis",rspermintaan.getString("diagnosa_klinis"));
                                data = Valid.saveToPDFTte("rptPeriksaLab12Permintaan.jasper","report",tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString(),param);
                                ttefile.isCek(data, kdmem.getText(),tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString(), Sequel.cariIsi("SELECT pl.nip  FROM pegawai p INNER JOIN periksa_lab pl ON pl.nip=p.nik WHERE pl.no_rawat='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString()+"' LIMIT 1"));
                                ttefile.setSize(540, 185);
                                ttefile.setLocationRelativeTo(internalFrame1);
                                ttefile.setVisible(true);
                            }else{
                                 data = Valid.saveToPDFTte("rptPeriksaLab12.jasper","report",tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString(),param); 
                                ttefile.isCek(data, kdmem.getText(),tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString(), Sequel.cariIsi("SELECT pl.nip  FROM pegawai p INNER JOIN periksa_lab pl ON pl.nip=p.nik WHERE pl.no_rawat='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString()+"' LIMIT 1"));
                                ttefile.setSize(540, 185);
                                ttefile.setLocationRelativeTo(internalFrame1);
                                ttefile.setVisible(true);
        ...
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_MnCetakHasilLab24tteActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnCetakHasilLab24tte;
    ...
    private void getData() {
        ...
        if(tbDokter.getSelectedRow()!= -1){
            ...
            kdmem.setText(Sequel.cariIsi("select no_rkm_medis from reg_periksa where no_rawat='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString()+"' "));
