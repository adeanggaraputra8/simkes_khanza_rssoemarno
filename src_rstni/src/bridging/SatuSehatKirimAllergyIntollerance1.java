 ...
 * @author dosen
 */
public final class SatuSehatKirimAllergyIntollerance1 extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public SatuSehatKirimAllergyIntollerance1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//                                rs.getString("allergy_code"), rs.getString("system"), rs.getString("display"), rs.getString("note"), rs.getString("id_allergy")
                    ...
                    try {
                        ...
                        json = "{\n"
                                ...
                                + "    },\n"
                                + "    \"recordedDate\": \"" + tbKamar.getValueAt(i, 13).toString().replaceAll(" ", "T")+"\",\n"
                                + "    \"recorder\": {\n"
...
//                        System.out.println(headers.toString());
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SatuSehatKirimAllergyIntollerance1 dialog = new SatuSehatKirimAllergyIntollerance1(new javax.swing.JFrame(), true);
