...
public class DlgCariPermintaanRadiologi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnKirimPermintaanKeOrthanc = new widget.Button();
        ...
        BtnKirimPermintaanKeOrthanc.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnKirimPermintaanKeOrthanc.setText("Kirim Permintaan Alat Radiologi LG");
        BtnKirimPermintaanKeOrthanc.setFocusPainted(false);
        BtnKirimPermintaanKeOrthanc.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnKirimPermintaanKeOrthanc.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnKirimPermintaanKeOrthanc.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnKirimPermintaanKeOrthanc.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnKirimPermintaanKeOrthanc.setName("BtnKirimPermintaanKeOrthanc"); // NOI18N
        BtnKirimPermintaanKeOrthanc.setPreferredSize(new java.awt.Dimension(215, 23));
        BtnKirimPermintaanKeOrthanc.setRoundRect(false);
        BtnKirimPermintaanKeOrthanc.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnKirimPermintaanKeOrthancActionPerformed(evt);
            }
        });
        FormMenu.add(BtnKirimPermintaanKeOrthanc);
...
private void tbRadiologiRalanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbRadiologiRalanKeyPressed
   if(tabMode.getRowCount()!=0){
    ...
    private void BtnKirimPermintaanKeOrthancActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKirimPermintaanKeOrthancActionPerformed
       if(TabPilihRawat.getSelectedIndex()==0){
            if(!NoRawat.equals("")){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                if(NoPermintaan.trim().equals("")){
    ...
    }//GEN-LAST:event_BtnKirimPermintaanKeOrthancActionPerformed
    ...
    */
    ...
    private widget.Button BtnKirimPermintaanKeOrthanc;
