...
public class DlgPassPhrase extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Passphrase ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Liberation Sans", 0, 13), new java.awt.Color(70, 70, 70))); // NOI18N
                ...
                metadata = root.path("metadata");
                 ...
                 JOptionPane.showMessageDialog(null,metadata.path("message").asText());        
                        if(metadata.path("code").asText().equals("200")){
                            Sequel.menyimpantf("berkas_tte","?,?,Now(),?,?,?,?","No.Rawat",6,new String[]{
                        txtNamaFile.getText(),txtNoRawat.getText(),"",txtLokasiFile.getText(),txtNamaFile.getText(),"MEDIS"
                        });
                        dispose(); 
                       }
            } catch (Exception e) {
