...
public class DlgCariPemesanan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TglTempo3 = new widget.Tanggal();
        label23 = new widget.Label();
        TglTempo4 = new widget.Tanggal();
        ...
        label16.setBounds(430, 10, 100, 23);

        label13.setText("Petugas :");
        label13.setName("label13"); // NOI18N
        label13.setPreferredSize(new java.awt.Dimension(70, 23));
        panelisi3.add(label13);
        label13.setBounds(430, 40, 100, 23);
        ...
        btnSuplier.setBounds(880, 10, 28, 23);
        ...
        btnPetugas.setBounds(880, 40, 28, 23);
        ...
        label14.setBounds(430, 70, 100, 23);
        ...
        RTempo.setBounds(310, 10, 20, 23);

        label22.setText("Tgl.Faktur :");
        label22.setName("label22"); // NOI18N
        label22.setPreferredSize(new java.awt.Dimension(60, 23));
        panelisi3.add(label22);
        label22.setBounds(330, 10, 62, 23);

        TglTempo3.setDisplayFormat("dd-MM-yyyy");
        TglTempo3.setName("TglTempo3"); // NOI18N
        TglTempo3.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TglTempo3KeyPressed(evt);
            }
        });
        panelisi3.add(TglTempo3);
        TglTempo3.setBounds(330, 30, 90, 23);
        ...
        label23.setBounds(350, 50, 25, 23);

        TglTempo4.setDisplayFormat("dd-MM-yyyy");
        TglTempo4.setName("TglTempo4"); // NOI18N
        TglTempo4.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TglTempo4KeyPressed(evt);
            }
        });
        panelisi3.add(TglTempo4);
        TglTempo4.setBounds(330, 70, 90, 23);
...
private void ppHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppHapusActionPerformed
    ...
    private void TglTempo3KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TglTempo3KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_TglTempo3KeyPressed

    private void TglTempo4KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TglTempo4KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_TglTempo4KeyPressed
    ...
    */
    ...
    private widget.Tanggal TglTempo3;
    private widget.Tanggal TglTempo4;
       ...
       Valid.tabelKosong(tabMode);
        try{   
            if(RDatang.isSelected()==true){
                ...
                tanggal=" pemesanan.tgl_tempo between '"+Valid.SetTgl(TglTempo3.getSelectedItem()+"")+"' and '"+Valid.SetTgl(TglTempo4.getSelectedItem()+"")+"' ";
            }
