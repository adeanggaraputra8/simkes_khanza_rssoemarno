...
public class DlgCekStok extends javax.swing.JDialog {
    ...
    public DlgCekStok(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "Kode Barang","Nama Barang","Kategori","Satuan","Harga","Stok","Harga Ralan/R","Harga Jl. Bebas"}){
    ...
    public void tampil() {
        try{  
            ...
            pstampil=koneksi.prepareStatement("select databarang.kode_brng, databarang.nama_brng,jenis.nama, databarang.kode_sat, "+
                "databarang."+hppfarmasi+" as dasar,databarang.ralan,databarang.jualbebas from databarang inner join jenis on databarang.kdjns=jenis.kdjns "+
            ...
            try {
                ...
                while(rstampil.next()){     
                    ...
                    tabMode.addRow(new Object[]{
                        ...
                        rstampil.getDouble("dasar"),stokbarang, rstampil.getDouble("ralan"), rstampil.getDouble("jualbebas")
                    });
                }  
            } catch (Exception e) {
