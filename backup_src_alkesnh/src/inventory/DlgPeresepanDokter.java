...
import modifikasi.DlgCariAturanPakaiLain;
...
public final class DlgPeresepanDokter extends javax.swing.JDialog {
    ...
    private String[] no,kodebarang,namabarang,kodesatuan,kandungan,letakbarang,namajenis,aturan,aturanlatin,industri,komposisi;
    public DlgCariAturanPakai aturanpakai=new DlgCariAturanPakai(null,false);
    public DlgCariAturanPakaiLain aturanpakailain=new DlgCariAturanPakaiLain(null,false);
    private WarnaTable2 warna=new WarnaTable2();
    private WarnaTable2 warna2=new WarnaTable2();
    private WarnaTable2 warna3=new WarnaTable2();
    private DlgCariMetodeRacik metoderacik=new DlgCariMetodeRacik(null,false);
    public DlgCariDokter dokter=new DlgCariDokter(null,false);
    public DlgRawatJalan rwtjl=new DlgRawatJalan(null,false);
    public static final int VK_ENTER  = 0x27;
    private String noracik="",aktifkanbatch="no",STOKKOSONGRESEP="no",qrystokkosong="",tampilkan_ppnobat_ralan="",status="",bangsal="",resep="",aturanpakai1="",ap="",
    ...
    public DlgPeresepanDokter(java.awt.Frame parent, boolean modal) {
        ...
        tabModeResep=new DefaultTableModel(null,new Object[]{
                ...
                "Harga(Rp)","Jenis Obat","Aturan Pakai","I.F.","H.Beli","Stok","atr"
            }){
            ...
            TCari.getDocument().addDocumentListener(new javax.swing.event.DocumentListener(){
                ...
                public void insertUpdate(DocumentEvent e) {
                    if(TCari.getText().length()>2){
                     if(Jenisobat.getSelectedItem().equals("Semua")){  
                        tampilobat();
                     }else if (Jenisobat.getSelectedItem().equals("BPJS")){
                        tampilobatbpjs();
                     }
                    }
                }
...
//        aturanpakailain.addWindowListener(new WindowListener() {
//            @Override
...
//                if(aturanpakailain.getTable().getSelectedRow()!= -1){  
//                    if(TabRawat.getSelectedIndex()==0){
//                        tbResep.setValueAt(aturanpakailain.atr().getText(),tbResep.getSelectedRow(),8);
//                        tbResep.setValueAt(aturanpakailain.latin().getText(),tbResep.getSelectedRow(),12);
...
//        });
 ...
 aturanpakai.addWindowListener(new WindowListener() {
    ...
    private void initComponents() {
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-03-2023" }));
        ...
        label13.setText("Jenis Obat :");
        label13.setName("label13"); // NOI18N
        label13.setPreferredSize(new java.awt.Dimension(50, 23));
        FormInput.add(label13);
        label13.setBounds(710, 70, 60, 23);

        Jenisobat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Semua", "BPJS" }));
        Jenisobat.setName("Jenisobat"); // NOI18N
        Jenisobat.setPreferredSize(new java.awt.Dimension(120, 23));
        Jenisobat.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                JenisobatItemStateChanged(evt);
            }
        });
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
       if(TCari.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Silahkan masukkan nama obat..!!");
            TCari.requestFocus();
        }
...
private void ppBersihkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBersihkanActionPerformed
    if(TabRawat.getSelectedIndex()==0){
        for(i=0;i<tbResep.getRowCount();i++){ 
            ...
            tbResep.setValueAt("",i,8);
            tbResep.setValueAt("",i,12);
        }
    }else if(TabRawat.getSelectedIndex()==1){
    ...
    private void JenisobatItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_JenisobatItemStateChanged
        if(Jenisobat.getSelectedItem().equals("Semua")){  
                        tampilobat();
                     }else if (Jenisobat.getSelectedItem().equals("BPJS")){
                        tampilobatbpjs();
                     }
    }//GEN-LAST:event_JenisobatItemStateChanged
    ...
    */
            ...
            if(kenaikan>0){
                if(aktifkanbatch.equals("yes")){
                    ...
                    psresepasuransi=koneksi.prepareStatement("select databarang.kode_brng, databarang.nama_brng,jenis.nama, databarang.kode_sat,(databarang.h_beli+(databarang.h_beli*?)) as harga,"+
                        ...
                        " inner join maping_obat_poli on databarang.kode_brng=maping_obat_poli.kode_brng "+
                        " where databarang.status='1' "+qrystokkosong+" and gudangbarang.no_batch<>'' and gudangbarang.no_faktur<>'' and gudangbarang.kd_bangsal=? and maping_obat_poli.kd_poli= ? and "+
                ...
                try{
                    ...
                    psresepasuransi.setString(3,kdpoli.getText());
                ...
                try{
                    ...
                    psresep.setString(2,kdpoli.getText());
            ...
            if(kenaikan>0){
                if(aktifkanbatch.equals("yes")){
                    ...
                    psresepasuransi=koneksi.prepareStatement("select databarang.kode_brng, databarang.nama_brng,jenis.nama, databarang.kode_sat,(databarang.h_beli+(databarang.h_beli*?)) as harga,"+
                        ...
                        " inner join industrifarmasi on industrifarmasi.kode_industri=databarang.kode_industri "+
                        " inner join gudangbarang on databarang.kode_brng=gudangbarang.kode_brng "+
                        " where databarang.status='1' "+qrystokkosong+" and gudangbarang.no_batch<>'' and gudangbarang.no_faktur<>'' and gudangbarang.kd_bangsal=? and jenis.nama='BPJS' and "+
                        " (databarang.kode_brng like ? or databarang.nama_brng like ? or databarang.letak_barang like ?) group by gudangbarang.kode_brng order by databarang.nama_brng");
                }else{
                    qrystokkosong="";
                    if(STOKKOSONGRESEP.equals("no")){
                        qrystokkosong=" and gudangbarang.stok>0 ";
                    ...
                    psresepasuransi=koneksi.prepareStatement("select databarang.kode_brng, databarang.nama_brng,jenis.nama, databarang.kode_sat,(databarang.h_beli+(databarang.h_beli*?)) as harga,"+
                        ...
                        " inner join gudangbarang on databarang.kode_brng=gudangbarang.kode_brng "+
                        " where databarang.status='1' "+qrystokkosong+" and gudangbarang.no_batch='' and gudangbarang.no_faktur='' and gudangbarang.kd_bangsal=? and jenis.nama='BPJS' and "+
                        " (databarang.kode_brng like ? or databarang.nama_brng like ? or databarang.letak_barang like ?) order by databarang.nama_brng");
                }
                ...
                try{
                    ...
                    rsobat=psresepasuransi.executeQuery();
                    while(rsobat.next()){
                        tabModeResep.addRow(new Object[] {false,"",rsobat.getString("kode_brng"),rsobat.getString("letak_barang"),
                           rsobat.getString("kode_sat"),rsobat.getString("letak_barang"),Valid.roundUp(rsobat.getDouble("harga"),100),
                           rsobat.getString("nama"),"",rsobat.getString("nama_industri"),
                           rsobat.getDouble("h_beli"),rsobat.getDouble("stok")
                        });    
        ...
        try {
                        ...
                        try {
                            ...
                            if(carikapasitas.next()){ 
                                if(Sequel.menyimpantf2("resep_dokter","?,?,?,?","data",4,new String[]{
                                    ...
                                    tbResep.getValueAt(i,8).toString(),tbResep.getValueAt(i,2).toString()
                                })==false){
                                    sukses=false;
                                }
                            }else{
            ...
            for(i=0;i<tbObatResepRacikan.getRowCount();i++){ 
                if(Valid.SetAngka(tbObatResepRacikan.getValueAt(i,4).toString())>0){ 
                    if(Sequel.menyimpantf2("resep_dokter_racikan","?,?,?,?,?,?,?,?","resep obat racikan",8,new String[]{
                       ...
                       tbObatResepRacikan.getValueAt(i,5).toString(),tbObatResepRacikan.getValueAt(i,6).toString(),tbObatResepRacikan.getValueAt(i,7).toString()
                    })==false){
                        sukses=false;
                    } 
                }
    ...
    private void getCekAturanPakai() {
        row2=tbResep.getRowCount();
            if(tbResep.getSelectedRow()!=-1){
            for(r=0;r<row2;r++){
                if(Valid.SetAngka(tbResep.getValueAt(r,1).toString())>0){
                    try {
                         if(tbResep.getValueAt(r,8).toString().equals("")){
                            JOptionPane.showMessageDialog(null,"Maaf, silahkan masukkan Aturan Pakai Obat...!!!");   
                        }  
                    } catch (Exception e) {
                    }
                }
    ...
    public void isset(){   
        if(Sequel.cariInteger("select count(no_rawat) from reg_periksa where no_rawat='"+TNoRw.getText()+"' and kd_pj='BPJ'")>0){
