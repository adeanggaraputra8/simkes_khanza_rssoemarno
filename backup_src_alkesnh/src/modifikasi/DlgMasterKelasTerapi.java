 ...
 * @author dosen
 */
public class DlgMasterKelasTerapi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgMasterKelasTerapi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{"ID","Kelas.Nama Terapi"}){
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Nama.getText().trim().equals("")){
            ...
            Sequel.menyimpan("master_terapi","'0','"+Nama.getText()+"'","letak");
            tampil();
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Nama.getText().trim().equals("")){
            ...
            Sequel.meghapus("master_terapi","id",tbkecamatan.getValueAt(tbkecamatan.getSelectedRow(),0).toString());  
            tampil();
            emptTeks();
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgMasterKelasTerapi dialog = new DlgMasterKelasTerapi(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select * from master_terapi where nama like ? ");
            try {
