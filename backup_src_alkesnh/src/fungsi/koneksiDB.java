...
public class koneksiDB {
    ...
    //antreanfktp
     public static String URLANTREANFKTP(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("URLANTREANFKTP");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String SECRETANTREANFKTP(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=EnkripsiAES.decrypt(prop.getProperty("SECRETANTREANFKTP"));
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String CONSIDANTREANFKTP(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=EnkripsiAES.decrypt(prop.getProperty("CONSIDANTREANFKTP"));
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String USERKEYANTREANFKTP(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=EnkripsiAES.decrypt(prop.getProperty("USERKEYANTREANFKTP"));
        }catch(Exception e){
            var=""; 
        }
        return var;
