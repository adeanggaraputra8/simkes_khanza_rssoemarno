...
public final class SuratKeteranganSehat extends javax.swing.JDialog {
    ...
    public SuratKeteranganSehat(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Tensi","Suhu","Buta Warna","Keperluan","Kesimpulan","Kolesterol","GDS"
        }){
    ...
    private void initComponents() {
        ...
        Tkolesterol = new widget.TextBox();
        ...
        TanggalSurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-03-2024" }));
        ...
        Tkolesterol.setName("Tkolesterol"); // NOI18N
        Tkolesterol.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TkolesterolKeyPressed(evt);
            }
        });
        FormInput.add(Tkolesterol);
        Tkolesterol.setBounds(800, 40, 70, 23);

        jLabel24.setText("Kolesterol :");
        jLabel24.setName("jLabel24"); // NOI18N
        FormInput.add(jLabel24);
        jLabel24.setBounds(730, 40, 70, 23);

        jLabel25.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel25.setText("mg/dl");
        jLabel25.setName("jLabel25"); // NOI18N
        FormInput.add(jLabel25);
        jLabel25.setBounds(870, 40, 40, 23);

        jLabel26.setText("GDS :");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(730, 68, 70, 23);
        ...
        FormInput.add(TGDS);
        TGDS.setBounds(800, 68, 70, 23);

        jLabel29.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel29.setText("mg/dl");
        jLabel29.setName("jLabel29"); // NOI18N
        FormInput.add(jLabel29);
        jLabel29.setBounds(870, 68, 40, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("surat_keterangan_sehat","?,?,?,?,?,?,?,?,?,?,?,?","No.Surat",12,new String[]{
                    ...
                    Keperluan.getText(),CmbKesimpulan.getSelectedItem()+"",Tkolesterol.getText(),TGDS.getText()
                })==true){
                tampil();
                emptTeks();
            }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            if(tbObat.getSelectedRow()!= -1){
                if(Sequel.mengedittf("surat_keterangan_sehat","no_surat=?","no_surat=?,no_rawat=?,tanggalsurat=?,berat=?,tinggi=?,tensi=?,suhu=?,butawarna=?,keperluan=?,kesimpulan=?,kolesterol=?,GDS=?",13,new String[]{
                    ...
                    Keperluan.getText(),CmbKesimpulan.getSelectedItem().toString(),Tkolesterol.getText(),TGDS.getText(),
       ...
       if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                Valid.MyReportqry("rptSuratKeteranganSehat.jasper","report","::[ Surat Keterangan Sehat ]::",
                              " select surat_keterangan_sehat.no_surat,DATE_FORMAT(surat_keterangan_sehat.tanggalsurat,'%d-%m-%Y')as tanggalsurat,surat_keterangan_sehat.berat,surat_keterangan_sehat.tinggi,surat_keterangan_sehat.tensi,surat_keterangan_sehat.suhu,surat_keterangan_sehat.kolesterol,surat_keterangan_sehat.GDS, "+
    ...
    private void TkolesterolKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TkolesterolKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_TkolesterolKeyPressed
    ...
    */
    ...
    private widget.TextBox Tkolesterol;
        ...
        try{
            ...
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                     "select surat_keterangan_sehat.no_surat,surat_keterangan_sehat.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,surat_keterangan_sehat.kolesterol,surat_keterangan_sehat.GDS,"+
                ...
                ps=koneksi.prepareStatement(
                     "select surat_keterangan_sehat.no_surat,surat_keterangan_sehat.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_keterangan_sehat.tanggalsurat,surat_keterangan_sehat.berat,surat_keterangan_sehat.tinggi,surat_keterangan_sehat.tensi,surat_keterangan_sehat.suhu,surat_keterangan_sehat.kolesterol,surat_keterangan_sehat.GDS, "+                  
                     "surat_keterangan_sehat.butawarna,surat_keterangan_sehat.keperluan,surat_keterangan_sehat.kesimpulan from surat_keterangan_sehat inner join reg_periksa on surat_keterangan_sehat.no_rawat=reg_periksa.no_rawat "+
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                     "where "+tgl+"and no_surat like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and surat_keterangan_sehat.no_rawat like '%"+TCari.getText().trim()+"%' or "+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString(10),rs.getString(11),rs.getString(12),rs.getString("kolesterol"),
                        rs.getString("GDS")
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Tkolesterol.setText(tbObat.getValueAt(tbObat.getSelectedRow(),12).toString());
            TGDS.setText(tbObat.getValueAt(tbObat.getSelectedRow(),13).toString());
        }
    }
    ...
    public void autoNomorSurat() {
        Valid.autoNomerSurat("select ifnull(MAX(CONVERT(LEFT(surat_keterangan_sehat.no_surat,3),signed)),0) from surat_keterangan_sehat where surat_keterangan_sehat.tanggalsurat like '%"+Valid.SetTgl(TanggalSurat.getSelectedItem()+"").substring(0, 7)+"%' ",
                "/KP.NH/SK.1/"+ Valid.SetTgl(TanggalSurat.getSelectedItem() + "").substring(5, 7)
                + "/" + Valid.SetTgl(TanggalSurat.getSelectedItem() + "").substring(0, 4), 3, NoSurat);
