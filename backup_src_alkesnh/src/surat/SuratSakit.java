...
public final class SuratSakit extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TanggalAkhir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "09-02-2023" }));
        ...
        TanggalAwal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "09-02-2023" }));
       ...
       if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                Valid.MyReportqry("rptSuratSakit5.jasper","report","::[ Surat Sakit ]::",
                              ...
                              " pasien.nm_pasien,pasien.jk,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur,pasien.pekerjaan,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat, dokter.no_ijn_praktek" +
    ...
    */
    ...
    private void autoNomorSurat(){
     Valid.autoNomerSurat("select ifnull(MAX(CONVERT(LEFT(suratsakit.no_surat,3),signed)),0) from suratsakit where suratsakit.tanggalawal like '%"+Valid.SetTgl(TanggalAwal.getSelectedItem()+"").substring(0, 7)+"%' ",
                "/KP.NH/SK.2/"+ Valid.SetTgl(TanggalAwal.getSelectedItem() + "").substring(5, 7)
