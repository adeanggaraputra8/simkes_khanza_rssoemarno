...
import fungsi.WarnaTablePasien;
...
import modifikasi.DlgRiwayatObatPRB;
...
public class DlgPasien extends javax.swing.JDialog {
    ...
    private String kdkel="",kdkec="",kdkab="",kdprop="",klg="SAUDARA",pengurutan="",asalform="",bulan="",tahun="",awalantahun="",awalanbulan="",posisitahun="",
            ...
            kabupaten="",pekerjaanpj="",alamatpj="",kelurahanpj="",kecamatanpj="",tampilindikasiprolanis="",
    ...
    private String URL="",link="",otorisasi,utc="",passpcare=Sequel.cariIsi("select pass from user_pcare where level='Admin' "), userpcare=Sequel.cariIsi("select user from user_pcare where level='Admin' ");
    ...
    public DlgPasien(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
              ...
              "kecamatanpj","kabupatenpj","propinsipj","Status Pasien"
            }){
        ...
        try {
            if(koneksiDB.AKTIFKANWARNARALAN().equals("yes")){
                tbPasien.setDefaultRenderer(Object.class, new WarnaTablePasien());
            }else{
    ...
    private void initComponents() {
        ...
        MnSinkrionDataAPIBPJS = new javax.swing.JMenuItem();
        ...
        ppObatPRB = new javax.swing.JMenuItem();
        ppCariProlanis = new javax.swing.JMenuItem();
        ...
        StatusPasien = new widget.ComboBox();
        ...
        MnSinkrionDataAPIBPJS.setBackground(new java.awt.Color(255, 255, 254));
        MnSinkrionDataAPIBPJS.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnSinkrionDataAPIBPJS.setForeground(new java.awt.Color(50, 50, 50));
        MnSinkrionDataAPIBPJS.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnSinkrionDataAPIBPJS.setText("Sinkron Data PRB / Prolanis");
        MnSinkrionDataAPIBPJS.setName("MnSinkrionDataAPIBPJS"); // NOI18N
        MnSinkrionDataAPIBPJS.setPreferredSize(new java.awt.Dimension(350, 26));
        MnSinkrionDataAPIBPJS.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnSinkrionDataAPIBPJSActionPerformed(evt);
            }
        });
        MenuBPJS.add(MnSinkrionDataAPIBPJS);
        ...
        ppObatPRB.setBackground(new java.awt.Color(255, 255, 254));
        ppObatPRB.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppObatPRB.setForeground(new java.awt.Color(50, 50, 50));
        ppObatPRB.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppObatPRB.setText("Input Obat PRB");
        ppObatPRB.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppObatPRB.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppObatPRB.setName("ppObatPRB"); // NOI18N
        ppObatPRB.setPreferredSize(new java.awt.Dimension(220, 26));
        ppObatPRB.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppObatPRBBtnPrintActionPerformed(evt);
            }
        });
        jPopupMenu1.add(ppObatPRB);

        ppCariProlanis.setBackground(new java.awt.Color(255, 255, 254));
        ppCariProlanis.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppCariProlanis.setForeground(new java.awt.Color(50, 50, 50));
        ppCariProlanis.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppCariProlanis.setText("Indikasi Prolanis HT");
        ppCariProlanis.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppCariProlanis.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppCariProlanis.setName("ppCariProlanis"); // NOI18N
        ppCariProlanis.setPreferredSize(new java.awt.Dimension(220, 26));
        ppCariProlanis.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppCariProlanisBtnPrintActionPerformed(evt);
            }
        });
        jPopupMenu1.add(ppCariProlanis);
        ...
        DTPLahir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-05-2026" }));
        ...
        DTPDaftar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-05-2026" }));
        ...
        jLabel37.setText("Status Pasien :");
        jLabel37.setName("jLabel37"); // NOI18N
        FormInput.add(jLabel37);
        jLabel37.setBounds(402, 370, 90, 23);
        ...
        StatusPasien.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "PRB", "Prolanis" }));
        StatusPasien.setLightWeightPopupEnabled(false);
        StatusPasien.setName("StatusPasien"); // NOI18N
        StatusPasien.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                StatusPasienKeyPressed(evt);
            }
        });
        FormInput.add(StatusPasien);
        StatusPasien.setBounds(500, 370, 72, 23);

        jLabel43.setText("Riwayat  Keluarga :");
        jLabel43.setName("jLabel43"); // NOI18N
        FormInput.add(jLabel43);
        jLabel43.setBounds(760, 390, 100, 23);
        ...
        scrollPane3.setBounds(660, 370, 90, 50);
        ...
        FormInput.add(BtnDulu);
        BtnDulu.setBounds(750, 370, 28, 23);
        ...
        scrollPane4.setBounds(860, 370, 90, 50);
        ...
        FormInput.add(BtnKeluarga);
        BtnKeluarga.setBounds(950, 370, 28, 23);

        jLabel44.setText("Instansi Pasien :");
        jLabel44.setName("jLabel44"); // NOI18N
        FormInput.add(jLabel44);
        jLabel44.setBounds(402, 342, 90, 23);

        jLabel45.setText("Riwayat Pasien :");
        jLabel45.setName("jLabel45"); // NOI18N
        FormInput.add(jLabel45);
        jLabel45.setBounds(560, 390, 100, 23);
...
private void tbPasienKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbPasienKeyPressed
       if(tabMode.getRowCount()!=0){
            if(evt.getKeyCode()==KeyEvent.VK_SPACE){
                ...
                ppObatPRBBtnPrintActionPerformed(null);
            }
        }
            ...
            if(Sequel.menyimpantf2("pasien","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rekam Medis Pasien",36,new String[]{
                ...
                Sequel.menyimpan2("status_pasien","?,?","Data",2,new String[]{
                  ...
                  Sequel.menyimpan("m_input_riwayat","?,?,?","Data",3, new String[]{
                        TNo.getText(),TRiwayatDulu.getText(),TRiwayaKeluarga.getText() 
                        });
...
private void KabupatenMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_KabupatenMouseMoved
    ...
    private void StatusPasienKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_StatusPasienKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_StatusPasienKeyPressed

    private void ppObatPRBBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppObatPRBBtnPrintActionPerformed
      if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data pasien sudah habis...!!!!");
            TNo.requestFocus();
        }else if(TNm.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            DlgRiwayatObatPRB form=new DlgRiwayatObatPRB(null,false);
            form.setNoRm(TNo.getText());
            form.isCek();
            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
    ...
    }//GEN-LAST:event_ppObatPRBBtnPrintActionPerformed
    ...
    private void ppCariProlanisBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppCariProlanisBtnPrintActionPerformed
        tampilindikasiprolanis=" and pasien.no_rkm_medis IN (SELECT rp.no_rkm_medis FROM reg_periksa rp INNER JOIN pemeriksaan_ralan pr ON rp.no_rawat=pr.no_rawat WHERE SUBSTRING(pr.tensi,1,3) > 159 ) AND status_pasien.status = '-' ";
        tampil();
    }//GEN-LAST:event_ppCariProlanisBtnPrintActionPerformed

    private void MnSinkrionDataAPIBPJSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSinkrionDataAPIBPJSActionPerformed
         if(tabMode.getRowCount()==0){
                JOptionPane.showMessageDialog(null,"Maaf, data pasien tidak ada...!");
                return;
            }

            int jawab = JOptionPane.showConfirmDialog(
                    null,
                    "Sinkron status PRB BPJS pasien yang tampil sekarang ?",
                    "Konfirmasi",
    ...
    }//GEN-LAST:event_MnSinkrionDataAPIBPJSActionPerformed
    ...
    private javax.swing.JMenuItem MnSinkrionDataAPIBPJS;
    ...
    private widget.ComboBox StatusPasien;
    ...
    private javax.swing.JMenuItem ppCariProlanis;
    ...
    private javax.swing.JMenuItem ppObatPRB;
    ...
    private void tampil() {    
        ...
        try{
            if(cmbHlm.getSelectedItem().toString().equals("Semua")){
                 if(Carialamat.getText().trim().equals("")&&TCari.getText().trim().equals("")&&tampilindikasiprolanis.equals("")){
                      ps=koneksi.prepareStatement("select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "+
                           "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu,pasien.agama, pasien.alamat,kelurahan.nm_kel,kecamatan.nm_kec,kabupaten.nm_kab,propinsi.nm_prop,"+
                           "pasien.gol_darah, pasien.pekerjaan,pasien.stts_nikah,status_pasien.status,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"+
                           "pasien.pnd, pasien.keluarga, pasien.namakeluarga,penjab.png_jawab,pasien.no_peserta,pasien.pekerjaanpj,"+
                           "pasien.alamatpj,pasien.kelurahanpj,pasien.kecamatanpj,pasien.kabupatenpj,pasien.propinsipj,"+
                           "perusahaan_pasien.kode_perusahaan,perusahaan_pasien.nama_perusahaan,pasien.bahasa_pasien,"+
                           "bahasa_pasien.nama_bahasa,pasien.suku_bangsa,suku_bangsa.nama_suku_bangsa,pasien.nip,pasien.email,cacat_fisik.nama_cacat,pasien.cacat_fisik,pasien.kd_pj,status_pasien.status from pasien "+
                           "inner join kelurahan on pasien.kd_kel=kelurahan.kd_kel inner join kecamatan on pasien.kd_kec=kecamatan.kd_kec "+
                           "inner join kabupaten on pasien.kd_kab=kabupaten.kd_kab inner join perusahaan_pasien on perusahaan_pasien.kode_perusahaan=pasien.perusahaan_pasien "+
                           "inner join cacat_fisik on pasien.cacat_fisik=cacat_fisik.id inner join propinsi on pasien.kd_prop=propinsi.kd_prop "+
                           "inner join bahasa_pasien on bahasa_pasien.id=pasien.bahasa_pasien inner join suku_bangsa on suku_bangsa.id=pasien.suku_bangsa "+
                           "inner join penjab on pasien.kd_pj=penjab.kd_pj inner join status_pasien on status_pasien.no_rm=pasien.no_rkm_medis order by pasien.no_rkm_medis desc");  
                 }else{
                      ps=koneksi.prepareStatement("select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "+
                           "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu,pasien.agama,pasien.alamat,kelurahan.nm_kel,kecamatan.nm_kec,kabupaten.nm_kab,propinsi.nm_prop,"+
                           "pasien.gol_darah, pasien.pekerjaan,pasien.stts_nikah,status_pasien.status,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"+
                           ...
                           "inner join cacat_fisik on pasien.cacat_fisik=cacat_fisik.id inner join propinsi on pasien.kd_prop=propinsi.kd_prop "+
                           "inner join bahasa_pasien on bahasa_pasien.id=pasien.bahasa_pasien inner join suku_bangsa on suku_bangsa.id=pasien.suku_bangsa "+
                           "inner join penjab on pasien.kd_pj=penjab.kd_pj inner join status_pasien on status_pasien.no_rm=pasien.no_rkm_medis "+
                           "where concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like ? "+tampilindikasiprolanis+
                           ...
                           "or bahasa_pasien.nama_bahasa like ? or suku_bangsa.nama_suku_bangsa like ? or pasien.nm_ibu like ? or pasien.tgl_daftar like ? "+
                           "or pasien.no_tlp like ? or status_pasien.status like ?) order by pasien.no_rkm_medis desc");  
                 }    
            }else{
                if(Carialamat.getText().trim().equals("")&&TCari.getText().trim().equals("")&&tampilindikasiprolanis.equals("")){
                    ps=koneksi.prepareStatement("select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "+
                           ...
                           "inner join cacat_fisik on pasien.cacat_fisik=cacat_fisik.id inner join propinsi on pasien.kd_prop=propinsi.kd_prop "+
                           "inner join bahasa_pasien on bahasa_pasien.id=pasien.bahasa_pasien inner join suku_bangsa on suku_bangsa.id=pasien.suku_bangsa "+
                           "inner join penjab on pasien.kd_pj=penjab.kd_pj inner join status_pasien on status_pasien.no_rm=pasien.no_rkm_medis order by pasien.no_rkm_medis desc LIMIT ? ");    
                }else{
                    ps=koneksi.prepareStatement("select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "+
                           "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu,pasien.agama,pasien.alamat,kelurahan.nm_kel,kecamatan.nm_kec,kabupaten.nm_kab,propinsi.nm_prop,"+
                           "pasien.gol_darah, pasien.pekerjaan,pasien.stts_nikah,status_pasien.status,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"+
                           ...
                           "or pasien.stts_nikah like ? or pasien.nip like ? or cacat_fisik.nama_cacat like ? or pasien.namakeluarga like ? or perusahaan_pasien.nama_perusahaan like ? "+
                           "or bahasa_pasien.nama_bahasa like ? or suku_bangsa.nama_suku_bangsa like ? or pasien.nm_ibu like ? or pasien.tgl_daftar like ? "+
                           "or pasien.no_tlp like ? or status_pasien.status like ?)  order by pasien.no_rkm_medis desc LIMIT ? ");    
                }       
            }          
            try{
                if(cmbHlm.getSelectedItem().toString().equals("Semua")){
                    if(Carialamat.getText().trim().equals("")&&TCari.getText().trim().equals("")&&tampilindikasiprolanis.equals("")){}else{
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("kecamatanpj"),rs.getString("kabupatenpj"),rs.getString("propinsipj"),rs.getString("status")
                    });
                }          
            }catch(Exception e){
                System.out.println("Notifikasi : "+e);
    ...
    private void getData() {
        if(tbPasien.getSelectedRow()!= -1){                
            try {                
                ...
                TRiwayatDulu.setText(Sequel.cariIsi("select riwayat_dulu from m_input_riwayat where no_rkm_medis ='"+tbPasien.getValueAt(tbPasien.getSelectedRow(),1)+"' "));
                TRiwayaKeluarga.setText(Sequel.cariIsi("select riwayat_keluarga from m_input_riwayat where no_rkm_medis ='"+tbPasien.getValueAt(tbPasien.getSelectedRow(),1).toString()+"' "));
                if(Sequel.cariInteger("select * from status_pasien where no_rm='"+tbPasien.getValueAt(tbPasien.getSelectedRow(),1)+"' ")>0){
                    StatusPasien.setSelectedItem(tbPasien.getValueAt(tbPasien.getSelectedRow(),45).toString());
                  }
                else
                  {
                  StatusPasien.setSelectedIndex(0);
                  }
    ...
    public void isCek(){
        ...
        if (akses.getkode()=="Admin Utama"){
            MnSinkrionDataAPIBPJS.setEnabled(true);
        }else{
            MnSinkrionDataAPIBPJS.setEnabled(false);
        }
    ...
    private void sinkronPRBPasien() {
            ...
            try {
                ...
                for(int i=0; i<tabMode.getRowCount(); i++){
                    ...
                    String noRM = tabMode.getValueAt(i,1).toString();
                    String noPeserta = tabMode.getValueAt(i,20).toString();
                    
                    if(noPeserta == null ||
                        noPeserta.trim().equals("") ||
                        noPeserta.trim().equals("-")){

                         try{

                             PreparedStatement ps2 = koneksi.prepareStatement(
                                 "update status_pasien set status='-' where no_rm=?"
                             );
                    ...
                    try {
                        ...
                        if(nameNode.path("message").asText().equals("OK")){
                           ...
                           String pstPrb = response.path("pstPrb").asText();

                            String pstProl = response.path("pstProl").asText();

                            String kdProvider = response.path("kdProviderPst")
                                                        .path("kdProvider")
                                                        .asText();

                            String status = "-";

                            // wajib provider klinik sendiri
                            boolean providerSesuai =
                                    kdProvider.equals("0269B004");

                            // PRB
                            boolean validPRB =
                                    pstPrb != null &&
                                    !pstPrb.trim().equals("") &&
                                    !pstPrb.equalsIgnoreCase("null");

                            // PROLANIS
                            boolean validProlanis =
                                    pstProl != null &&
                                    !pstProl.trim().equals("") &&
                                    !pstProl.equalsIgnoreCase("null");
                        ...
                        PreparedStatement cek = koneksi.prepareStatement(
                            "select no_rm from status_pasien where no_rm=?"
                        );
                        ...
                        if(rscek.next()){
                            ...
                            // INSERT
                            PreparedStatement ps2 = koneksi.prepareStatement(
                                "insert into status_pasien(no_rm,status) values(?,?)"
                            );
