...
public class frmUtama extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("SIMKES Khanza Service Mobile JKN Belum Dilayani");
    ...
    private void jam(){
        ActionListener taskPerformer = new ActionListener(){
                ...
                if(detik.equals("01")&&((nilai_menit%10)==0)){
                    ...
                    try {
                        ...
                        ps=koneksi.prepareStatement(
                            " Select antrian_bantu_belum.no_rawat,(SELECT FLOOR(RAND()*(1-15+1))+15) as no_reg " +
                            " from antrian_bantu_belum where " +
                            " antrian_bantu_belum.tanggal1 BETWEEN '"+Tanggal1.getText()+" 00:00:00' and '"+Tanggal2.getText()+" 23:59:59' "+
                            " order by antrian_bantu_belum.tanggal1 asc ");
                        try {
                            rs=ps.executeQuery();
                            while(rs.next()){                             
                                    Sequel.mengedit("antrian_bantu_belum","no_rawat='"+rs.getString("no_rawat")+"'","status='Sudah Valid',tanggal2=tanggal1 + INTERVAL "+Sequel.cariIsi("SELECT FLOOR(RAND()*(1-15+1))+15")+" MINUTE ");
                                        
                                
               //mulai task 1                                                    
                               datajam=Sequel.cariIsi("SELECT tanggal1  FROM  antrian_bantu_belum ab  WHERE  no_rawat=? AND  tanggal1 <>'0000-00-00 00:00:00'",rs.getString("no_rawat"));
                                if(!datajam.equals("")){
                                    Sequel.mengedit("antrian_bantu_belum","no_rawat='"+rs.getString("no_rawat")+"'","status='Sudah Valid',tanggal3=tanggal2 + INTERVAL "+Sequel.cariIsi("SELECT FLOOR(RAND()*(2-8+1))+8")+" MINUTE ");
            ...
            //mulai task 2                                                    
                                datajam=Sequel.cariIsi("SELECT tanggal2  FROM  antrian_bantu_belum ab  WHERE  no_rawat=? AND  tanggal2 <>'0000-00-00 00:00:00'",rs.getString("no_rawat"));
                                if(!datajam.equals("")){
                                    Sequel.mengedit("antrian_bantu_belum","no_rawat='"+rs.getString("no_rawat")+"'","status='Sudah Valid',tanggal4=tanggal3 + INTERVAL "+Sequel.cariIsi("SELECT FLOOR(RAND()*(15-30+1))+30")+" MINUTE ");
                                        parsedDate = dateFormat.parse(datajam);
                                        try {     
      ...
      //mulai task 3                                                    
                                datajam=Sequel.cariIsi("SELECT tanggal3  FROM  antrian_bantu_belum ab  WHERE  no_rawat=? AND  tanggal3 <>'0000-00-00 00:00:00'",rs.getString("no_rawat"));
                                if(!datajam.equals("")){
                                    Sequel.mengedit("antrian_bantu_belum","no_rawat='"+rs.getString("no_rawat")+"'","status='Sudah Valid',tanggal5=tanggal4 + INTERVAL "+Sequel.cariIsi("SELECT FLOOR(RAND()*(1-15+1))+15")+" MINUTE ");
                                        parsedDate = dateFormat.parse(datajam);
                                        try {     
                ...
                //mulai task 4                                                    
                                datajam=Sequel.cariIsi("SELECT tanggal4  FROM  antrian_bantu_belum ab  WHERE  no_rawat=? AND  tanggal4 <>'0000-00-00 00:00:00'",rs.getString("no_rawat"));
                                if(!datajam.equals("")){
                                     Sequel.mengedit("antrian_bantu_belum","no_rawat='"+rs.getString("no_rawat")+"'","status='Sudah Valid',tanggal6=tanggal5 + INTERVAL "+Sequel.cariIsi("SELECT FLOOR(RAND()*(5-30+1))+30")+" MINUTE ");
                                        parsedDate = dateFormat.parse(datajam);
                                        try {     
           ...
           //mulai task 5                                                    
                                 datajam=Sequel.cariIsi("SELECT tanggal5  FROM  antrian_bantu_belum ab  WHERE  no_rawat=? AND  tanggal5 <>'0000-00-00 00:00:00'",rs.getString("no_rawat"));
                                if(!datajam.equals("")){
                                      Sequel.mengedit("antrian_bantu_belum","no_rawat='"+rs.getString("no_rawat")+"'","status='Sudah Valid',tanggal7=tanggal6 + INTERVAL "+Sequel.cariIsi("SELECT FLOOR(RAND()*(1-5+1))+5")+" MINUTE ");    
                                        parsedDate = dateFormat.parse(datajam);
                                        try {     
                            ...
                            //add antrian farmasi
                                    ...
                                    try {     
                                        ...
                                        requestJson ="{" +
                                                         ...
                                                         "\"nomorantrean\": 0"+rs.getString("no_reg")+"," +
             ...
             //mulai task 6                                                    
                               datajam=Sequel.cariIsi("SELECT tanggal6  FROM  antrian_bantu_belum ab  WHERE  no_rawat=? AND  tanggal6 <>'0000-00-00 00:00:00'",rs.getString("no_rawat"));
                                if(!datajam.equals("")){                                   
                                        parsedDate = dateFormat.parse(datajam);
                                        try {     
                       ...
                       //mulai task 7                                                    
                              datajam=Sequel.cariIsi("SELECT tanggal7  FROM  antrian_bantu_belum ab  WHERE  no_rawat=? AND  tanggal7 <>'0000-00-00 00:00:00'",rs.getString("no_rawat"));
                                if(!datajam.equals("")){                                   
                                        parsedDate = dateFormat.parse(datajam);
                                        try {     
