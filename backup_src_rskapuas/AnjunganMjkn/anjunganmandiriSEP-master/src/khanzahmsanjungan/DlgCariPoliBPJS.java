    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("SELECT\n"
                    +" maping_poli_bpjs.kd_poli_bpjs, poliklinik.nm_poli FROM \n" 
                    +" maping_poli_bpjs INNER JOIN poliklinik ON poliklinik.kd_poli=maping_poli_bpjs.kd_poli_rs WHERE maping_poli_bpjs.kd_poli_bpjs NOT IN ('IGD','GIG')");
             try {
                rs = ps.executeQuery();
                while (rs.next()) {
