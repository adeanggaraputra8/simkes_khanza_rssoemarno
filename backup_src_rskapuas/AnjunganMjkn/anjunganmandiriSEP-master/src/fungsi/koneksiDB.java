...
public class koneksiDB {
        ...
        if(connection == null){
            try{
                ...
                System.out.println("  Koneksi Berhasil. Sorry bro loading, silahkan baca dulu.... \n\n"+
                        ...
                        "  POWERED BY TIM IT RSUD SOEMARNO .S \n"  );
            }catch(Exception e){
    ...
    public static String ALARMPERMINTAANRANAP(){
      ...
      public static String URLAPIWAAPI(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("URLAPIWAAPI");
        }catch(Exception e){
            var=""; 
        }
        return var;
      ...
      public static String URLAPIWAAPIMEDIA(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("URLAPIWAAPIMEDIA");
        }catch(Exception e){
            var=""; 
        }
        return var;
     ...
     public static String NOHPRS(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("NOHPRS");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String CONSIDAPIBPJS(){
      ...
      public static String USERKEYAPIBPJS(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("USERKEYAPIBPJS");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String SECRETKEYAPIICARE(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("SECRETKEYAPIICARE");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String CONSIDAPIICARE(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("CONSIDAPIICARE");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String USERKEYAPIICARE(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("USERKEYAPIICARE");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String USERKEYAPIAPLICARE(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("USERKEYAPIAPLICARE");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String SECRETKEYAPIMOBILEJKN(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("SECRETKEYAPIMOBILEJKN");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String CONSIDAPIMOBILEJKN(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("CONSIDAPIMOBILEJKN");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String USERKEYAPIMOBILEJKN(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("USERKEYAPIMOBILEJKN");
        }catch(Exception e){
            var=""; 
        }
        return var;
   ...
   public static String IDCORONA(){
    ...
    public static String PASSCORONA(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("PASSCORONA");
        }catch(Exception e){
            var=""; 
        }
        return var;
