...
import modifikasi.DlgCariStatus;
import modifikasi.DlgCariTipe;
import modifikasi.DlgMapingObatDokter;
import modifikasi.DlgMapingObatPoli;
import modifikasi.DlgMapingPaketObatBHP;
import modifikasi.DlgPaketObat;
...
public class DlgBarang extends javax.swing.JDialog {
    ...
    public DlgCariTipe tipeobat = new DlgCariTipe(null, false);
    public DlgCariStatus statusobat = new DlgCariStatus(null, false);
    private DlgPaketObat paketobat = new DlgPaketObat(null, false);
    ...
    public DlgBarang(java.awt.Frame parent, boolean modal) {
        ...
        tipeobat.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {
            }
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgBarang")) {
                    if (tipeobat.getTable().getSelectedRow() != -1) {
                        KdTipe.setText(tipeobat.getTable().getValueAt(tipeobat.getTable().getSelectedRow(), 0).toString());
                        Tipe.setText(tipeobat.getTable().getValueAt(tipeobat.getTable().getSelectedRow(), 1).toString());
                    }
                }
                KdTipe.requestFocus();
            }
        ...
        statusobat.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {
            }
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgBarang")) {
                    if (statusobat.getTable().getSelectedRow() != -1) {
                        kd_status.setText(statusobat.getTable().getValueAt(statusobat.getTable().getSelectedRow(), 0).toString());
                        status.setText(statusobat.getTable().getValueAt(statusobat.getTable().getSelectedRow(), 1).toString());
                    }
                }
                kd_status.requestFocus();
            }
         ...
         paketobat.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {}
            @Override
            public void windowClosing(WindowEvent e) {}
            ...
            public void windowClosed(WindowEvent e) {
                if(akses.getform().equals("DlgBarang")){
                    if(paketobat.getTable().getSelectedRow()!= -1){                   
                        nm_paket.setText(paketobat.getTable().getValueAt(paketobat.getTable().getSelectedRow(),1).toString());                    
                    }  
                    BtnPaket.requestFocus();
                }
            }
            @Override
            public void windowIconified(WindowEvent e) {}
        ...
        paketobat.getTable().addKeyListener(new KeyListener() {
            @Override
            public void keyTyped(KeyEvent e) {}
            @Override
            public void keyPressed(KeyEvent e) {
    ...
    private void initComponents() {
        ...
        MnMapingObatDokter = new javax.swing.JMenuItem();
        MnMapingPaketObat = new javax.swing.JMenuItem();
        ...
        kd_status = new widget.TextBox();
        status = new widget.TextBox();
        Tipe = new widget.TextBox();
        KdTipe = new widget.TextBox();
        label25 = new widget.Label();
        label41 = new widget.Label();
        label42 = new widget.Label();
        BtnTipe = new widget.Button();
        BtnStatus = new widget.Button();
        ...
        MnMapingObat.setText("Maping Obat Poli");
        ...
        MnMapingObatDokter.setBackground(new java.awt.Color(255, 255, 254));
        MnMapingObatDokter.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnMapingObatDokter.setForeground(new java.awt.Color(50, 50, 50));
        MnMapingObatDokter.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnMapingObatDokter.setText("Maping Obat Dokter");
        MnMapingObatDokter.setToolTipText("");
        MnMapingObatDokter.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnMapingObatDokter.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnMapingObatDokter.setName("MnMapingObatDokter"); // NOI18N
        MnMapingObatDokter.setPreferredSize(new java.awt.Dimension(200, 26));
        MnMapingObatDokter.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnMapingObatDokterActionPerformed(evt);
            }
        });
        Popup.add(MnMapingObatDokter);

        MnMapingPaketObat.setBackground(new java.awt.Color(255, 255, 254));
        MnMapingPaketObat.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnMapingPaketObat.setForeground(new java.awt.Color(50, 50, 50));
        MnMapingPaketObat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnMapingPaketObat.setText("Maping Paket Obat/BHP");
        MnMapingPaketObat.setToolTipText("");
        MnMapingPaketObat.setActionCommand("Mapinng Paket Obat/BHP");
        MnMapingPaketObat.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnMapingPaketObat.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnMapingPaketObat.setName("MnMapingPaketObat"); // NOI18N
        MnMapingPaketObat.setPreferredSize(new java.awt.Dimension(200, 26));
        MnMapingPaketObat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnMapingPaketObatActionPerformed(evt);
            }
        });
        Popup.add(MnMapingPaketObat);
        ...
        Ket1.setBackground(new java.awt.Color(255, 255, 255));
        Ket1.setForeground(new java.awt.Color(0, 0, 0));
        Ket1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "BPJS", "UMUM", "HIBAH" }));
        ...
        FormInput.add(Ket1);
        Ket1.setBounds(850, 70, 90, 23);

        kd_status.setName("kd_status"); // NOI18N
        kd_status.setPreferredSize(new java.awt.Dimension(207, 23));
        kd_status.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                kd_statusKeyPressed(evt);
            }
        });
        FormInput.add(kd_status);
        kd_status.setBounds(850, 40, 90, 23);

        status.setEditable(false);
        status.setName("status"); // NOI18N
        status.setPreferredSize(new java.awt.Dimension(207, 23));
        FormInput.add(status);
        status.setBounds(940, 40, 140, 23);

        Tipe.setEditable(false);
        Tipe.setName("Tipe"); // NOI18N
        Tipe.setPreferredSize(new java.awt.Dimension(207, 23));
        FormInput.add(Tipe);
        Tipe.setBounds(940, 10, 140, 23);

        KdTipe.setName("KdTipe"); // NOI18N
        KdTipe.setPreferredSize(new java.awt.Dimension(207, 23));
        KdTipe.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KdTipeKeyPressed(evt);
            }
        });
        FormInput.add(KdTipe);
        KdTipe.setBounds(850, 10, 90, 23);

        label25.setText(" Sediaan :");
        label25.setName("label25"); // NOI18N
        label25.setPreferredSize(new java.awt.Dimension(65, 23));
        FormInput.add(label25);
        label25.setBounds(778, 10, 70, 23);

        label41.setText(" Status : ");
        label41.setName("label41"); // NOI18N
        label41.setPreferredSize(new java.awt.Dimension(65, 23));
        FormInput.add(label41);
        label41.setBounds(770, 40, 80, 23);

        label42.setText(" Keterangan : ");
        label42.setName("label42"); // NOI18N
        label42.setPreferredSize(new java.awt.Dimension(65, 23));
        FormInput.add(label42);
        label42.setBounds(770, 70, 80, 23);

        BtnTipe.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnTipe.setMnemonic('2');
        BtnTipe.setToolTipText("Alt+2");
        BtnTipe.setName("BtnTipe"); // NOI18N
        BtnTipe.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnTipe.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnTipeActionPerformed(evt);
            }
        });
        FormInput.add(BtnTipe);
        BtnTipe.setBounds(1085, 10, 25, 23);

        BtnStatus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnStatus.setMnemonic('2');
        BtnStatus.setToolTipText("Alt+2");
        BtnStatus.setName("BtnStatus"); // NOI18N
        BtnStatus.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnStatus.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnStatusActionPerformed(evt);
            }
        });
        FormInput.add(BtnStatus);
        ...
        label45.setBounds(770, 100, 80, 23);
        ...
        label46.setBounds(770, 130, 80, 23);
        ...
        label47.setBounds(740, 160, 110, 23);
        ...
        highalert.setBounds(850, 160, 90, 23);
        ...
        lifesaving.setBounds(850, 130, 90, 23);
        ...
        scrollPane2.setBounds(1060, 70, 210, 90);
        ...
        label48.setBounds(950, 70, 90, 23);

        nm_paket.setEditable(false);
        nm_paket.setName("nm_paket"); // NOI18N
        nm_paket.setPreferredSize(new java.awt.Dimension(207, 23));
        FormInput.add(nm_paket);
        nm_paket.setBounds(850, 190, 150, 23);

        label43.setText(" Paket Obat : ");
        label43.setName("label43"); // NOI18N
        label43.setPreferredSize(new java.awt.Dimension(65, 23));
        FormInput.add(label43);
        label43.setBounds(770, 190, 80, 23);
        ...
        FormInput.add(BtnPaket);
        BtnPaket.setBounds(1000, 190, 25, 23);

        label44.setText(" Suhu (Derajat) : ");
        label44.setName("label44"); // NOI18N
        label44.setPreferredSize(new java.awt.Dimension(65, 23));
        FormInput.add(label44);
        label44.setBounds(760, 220, 90, 23);

        Tsuhu.setName("Tsuhu"); // NOI18N
        Tsuhu.setPreferredSize(new java.awt.Dimension(207, 23));
        ...
        FormInput.add(Tsuhu);
        Tsuhu.setBounds(850, 220, 80, 23);

        label49.setText(" Pengadaan : ");
        label49.setName("label49"); // NOI18N
        label49.setPreferredSize(new java.awt.Dimension(65, 23));
        FormInput.add(label49);
        label49.setBounds(740, 250, 110, 23);

        pengadaan.setForeground(new java.awt.Color(50, 70, 50));
        pengadaan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "Rumah Sakit", "Program Dinkes" }));
        pengadaan.setName("pengadaan"); // NOI18N
        pengadaan.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                pengadaanItemStateChanged(evt);
            }
        });
        pengadaan.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                pengadaanMouseClicked(evt);
            }
        });
        ...
        pengadaan.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                pengadaanKeyPressed(evt);
            }
        });
        FormInput.add(pengadaan);
        pengadaan.setBounds(850, 250, 150, 23);
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (Kd.getText().trim().equals("")) {
        ...
        }  else if (KdTipe.getText().trim().equals("") || Tipe.getText().trim().equals("")) {
            Valid.textKosong(KdTipe, "Tipe Obat");
        } else if (kd_status.getText().trim().equals("") || status.getText().trim().equals("")) {
            Valid.textKosong(kd_status, "Status");
        } else {
            ...
            Valid.editTable(tabMode, "databarang", "kode_brng", "?", "nama_brng=?,kode_brng=?,kapasitas=?,kode_sat=?,letak_barang=?,"
                    ...
                    + "karyawan=?,expire=?,kode_industri=?,kode_kategori=?,kode_golongan=?,kode_satbesar=?,dasar=?,isi=?,kode_tipe=?,kode_status=?,status1=?,"
                    + "lasa=?,lifesaving=?,highalert=?,paketobat=?,suhu=?,pengadaan=?,retriksi=?", 36, new String[]{
                        ...
                        kdkategori.getText(),kdgolongan.getText(),kdsatBesar.getText(),dasar.getText(),Isi.getText(),KdTipe.getText(),kd_status.getText(),
                        Ket1.getSelectedItem().toString(),lasal.getSelectedItem().toString(),lifesaving.getSelectedItem().toString(),highalert.getSelectedItem().toString(),
                        nm_paket.getText(),Tsuhu.getText(),pengadaan.getSelectedItem().toString(),TRetriksi.getText(),
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Kd.getText().trim().equals("")) {
            ...
            if(Sequel.menyimpantf("databarang", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Kode Barang", 36, new String[]{
                ...
                KdIF.getText(),kdkategori.getText(),kdgolongan.getText(),KdTipe.getText(), kd_status.getText(),Ket1.getSelectedItem().toString(),
                lasal.getSelectedItem().toString(),lifesaving.getSelectedItem().toString(),highalert.getSelectedItem().toString(),
                nm_paket.getText(),Tsuhu.getText(),pengadaan.getSelectedItem().toString(),TRetriksi.getText()
                })==true){
                    tampil();
                    emptTeks();
...
private void KapasitasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KapasitasKeyPressed
    ...
    private void kd_statusKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_kd_statusKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_kd_statusKeyPressed

    private void KdTipeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KdTipeKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_PAGE_DOWN) {
            Sequel.cariIsi("select tipe from tipe_barang where kode=?", Tipe, KdTipe.getText());
        } else if (evt.getKeyCode() == KeyEvent.VK_PAGE_UP) {
            Sequel.cariIsi("select tipe from tipe_barang where kode=?", Tipe, KdTipe.getText());

        } else if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            Sequel.cariIsi("select nama from kategori where kode=?", Tipe, KdTipe.getText());

        } else if (evt.getKeyCode() == KeyEvent.VK_SPACE) {
            BtnKategoriActionPerformed(null);
        }
    }//GEN-LAST:event_KdTipeKeyPressed

    private void BtnTipeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTipeActionPerformed
        akses.setform("DlgBarang");
        tipeobat.isCek();
        tipeobat.setSize(internalFrame1.getWidth() - 40, internalFrame1.getHeight() - 40);
        tipeobat.setLocationRelativeTo(internalFrame1);
        tipeobat.setAlwaysOnTop(false);
        tipeobat.setVisible(true);
    }//GEN-LAST:event_BtnTipeActionPerformed

    private void BtnStatusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnStatusActionPerformed
        akses.setform("DlgBarang");
        statusobat.isCek();
        statusobat.setSize(internalFrame1.getWidth() - 40, internalFrame1.getHeight() - 40);
        statusobat.setLocationRelativeTo(internalFrame1);
        statusobat.setAlwaysOnTop(false);
        statusobat.setVisible(true);
    ...
    private void BtnPaketActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPaketActionPerformed
       akses.setform("DlgBarang");
        paketobat.setSize(internalFrame1.getWidth() - 40, internalFrame1.getHeight() - 40);
        paketobat.setLocationRelativeTo(internalFrame1);
        paketobat.setAlwaysOnTop(false);
        paketobat.setVisible(true);
    ...
    private void pengadaanItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_pengadaanItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_pengadaanItemStateChanged

    private void pengadaanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pengadaanMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_pengadaanMouseClicked
    ...
    private void pengadaanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_pengadaanKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_pengadaanKeyPressed
    ...
    private void MnMapingObatDokterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnMapingObatDokterActionPerformed
        DlgMapingObatDokter maping=new DlgMapingObatDokter(null, false);
        maping.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
        maping.setLocationRelativeTo(internalFrame1);
        maping.setVisible(true);
    }//GEN-LAST:event_MnMapingObatDokterActionPerformed

    private void MnMapingPaketObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnMapingPaketObatActionPerformed
        DlgMapingPaketObatBHP maping=new DlgMapingPaketObatBHP(null, false);
        maping.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
        maping.setLocationRelativeTo(internalFrame1);
        maping.setVisible(true);
    }//GEN-LAST:event_MnMapingPaketObatActionPerformed
    ...
    private widget.Button BtnStatus;
    private widget.Button BtnTipe;
    ...
    private widget.TextBox KdTipe;
    private widget.ComboBox Ket1;
    private widget.Label LCount;
    private widget.TextBox Letak;
    private javax.swing.JMenuItem MnMapingObat;
    private javax.swing.JMenuItem MnMapingObatDokter;
    private javax.swing.JMenuItem MnMapingPaketObat;
    ...
    private widget.TextBox kd_status;
    ...
    private widget.TextBox nm_paket;
    ...
    private widget.ComboBox pengadaan;
        ...
        if(aktifkanbatch.equals("no")){
            try {
                if(TCari.getText().trim().equals("")){
                    ps = koneksi.prepareStatement(
                            ...
                            + " databarang.karyawan,databarang.stokminimal, databarang.kdjns,"
                            + " jenis.nama,kapasitas,databarang.expire,databarang.kode_industri,industrifarmasi.nama_industri, "
                            + " databarang.kode_kategori,kategori_barang.nama as kategori,databarang.kode_golongan,golongan_barang.nama as golongan,databarang.kode_tipe,tipe_barang.tipe,databarang.kode_status,status_barang.status,databarang.status1, "
                            + " databarang.lasa,databarang.lifesaving,databarang.highalert,databarang.paketobat,databarang.suhu,databarang.pengadaan,databarang.retriksi"
                            + " from databarang inner join kodesatuan on databarang.kode_sat=kodesatuan.kode_sat "
                            + " left join kodesatuan as satuanbesar on databarang.kode_satbesar=satuanbesar.kode_sat "
                            + " inner join jenis on databarang.kdjns=jenis.kdjns "
                            + " inner join industrifarmasi on databarang.kode_industri=industrifarmasi.kode_industri "
                            + " inner join golongan_barang on databarang.kode_golongan=golongan_barang.kode "
                            + " inner join kategori_barang on databarang.kode_kategori=kategori_barang.kode "
                            + " left join tipe_barang on databarang.kode_tipe=tipe_barang.kode "
                            + " left join status_barang on status_barang.kode=databarang.kode_status "
                    ...
                    ps = koneksi.prepareStatement(
                            ...
                            + " databarang.status='1' and tipe_barang.tipe like ? or "
                            + " databarang.status='1' and status_barang.status like ? or "
                            + " databarang.status='1' and databarang.status1 like ? or "
                            + " databarang.status='1' and industrifarmasi.nama_industri like ? or "
                            + " databarang.status='1' and databarang.lasa like ? or "
                            + " databarang.status='1' and databarang.lifesaving like ? or "
                            + " databarang.status='1' and databarang.highalert like ? or "
                            + " databarang.status='1' and databarang.paketobat like ? or "
                            + " databarang.status='1' and databarang.suhu like ? or "
                            + " databarang.status='1' and databarang.pengadaan like ? or "
                ...
                try {
                    ...
                    while (rs.next()) {
                        tabMode.addRow(new Object[]{
                            ...
                            rs.getString("kode_tipe"),
                            rs.getString("tipe"),
                            rs.getString("kode_status"),
                            rs.getString("status"),
                            rs.getString("status1"),
                            rs.getString("lasa"),
                            rs.getString("lifesaving"),
                            rs.getString("highalert"),
                            rs.getString("paketobat"),
                            rs.getString("suhu"),
                            rs.getString("pengadaan"),
            ...
            try {
                ps = koneksi.prepareStatement(
                    ...
                    + " databarang.kode_kategori,kategori_barang.nama as kategori,databarang.kode_golongan,golongan_barang.nama as golongan,data_batch.no_batch,data_batch.no_faktur,databarang.kode_tipe,tipe_barang.tipe,databarang.kode_status,status_barang.status,databarang.status1, "
                    + " databarang.lasa,databarang.lifesaving,databarang.highalert,databarang.paketobat,databarang.suhu,databarang.pengadaan,databarang.retriksi "
                    ...
                    + " data_batch.sisa>0 and databarang.lasa like ? or "
                    + " data_batch.sisa>0 and databarang.lifesaving like ? or "
                    + " data_batch.sisa>0 and databarang.highalert like ? or "
                    + " data_batch.sisa>0 and databarang.paketobat like ? or "
                    + " data_batch.sisa>0 and databarang.suhu like ? or "
                    + " data_batch.sisa>0 and databarang.pengadaan like ? or "
    ...
    private void getData() {
        ...
        if (row != -1) {
            ...
            KdTipe.setText(tbDokter.getValueAt(row, 32).toString());
            Tipe.setText(tbDokter.getValueAt(row, 33).toString());
            kd_status.setText(tbDokter.getValueAt(row, 34).toString());
            status.setText(tbDokter.getValueAt(row, 35).toString());
            Ket1.setSelectedItem(tbDokter.getValueAt(tbDokter.getSelectedRow(),36).toString());
            lasal.setSelectedItem(tbDokter.getValueAt(tbDokter.getSelectedRow(),37).toString());
            lifesaving.setSelectedItem(tbDokter.getValueAt(tbDokter.getSelectedRow(),38).toString());
            highalert.setSelectedItem(tbDokter.getValueAt(tbDokter.getSelectedRow(),39).toString());
            nm_paket.setText(tbDokter.getValueAt(row, 40).toString());
            Tsuhu.setText(tbDokter.getValueAt(row, 41).toString());
            pengadaan.setSelectedItem(tbDokter.getValueAt(tbDokter.getSelectedRow(),42).toString());
            TRetriksi.setText(tbDokter.getValueAt(row, 43).toString());
    ...
    public void isBatch(){
        tabMode = new DefaultTableModel(null,new Object[]{
                ...
                "Kelas Utama/BPJS(Rp)", "Ranap VIP(Rp)", "Ranap VVIP(Rp)", "Beli Luar(Rp)","Jual Bebas(Rp)", "Karyawan(Rp)", 
                "Stok Min", "Kode Jenis", "Nama Jenis","Kadaluwarsa","Kode I.F.","Industri Farmasi","Kode Kategori","Kategori",
                "Kode Golongan","Golongan","No.Batch","No.Faktur","Kode Sediaan","Sediaan","Kode Status","Status","Keterangan Obat","Lasa","Life Saving",
                "High Alert","Paket Obat/BHP","Suhu (Derajat)","Pengadaan","Retriksi"
            }) {
                @Override
                public boolean isCellEditable(int rowIndex, int colIndex) {
