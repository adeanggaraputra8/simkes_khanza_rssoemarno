...
public final class DlgResepObat extends javax.swing.JDialog {
    ...
    private PreparedStatement ps,ps2,psracikan,pskandungan;
    private ResultSet rs,rs2,rsracikan,rskandungan;
    public DlgCariDokter dokter=new DlgCariDokter(null,false);
    private DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    private Date date = new Date();
    private String now=dateFormat.format(date),lembarobat="",status="",rincianobat="",finger="",kandunganobat="";
    ...
    public DlgResepObat(java.awt.Frame parent, boolean modal) {
        ...
        NoResep.setDocument(new batasInput((byte)13).getKata(NoResep));
    ...
    private void initComponents() {
        ...
        ppLembarObat3 = new javax.swing.JMenuItem();
        ...
        ppLembarObat3.setBackground(new java.awt.Color(255, 255, 254));
        ppLembarObat3.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppLembarObat3.setForeground(new java.awt.Color(50, 50, 50));
        ppLembarObat3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppLembarObat3.setText("Lembar Pemberian Obat 4");
        ppLembarObat3.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppLembarObat3.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppLembarObat3.setName("ppLembarObat3"); // NOI18N
        ppLembarObat3.setPreferredSize(new java.awt.Dimension(225, 25));
        ppLembarObat3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppLembarObat3ActionPerformed(evt);
            }
        });
        Popup2.add(ppLembarObat3);
        ...
        ppLabelObatKronis.setBackground(new java.awt.Color(255, 255, 254));
        ppLabelObatKronis.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppLabelObatKronis.setForeground(new java.awt.Color(50, 50, 50));
        ppLabelObatKronis.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppLabelObatKronis.setText("Label Daftar Obat Kronis");
        ppLabelObatKronis.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppLabelObatKronis.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppLabelObatKronis.setName("ppLabelObatKronis"); // NOI18N
        ppLabelObatKronis.setPreferredSize(new java.awt.Dimension(225, 25));
        ppLabelObatKronis.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppLabelObatKronisActionPerformed(evt);
            }
        });
        Popup2.add(ppLabelObatKronis);
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "28-04-2024 16:21:34" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "28-04-2024 16:21:34" }));
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "28-04-2024" }));
  ...
  isForm();                
    ...
    private void ppResepObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppResepObatActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            param1.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
            if(Sequel.cariInteger(
                    "select count(*) from resep_obat inner join "+
                ...
                Valid.MyReportqry("rptItemResep12.jasper","report","::[ Aturan Pakai Obat ]::",
                    "select resep_obat.no_resep,resep_obat.tgl_perawatan,resep_obat.jam,pasien.tgl_lahir," +
                    "resep_obat.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,obat_racikan.nama_racik," +
                    "obat_racikan.aturan_pakai,obat_racikan.jml_dr,metode_racik.nm_racik,pasien.jk,reg_periksa.umurdaftar,reg_periksa.sttsumur,pasien.jk " +
                    "from resep_obat inner join reg_periksa inner join pasien inner join " +
                    ...
                    "where resep_obat.no_resep='"+NoResep.getText()+"'",param1);
            }                
            this.setCursor(Cursor.getDefaultCursor());
        }
    ...
    private void ppLembarObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppLembarObatActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
            param.put("nobpjs",Sequel.cariIsi("select pasien.no_peserta from pasien where no_rkm_medis='"+TNoRm.getText()+"' "));
    ...
    private void ppResepObat1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppResepObat1ActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            if(Sequel.cariInteger(
                    ...
                    "resep_obat.tgl_perawatan=aturan_pakai.tgl_perawatan and " +
                    "resep_obat.jam=aturan_pakai.jam where resep_obat.no_resep=? and aturan_pakai.aturan<>''",NoResep.getText())>0){
                Valid.MyReportqry("rptItemResep10.jasper","report","::[ Aturan Pakai Obat ]::",
                    "select resep_obat.no_resep,resep_obat.tgl_perawatan,resep_obat.jam,pasien.tgl_lahir, "+
                    "resep_obat.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,databarang.nama_brng,"+
    ...
    private void ppResepObat2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppResepObat2ActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            if(Sequel.cariInteger(
                    ...
                    "resep_obat.tgl_perawatan=aturan_pakai.tgl_perawatan and " +
                    "resep_obat.jam=aturan_pakai.jam where resep_obat.no_resep=? and aturan_pakai.aturan<>''",NoResep.getText())>0){
                Valid.MyReportqry("rptItemResep11.jasper","report","::[ Aturan Pakai Obat ]::",
                    "select resep_obat.no_resep,resep_obat.tgl_perawatan,resep_obat.jam,pasien.tgl_lahir, "+
                    "resep_obat.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,databarang.nama_brng,"+
                    "aturan_pakai.aturan,detail_pemberian_obat.jml,kodesatuan.satuan,pasien.jk,reg_periksa.umurdaftar,reg_periksa.sttsumur "+
                    "from resep_obat inner join reg_periksa inner join pasien inner join "+
              ...
              psracikan=koneksi.prepareStatement(
                ...
                try {
                    ...
                    while(rsracikan.next()){
                        ...
                        Sequel.menyimpan("temporary_resep","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",38,new String[]{
                            ""+i,"Racikan : "+rsracikan.getString("nama_racik")+" ("+rincianobat+")",rsracikan.getString("aturan_pakai"),rsracikan.getString("jml_dr"),rsracikan.getString("nm_racik"),"","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",akses.getalamatip()
                        });
                        i++;
                    }
                } catch (Exception e) {
    ...
    private void ppLabelObatKronisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppLabelObatKronisActionPerformed
        if(tabMode.getRowCount()==0){
             JOptionPane.showMessageDialog(null,"Maaf, data sudah habis...!!!!");
             TNoRw.requestFocus();
        }else if(TPasien.getText().trim().equals("")){
            ...
            param.put("pasien",TPasien.getText());
            param.put("norm",TNoRm.getText());
            param.put("nosep",Sequel.cariIsi("select concat(no_kartu,'/',no_sep) from bridging_sep where no_rawat='"+TNoRw.getText()+"' ")); 
            
            Valid.MyReportqry("rptItemResepkronis.jasper","report","::[ Label Daftar Obat ]::","select * from temporary_resep where temporary_resep.temp37='"+akses.getalamatip()+"' order by temporary_resep.no",param);
            this.setCursor(Cursor.getDefaultCursor());
        }
    }//GEN-LAST:event_ppLabelObatKronisActionPerformed

    private void ppLembarObat3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppLembarObat3ActionPerformed
        if(tabMode.getRowCount()==0){
             JOptionPane.showMessageDialog(null,"Maaf, data sudah habis...!!!!");
             TNoRw.requestFocus();
        }else if(TPasien.getText().trim().equals("")){
                ...
                try {
                    ...
                    while(rsracikan.next()){
                        ...
                        try {
                            ...
                            total=0;
                            while(rs2.next()){
                                pskandungan=koneksi.prepareStatement(
                                        "SELECT kandungan FROM resep_dokter_racikan_detail rd INNER JOIN resep_obat ro ON rd.no_resep=ro.no_resep  INNER JOIN detail_obat_racikan dor on dor.no_rawat=ro.no_rawat AND " +
                                        "rd.kode_brng=dor.kode_brng and " +
    ...
    }//GEN-LAST:event_ppLembarObat3ActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem ppLabelObatKronis;
    ...
    private javax.swing.JMenuItem ppLembarObat3;
    ...
    private void autoresep() {
        if(ChkRM.isSelected()==true){
            Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(resep_obat.no_resep,4),signed)),0) from resep_obat where resep_obat.tgl_peresepan='"+Valid.SetTgl(DTPBeri.getSelectedItem()+"")+"' or resep_obat.tgl_peresepan='"+Valid.SetTgl(DTPBeri.getSelectedItem()+"")+"' ",
