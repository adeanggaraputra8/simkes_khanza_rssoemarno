...
public class DlgMutasiBarang extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        label15.setBounds(720, 40, 92, 23);
        ...
        NoPermintaan.setBounds(820, 40, 120, 23);

        label13.setText("Pegawai :");
        label13.setName("label13"); // NOI18N
        label13.setPreferredSize(new java.awt.Dimension(70, 23));
        panelisi3.add(label13);
        label13.setBounds(680, 10, 100, 23);
        ...
        panelisi3.add(kdptg);
        kdptg.setBounds(790, 10, 90, 23);

        nmptg.setEditable(false);
        nmptg.setName("nmptg"); // NOI18N
        nmptg.setPreferredSize(new java.awt.Dimension(207, 23));
        panelisi3.add(nmptg);
        nmptg.setBounds(880, 10, 150, 23);
        ...
        btnPetugas.setBounds(1030, 10, 28, 23);
...
*/
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        if(nmdari.getText().trim().equals("")||kddari.getText().trim().equals("")){
            ...
            Valid.textKosong(kdptg,"Nama Petugas");
                    ...
                    try {
                        if(Valid.SetAngka(tbDokter.getValueAt(i,0).toString())>0){
                            if(Sequel.menyimpantf2("mutasibarang","'"+tbDokter.getValueAt(i,3).toString()+"','"+Valid.SetAngka(tbDokter.getValueAt(i,0).toString())+"',"+
                                ...
                                "'"+Keterangan.getText()+"','"+tbDokter.getValueAt(i,8).toString()+"','"+tbDokter.getValueAt(i,9).toString()+"','"+NoPermintaan.getText()+"','"+kdptg.getText()+"'",
    ...
    */
    ...
    public void tampil(String nopermintaan) {
        ...
        try{
            ...
            NoPermintaan.setText(nomorpermintaan);
    ...
    public void isCek(){
        ...
        btnPetugas.setEnabled(akses.getmutasi_barang());
        if(akses.getjml2()>=1){
