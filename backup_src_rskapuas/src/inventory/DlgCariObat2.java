...
public final class DlgCariObat2 extends javax.swing.JDialog {
    ...
    private double h_belicari=0, hargacari=0, sisacari=0,x=0,y=0,embalase=Sequel.cariIsiAngka("select embalase_per_obat from set_embalase"),
            tuslah=Sequel.cariIsiAngka("select tuslah_per_obat from set_embalase"),kenaikan,stokbarang,ttlhpp,ttljual,ttl=0;
    private int jml=0,i=0,z=0,row=0,row2,r;
    ...
    private DlgBarang barang=new DlgBarang(null,false);
     private String signa1="1",signa2="1",kdObatSK="",requestJson="",nokunjungan="",URL="",otorisasi,sql="",no_batchcari="", tgl_kadaluarsacari="", 
                   ...
                   Persediaan_Obat_Rawat_Inap="",hppfarmasi="",bangsaldefault=Sequel.cariIsi("select set_lokasi.kd_bangsal from set_lokasi limit 1"),depoaktifranap="",VALIDASIULANGBERIOBAT="",DEPOAKTIFOBAT="";
    ...
    public DlgCariObat2(java.awt.Frame parent, boolean modal) {
        ...
        try {
         ...
         try {
            depoaktifranap = koneksiDB.DEPOAKTIFRANAP();
        } catch (Exception e) {
            System.out.println("E : "+e);
            depoaktifranap = "";
        }
    ...
    private void initComponents() {
        ...
        BtnSimpan1.setPreferredSize(new java.awt.Dimension(85, 23));
        ...
        jLabel5.setBounds(0, 50, 68, 23);

        DTPTgl.setForeground(new java.awt.Color(50, 70, 50));
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-06-2020" }));
        ...
        Jeniskelas.setBounds(440, 50, 110, 23);

        label21.setText("Depo :");
        label21.setName("label21"); // NOI18N
        label21.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label21);
        label21.setBounds(0, 80, 68, 23);
        ...
        kdgudang.setBounds(70, 80, 55, 23);

        nmgudang.setEditable(false);
        nmgudang.setName("nmgudang"); // NOI18N
        nmgudang.setPreferredSize(new java.awt.Dimension(207, 23));
        FormInput.add(nmgudang);
        nmgudang.setBounds(130, 80, 197, 23);
        ...
        BtnGudang.setBounds(330, 80, 28, 23);
        ...
        ChkNoResep1.setBorder(null);
        ChkNoResep1.setSelected(true);
        ChkNoResep1.setText("No.Resep :  ");
        ChkNoResep1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ChkNoResep1.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ChkNoResep1.setName("ChkNoResep1"); // NOI18N
        ChkNoResep1.setOpaque(false);
        ChkNoResep1.setPreferredSize(new java.awt.Dimension(85, 23));
        ChkNoResep1.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                ChkNoResep1ItemStateChanged(evt);
            }
        });
        ChkNoResep1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ChkNoResep1ActionPerformed(evt);
            }
        });
        FormInput.add(ChkNoResep1);
        ChkNoResep1.setBounds(370, 80, 80, 23);
        ...
        NoResep.setBounds(450, 80, 100, 23);
        ...
        NmDokter.setBounds(320, 110, 170, 23);
        ...
        KdDokter.setBounds(270, 110, 50, 23);

        jLabel13.setText("Dokter Peresep :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(180, 110, 81, 23);

        jLabel8.setText("Total :");
        jLabel8.setName("jLabel8"); // NOI18N
        jLabel8.setPreferredSize(new java.awt.Dimension(45, 23));
        FormInput.add(jLabel8);
        jLabel8.setBounds(0, 110, 65, 23);
        ...
        btnDokter.setBounds(490, 110, 28, 23);
                                ...
                                try {
                                    ...
                                    if(carikapasitas.next()){ 
                                        ...
                                        if(Sequel.menyimpantf2("detail_pemberian_obat","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","data",16,new String[]{
                                            ...
                                            "Ranap",kdgudang.getText(),tbObat.getValueAt(i,16).toString(),NoResep.getText(),"",tbObat.getValueAt(i,17).toString()
                                        })==true){
                                            ...
                                            if(aktifkanbatch.equals("yes")){
                                                ...
                                                Trackobat.catatRiwayat(tbObat.getValueAt(i,2).toString(),0,(Double.parseDouble(tbObat.getValueAt(i,1).toString())/carikapasitas.getDouble(1)),"Pemberian Obat",akses.getkode(),kdgudang.getText(),"Simpan",tbObat.getValueAt(i,16).toString(),tbObat.getValueAt(i,17).toString(),TNoRw.getText()+" "+LblNoRM.getText()+" "+LblNoRM.getText());
                                                ...
                                                Trackobat.catatRiwayat(tbObat.getValueAt(i,2).toString(),0,(Double.parseDouble(tbObat.getValueAt(i,1).toString())/carikapasitas.getDouble(1)),"Pemberian Obat",akses.getkode(),kdgudang.getText(),"Simpan","","",TNoRw.getText()+" "+LblNoRM.getText()+" "+LblNoRM.getText());
                                        ...
                                        if(Sequel.menyimpantf2("detail_pemberian_obat","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","data",16,new String[]{
                                            ...
                                            if(aktifkanbatch.equals("yes")){
                                                ...
                                                Trackobat.catatRiwayat(tbObat.getValueAt(i,2).toString(),0,Double.parseDouble(tbObat.getValueAt(i,1).toString()),"Pemberian Obat",akses.getkode(),kdgudang.getText(),"Simpan",tbObat.getValueAt(i,16).toString(),tbObat.getValueAt(i,17).toString(),TNoRw.getText()+" "+LblNoRM.getText()+" "+LblNoRM.getText());
                                                ...
                                                Trackobat.catatRiwayat(tbObat.getValueAt(i,2).toString(),0,Double.parseDouble(tbObat.getValueAt(i,1).toString()),"Pemberian Obat",akses.getkode(),kdgudang.getText(),"Simpan","","",TNoRw.getText()+" "+LblNoRM.getText()+" "+LblNoRM.getText());
                            ...
                            if(Sequel.menyimpantf2("detail_obat_racikan","?,?,?,?,?","Data",5,new String[]{
                               ...
                               tbDetailObatRacikan.getValueAt(i,0).toString(),tbDetailObatRacikan.getValueAt(i,1).toString()
                                ...
                                if(Sequel.menyimpantf2("detail_pemberian_obat","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","data",16,new String[]{
                                    ...
                                    "Ranap",kdgudang.getText(),tbDetailObatRacikan.getValueAt(i,16).toString(),NoResep.getText(),"",tbDetailObatRacikan.getValueAt(i,17).toString()
                                })==true){
                                    ...
                                    if(aktifkanbatch.equals("yes")){
                                        ...
                                        Trackobat.catatRiwayat(tbDetailObatRacikan.getValueAt(i,1).toString(),0,Double.parseDouble(tbDetailObatRacikan.getValueAt(i,10).toString()),"Pemberian Obat",akses.getkode(),kdgudang.getText(),"Simpan",tbDetailObatRacikan.getValueAt(i,16).toString(),tbDetailObatRacikan.getValueAt(i,17).toString(),TNoRw.getText()+" "+LblNoRM.getText()+" "+LblNoRM.getText());
                                        ...
                                        Trackobat.catatRiwayat(tbDetailObatRacikan.getValueAt(i,1).toString(),0,Double.parseDouble(tbDetailObatRacikan.getValueAt(i,10).toString()),"Pemberian Obat",akses.getkode(),kdgudang.getText(),"Simpan","","",TNoRw.getText()+" "+LblNoRM.getText()+" "+LblNoRM.getText());
                   ...
                   if(!noresep.equals("")){
                    ...
                    if(sukses==true){
                        ...
                        if((ttljual>0)||(ttlhpp>0)){
                            sukses=jur.simpanJurnal(TNoRw.getText(),"U","PEMBERIAN OBAT RAWAT INAP PASIEN, DIPOSTING OLEH "+akses.getkode());     
                        }
                    }
                    ...
                    ChkJln.setSelected(true);
                        if(sukses==true){
                           if(ChkNoResep1.isSelected()==true){
...
private void ChkJlnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkJlnActionPerformed
    ...
    private void ChkNoResep1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_ChkNoResep1ItemStateChanged
          if(ChkNoResep1.isSelected()==true){
                    DlgResepObat resep=new DlgResepObat(null,false);
                    resep.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
                    resep.setLocationRelativeTo(internalFrame1);
    ...
    }//GEN-LAST:event_ChkNoResep1ItemStateChanged

    private void ChkNoResep1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkNoResep1ActionPerformed
        if(ChkNoResep1.isSelected()==true){
            NoResep.setEditable(false);
            NoResep.setBackground(new Color(245,250,240));
             Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(no_resep,4),signed)),0) from resep_obat where tgl_perepan='"+Valid.SetTgl(DTPTgl.getSelectedItem()+"")+"' ",
                DTPTgl.getSelectedItem().toString().substring(6,10)+DTPTgl.getSelectedItem().toString().substring(3,5)+DTPTgl.getSelectedItem().toString().substring(0,2),4,NoResep); 
        }else if(ChkNoResep1.isSelected()==false){
            NoResep.setEditable(true);
            NoResep.setBackground(new Color(250,255,245));
            //NoResep.setText("");
        }
    }//GEN-LAST:event_ChkNoResep1ActionPerformed
                                    ...
                                    if(carikapasitas.next()){ 
                                        ...
                                        if(Sequel.menyimpantf2("detail_pemberian_obat","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","data",16,new String[]{
                                            ...
                                            tbObat.getValueAt(i,8).toString(),tbObat.getValueAt(i,9).toString(),""+Valid.SetAngka2(Double.parseDouble(tbObat.getValueAt(i,8).toString())+
                                                Double.parseDouble(tbObat.getValueAt(i,9).toString())+(Double.parseDouble(tbObat.getValueAt(i,6).toString())*
                                                (Double.parseDouble(tbObat.getValueAt(i,1).toString())/carikapasitas.getDouble(1)))),
                                            "Ranap",kdgudang.getText(),tbObat.getValueAt(i,16).toString(),NoResep.getText(),"UMUM",tbObat.getValueAt(i,17).toString()
                                        })==true){
                                            ttljual=ttljual+Double.parseDouble(tbObat.getValueAt(i,8).toString())+
                                                    Double.parseDouble(tbObat.getValueAt(i,9).toString())+(Double.parseDouble(tbObat.getValueAt(i,6).toString())*
                                                            (Double.parseDouble(tbObat.getValueAt(i,1).toString())/carikapasitas.getDouble(1)));
                               ...
                               tbDetailObatRacikan.getValueAt(i,0).toString(),tbDetailObatRacikan.getValueAt(i,1).toString()
                                ...
                                if(Sequel.menyimpantf2("detail_pemberian_obat","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","data",16,new String[]{
                                    ...
                                    ""+(Double.parseDouble(tbDetailObatRacikan.getValueAt(i,11).toString())+                                        
                                        ...
                                        (Double.parseDouble(tbDetailObatRacikan.getValueAt(i,4).toString())*
                                        Double.parseDouble(tbDetailObatRacikan.getValueAt(i,10).toString()))),
                                    "Ranap",kdgudang.getText(),tbDetailObatRacikan.getValueAt(i,16).toString(),NoResep.getText(),"UMUM",tbDetailObatRacikan.getValueAt(i,17).toString()
                                })==true){
                                    ttljual=ttljual+Double.parseDouble(tbDetailObatRacikan.getValueAt(i,11).toString())+
                                            Double.parseDouble(tbDetailObatRacikan.getValueAt(i,12).toString())+(Double.parseDouble(tbDetailObatRacikan.getValueAt(i,4).toString())*
                                                    Double.parseDouble(tbDetailObatRacikan.getValueAt(i,10).toString()));
    ...
    */
    ...
    private widget.CekBox ChkNoResep1;
...
//        if(ChkNoResep1.isSelected()==true){
//             Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(no_resep,4),signed)),0) from resep_obat where tgl_perawatan='"+Valid.SetTgl(DTPTgl.getSelectedItem()+"")+"' ",
//                DTPTgl.getSelectedItem().toString().substring(6,10)+DTPTgl.getSelectedItem().toString().substring(3,5)+DTPTgl.getSelectedItem().toString().substring(0,2),4,NoResep); 
//        }
        TCari.requestFocus();
    }
     private void hitungObat() {
        ttl=0;
        y=0;
        row=tbObat.getRowCount();
        for(r=0;r<row;r++){ 
            try {
                if(Double.parseDouble(tbObat.getValueAt(r,1).toString())>0){
                    try {                
                        y=Double.parseDouble(tbObat.getValueAt(r,1).toString())*
                          Double.parseDouble(tbObat.getValueAt(r,6).toString())+
                          Double.parseDouble(tbObat.getValueAt(r,8).toString())+
                          Double.parseDouble(tbObat.getValueAt(r,9).toString());                                                
                    } catch (Exception e) {
                        y=0;
                    }
                    ttl=ttl+y;
    ...
    public void isCek(){  
        if(depoaktifranap.equals("yes")){
            kdgudang.setText("DPO");
            Sequel.cariIsi("select bangsal.nm_bangsal from bangsal where bangsal.kd_bangsal=?",nmgudang,kdgudang.getText());  
