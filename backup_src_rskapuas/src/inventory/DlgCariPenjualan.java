...
public class DlgCariPenjualan extends javax.swing.JDialog {
    ...
    private String aktifkanbatch="no",kdrek="",pilihan="";
    ...
    private void initComponents() {
        ...
        BtnSimpan5.setBounds(520, 30, 120, 30);
        ...
        switch (TabRawat.getSelectedIndex()) {
            case 0:
                if(tabMode.getRowCount()==0){
                  ...
                  pilihan = (String)JOptionPane.showInputDialog(null,"Silahkan pilih laporan..!","Laporan Penjualan",JOptionPane.QUESTION_MESSAGE,null,new Object[]{"Laporan Setoran","Laporan 2","Rekap Penjualan Obat Untuk Karyawan RS"},"Laporan 1");
            switch (pilihan) {
                case "Laporan Setoran":
                      Valid.MyReportqry("rptPenjualan.jasper","report","::[ Transaksi Penjualan Barang ]::",
                            "select no, temp1, temp2, temp3, temp4, temp5, temp6, temp7, temp8, temp9, temp10, temp11, temp12, temp13, temp14, temp14, temp15, temp16, temp17, temp18, temp19 from temporary  where temporary.temp37='"+akses.getalamatip()+"' order by no desc limit 1 ",param);
                      break;
                case "Laporan 2":
                      Valid.MyReportqry("rptPenjualan2.jasper","report","::[ Transaksi Penjualan Barang ]::",
                ...
                case "Rekap Penjualan Obat Untuk Karyawan RS":
                    ...
                    param1.put("periode", "Periode Tgl. " + Tgl1.getSelectedItem() + " s.d " + Tgl2.getSelectedItem());
                    Valid.MyReportqry("rptdetailjualobatkaryawan.jasper", "report", "::[ Detail Jual Obat untuk Karyawan RS ]::",
                        "SELECT penjualan.nota_jual,penjualan.tgl_jual,penjualan.nm_pasien,databarang.nama_brng,detailjual.h_jual,detailjual.jumlah,detailjual.subtotal,detailjual.embalase,detailjual.total FROM penjualan " +
                        ...
                        "WHERE penjualan.tgl_jual BETWEEN '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' AND '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "' AND nm_pasien='Karyawan RS' AND penjualan.jns_jual='Karyawan' AND penjualan.kd_bangsal='DPO' " +
                        "ORDER BY penjualan.tgl_jual ASC, penjualan.nota_jual ASC ",param1);
