...
public final class DlgCariObat extends javax.swing.JDialog {
    ...
    private PreparedStatement psobat,pscarikapasitas,psstok,ps2,psbatch,psrekening,pspaket;
    private ResultSet rsobat,carikapasitas,rsstok,rs2,rsbatch,rsrekening,rspaket;
    ...
    private int i=0,z=0,row=0,row2,r,i2=0,z2=0,z3=0;
    private boolean[] pilih,pilih2; 
    private double[] jumlah,harga,eb,ts,stok,beli,kapasitas,kandungan,jumlah2,harga2,eb2,ts2,stok2,beli2,kapasitas2,kandungan2;
    private String[] kodebarang,namabarang,kodesatuan,letakbarang,namajenis,aturan,industri,kategori,golongan,no,nobatch,nofaktur,kadaluarsa,kodebarang2,namabarang2,kodesatuan2,letakbarang2,namajenis2,aturan2,industri2,kategori2,golongan2,no2,nobatch2,nofaktur2,kadaluarsa2;
    private String signa1="1",signa2="1",nokunjungan="",kdObatSK="",requestJson="",URL="",otorisasi,sql="",sql2="",aktifpcare="no",no_batchcari="", tgl_kadaluarsacari="", no_fakturcari="", aktifkanbatch="no",kodedokter="",status="",namadokter="",noresep="",bangsal="",bangsaldefault=Sequel.cariIsi("select kd_bangsal from set_lokasi limit 1"),tampilkan_ppnobat_ralan="",
                    Suspen_Piutang_Obat_Ralan="",Obat_Ralan="",HPP_Obat_Rawat_Jalan="",Persediaan_Obat_Rawat_Jalan="",hppfarmasi="",a="",VALIDASIULANGBERIOBAT="",DEPOAKTIFOBAT="";
    ...
    public DlgMutasiBarang mutasi=new DlgMutasiBarang(null,false);
    ...
    private void initComponents() {
        ...
        ChkPaketObat = new widget.CekBox();
        ...
        ChkPaketObat.setBorder(null);
        ChkPaketObat.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ChkPaketObat.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ChkPaketObat.setLabel("Tampilkan Paket Obat");
        ChkPaketObat.setName("ChkPaketObat"); // NOI18N
        ChkPaketObat.setOpaque(false);
        ChkPaketObat.setPreferredSize(new java.awt.Dimension(140, 23));
        ChkPaketObat.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                ChkPaketObatItemStateChanged(evt);
            }
        });
        ChkPaketObat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ChkPaketObatActionPerformed(evt);
            }
        });
        panelisi3.add(ChkPaketObat);
        ...
        BtnSimpan1.setMnemonic('V');
        BtnSimpan1.setText("UMUM");
        BtnSimpan1.setToolTipText("Alt+V");
        BtnSimpan1.setName("BtnSimpan1"); // NOI18N
        BtnSimpan1.setPreferredSize(new java.awt.Dimension(80, 23));
        ...
        BtnMutasi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/shopping-bag24.png"))); // NOI18N
        BtnMutasi.setMnemonic('2');
        BtnMutasi.setText("Mutasi Barang");
        BtnMutasi.setToolTipText("");
        BtnMutasi.setName("BtnMutasi"); // NOI18N
        BtnMutasi.setPreferredSize(new java.awt.Dimension(130, 23));
        BtnMutasi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnMutasiActionPerformed(evt);
            }
        });
        BtnMutasi.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnMutasiKeyPressed(evt);
            }
        });
        panelisi3.add(BtnMutasi);
        ...
        Jeniskelas.setBounds(440, 40, 130, 23);
        ...
        ChkNoResep.setBounds(690, 10, 80, 23);
        ...
        jLabel12.setBounds(350, 10, 80, 23);
        ...
        LblNamaPasien.setBounds(430, 10, 237, 23);
        ...
        NoResep.setBounds(770, 10, 130, 23);
        ...
        KdDokter.setBounds(680, 40, 50, 23);

        jLabel13.setText("Dokter Peresep :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(590, 40, 81, 23);
        ...
        btnDokter.setBounds(910, 40, 28, 23);
        ...
        NmDokter.setBounds(730, 40, 170, 23);
    ...
    private void tbObatKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbObatKeyPressed
        if(tbObat.getRowCount()!=0){
            ...
            }else if(evt.getKeyCode()==KeyEvent.VK_DELETE || evt.getKeyCode()==KeyEvent.VK_D ){
                i=tbObat.getSelectedColumn();
                if((i==1)||(i==11)||(i==8)||(i==9)||(i==3)){
                    if(tbObat.getSelectedRow()!= -1){
                        tbObat.setValueAt("",tbObat.getSelectedRow(),1);
...
private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
    ...
    if(TNoRw.getText().trim().equals("")){
            ...
            TCari.requestFocus();
        }else if(NoResep.getText().equals("")){
            Valid.textKosong(NoResep,"No.Resep");
        }else if(Sequel.cariInteger("SELECT count(no_rawat) FROM reg_periksa WHERE kd_pj in ('002','009','INH','-') AND no_rawat=?",TNoRw.getText())>0){
            JOptionPane.showMessageDialog(null,"Maaf, Gunakan Simpan UMUM karena pasien UMUM !!!");
            ...
            if (reply == JOptionPane.YES_OPTION) {
                try { 
                    ...
                    if(Sequel.cariInteger("SELECT COUNT(resep_obat.no_resep) FROM resep_obat INNER JOIN resep_dokter ON resep_obat.no_resep=resep_dokter.no_resep WHERE resep_obat.no_resep=?",NoResep.getText())>0){
                                ...
                                try {
                                    ...
                                    if(carikapasitas.next()){ 
                                        ...
                                        if(Sequel.menyimpantf2("detail_pemberian_obat","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","data",16,new String[]{
                                            ...
                                            "Ralan",kdgudang.getText(),tbObat.getValueAt(i,16).toString(),NoResep.getText(),"",tbObat.getValueAt(i,17).toString()
                                        })==true){
                                            ...
                                            if(aktifkanbatch.equals("yes")){
                                                ...
                                                Trackobat.catatRiwayat(tbObat.getValueAt(i,2).toString(),0,(Double.parseDouble(tbObat.getValueAt(i,1).toString())/carikapasitas.getDouble(1)),"Pemberian Obat",akses.getkode(),kdgudang.getText(),"Simpan",tbObat.getValueAt(i,16).toString(),tbObat.getValueAt(i,17).toString(),TNoRw.getText()+" "+LblNoRM.getText()+" "+LblNamaPasien.getText());
                                                ...
                                                Trackobat.catatRiwayat(tbObat.getValueAt(i,2).toString(),0,(Double.parseDouble(tbObat.getValueAt(i,1).toString())/carikapasitas.getDouble(1)),"Pemberian Obat",akses.getkode(),kdgudang.getText(),"Simpan","","",TNoRw.getText()+" "+LblNoRM.getText()+" "+LblNamaPasien.getText());
                                        ...
                                        if(Sequel.menyimpantf2("detail_pemberian_obat","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","data",16,new String[]{
                                            ...
                                            if(aktifkanbatch.equals("yes")){
                                                ...
                                                Trackobat.catatRiwayat(tbObat.getValueAt(i,2).toString(),0,Double.parseDouble(tbObat.getValueAt(i,1).toString()),"Pemberian Obat",akses.getkode(),kdgudang.getText(),"Simpan",tbObat.getValueAt(i,16).toString(),tbObat.getValueAt(i,17).toString(),TNoRw.getText()+" "+LblNoRM.getText()+" "+LblNamaPasien.getText());
                                                ...
                                                Trackobat.catatRiwayat(tbObat.getValueAt(i,2).toString(),0,Double.parseDouble(tbObat.getValueAt(i,1).toString()),"Pemberian Obat",akses.getkode(),kdgudang.getText(),"Simpan","","",TNoRw.getText()+" "+LblNoRM.getText()+" "+LblNamaPasien.getText());
                            ...
                            if(Sequel.menyimpantf2("detail_obat_racikan","?,?,?,?,?","Data",5,new String[]{
                               ...
                               tbDetailObatRacikan.getValueAt(i,0).toString(),tbDetailObatRacikan.getValueAt(i,1).toString()
                                ...
                                if(Sequel.menyimpantf2("detail_pemberian_obat","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","data",16,new String[]{
                                    ...
                                    "Ralan",kdgudang.getText(),tbDetailObatRacikan.getValueAt(i,16).toString(),NoResep.getText(),"",tbDetailObatRacikan.getValueAt(i,17).toString()
                                })==true){
                                    ...
                                    if(aktifkanbatch.equals("yes")){
                                        ...
                                        Trackobat.catatRiwayat(tbDetailObatRacikan.getValueAt(i,1).toString(),0,Double.parseDouble(tbDetailObatRacikan.getValueAt(i,10).toString()),"Pemberian Obat",akses.getkode(),kdgudang.getText(),"Simpan",tbDetailObatRacikan.getValueAt(i,16).toString(),tbDetailObatRacikan.getValueAt(i,17).toString(),TNoRw.getText()+" "+LblNoRM.getText()+" "+LblNamaPasien.getText());
                                        ...
                                        Trackobat.catatRiwayat(tbDetailObatRacikan.getValueAt(i,1).toString(),0,Double.parseDouble(tbDetailObatRacikan.getValueAt(i,10).toString()),"Pemberian Obat",akses.getkode(),kdgudang.getText(),"Simpan","","",TNoRw.getText()+" "+LblNoRM.getText()+" "+LblNamaPasien.getText());
                    ...
                    if(sukses==true){
                        ...
                        if((ttljual>0)||(ttlhpp>0)){
                            sukses=jur.simpanJurnal(TNoRw.getText(),"U","PEMBERIAN OBAT RAWAT JALAN PASIEN, DIPOSTING OLEH "+akses.getkode());     
                        }
                    }
...
//      
                        ...
                        if(ChkNoResep.isSelected() == true) {
                              Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(no_resep,4),signed)),0) from resep_obat where tgl_peresepan='"+Valid.SetTgl(DTPTgl.getSelectedItem()+"")+"' ",
                        ...
                        if(Sequel.menyimpantf("resep_obat","?,?,?,?,?,?,?,?,?,?","Nomer Resep",10,new String[]{
                                                ...
                                                LblNoRawat.getText(),KdDokter.getText(),Valid.SetTgl(DTPTgl.getSelectedItem()+""),
                                                cmbJam.getSelectedItem()+":"+DTPTgl.getSelectedItem().toString().substring(0,2)+":"+cmbDtk.getSelectedItem(),Sequel.cariIsi("SELECT status_lanjut FROM reg_periksa WHERE no_rawat=?",LblNoRawat.getText()),"0000-00-00","00:00:00"
                                            })==true);
...
private void JeniskelasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_JeniskelasKeyPressed
    ...
    private void ChkNoResepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkNoResepActionPerformed
     if(ChkNoResep.isSelected()==true){
            ...
            Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(no_resep,4),signed)),0) from resep_obat where tgl_peresepan='"+Valid.SetTgl(DTPTgl.getSelectedItem()+"")+"' ",
                DTPTgl.getSelectedItem().toString().substring(6,10)+DTPTgl.getSelectedItem().toString().substring(3,5)+DTPTgl.getSelectedItem().toString().substring(0,2),4,NoResep); 
     }else if(ChkNoResep.isSelected()==false){
    ...
    private void BtnMutasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnMutasiActionPerformed
        mutasi.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
        mutasi.setLocationRelativeTo(internalFrame1);
        mutasi.setAlwaysOnTop(false);
        mutasi.setVisible(true);
        this.setCursor(Cursor.getDefaultCursor());    
    }//GEN-LAST:event_BtnMutasiActionPerformed

    private void BtnMutasiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnMutasiKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnMutasiKeyPressed
    ...
    private void BtnSimpan1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpan1ActionPerformed
        ...
        if(TNoRw.getText().trim().equals("")){
            ...
            Valid.textKosong(btnDokter,"Dokter");
        }else if(Sequel.cariInteger("SELECT count(no_rawat) FROM reg_periksa WHERE kd_pj in ('003','004','005','006','007','008','BPJ') AND no_rawat=?",TNoRw.getText())>0){
            JOptionPane.showMessageDialog(null,"Maaf, Gunakan Simpan BPJS karena pasien BPJS!!!");
            BtnSimpan1.requestFocus();
        }else{
            tampilpaket2();
            tampilobat();
            ...
            if (reply == JOptionPane.YES_OPTION) {
                 ...
                 if(Sequel.cariInteger("SELECT count(no_rawat) FROM reg_periksa WHERE kd_pj in ('002','009','INH','-') AND no_rawat=?",LblNoRawat.getText())>0){
                                     if(Sequel.menyimpantf3("status_resep","?,?,?,?,?,?,?,?,?","Nomer Resep",9,new String[]{
                                      NoResep.getText(),Valid.SetTgl(DTPTgl.getSelectedItem()+""),
                                      TNoRw.getText(),Sequel.cariIsi("SELECT kd_pj FROM reg_periksa WHERE no_rawat=?",LblNoRawat.getText()),
                                      Sequel.cariIsi("SELECT status_lanjut FROM reg_periksa WHERE no_rawat=?",LblNoRawat.getText()),"",kdgudang.getText(),"belum bayar",""
                                       })==true);
                                    ...
                                    if(carikapasitas.next()){ 
                                        ...
                                        if(Sequel.menyimpantf2("detail_pemberian_obat","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","data",16,new String[]{
                                            ...
                                            tbObat.getValueAt(i,8).toString(),tbObat.getValueAt(i,9).toString(),""+Valid.SetAngka2(Double.parseDouble(tbObat.getValueAt(i,8).toString())+
                                                Double.parseDouble(tbObat.getValueAt(i,9).toString())+(Double.parseDouble(tbObat.getValueAt(i,6).toString())*
                                                (Double.parseDouble(tbObat.getValueAt(i,1).toString())/carikapasitas.getDouble(1)))),
                                            "Ralan",kdgudang.getText(),tbObat.getValueAt(i,16).toString(),NoResep.getText(),"UMUM",tbObat.getValueAt(i,17).toString()
                                        })==true){
                                            ttljual=ttljual+Double.parseDouble(tbObat.getValueAt(i,8).toString())+
                                                    Double.parseDouble(tbObat.getValueAt(i,9).toString())+(Double.parseDouble(tbObat.getValueAt(i,6).toString())*
                                                            (Double.parseDouble(tbObat.getValueAt(i,1).toString())/carikapasitas.getDouble(1)));
                               ...
                               tbDetailObatRacikan.getValueAt(i,0).toString(),tbDetailObatRacikan.getValueAt(i,1).toString()
                                ...
                                if(Sequel.menyimpantf2("detail_pemberian_obat","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","data",16,new String[]{
                                    ...
                                    ""+(Double.parseDouble(tbDetailObatRacikan.getValueAt(i,11).toString())+                                        
                                        ...
                                        (Double.parseDouble(tbDetailObatRacikan.getValueAt(i,4).toString())*
                                        Double.parseDouble(tbDetailObatRacikan.getValueAt(i,10).toString()))),
                                    "Ralan",kdgudang.getText(),tbDetailObatRacikan.getValueAt(i,16).toString(),NoResep.getText(),"UMUM",tbDetailObatRacikan.getValueAt(i,17).toString()
                                })==true){
                                    ttljual=ttljual+Double.parseDouble(tbDetailObatRacikan.getValueAt(i,11).toString())+
                                            Double.parseDouble(tbDetailObatRacikan.getValueAt(i,12).toString())+(Double.parseDouble(tbDetailObatRacikan.getValueAt(i,4).toString())*
                                                    Double.parseDouble(tbDetailObatRacikan.getValueAt(i,10).toString()));
...
//                       
                     ...
                     if(ChkNoResep.isSelected() == true) {
                              Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(no_resep,4),signed)),0) from resep_obat where resep_obat.tgl_peresepan='"+Valid.SetTgl(DTPTgl.getSelectedItem()+"")+"' ",
                               DTPTgl.getSelectedItem().toString().substring(6,10)+DTPTgl.getSelectedItem().toString().substring(3,5)+DTPTgl.getSelectedItem().toString().substring(0,2),4,NoResep); 
                            }
                        if(Sequel.menyimpantf("resep_obat","?,?,?,?,?,?,?,?,?,?","Nomer Resep",10,new String[]{
                                                NoResep.getText(),Valid.SetTgl(DTPTgl.getSelectedItem()+""),
    ...
    private void ChkPaketObatItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_ChkPaketObatItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_ChkPaketObatItemStateChanged

    private void ChkPaketObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkPaketObatActionPerformed
       if(ChkPaketObat.isSelected()==true){
           tampilpaket2();
           tampilobat();
       }
    }//GEN-LAST:event_ChkPaketObatActionPerformed
    ...
    */
    ...
    private widget.Button BtnMutasi;
    ...
    private widget.CekBox ChkPaketObat;
...
//                    sql2="select maping_paketobat.kode_brng,maping_paketobat.nm_brng,maping_paketobat.jumlah,jenis.nama, databarang.kode_sat,databarang.karyawan,databarang.ralan,databarang.beliluar,"+
//                            " databarang.letak_barang,databarang.utama,industrifarmasi.nama_industri,databarang.h_beli,kategori_barang.nama as kategori,golongan_barang.nama as golongan,gudangbarang.stok "+
//                            " from databarang inner join maping_paketobat inner join jenis inner join industrifarmasi inner join golongan_barang inner join kategori_barang inner join gudangbarang on databarang.kdjns=jenis.kdjns "+
//                            " and industrifarmasi.kode_industri=databarang.kode_industri and databarang.kode_golongan=golongan_barang.kode and databarang.kode_kategori=kategori_barang.kode and maping_paketobat.kode_brng=databarang.kode_brng " +
//                            " and gudangbarang.kode_brng=databarang.kode_brng";
//
//                        pspaket=koneksi.prepareStatement(
//                            sql2+" where databarang.status='1' and gudangbarang.stok > 0 and gudangbarang.kd_bangsal=? and maping_paketobat.kode_paket=? and databarang.kode_brng like ? or "+
//                            " databarang.status='1' and gudangbarang.stok > 0 and gudangbarang.kd_bangsal=? and maping_paketobat.kode_paket=? and databarang.nama_brng like ? or "+
//                            " databarang.status='1' and gudangbarang.stok > 0 and gudangbarang.kd_bangsal=? and  maping_paketobat.kode_paket=? and kategori_barang.nama like ? or "+
//                            " databarang.status='1' and gudangbarang.stok > 0 and gudangbarang.kd_bangsal=? and maping_paketobat.kode_paket=? and golongan_barang.nama like ? or "+
//                            " databarang.status='1' and gudangbarang.stok > 0 and gudangbarang.kd_bangsal=? and maping_paketobat.kode_paket=? and jenis.nama like ? order by databarang.nama_brng");
//                        try{
//                            pspaket.setString(1,kdgudang.getText());
//                            pspaket.setString(2,tbObat.getValueAt(i2,2).toString());
//                            pspaket.setString(3,"%"+TCari.getText().trim()+"%");
//                            pspaket.setString(4,kdgudang.getText());
//                            pspaket.setString(5,tbObat.getValueAt(i2,2).toString());
//                            pspaket.setString(6,"%"+TCari.getText().trim()+"%");
//                             pspaket.setString(7,kdgudang.getText());
//                            pspaket.setString(8,tbObat.getValueAt(i2,2).toString());
//                            pspaket.setString(9,"%"+TCari.getText().trim()+"%");
//                             pspaket.setString(10,kdgudang.getText());
//                            pspaket.setString(11,tbObat.getValueAt(i2,2).toString());
//                            pspaket.setString(12,"%"+TCari.getText().trim()+"%");
//                             pspaket.setString(13,kdgudang.getText());
//                            pspaket.setString(14,tbObat.getValueAt(i2,2).toString());
//                            pspaket.setString(15,"%"+TCari.getText().trim()+"%");
//                            rspaket=pspaket.executeQuery();
//                            while(rspaket.next()){
//                                if(Jeniskelas.getSelectedItem().equals("Karyawan")){
//                                    tabModeobat.addRow(new Object[] {false,+rspaket.getDouble("jumlah"),"     "+rspaket.getString("kode_brng"),rspaket.getString("nm_brng"),
//                                       rspaket.getString("kode_sat"),rspaket.getString("letak_barang"),Valid.roundUp(rspaket.getDouble("karyawan"),100),
//                                       rspaket.getString("nama"),0,0,rspaket.getDouble("stok"),"",rspaket.getString("nama_industri"),
//                                       rspaket.getDouble("h_beli"),rspaket.getString("kategori"),rspaket.getString("golongan"),"","",""
//                                    });
//                                }else if(Jeniskelas.getSelectedItem().equals("Rawat Jalan")){
//                                    tabModeobat.addRow(new Object[] {false,rspaket.getDouble("jumlah"),"     "+rspaket.getString("kode_brng"),rspaket.getString("nm_brng"),
//                                       rspaket.getString("kode_sat"),rspaket.getString("letak_barang"),Valid.roundUp(rspaket.getDouble("ralan"),100),
//                                       rspaket.getString("nama"),0,0,rspaket.getDouble("stok"),"",rspaket.getString("nama_industri"),
//                                       rspaket.getDouble("h_beli"),rspaket.getString("kategori"),rspaket.getString("golongan"),"","",""
//                                    });
//                                }else if(Jeniskelas.getSelectedItem().equals("Beli Luar")){
//                                    tabModeobat.addRow(new Object[] {false,rspaket.getDouble("jumlah"),"     "+rspaket.getString("kode_brng"),rspaket.getString("nm_brng"),
//                                       rspaket.getString("kode_sat"),rspaket.getString("letak_barang"),Valid.roundUp(rspaket.getDouble("beliluar"),100),
//                                       rspaket.getString("nama"),0,0,rspaket.getDouble("stok"),"",rspaket.getString("nama_industri"),
//                                       rspaket.getDouble("h_beli"),rspaket.getString("kategori"),rspaket.getString("golongan"),"","",""
//                                    });
//                                }else if(Jeniskelas.getSelectedItem().equals("Utama/BPJS")){
//                                    tabModeobat.addRow(new Object[] {false,rspaket.getDouble("jumlah"),"     "+rspaket.getString("kode_brng"),rspaket.getString("nm_brng"),
//                                       rspaket.getString("kode_sat"),rspaket.getString("letak_barang"),Valid.roundUp(rspaket.getDouble("utama"),100),
//                                       rspaket.getString("nama"),0,rspaket.getDouble("stok"),"",rspaket.getString("nama_industri"),
//                                       rspaket.getDouble("h_beli"),rspaket.getString("kategori"),rspaket.getString("golongan"),"","",""
//                                    });
//                                }                 
//                            }
...
//        row2=tbObat.getRowCount();
//        for(r=0;r<row2;r++){
//            try {                
//                tabModeobat.setValueAt("",r,1);
//                tabModeobat.setValueAt(0,r,10);
//                tabModeobat.setValueAt(0,r,9);
//                tabModeobat.setValueAt(0,r,8);
//                } catch (Exception e) {
//                }
//        }
//          
//    }
      ...
      private void tampilpaket2() {
        //a=Sequel.cariIsi("SELECT mp.kode_paket  FROM maping_paketobat mp group by mp.kode_paket");
        row2=tabModeobat.getRowCount();
        for(r=0;r<row2;r++){ 
            try {
                if(Double.parseDouble(tabModeobat.getValueAt(r,1).toString())>0 && tabModeobat.getValueAt(r,7).toString().equals("Paket")){
                    ...
                    try {                
                        ...
                        pspaket=koneksi.prepareStatement(
                            sql2+" where databarang.status='1' and gudangbarang.stok > 0 and gudangbarang.kd_bangsal=? and maping_paketobat.kode_paket=? order by databarang.nama_brng");
                        try{
                            
                            pspaket.setString(1,kdgudang.getText());
                            pspaket.setString(2,tabModeobat.getValueAt(r,2).toString());
                            rspaket=pspaket.executeQuery();
                            while(rspaket.next()){
                                if(Jeniskelas.getSelectedItem().equals("Karyawan")){
                                    tabModeobat.addRow(new Object[] {false,+rspaket.getDouble("jumlah"),rspaket.getString("kode_brng"),rspaket.getString("nm_brng"),
    ...
    public void tampilobat2(String no_resep) {     
        this.noresep=no_resep; 
         KdDokter.setText(Sequel.cariIsi("SELECT resep_obat.kd_dokter FROM resep_obat INNER JOIN dokter on dokter.kd_dokter=resep_obat.kd_dokter WHERE resep_obat.no_resep=?",no_resep));
         NmDokter.setText(Sequel.cariIsi("SELECT dokter.nm_dokter FROM resep_obat INNER JOIN dokter on dokter.kd_dokter=resep_obat.kd_dokter WHERE resep_obat.no_resep=?",no_resep));
        try {
            Valid.tabelKosong(tabModeobat);
            Valid.tabelKosong(tabModeObatRacikan);
            Valid.tabelKosong(tabModeDetailObatRacikan);
    ...
    public void isCek(){   
        ...
        if(akses.getkode().equals("Admin Utama")||akses.getmutasi_barang()==true){
            BtnMutasi.setVisible(true);
        }else{
            BtnMutasi.setVisible(false);
        }
    }
