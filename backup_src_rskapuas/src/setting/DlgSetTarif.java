...
public class DlgSetTarif extends javax.swing.JDialog {
    ...
    public DlgSetTarif(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"Per Poli Ralan","Per Jenis Bayar Ralan","Per Ruang Ranap",
                      ...
                      "Per Kelas Radiologi","Per Kelas Operasi","BPJS 1","BPJS 2"
        };
    ...
    private void initComponents() {
        ...
        persenBPJS2 = new widget.TextBox();
        persenBPJS1 = new widget.TextBox();
        ...
        panelisi2.setPreferredSize(new java.awt.Dimension(100, 240));
        ...
        label46.setText("Selisih Tarif Naik Kelas BPJS (1) % : ");
        label46.setName("label46"); // NOI18N
        label46.setPreferredSize(new java.awt.Dimension(82, 23));
        panelisi2.add(label46);
        label46.setBounds(340, 160, 200, 23);

        label47.setForeground(new java.awt.Color(0, 0, 0));
        label47.setText("Selisih Tarif Naik Kelas BPJS (2) % : ");
        label47.setName("label47"); // NOI18N
        label47.setPreferredSize(new java.awt.Dimension(82, 23));
        panelisi2.add(label47);
        label47.setBounds(340, 190, 200, 23);

        persenBPJS2.setForeground(new java.awt.Color(0, 0, 0));
        persenBPJS2.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        persenBPJS2.setHighlighter(null);
        persenBPJS2.setMaxLenth(4);
        persenBPJS2.setName("persenBPJS2"); // NOI18N
        persenBPJS2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                persenBPJS2KeyPressed(evt);
            }
        });
        panelisi2.add(persenBPJS2);
        persenBPJS2.setBounds(540, 190, 50, 23);

        persenBPJS1.setForeground(new java.awt.Color(0, 0, 0));
        persenBPJS1.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        persenBPJS1.setHighlighter(null);
        persenBPJS1.setMaxLenth(4);
        persenBPJS1.setName("persenBPJS1"); // NOI18N
        persenBPJS1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                persenBPJS1KeyPressed(evt);
            }
        });
        panelisi2.add(persenBPJS1);
        persenBPJS1.setBounds(540, 160, 50, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(tabMode.getRowCount()==0){
            Sequel.menyimpan("set_tarif","?,?,?,?,?,?,?,?,?,?,?,?,?","Set Tarif",13,new String[]{
                ...
                YesNo10.getSelectedItem().toString(),YesNo11.getSelectedItem().toString(),persenBPJS1.getText(),persenBPJS2.getText()
            });
            tampil();
            emptTeks();
    ...
    private void persenBPJS2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_persenBPJS2KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_persenBPJS2KeyPressed

    private void persenBPJS1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_persenBPJS1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_persenBPJS1KeyPressed
    ...
    */
    ...
    private widget.TextBox persenBPJS1;
    private widget.TextBox persenBPJS2;
    ...
    private void getData() {
        ...
        if(row!= -1){
            ...
            persenBPJS1.setText(tbAdmin.getValueAt(row,11).toString());
            persenBPJS2.setText(tbAdmin.getValueAt(row,12).toString());
        }
    }
    ...
    public void emptTeks() {
        ...
        persenBPJS1.setText("0");
        persenBPJS2.setText("0");
    }
}
