...
public class DlgSetPenjabLab extends javax.swing.JDialog {
    ...
    public DlgSetPenjabLab(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                "P.J.Laboratorium PK","P.J.Radiologi","P.J.Hemodialisa","P.J.Tranfusi Darah","P.J.Laboratorium PA","P.J.Laboratorium MB","P.J.Rehab Medik",
                "Kode PK","Kode Radiologi","Kode Hemodialisa","Kode Tranfusi Darah","Kode PA","Kode MB","Kode IRM"
            }){
        ...
        kddokter7.setDocument(new batasInput((byte)20).getKata(kddokter7));
            ...
            public void windowClosed(WindowEvent e) {
                if(dokter.getTable().getSelectedRow()!= -1){                    
                    if(pilihan==1){
                        ...
                        kddokter7.setText(dokter.getTable().getValueAt(dokter.getTable().getSelectedRow(),0).toString());
                        TDokter7.setText(dokter.getTable().getValueAt(dokter.getTable().getSelectedRow(),1).toString());
                        kddokter7.requestFocus();
                    }
                }                
            }
            @Override
    ...
    private void initComponents() {
        ...
        jLabel19.setText("P.J. IRM :");
        jLabel19.setName("jLabel19"); // NOI18N
        panelGlass7.add(jLabel19);
        jLabel19.setBounds(520, 10, 120, 23);

        kddokter7.setHighlighter(null);
        kddokter7.setName("kddokter7"); // NOI18N
        kddokter7.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                kddokter7KeyPressed(evt);
            }
        });
        panelGlass7.add(kddokter7);
        kddokter7.setBounds(640, 10, 95, 23);

        TDokter7.setEditable(false);
        TDokter7.setName("TDokter7"); // NOI18N
        panelGlass7.add(TDokter7);
        TDokter7.setBounds(740, 10, 264, 23);

        BtnDokter7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnDokter7.setMnemonic('3');
        BtnDokter7.setToolTipText("ALt+3");
        ...
        panelGlass7.add(BtnDokter7);
        BtnDokter7.setBounds(1010, 10, 28, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TDokter.getText().trim().equals("")||kddokter.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("set_pjlab","?,?,?,?,?,?,?","Penanggung Jawab",7,new String[]{
                kddokter.getText(),kddokter2.getText(),kddokter3.getText(),kddokter4.getText(),kddokter5.getText(),kddokter6.getText(),kddokter7.getText()
            })==true){
    ...
    private void kddokter7KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_kddokter7KeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
            TDokter7.setText(dokter.tampil3(kddokter7.getText()));
        }else if(evt.getKeyCode()==KeyEvent.VK_UP){
            BtnDokter7ActionPerformed(null);
        }else{
            Valid.pindah(evt,kddokter6,BtnSimpan);
        }
    }//GEN-LAST:event_kddokter7KeyPressed
    ...
    */
    ...
    private widget.TextBox TDokter7;
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        ...
                        Sequel.cariIsi("select dokter.nm_dokter from dokter where dokter.kd_dokter=?",rs.getString(7)),
    ...
    private void getData() {
        if(tbAdmin.getSelectedRow()!= -1){
            ...
            TDokter7.setText(tbAdmin.getValueAt(tbAdmin.getSelectedRow(),6).toString());
            kddokter.setText(tbAdmin.getValueAt(tbAdmin.getSelectedRow(),7).toString());
            kddokter2.setText(tbAdmin.getValueAt(tbAdmin.getSelectedRow(),8).toString());
            kddokter3.setText(tbAdmin.getValueAt(tbAdmin.getSelectedRow(),9).toString());
            kddokter4.setText(tbAdmin.getValueAt(tbAdmin.getSelectedRow(),10).toString());
            kddokter5.setText(tbAdmin.getValueAt(tbAdmin.getSelectedRow(),11).toString());
            kddokter6.setText(tbAdmin.getValueAt(tbAdmin.getSelectedRow(),12).toString());
            kddokter7.setText(tbAdmin.getValueAt(tbAdmin.getSelectedRow(),13).toString());
        }
    }
