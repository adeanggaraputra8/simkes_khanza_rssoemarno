 ...
 * @author dosen
 */
public final class DlgTipe extends javax.swing.JDialog {
     ...
     *@param parent
     *@param modal */
    public DlgTipe(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,2);
        setSize(628,674);

        Object[] row={"P","Kode Sediaan","Sediaan"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Sediaan Obat, Alkes & BHP Medis ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 12), new java.awt.Color(130, 100, 100))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Kd.getText().trim().equals("")){
            Valid.textKosong(Kd,"Kode Tipe");
        }else if(Nm.getText().trim().equals("")){
            Valid.textKosong(Nm,"Tipe Obat");
        }else{
            Sequel.menyimpan("tipe_barang","'"+Kd.getText()+"','"+Nm.getText()+"'","Kode Tipe");
            BtnCariActionPerformed(evt);
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for(i=0;i<tbKamar.getRowCount();i++){ 
            if(tbKamar.getValueAt(i,0).toString().equals("true")){
                Sequel.meghapus("tipe_barang","kode",tbKamar.getValueAt(i,1).toString());
            }
        } 
        BtnCariActionPerformed(evt);
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(Kd.getText().trim().equals("")){
            ...
            Valid.editTable(tabMode,"tipe_barang","kode","?","tipe=?,kode=?",3,new String[]{
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptTipeObat.jrxml","report","::[ Tipe Obat ]::","select kode, tipe "+
                " from tipe_barang where  kode like '%"+TCari.getText().trim()+"%' or "+
                " tipe like '%"+TCari.getText().trim()+"%' order by kode");
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgTipe dialog = new DlgTipe(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{   
            ps=koneksi.prepareStatement("select kode,tipe  "+
                    " from tipe_barang where  kode like ? or "+
                    " tipe like ? order by tipe ");
            try {                
    ...
    public void emptTeks() {
        ...
        Nm.setText("");
        Kd.requestFocus();        
        Valid.autoNomer("tipe_barang","T",2,Kd);
    }
