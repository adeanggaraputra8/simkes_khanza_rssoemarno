 ...
 * @author perpustakaan
 */
public final class DlgPenyiapanRMRanap extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgPenyiapanRMRanap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(8,1);
        setSize(885,674);

        Object[] rowRwJlDr={"No.","No.RM","Nama Pasien","Dokter","Bangsal","Jam Daftar","Jam Berkas Dikirim","Durasi(m)"};
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPenyiapanRMRanap dialog = new DlgPenyiapanRMRanap(new javax.swing.JFrame(), true);
    ...
    public void tampil(){        
        try{   
            ...
            ps=koneksi.prepareStatement(
                "SELECT rp.no_rkm_medis, p.nm_pasien,d.nm_dokter,b.nm_bangsal,pr.tanggal, pr.waktu,ki.jam_masuk,round((TIME_TO_SEC(CONCAT(ki.tgl_masuk,' ',ki.jam_masuk))-TIME_TO_SEC(CONCAT(pr.tanggal,' ',pr.waktu)))/60,2)  as durasi " +
                "FROM  kamar_inap ki inner join permintaan_ranap pr on pr.no_rawat = ki.no_rawat " +
                ...
                "where ki.stts_pulang not in ('Pindah Kamar') and pr.tanggal between ? and ? and b.nm_bangsal like ? or " +
                "ki.stts_pulang not in ('Pindah Kamar') and pr.tanggal between ? and ? and d.nm_dokter like ? or " +
                "ki.stts_pulang not in ('Pindah Kamar') and pr.tanggal between ? and ? and rp.no_rkm_medis like ? or " +
                "ki.stts_pulang not in ('Pindah Kamar') and pr.tanggal between ? and ? and p.nm_pasien like ?  "+
                "order by pr.tanggal,pr.waktu");
            try {
