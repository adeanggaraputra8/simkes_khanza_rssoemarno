 ...
 * @author dosen
 */
public final class DlgCariPoli3 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariPoli3(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariPoli3 dialog = new DlgCariPoli3(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try {
            ps=koneksi.prepareStatement("select kd_poli, nm_poli, registrasi, registrasilama "+
                " from poliklinik where kd_poli NOT IN('PPN','IGDC','IGDK') and status='1' and kd_poli like ? or "+
                " kd_poli NOT IN('PPN','IGDC','IGDK')and status='1' and nm_poli like ? order by nm_poli");
            try{            
