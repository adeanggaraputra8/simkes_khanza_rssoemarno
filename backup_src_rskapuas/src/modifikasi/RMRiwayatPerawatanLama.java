 ...
 * @author windiarto
 */
public final class RMRiwayatPerawatanLama extends javax.swing.JDialog {    
     ...
     * @param parent
     * @param modal */
    public RMRiwayatPerawatanLama(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMRiwayatPerawatanLama dialog = new RMRiwayatPerawatanLama(new javax.swing.JFrame(), true);
                            ...
                            if(rs2.next()){
                                ...
                                while(rs2.next()){
                                    htmlContent.append(
                                         ...
                                         "<tr>"+
                                            "<td valign='top'>"+
                                               "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0px' class='tbl_form'>"+
                                                  "<tr>"+
                                                       "<td valign='middle' bgcolor='#FFFAF8' align='center' width='40%'>MASALAH KEPERAWATAN :</td>"+
                                                       "<td valign='middle' bgcolor='#FFFAF8' align='center' width='40%'>RENCANA KEPERAWATAN :</td>"+
                                                       "<td valign='middle' bgcolor='#FFFAF8' align='center' width='20%'>IMPLEMENTASI :</td>"+
                                                  "</tr>"+
                                                  "<tr>"+
                                                       "<td>");
                                    try {
                                    ...
                                    htmlContent.append("</td>"+
                                                       ...
                                                       "<td>"+rs2.getString("implementasi")+"</td>"+
                                                  "</tr>"+
                                               "</table>"+
                                            "</td>"+
                                         "</tr>"
                                    ...
                                    "<td valign='top' width='79%'>"+
                                      "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                         "<tr align='center'>"+
                                            "<td valign='top' width='4%' bgcolor='#FFFAF8'>No.</td>"+
                                            "<td valign='top' width='15%' bgcolor='#FFFAF8'>Tanggal</td>"+
                                            "<td valign='top' width='54%' bgcolor='#FFFAF8' colspan='6'>Dokter/Perawat/Bidan/Tenaga Medis</td>"+
