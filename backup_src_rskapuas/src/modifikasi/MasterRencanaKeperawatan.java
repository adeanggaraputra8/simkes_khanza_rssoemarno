...
public class MasterRencanaKeperawatan extends javax.swing.JDialog {
    ...
    public MasterRencanaKeperawatan(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"Kode","Rencana Keperawatan"};
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Valid.textKosong(TNm,"Rencana");
        }else{
            Sequel.menyimpan("master_rencana_keperawatan","'"+TKd.getText()+"','"+TNm.getText()+"'","Kode");
            tampil();
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,TKd,"master_rencana_keperawatan","kode_rencana");
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            if(tbSpesialis.getSelectedRow()> -1){
                Sequel.mengedit("master_rencana_keperawatan","kode_rencana=?","kode_rencana=?,nama_rencana=?",3,new String[]{
    ...
    */
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select * from master_rencana_keperawatan where kode_rencana like ? or nama_rencana like ? order by kode_rencana");
            try {
