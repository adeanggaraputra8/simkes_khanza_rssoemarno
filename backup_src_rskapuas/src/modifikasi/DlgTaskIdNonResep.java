 ...
 * @author dosen
 */
public final class DlgTaskIdNonResep extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgTaskIdNonResep(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Task ID Mobile JKN Non Resep ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void addantrianActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addantrianActionPerformed
             ...
             try {
                ...
                try {  
                     ...
                     requestJson ="{" +
                                     ...
                                     "\"kodepoli\": \""+tbJnsPerawatan.getValueAt(i,3).toString()+"\"," +
        ...
        Sequel.mengedit("antrian_bantu","no_rawat='"+tbJnsPerawatan.getValueAt(i,0).toString()+"'","status='Sudah Valid',tanggal2=tanggal1 + INTERVAL "+Sequel.cariIsi("SELECT FLOOR(RAND()*(1-15+1))+15")+" MINUTE ");
       } 
        ...
        for(i=0;i<tbJnsPerawatan.getRowCount();i++){
            try {
             datajam=Sequel.cariIsi("SELECT tanggal1  FROM  antrian_bantu ab  WHERE  no_rawat=? AND  tanggal1 <>'0000-00-00 00:00:00'",tbJnsPerawatan.getValueAt(i,0).toString());
                ...
                Sequel.mengedit("antrian_bantu","no_rawat='"+tbJnsPerawatan.getValueAt(i,0).toString()+"'","status='Sudah Valid',tanggal3=tanggal2 + INTERVAL "+Sequel.cariIsi("SELECT FLOOR(RAND()*(2-8+1))+8")+" MINUTE ");
            ...
            try {
             datajam=Sequel.cariIsi("SELECT tanggal2  FROM  antrian_bantu ab  WHERE  no_rawat=? AND  tanggal2 <>'0000-00-00 00:00:00'",tbJnsPerawatan.getValueAt(i,0).toString());
                if(!datajam.equals("")){
                   ...
                   Sequel.mengedit("antrian_bantu","no_rawat='"+tbJnsPerawatan.getValueAt(i,0).toString()+"'","status='Sudah Valid',tanggal4=tanggal3 + INTERVAL "+Sequel.cariIsi("SELECT FLOOR(RAND()*(15-30+1))+30")+" MINUTE ");
                }
             }catch(Exception e){
            System.out.println("Notifikasi : "+e);
        }
            ...
            try {
             datajam=Sequel.cariIsi("SELECT tanggal3  FROM  antrian_bantu ab  WHERE  no_rawat=? AND  tanggal3 <>'0000-00-00 00:00:00'",tbJnsPerawatan.getValueAt(i,0).toString());
                if(!datajam.equals("")){
                   ...
                   Sequel.mengedit("antrian_bantu","no_rawat='"+tbJnsPerawatan.getValueAt(i,0).toString()+"'","status='Sudah Valid',tanggal5=tanggal4 + INTERVAL "+Sequel.cariIsi("SELECT FLOOR(RAND()*(1-15+1))+15")+" MINUTE ");
                }
             }catch(Exception e){
            System.out.println("Notifikasi : "+e);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgTaskIdNonResep dialog = new DlgTaskIdNonResep(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                   ...
                   " reg_periksa.no_rawat not in (select referensi_mobilejkn_bpjs.no_rawat from referensi_mobilejkn_bpjs) and reg_periksa.kd_poli in ('IRM','GIG','HDL') "+
