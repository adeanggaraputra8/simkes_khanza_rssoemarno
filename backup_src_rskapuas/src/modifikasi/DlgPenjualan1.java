...
public class DlgPenjualan1 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgPenjualan1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        catatan.setText("Hanya Khusus Karyawan RS");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPenjualan1 dialog = new DlgPenjualan1(new javax.swing.JFrame(), true);
