 ...
 * @author khanzamedia
 */
public class DlgBilingParsialRalan1 extends javax.swing.JDialog {
    ...
    private DefaultTableModel tabModeAkunBayar,TabModeTindakanDr,
            ...
            TabModeLaboratBayar,TabModeDetailLaboratBayar,TabModeLaboratPA,TabModeDetailLaboratPA,
            TabModeLaboratBayarPA,TabModeDetailLaboratBayarPA,TabModeObat,TabModeObatBayar, tabModeBillingBayar;
    private int row2=0,r=0,i=0,countbayar=0,z=0,jml=0,jmlradiologi=0,jmllaborat=0,index=0,jmlreg=0,jmllaboratpa=0;
    ...
    private PreparedStatement psakunbayar,pstindakan,psset_tarif,psreg,
            pscaripoli,pscarialamat,psdokterralan,psrekening,psbiling,psbilingbayar;
    private ResultSet rsakunbayar,rstindakan,rsset_tarif,rsbayar,rsreg,rscaripoli,
            rscarialamat,rsdokterralan,rsrekening,rsbilingbayar;
    private String noorderradiologi="",noorderlaborat="",noorderlaboratpa="",jmls="",kd_pj="",kd_poli="",poli_ralan="Yes",cara_bayar_ralan="Yes",cara_bayar_lab="Yes",kelas_lab="Yes",
            ...
            rinciandokterralan="No",sqlpsdokterralan="select dokter.nm_dokter from reg_periksa "+
                            ...
                            "where no_rawat=?",
            sqlpsbiling="insert into billing_parsial values(?,?,?,?,?,?,?,?,?,?,?,?,?)",
    ...
    private double ppnobat=0,ttl=0,y=0,ttlLaborat=0,ttlRadiologi=0,ttlLaboratpa=0,
     ...
     */
    public DlgBilingParsialRalan1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
            ...
            public void windowClosed(WindowEvent e) {
                if(dokter.getTable().getSelectedRow()!= -1){
                    if(TabRawat.getSelectedIndex()==0){
                        ...
                        KdDokPerujukLab1.setText(dokter.getTable().getValueAt(dokter.getTable().getSelectedRow(),0).toString());
                        TDokterPerujukLab1.setText(dokter.getTable().getValueAt(dokter.getTable().getSelectedRow(),1).toString());
                        KdDokPerujukLab1.requestFocus();
                    }                        
                } 
            }
            @Override
            ...
            public void windowClosed(WindowEvent e) {
                if(dokter1.getTable().getSelectedRow()!= -1){
                    if(TabRawat.getSelectedIndex()==3){
                        KdDokRad.setText(dokter1.getTable().getValueAt(dokter1.getTable().getSelectedRow(),0).toString());
                        TDokterRad.setText(dokter1.getTable().getValueAt(dokter1.getTable().getSelectedRow(),1).toString());
                        KdDokRad.requestFocus();
                    }else if(TabRawat.getSelectedIndex()==4){
                        KdDokLabPK.setText(dokter1.getTable().getValueAt(dokter1.getTable().getSelectedRow(),0).toString());
                        TDokterLabPK.setText(dokter1.getTable().getValueAt(dokter1.getTable().getSelectedRow(),1).toString());
                        KdDokLabPK.requestFocus();
                     }
//                    } else if(TabRawat.getSelectedIndex()==5){
//                        KdDokPerujukLab.setText(dokter.getTable().getValueAt(dokter.getTable().getSelectedRow(),0).toString());
//                        TDokterPerujukLab1.setText(dokter.getTable().getValueAt(dokter.getTable().getSelectedRow(),1).toString());
...
//                    }                        
        ...
        tbLaborat.setDefaultRenderer(Object.class, new WarnaTable());
         ...
         TabModeLaboratPA=new DefaultTableModel(null,new Object[]{
            "P","Kode Periksa","Nama Pemeriksaan","Tarif","Bagian RS","BHP","Tarif Perujuk",
            "Tarif Dokter","Tarif Petugas","Kso","Menejemen","Tanggal","Jam","No.Order"
            }){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){
        ...
        tbLaboratpa.setModel(TabModeLaboratPA);        
        
        tbLaboratpa.setPreferredScrollableViewportSize(new Dimension(500,500));
        tbLaboratpa.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for(i = 0; i < 14; i++) {
            TableColumn column = tbLaboratpa.getColumnModel().getColumn(i);
            if(i==0){
                column.setPreferredWidth(20);
            }else if(i==1){
                column.setPreferredWidth(100);
        ...
        tbLaboratpa.setDefaultRenderer(Object.class, new WarnaTable());
        ...
        tbDetailLaborat.setDefaultRenderer(Object.class, new WarnaTable());
           ...
           TabModeDetailLaboratPA=new DefaultTableModel(null,new Object[]{
            "P","ID Periksa","Nama Sub Pemeriksaan","Tarif","Bagian RS","BHP","Tarif Perujuk",
            "Tarif Dokter","Tarif Petugas","Kso","Menejemen","Tanggal","Jam","No.Order","Kode Jenis"
            }){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){
        ...
        tbDetailLaboratpa.setModel(TabModeDetailLaboratPA);        
        
        tbDetailLaboratpa.setPreferredScrollableViewportSize(new Dimension(500,500));
        tbDetailLaboratpa.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for(i = 0; i < 15; i++) {
            TableColumn column = tbDetailLaboratpa.getColumnModel().getColumn(i);
            if(i==0){
                column.setPreferredWidth(20);
            }else if(i==2){
                column.setPreferredWidth(405);
        ...
        tbDetailLaboratpa.setDefaultRenderer(Object.class, new WarnaTable());
        
        TabModeObat=new DefaultTableModel(null,new Object[]{
                "P","No.Resep","No.Rawat","No.R.M.","Nama Pasien","Tanggal Bayar","Status","Jaminan","Petugas Kasir",
        ...
        TabModeDetailLaboratBayarPA=new DefaultTableModel(null,new Object[]{
            "P","ID Periksa","Nama Sub Pemeriksaan","Tarif","Bagian RS","BHP","Tarif Perujuk",
            "Tarif Dokter","Tarif Petugas","Kso","Menejemen","Tanggal","Jam","No.Order","Kode Jenis","Status"
            }){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){
        ...
        tbDetailLaboratBayarpa.setModel(TabModeDetailLaboratBayarPA);        
        
        tbDetailLaboratBayarpa.setPreferredScrollableViewportSize(new Dimension(500,500));
        tbDetailLaboratBayarpa.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for(i = 0; i < 16; i++) {
            TableColumn column = tbDetailLaboratBayarpa.getColumnModel().getColumn(i);
            if(i==0){
                column.setPreferredWidth(20);
            }else if(i==2){
                column.setPreferredWidth(405);
        ...
        tbDetailLaboratBayarpa.setDefaultRenderer(Object.class, new WarnaTable());
        ...
        TabModeLaboratBayarPA=new DefaultTableModel(null,new Object[]{
            "P","Kode Periksa","Nama Pemeriksaan","Tarif","Bagian RS","BHP","Tarif Perujuk",
            "Tarif Dokter","Tarif Petugas","Kso","Menejemen","Tanggal","Jam","No.Order","Status"
            }){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){
        ...
        tbLaboratBayarpa.setModel(TabModeLaboratBayarPA);        
        
        //tbObat.setDefaultRenderer(Object.class, new WarnaTable(panelJudul.getBackground(),tbObat.getBackground()));
        tbLaboratBayarpa.setPreferredScrollableViewportSize(new Dimension(500,500));
        tbLaboratBayarpa.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for(i = 0; i < 15; i++) {
            TableColumn column = tbLaboratBayarpa.getColumnModel().getColumn(i);
            if(i==0){
                column.setPreferredWidth(20);
            }else if(i==1){
                column.setPreferredWidth(100);
        ...
        tbLaboratBayarpa.setDefaultRenderer(Object.class, new WarnaTable());
        ...
        tbBilling.setDefaultRenderer(Object.class, new WarnaTable());
         ...
         tabModeBillingBayar=new DefaultTableModel(null,new Object[]{
              "No.Nota","Tgl.Bayar","Keterangan","Tagihan/Tindakan/Terapi","","Biaya","Jumlah","Tambahan","Total Biaya",""}){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){
                    boolean a = false;
        ...
        tbBillingBayar.setModel(tabModeBillingBayar);
        tbBillingBayar.setPreferredScrollableViewportSize(new Dimension(800,800));
        tbBillingBayar.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
        
        for (i = 0; i < 10; i++) {
            TableColumn column = tbBillingBayar.getColumnModel().getColumn(i);
            if(i==0){
        ...
        tbBillingBayar.setDefaultRenderer(Object.class, new WarnaTable());
    ...
    private void initComponents() {
        ...
        Popuphapusbiling = new javax.swing.JPopupMenu();
        ppCetakNota = new javax.swing.JMenuItem();
        ppHapusBilling = new javax.swing.JMenuItem();
        ppGantiDrRad = new javax.swing.JMenuItem();
        ppGantiDrLab = new javax.swing.JMenuItem();
        TNoNota1 = new widget.TextBox();
        ...
        BtnSeekDokter5 = new widget.Button();
        TDokterRad = new widget.TextBox();
        KdDokRad = new widget.TextBox();
        jLabel17 = new widget.Label();
        BtnSeekDokter7 = new widget.Button();
        ...
        KdDokLabPK = new widget.TextBox();
        TDokterLabPK = new widget.TextBox();
        BtnSeekDokter6 = new widget.Button();
        BtnSeekDokter8 = new widget.Button();
        ...
        KdDokPerujukLab1 = new widget.TextBox();
        BtnSeekDokter4 = new widget.Button();
        TDokterPerujukLab1 = new widget.TextBox();
        internalFrame11 = new widget.InternalFrame();
        TabRawatLaborat1 = new javax.swing.JTabbedPane();
        Scroll18 = new widget.ScrollPane();
        tbLaboratpa = new widget.Table();
        Scroll19 = new widget.ScrollPane();
        tbDetailLaboratpa = new widget.Table();
        internalFrame12 = new widget.InternalFrame();
        TabRawatLaboratBayar1 = new javax.swing.JTabbedPane();
        Scroll20 = new widget.ScrollPane();
        tbLaboratBayarpa = new widget.Table();
        Scroll21 = new widget.ScrollPane();
        tbDetailLaboratBayarpa = new widget.Table();
        ...
        tbBillingBayar = new widget.Table();
        ...
        Popuphapusbiling.setBackground(new java.awt.Color(255, 255, 254));
        ...
        ppCetakNota.setPreferredSize(new java.awt.Dimension(160, 25));
        ppCetakNota.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppCetakNotaActionPerformed(evt);
            }
        });
        Popuphapusbiling.add(ppCetakNota);

        ppHapusBilling.setBackground(new java.awt.Color(255, 255, 254));
        ppHapusBilling.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppHapusBilling.setForeground(new java.awt.Color(50, 50, 50));
        ppHapusBilling.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppHapusBilling.setText("Hapus Nota");
        ppHapusBilling.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppHapusBilling.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppHapusBilling.setPreferredSize(new java.awt.Dimension(160, 25));
        ppHapusBilling.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppHapusBillingActionPerformed(evt);
            }
        });
        Popuphapusbiling.add(ppHapusBilling);

        ppGantiDrRad.setBackground(new java.awt.Color(255, 255, 254));
        ppGantiDrRad.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppGantiDrRad.setForeground(new java.awt.Color(50, 50, 50));
        ppGantiDrRad.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppGantiDrRad.setText("Ganti dr Radiologi");
        ppGantiDrRad.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppGantiDrRad.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppGantiDrRad.setPreferredSize(new java.awt.Dimension(160, 25));
        ppGantiDrRad.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppGantiDrRadActionPerformed(evt);
            }
        });
        Popuphapusbiling.add(ppGantiDrRad);

        ppGantiDrLab.setBackground(new java.awt.Color(255, 255, 254));
        ppGantiDrLab.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppGantiDrLab.setForeground(new java.awt.Color(50, 50, 50));
        ppGantiDrLab.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppGantiDrLab.setText("Ganti dr Laboratorium");
        ppGantiDrLab.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppGantiDrLab.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppGantiDrLab.setPreferredSize(new java.awt.Dimension(160, 25));
        ppGantiDrLab.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppGantiDrLabActionPerformed(evt);
            }
        });
        Popuphapusbiling.add(ppGantiDrLab);

        TNoNota1.setHighlighter(null);
        TNoNota1.setPreferredSize(new java.awt.Dimension(150, 23));
        TNoNota1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TNoNota1KeyPressed(evt);
            }
        });
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-06-2021 01:37:57" }));
        ...
        jLabel15.setText("No. Nota :");
        jLabel15.setPreferredSize(new java.awt.Dimension(65, 23));
        ...
        BtnSeekDokter1.setBounds(540, 10, 28, 23);

        TDokterPerujukRad.setEditable(false);
        TDokterPerujukRad.setHighlighter(null);
        panelGlass9.add(TDokterPerujukRad);
        TDokterPerujukRad.setBounds(206, 10, 330, 23);

        BtnSeekDokter5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnSeekDokter5.setMnemonic('4');
        BtnSeekDokter5.setToolTipText("ALt+4");
        BtnSeekDokter5.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnSeekDokter5ActionPerformed(evt);
            }
        });
        panelGlass9.add(BtnSeekDokter5);
        BtnSeekDokter5.setBounds(1120, 10, 28, 23);

        TDokterRad.setEditable(false);
        TDokterRad.setHighlighter(null);
        panelGlass9.add(TDokterRad);
        TDokterRad.setBounds(780, 10, 330, 23);

        KdDokRad.setEditable(false);
        KdDokRad.setHighlighter(null);
        KdDokRad.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KdDokRadKeyPressed(evt);
            }
        });
        panelGlass9.add(KdDokRad);
        KdDokRad.setBounds(650, 10, 130, 23);

        jLabel17.setText("dr.Radiologi :");
        panelGlass9.add(jLabel17);
        jLabel17.setBounds(580, 10, 70, 23);

        BtnSeekDokter7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Save.png"))); // NOI18N
        BtnSeekDokter7.setMnemonic('4');
        BtnSeekDokter7.setText("ganti dokter");
        BtnSeekDokter7.setToolTipText("ALt+4");
        BtnSeekDokter7.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnSeekDokter7ActionPerformed(evt);
            }
        });
        panelGlass9.add(BtnSeekDokter7);
        BtnSeekDokter7.setBounds(1150, 10, 120, 23);
        ...
        BtnSeekDokter3.setBounds(550, 10, 28, 23);

        TDokterPerujukLab.setEditable(false);
        TDokterPerujukLab.setHighlighter(null);
        panelGlass12.add(TDokterPerujukLab);
        TDokterPerujukLab.setBounds(206, 10, 340, 23);

        jLabel18.setText("dr.Lab PK :");
        panelGlass12.add(jLabel18);
        jLabel18.setBounds(580, 10, 70, 23);

        KdDokLabPK.setEditable(false);
        KdDokLabPK.setHighlighter(null);
        KdDokLabPK.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KdDokLabPKKeyPressed(evt);
            }
        });
        panelGlass12.add(KdDokLabPK);
        KdDokLabPK.setBounds(650, 10, 130, 23);

        TDokterLabPK.setEditable(false);
        TDokterLabPK.setHighlighter(null);
        panelGlass12.add(TDokterLabPK);
        TDokterLabPK.setBounds(780, 10, 330, 23);

        BtnSeekDokter6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnSeekDokter6.setMnemonic('4');
        BtnSeekDokter6.setToolTipText("ALt+4");
        BtnSeekDokter6.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnSeekDokter6ActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnSeekDokter6);
        BtnSeekDokter6.setBounds(1120, 10, 28, 23);

        BtnSeekDokter8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Save.png"))); // NOI18N
        BtnSeekDokter8.setMnemonic('4');
        BtnSeekDokter8.setText("ganti dokter");
        BtnSeekDokter8.setToolTipText("ALt+4");
        BtnSeekDokter8.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnSeekDokter8ActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnSeekDokter8);
        BtnSeekDokter8.setBounds(1150, 10, 120, 23);
        ...
        TabRawat.addTab("Laboratorium PK", internalFrame6);

        internalFrame10.setBorder(null);
        internalFrame10.setLayout(new java.awt.BorderLayout(1, 1));

        panelGlass14.setBorder(null);
        panelGlass14.setPreferredSize(new java.awt.Dimension(44, 40));
        panelGlass14.setLayout(null);

        jLabel16.setText("Perujuk :");
        panelGlass14.add(jLabel16);
        jLabel16.setBounds(0, 10, 70, 23);

        KdDokPerujukLab1.setEditable(false);
        KdDokPerujukLab1.setHighlighter(null);
        KdDokPerujukLab1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KdDokPerujukLab1KeyPressed(evt);
            }
        });
        panelGlass14.add(KdDokPerujukLab1);
        KdDokPerujukLab1.setBounds(74, 10, 130, 23);
        ...
        panelGlass14.add(BtnSeekDokter4);
        BtnSeekDokter4.setBounds(849, 10, 28, 23);

        TDokterPerujukLab1.setEditable(false);
        TDokterPerujukLab1.setHighlighter(null);
        panelGlass14.add(TDokterPerujukLab1);
        TDokterPerujukLab1.setBounds(206, 10, 641, 23);

        internalFrame10.add(panelGlass14, java.awt.BorderLayout.PAGE_START);

        internalFrame11.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(241, 246, 236)), " Daftar Pemeriksaan ", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        internalFrame11.setLayout(new java.awt.BorderLayout(1, 1));

        TabRawatLaborat1.setBackground(new java.awt.Color(255, 255, 253));
        TabRawatLaborat1.setForeground(new java.awt.Color(50, 50, 50));
        ...
        Scroll18.setComponentPopupMenu(PopupLaborat);
        Scroll18.setOpaque(true);
        Scroll18.setPreferredSize(new java.awt.Dimension(540, 500));

        tbLaboratpa.setComponentPopupMenu(PopupLaborat);
        Scroll18.setViewportView(tbLaboratpa);

        TabRawatLaborat1.addTab("Pemeriksaan", Scroll18);

        Scroll19.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        Scroll19.setComponentPopupMenu(PopupDetailLaborat);
        Scroll19.setOpaque(true);
        Scroll19.setPreferredSize(new java.awt.Dimension(540, 500));

        tbDetailLaboratpa.setComponentPopupMenu(PopupDetailLaborat);
        Scroll19.setViewportView(tbDetailLaboratpa);

        TabRawatLaborat1.addTab("Sub Pemeriksaan", Scroll19);

        internalFrame11.add(TabRawatLaborat1, java.awt.BorderLayout.CENTER);

        internalFrame10.add(internalFrame11, java.awt.BorderLayout.WEST);

        internalFrame12.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(241, 246, 236)), " Sudah Dibayar ", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        internalFrame12.setLayout(new java.awt.BorderLayout(1, 1));

        TabRawatLaboratBayar1.setBackground(new java.awt.Color(255, 255, 253));
        TabRawatLaboratBayar1.setForeground(new java.awt.Color(50, 50, 50));
        TabRawatLaboratBayar1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        TabRawatLaboratBayar1.setPreferredSize(new java.awt.Dimension(540, 500));
        TabRawatLaboratBayar1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                TabRawatLaboratBayar1MouseClicked(evt);
            }
        });

        Scroll20.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        Scroll20.setComponentPopupMenu(PopupLaboratBayar);
        Scroll20.setOpaque(true);
        Scroll20.setPreferredSize(new java.awt.Dimension(540, 500));

        tbLaboratBayarpa.setComponentPopupMenu(PopupLaboratBayar);
        tbLaboratBayarpa.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbLaboratBayarpaMouseClicked(evt);
            }
        });
        Scroll20.setViewportView(tbLaboratBayarpa);

        TabRawatLaboratBayar1.addTab("Pemeriksaan", Scroll20);

        Scroll21.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        Scroll21.setComponentPopupMenu(PopupDetailLaboratBayar);
        Scroll21.setOpaque(true);
        Scroll21.setPreferredSize(new java.awt.Dimension(540, 500));

        tbDetailLaboratBayarpa.setComponentPopupMenu(PopupDetailLaboratBayar);
        tbDetailLaboratBayarpa.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbDetailLaboratBayarpaMouseClicked(evt);
            }
        });
        Scroll21.setViewportView(tbDetailLaboratBayarpa);

        TabRawatLaboratBayar1.addTab("Sub Pemeriksaan", Scroll21);

        internalFrame12.add(TabRawatLaboratBayar1, java.awt.BorderLayout.CENTER);

        internalFrame10.add(internalFrame12, java.awt.BorderLayout.CENTER);

        TabRawat.addTab("Laboratorium PA", internalFrame10);
        ...
        Scroll22.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        Scroll22.setComponentPopupMenu(Popuphapusbiling);
        Scroll22.setOpaque(true);
        Scroll22.setPreferredSize(new java.awt.Dimension(440, 404));

        tbBillingBayar.setComponentPopupMenu(Popuphapusbiling);
        tbBillingBayar.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbBillingBayarMouseClicked(evt);
            }
        });
        tbBillingBayar.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tbBillingBayarKeyPressed(evt);
            }
        });
        Scroll22.setViewportView(tbBillingBayar);

        TabRawat.addTab("Sudah Bayar", Scroll22);
    ...
    private void TabRawatMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabRawatMouseClicked
        if(TabRawat.getSelectedIndex()==0){
            ...
            if(TabRawatLaborat1.getSelectedIndex()==0){
                tampilLaboratpa();
                 BtnSimpan.setEnabled(true);
            }else if(TabRawatLaborat1.getSelectedIndex()==1){
                tampilDetailLaboratpa();
                 BtnSimpan.setEnabled(true);
            }         
            if(TabRawatLaboratBayar1.getSelectedIndex()==0){
                tampilLaboratBayarpa();
            }else if(TabRawatLaboratBayar1.getSelectedIndex()==1){
                tampilDetailLaboratBayarpa();
                 BtnSimpan.setEnabled(true);
            } 
            ...
            //tampilObatBayar();
             ...
             BtnSimpan.setEnabled(true);
            SttsPoli.setText("Status Bayar Poli : "+Sequel.cariIsi("select if(count(no_rawat)>0,'Sudah','Belum') from permintaan_registrasi where no_rawat='"+TNoRw.getText()+"' AND kd_poli='"+kd_poli+"' "));
    ...
    private void chkPoliMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_chkPoliMouseClicked
        jmlreg=Sequel.cariInteger("select count(no_rawat) from permintaan_registrasi where no_rawat='"+TNoRw+"' and kd_poli='"+kd_poli+"' ");
        if(jmlreg==1){
            tampilhapus();           
        }
    ...
    private void KdDokPerujukLab1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KdDokPerujukLab1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_KdDokPerujukLab1KeyPressed
    ...
    private void tbLaboratBayarpaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbLaboratBayarpaMouseClicked
         if(TabRawatLaboratBayar1.getSelectedIndex()==0){
            tampilLaboratBayarpa();
        }else if(TabRawatLaboratBayar1.getSelectedIndex()==1){
            tampilDetailLaboratBayarpa();
        ...
        tampilhapus();
    }//GEN-LAST:event_tbLaboratBayarpaMouseClicked

    private void tbDetailLaboratBayarpaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbDetailLaboratBayarpaMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_tbDetailLaboratBayarpaMouseClicked

    private void TabRawatLaboratBayar1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabRawatLaboratBayar1MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_TabRawatLaboratBayar1MouseClicked

    private void tbBillingBayarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbBillingBayarMouseClicked
      if(TabRawat.getSelectedIndex()==8){
        if(tabModeBillingBayar.getRowCount()!=0){      
                try {
                    getdata();
    ...
    }//GEN-LAST:event_tbBillingBayarMouseClicked

    private void tbBillingBayarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbBillingBayarKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_tbBillingBayarKeyPressed
    ...
    private void ppHapusBillingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppHapusBillingActionPerformed
        isSimpanHapus();
    }//GEN-LAST:event_ppHapusBillingActionPerformed

    private void ppCetakNotaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppCetakNotaActionPerformed
         Valid.panggilUrl("billing/BillingParsial.php?petugas="+akses.getkode().replaceAll(" ","_")+"&tanggal="+DTPTgl.getSelectedItem().toString().replaceAll(" ","_")+"&no_nota="+tbBillingBayar.getValueAt(tbBillingBayar.getSelectedRow(),0));
    }//GEN-LAST:event_ppCetakNotaActionPerformed

    private void TNoNota1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TNoNota1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_TNoNota1KeyPressed

    private void BtnSeekDokter5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSeekDokter5ActionPerformed
        dokter1.emptTeks();
        dokter1.isCek();
    ...
    }//GEN-LAST:event_BtnSeekDokter5ActionPerformed

    private void KdDokRadKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KdDokRadKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_KdDokRadKeyPressed

    private void KdDokLabPKKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KdDokLabPKKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_KdDokLabPKKeyPressed

    private void BtnSeekDokter6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSeekDokter6ActionPerformed
        dokter1.emptTeks();
        dokter1.isCek();
        dokter1.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
        dokter1.setLocationRelativeTo(internalFrame1);
        dokter1.setVisible(true);
    }//GEN-LAST:event_BtnSeekDokter6ActionPerformed

    private void ppGantiDrRadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppGantiDrRadActionPerformed
       BtnSeekDokter5ActionPerformed(null);
       TabRawat.setSelectedIndex(3);
       
    }//GEN-LAST:event_ppGantiDrRadActionPerformed

    private void ppGantiDrLabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppGantiDrLabActionPerformed
       BtnSeekDokter6ActionPerformed(null);
       TabRawat.setSelectedIndex(4);
    }//GEN-LAST:event_ppGantiDrLabActionPerformed

    private void BtnSeekDokter7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSeekDokter7ActionPerformed
        Sequel.mengedit("permintaan_pemeriksaan_radiologi_par","no_nota='"+TNoNota.getText()+"'","kd_dokter='"+KdDokRad.getText()+"'");
    }//GEN-LAST:event_BtnSeekDokter7ActionPerformed

    private void BtnSeekDokter8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSeekDokter8ActionPerformed
       Sequel.mengedit("permintaan_pemeriksaan_lab_par","no_nota='"+TNoNota.getText()+"'","kd_dokter='"+KdDokLabPK.getText()+"'");
    }//GEN-LAST:event_BtnSeekDokter8ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlgBilingParsialRalan1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DlgBilingParsialRalan1 dialog = new DlgBilingParsialRalan1(new javax.swing.JFrame(), true);
    ...
    private widget.Button BtnSeekDokter5;
    private widget.Button BtnSeekDokter6;
    private widget.Button BtnSeekDokter7;
    private widget.Button BtnSeekDokter8;
    ...
    private widget.TextBox KdDokLabPK;
    private widget.TextBox KdDokPerujukLab;
    private widget.TextBox KdDokPerujukLab1;
    private widget.TextBox KdDokPerujukRad;
    private widget.TextBox KdDokRad;
    ...
    private javax.swing.JPopupMenu Popuphapusbiling;
    ...
    private widget.TextBox TDokterLabPK;
    private widget.TextBox TDokterPerujukLab;
    private widget.TextBox TDokterPerujukLab1;
    private widget.TextBox TDokterPerujukRad;
    private widget.TextBox TDokterRad;
    public widget.TextBox TKembali;
    public widget.TextBox TNoNota;
    public widget.TextBox TNoNota1;
    ...
    private javax.swing.JTabbedPane TabRawatLaboratBayar1;
    ...
    private javax.swing.JMenuItem ppGantiDrLab;
    private javax.swing.JMenuItem ppGantiDrRad;
    private javax.swing.JMenuItem ppHapusBilling;
    ...
    private widget.Table tbBillingBayar;
    private widget.Table tbDetailLaborat;
    private widget.Table tbDetailLaboratBayar;
    private widget.Table tbDetailLaboratBayarpa;
    private widget.Table tbDetailLaboratpa;
    private widget.Table tbLaborat;
    private widget.Table tbLaboratBayar;
    private widget.Table tbLaboratBayarpa;
    private widget.Table tbLaboratpa;
    ...
    public void setNoRm(String norwt,String kodedokter, String namadokter,String KodePoli) {
        ...
        TDokterPerujukLab.setText(namadokter);
         KdDokPerujukLab1.setText(kodedokter);
        TDokterPerujukLab1.setText(namadokter);
    ...
    private void tampilAkunBayar() {
        if(statushapus==true){
            try {
                ...
                psakunbayar=koneksi.prepareStatement(
                        "select nota_jalan_par.nama_bayar,nota_jalan_par.besar_bayar,nota_jalan_par.besarppn from nota_jalan_par WHERE no_rawat=? ");
                try{
                    psakunbayar.setString(1,TNoRw.getText());
                    rsakunbayar=psakunbayar.executeQuery();
                    while(rsakunbayar.next()){                    
                        tabModeAkunBayar.addRow(new Object[]{rsakunbayar.getString(1),"",rsakunbayar.getString(2),"",rsakunbayar.getString(3)});
                    } 
                }catch (Exception e) {
                    System.out.println("Notifikasi : "+e);
                } finally{
        ...
        }else
        {
            try{           
                ...
                psakunbayar=koneksi.prepareStatement("select * from akun_bayar where nama_bayar like '%cash%' order by nama_bayar");
                try{
        ...
        try{    
            if(Sequel.cariInteger("select count(*) from rawat_jl_pr where no_rawat=? and stts_bayar='Belum'",TNoRw.getText())>0){
                ...
                if(kdptg.getText().trim().equals("")||TPerawat.getText().trim().equals("")){
                    JOptionPane.showMessageDialog(null,"Maaf,,, Nama Petugas Wajib Diisi Dengan Benar...!!!");
                    BtnSeekPetugas.requestFocus();
                }else{
    ...
    private void tampilDrPr() {
        try{                      
            if(Sequel.cariInteger("select count(*) from rawat_jl_drpr where no_rawat=? and stts_bayar='Belum'",TNoRw.getText())>0){
                ...
                if(kdptg2.getText().trim().equals("")||TPerawat2.getText().trim().equals("")){
                    JOptionPane.showMessageDialog(null,"Maaf,,, Nama Petugas Wajib Diisi Dengan Benar...!!!");
    ...
    public void tampilLaborat() {         
        try{    
            if(Sequel.cariInteger("select count(*) from permintaan_pemeriksaan_lab inner join permintaan_lab "+
                ...
                pstindakan=koneksi.prepareStatement(
                    ...
                    "permintaan_lab.no_rawat=? and permintaan_pemeriksaan_lab.stts_bayar='Belum' and jns_perawatan_lab.kategori='PK' order by jns_perawatan_lab.kd_jenis_prw");
                try {
                    pstindakan.setString(1,TNoRw.getText());
                    rstindakan=pstindakan.executeQuery();
                    while(rstindakan.next()){                
     ...
     public void tampilLaboratpa() {         
        try{    
            if(Sequel.cariInteger("select count(*) from permintaan_pemeriksaan_labpa inner join permintaan_labpa "+
                    "on permintaan_labpa.noorder=permintaan_pemeriksaan_labpa.noorder where permintaan_labpa.no_rawat=? "+
                    "and permintaan_pemeriksaan_labpa.stts_bayar='Belum'",TNoRw.getText())>0){
                Valid.tabelKosong(TabModeLaboratPA);
                pstindakan=koneksi.prepareStatement(
                    "select jns_perawatan_lab.kd_jenis_prw,jns_perawatan_lab.nm_perawatan,jns_perawatan_lab.total_byr,"+
                    "jns_perawatan_lab.bagian_rs,jns_perawatan_lab.bhp,jns_perawatan_lab.tarif_perujuk,"+
                    "jns_perawatan_lab.tarif_tindakan_dokter,jns_perawatan_lab.tarif_tindakan_petugas,"+
                    ...
                    "from jns_perawatan_lab inner join permintaan_labpa inner join permintaan_pemeriksaan_labpa "+
                    "on jns_perawatan_lab.kd_jenis_prw=permintaan_pemeriksaan_labpa.kd_jenis_prw and "+
                    "permintaan_labpa.noorder=permintaan_pemeriksaan_labpa.noorder where "+
                    "permintaan_labpa.no_rawat=? and permintaan_pemeriksaan_labpa.stts_bayar='Belum' and jns_perawatan_lab.kategori='PA' order by jns_perawatan_lab.kd_jenis_prw");
                try {
                    pstindakan.setString(1,TNoRw.getText());
                    rstindakan=pstindakan.executeQuery();
                    while(rstindakan.next()){                
                        TabModeLaboratPA.addRow(new Object[]{
                            false,rstindakan.getString(1),rstindakan.getString(2),rstindakan.getDouble(3),
                            rstindakan.getDouble(4),rstindakan.getDouble(5),rstindakan.getDouble(6),
                            rstindakan.getDouble(7),rstindakan.getDouble(8),rstindakan.getDouble(9),
                            rstindakan.getDouble(10),rstindakan.getString(11),rstindakan.getString(12),
                ...
                jml=0;
                for(i=0;i<tbLaboratpa.getRowCount();i++){
                    if(tbLaboratpa.getValueAt(i,0).toString().equals("true")){
                        jml++;
                    }
                }
                ...
                for(i=0;i<tbLaboratpa.getRowCount();i++){
                    if(tbLaboratpa.getValueAt(i,0).toString().equals("true")){
                        pilih[index]=true;
                        kode[index]=tbLaboratpa.getValueAt(i,1).toString();
                        nama[index]=tbLaboratpa.getValueAt(i,2).toString();
                        totaltnd[index]=Double.parseDouble(tbLaboratpa.getValueAt(i,3).toString());
                        bagianrs[index]=Double.parseDouble(tbLaboratpa.getValueAt(i,4).toString());
                        bhp[index]=Double.parseDouble(tbLaboratpa.getValueAt(i,5).toString());
                        tarif_perujuk[index]=Double.parseDouble(tbLaboratpa.getValueAt(i,6).toString());
                        jmdokter[index]=Double.parseDouble(tbLaboratpa.getValueAt(i,7).toString());
                        jmperawat[index]=Double.parseDouble(tbLaboratpa.getValueAt(i,8).toString());
                        kso[index]=Double.parseDouble(tbLaboratpa.getValueAt(i,9).toString());
                        menejemen[index]=Double.parseDouble(tbLaboratpa.getValueAt(i,10).toString()); 
                        tanggal[index]=tbLaboratpa.getValueAt(i,11).toString();
                        jam[index]=tbLaboratpa.getValueAt(i,12).toString();
                        noorder[index]=tbLaboratpa.getValueAt(i,13).toString();
                        index++;
                    }
                }
                ...
                Valid.tabelKosong(TabModeLaboratPA);
                for(i=0;i<jml;i++){                
                    TabModeLaboratPA.addRow(new Object[] {pilih[i],kode[i],nama[i],totaltnd[i],bagianrs[i],bhp[i],tarif_perujuk[i],jmdokter[i],jmperawat[i],kso[i],menejemen[i],tanggal[i],jam[i],noorder[i]});
                }
    ...
    public void tampilDetailLaboratpa() {         
        try{    
            if(Sequel.cariInteger("select count(*) from permintaan_detail_permintaan_lab inner join permintaan_labpa "+
                    "on permintaan_labpa.noorder=permintaan_detail_permintaan_lab.noorder where permintaan_labpa.no_rawat=? "+
                    "and permintaan_detail_permintaan_lab.stts_bayar='Belum'",TNoRw.getText())>0){
                Valid.tabelKosong(TabModeDetailLaboratPA);
                pstindakan=koneksi.prepareStatement(
                    "select template_laboratorium.id_template,template_laboratorium.Pemeriksaan,template_laboratorium.biaya_item,"+
                    "template_laboratorium.bagian_rs,template_laboratorium.bhp,template_laboratorium.bagian_perujuk,"+
                    "template_laboratorium.bagian_dokter,template_laboratorium.bagian_laborat,"+
                    "template_laboratorium.kso,template_laboratorium.menejemen,permintaan_labpa.tgl_permintaan,"+
                    "permintaan_labpa.jam_permintaan,permintaan_labpa.noorder,permintaan_detail_permintaan_lab.kd_jenis_prw "+
                    "from template_laboratorium inner join permintaan_labpa inner join permintaan_detail_permintaan_lab "+
                    "on template_laboratorium.id_template=permintaan_detail_permintaan_lab.id_template and "+
                    "permintaan_labpa.noorder=permintaan_detail_permintaan_lab.noorder where "+
                    "permintaan_labpa.no_rawat=? and permintaan_detail_permintaan_lab.stts_bayar='Belum' order by template_laboratorium.urut");
                try {
                    pstindakan.setString(1,TNoRw.getText());
                    rstindakan=pstindakan.executeQuery();
                    while(rstindakan.next()){                
                        TabModeDetailLaboratPA.addRow(new Object[]{
                            false,rstindakan.getString(1),rstindakan.getString(2),rstindakan.getDouble(3),
                            rstindakan.getDouble(4),rstindakan.getDouble(5),rstindakan.getDouble(6),
                            rstindakan.getDouble(7),rstindakan.getDouble(8),rstindakan.getDouble(9),
                            rstindakan.getDouble(10),rstindakan.getString(11),rstindakan.getString(12),
                ...
                jml=0;
                for(i=0;i<tbDetailLaboratpa.getRowCount();i++){
                    if(tbDetailLaboratpa.getValueAt(i,0).toString().equals("true")){
                        jml++;
                    }
                }
                ...
                for(i=0;i<tbDetailLaboratpa.getRowCount();i++){
                    if(tbDetailLaboratpa.getValueAt(i,0).toString().equals("true")){
                        pilih[index]=true;
                        kode[index]=tbDetailLaboratpa.getValueAt(i,1).toString();
                        nama[index]=tbDetailLaboratpa.getValueAt(i,2).toString();
                        totaltnd[index]=Double.parseDouble(tbDetailLaboratpa.getValueAt(i,3).toString());
                        bagianrs[index]=Double.parseDouble(tbDetailLaboratpa.getValueAt(i,4).toString());
                        bhp[index]=Double.parseDouble(tbDetailLaboratpa.getValueAt(i,5).toString());
                        tarif_perujuk[index]=Double.parseDouble(tbDetailLaboratpa.getValueAt(i,6).toString());
                        jmdokter[index]=Double.parseDouble(tbDetailLaboratpa.getValueAt(i,7).toString());
                        jmperawat[index]=Double.parseDouble(tbDetailLaboratpa.getValueAt(i,8).toString());
                        kso[index]=Double.parseDouble(tbDetailLaboratpa.getValueAt(i,9).toString());
                        menejemen[index]=Double.parseDouble(tbDetailLaboratpa.getValueAt(i,10).toString()); 
                        tanggal[index]=tbDetailLaboratpa.getValueAt(i,11).toString();
                        jam[index]=tbDetailLaboratpa.getValueAt(i,12).toString();
                        noorder[index]=tbDetailLaboratpa.getValueAt(i,13).toString();
                        index++;
                    }
                }
                ...
                Valid.tabelKosong(TabModeDetailLaboratPA);
                for(i=0;i<jml;i++){                
                    TabModeDetailLaboratPA.addRow(new Object[] {pilih[i],kode[i],nama[i],totaltnd[i],bagianrs[i],bhp[i],tarif_perujuk[i],jmdokter[i],jmperawat[i],kso[i],menejemen[i],tanggal[i],jam[i],noorder[i]});
                }
                
                for(i=0;i<tbLaboratpa.getRowCount();i++){ 
                    if(tbLaboratpa.getValueAt(i,0).toString().equals("true")){
                        TabModeDetailLaboratPA.addRow(new Object[]{
                            false,"",tbLaboratpa.getValueAt(i,2).toString(),0,0,0,0,0,0,0,0,"0000-00-00","00:00:00","",""
                        });
                        pstindakan=koneksi.prepareStatement(
                            "select template_laboratorium.id_template,template_laboratorium.Pemeriksaan,template_laboratorium.biaya_item,"+
                            "template_laboratorium.bagian_rs,template_laboratorium.bhp,template_laboratorium.bagian_perujuk,"+
    ...
    public void tampilDetailLaboratBayarpa() {         
        try{  
            Valid.tabelKosong(TabModeDetailLaboratBayarPA);
            pstindakan=koneksi.prepareStatement(
                "select template_laboratorium.id_template,template_laboratorium.Pemeriksaan,template_laboratorium.biaya_item,"+
                "template_laboratorium.bagian_rs,template_laboratorium.bhp,template_laboratorium.bagian_perujuk,"+
                "template_laboratorium.bagian_dokter,template_laboratorium.bagian_laborat,"+
                "template_laboratorium.kso,template_laboratorium.menejemen,permintaan_labpa.tgl_permintaan,"+
                "permintaan_labpa.jam_permintaan,permintaan_labpa.noorder,permintaan_detail_permintaan_lab.kd_jenis_prw, "+
                "permintaan_detail_permintaan_lab.stts_bayar from template_laboratorium inner join permintaan_labpa inner join permintaan_detail_permintaan_lab "+
                "on template_laboratorium.id_template=permintaan_detail_permintaan_lab.id_template and "+
                "permintaan_labpa.noorder=permintaan_detail_permintaan_lab.noorder where "+
                "permintaan_labpa.no_rawat=? and permintaan_detail_permintaan_lab.stts_bayar<>'Belum' order by template_laboratorium.urut");
            try {
                ...
                rstindakan=pstindakan.executeQuery();
                while(rstindakan.next()){                
                    TabModeDetailLaboratBayarPA.addRow(new Object[]{
                        false,rstindakan.getString(1),rstindakan.getString(2),rstindakan.getDouble(3),
                        rstindakan.getDouble(4),rstindakan.getDouble(5),rstindakan.getDouble(6),
                        rstindakan.getDouble(7),rstindakan.getDouble(8),rstindakan.getDouble(9),
                        rstindakan.getDouble(10),rstindakan.getString(11),rstindakan.getString(12),
    ...
    public void isCek(){
        ...
        if(Sequel.cariIsi("select tampilkan_tombol_nota_ralan from set_nota").equals("Yes")){
            ...
            if(akses.getkode().equals("Admin Utama")){
                BtnNota.setVisible(true);
                ppHapusBilling.setVisible(true);
            }else{
                BtnNota.setVisible(false);
                ppHapusBilling.setVisible(false);
            }            
        }
    }
    ...
    private void tampilbilling() {
        ...
        try{   
            ...
            try{
                ...
                if(rsreg.next()){
                    NoNota=Sequel.cariIsi("select no_nota from nota_jalan_par where no_rawat=?",TNoRw.getText());
                    if(NoNota.equals("")){
                        tabModeBilling.addRow(new Object[]{"No.Nota",": "+TNoNota.getText(),"",null,null,null,"-"});                
                    }else{
                        tabModeBilling.addRow(new Object[]{"No.Nota",": "+TNoNota.getText(),"",null,null,null,"-"});                
                    }
                    ...
                    for(i=0;i<tbLaboratpa.getRowCount();i++){
                        if(tbLaboratpa.getValueAt(i,0).toString().equals("true")){
                            jml++;
                            if(tbLaboratpa.getValueAt(i,11).toString().equals("0000-00-00")){
                                jmllaboratpa++;
                            }                                
                        }
                    }
                    ...
                    for(i=0;i<tbDetailLaboratpa.getRowCount();i++){
                        if(tbDetailLaboratpa.getValueAt(i,0).toString().equals("true")){
                            jml++;
                            if(tbDetailLaboratpa.getValueAt(i,11).toString().equals("0000-00-00")){
                                jmllaboratpa++;
                            }                                
                        }
                    }
                    ...
                    if(jml>0){
                      ...
                      if(Sequel.cariInteger("select count(no_rawat) from permintaan_registrasi where no_rawat='"+TNoRw.getText()+"' and kd_poli='"+kd_poli+"' ")==0){
                        if(chkPoli.isSelected()==true){
                            tabModeBilling.addRow(new Object[]{
                                "","Registrasi "+Sequel.cariIsi("select nm_poli from poliklinik where kd_poli=?", kd_poli)+"",":",Double.parseDouble(TBiaya.getText()),1,Double.parseDouble(TBiaya.getText()),1,
                                    Double.parseDouble(TBiaya.getText()),1,Double.parseDouble(TBiaya.getText()),"Registrasi"
                            });
                        }                            
                    }else{
                        chkPoli.setSelected(false);
                    ...
                    for(i=0;i<tbLaboratpa.getRowCount();i++){
                        if(tbLaboratpa.getValueAt(i,0).toString().equals("true")){
                            if(tbLaboratpa.getValueAt(i,11).toString().equals("0000-00-00")){
                                if((!KdDokPerujukLab.getText().equals(""))&&(!TDokterPerujukLab.getText().equals(""))){
                                    Jasa_Medik_Dokter_Laborat_Ralan=Jasa_Medik_Dokter_Laborat_Ralan+Double.parseDouble(tbLaboratpa.getValueAt(i,7).toString());
                                    Jasa_Medik_Petugas_Laborat_Ralan=Jasa_Medik_Petugas_Laborat_Ralan+Double.parseDouble(tbLaboratpa.getValueAt(i,8).toString());
                                    Kso_Laborat_Ralan=Kso_Laborat_Ralan+Double.parseDouble(tbLaboratpa.getValueAt(i,9).toString());
                                    Persediaan_Laborat_Rawat_Jalan=Persediaan_Laborat_Rawat_Jalan+Double.parseDouble(tbLaboratpa.getValueAt(i,5).toString());
                                    Jasa_Sarana_Laborat_Ralan=Jasa_Sarana_Laborat_Ralan+Double.parseDouble(tbLaboratpa.getValueAt(i,4).toString());
                                    Jasa_Perujuk_Laborat_Ralan=Jasa_Perujuk_Laborat_Ralan+Double.parseDouble(tbLaboratpa.getValueAt(i,6).toString());
                                    Jasa_Menejemen_Laborat_Ralan=Jasa_Menejemen_Laborat_Ralan+Double.parseDouble(tbLaboratpa.getValueAt(i,10).toString());
                                    tabModeBilling.addRow(new Object[]{
                                        "",tbLaboratpa.getValueAt(i,2).toString(),":",
                                        Double.parseDouble(tbLaboratpa.getValueAt(i,3).toString()),1,
                                        Double.parseDouble(tbLaboratpa.getValueAt(i,3).toString()),"Laboratpa"
                                    });
                                }
                            }else{
                                Jasa_Medik_Dokter_Laborat_Ralan=Jasa_Medik_Dokter_Laborat_Ralan+Double.parseDouble(tbLaboratpa.getValueAt(i,7).toString());
                    ...
                    for(i=0;i<tbDetailLaboratpa.getRowCount();i++){
                        if(tbDetailLaboratpa.getValueAt(i,0).toString().equals("true")){
                            if(tbDetailLaboratpa.getValueAt(i,11).toString().equals("0000-00-00")){
                                if(!tbDetailLaboratpa.getValueAt(i,1).toString().equals("")){
                                    if((!KdDokPerujukLab.getText().equals(""))&&(!TDokterPerujukLab.getText().equals(""))){
                                        Jasa_Medik_Dokter_Laborat_Ralan=Jasa_Medik_Dokter_Laborat_Ralan+Double.parseDouble(tbDetailLaboratpa.getValueAt(i,7).toString());
                                        Jasa_Medik_Petugas_Laborat_Ralan=Jasa_Medik_Petugas_Laborat_Ralan+Double.parseDouble(tbDetailLaboratpa.getValueAt(i,8).toString());
                                        Kso_Laborat_Ralan=Kso_Laborat_Ralan+Double.parseDouble(tbDetailLaboratpa.getValueAt(i,9).toString());
                                        Persediaan_Laborat_Rawat_Jalan=Persediaan_Laborat_Rawat_Jalan+Double.parseDouble(tbDetailLaboratpa.getValueAt(i,5).toString());
                                        Jasa_Sarana_Laborat_Ralan=Jasa_Sarana_Laborat_Ralan+Double.parseDouble(tbDetailLaboratpa.getValueAt(i,4).toString());
                                        Jasa_Perujuk_Laborat_Ralan=Jasa_Perujuk_Laborat_Ralan+Double.parseDouble(tbDetailLaboratpa.getValueAt(i,6).toString());
                                        Jasa_Menejemen_Laborat_Ralan=Jasa_Menejemen_Laborat_Ralan+Double.parseDouble(tbDetailLaboratpa.getValueAt(i,10).toString());
                                        tabModeBilling.addRow(new Object[]{
                                                "",tbDetailLaboratpa.getValueAt(i,2).toString().replaceAll("   ",""),":",
                                                Double.parseDouble(tbDetailLaboratpa.getValueAt(i,3).toString()),1,
                                                Double.parseDouble(tbDetailLaboratpa.getValueAt(i,3).toString()),"Laboratpa"
                                        });
                                    }
                                }
                            }else{
                                ...
                                Jasa_Menejemen_Laborat_Ralan=Jasa_Menejemen_Laborat_Ralan+Double.parseDouble(tbDetailLaboratpa.getValueAt(i,10).toString());
                                tabModeBilling.addRow(new Object[]{
                                    "",tbDetailLaboratpa.getValueAt(i,2).toString(),":",
                                    Double.parseDouble(tbDetailLaboratpa.getValueAt(i,3).toString()),1,
                                    Double.parseDouble(tbDetailLaboratpa.getValueAt(i,3).toString()),"Laboratpa"
                                });
                            }                                
    ...
    private void isHitung() {   
        ttl=0;
        y=0;
        ttlLaborat=0;ttlRadiologi=0;ttlObat=0;ttlRalan_Dokter=0;ttlLaboratpa=0;
    ...
    private void isSimpan() {        
        ...
        if(jawab==JOptionPane.YES_OPTION){
            ...
            try {
                        ...
                        if(tbTindakanDr.getValueAt(i,11).toString().equals("0000-00-00")){
                            if((!KdDok.getText().equals(""))&&(!TDokter.getText().equals(""))){
                                if(Sequel.menyimpantf2("rawat_jl_dr","?,?,?,?,?,?,?,?,?,?,?,?","Tindakan dokter",12,new String[]{
                                  ...
                                  //table bantuan parsial rwjdr
                                   if(Sequel.menyimpantf2("rawat_jl_dr_par","?,?,?,?,?,?,?,?,?,?,?,?","Tindakan Dokter",12,new String[]{
                                    TNoRw.getText(),tbTindakanDr.getValueAt(i,1).toString(),KdDok.getText(),
                                    Valid.SetTgl(DTPTgl.getSelectedItem()+""),kd_poli,"Ralan",tbTindakanDr.getValueAt(i,4).toString(),
                                    "Sudah",Valid.SetTgl(DTPTgl.getSelectedItem()+""),TNoNota.getText(),"Tind Dokter",DTPTgl.getSelectedItem().toString().substring(11,19)
                                  })==true) 
                            ...
                            if(Sequel.mengedittf("rawat_jl_dr","tgl_perawatan=? and jam_rawat=? and no_rawat=? and kd_jenis_prw=?","stts_bayar='Sudah'",4,new String[]{
                                    ...
                                    TNoRw.getText(),tbTindakanDr.getValueAt(i,1).toString(),KdDok.getText(),
                                    Valid.SetTgl(DTPTgl.getSelectedItem()+""),kd_poli,"Ralan",tbTindakanDr.getValueAt(i,4).toString(),
                                    "Sudah",tbTindakanDr.getValueAt(i,11).toString(),TNoNota.getText(),"Tind Dokter",tbTindakanDr.getValueAt(i,12).toString()
                                  })==true) 
                            {
                                tbTindakanDr.setValueAt(false,i,0);
                            }else{
                        ...
                        if(tbTindakanPr.getValueAt(i,11).toString().equals("0000-00-00")){
                            if((!kdptg.getText().equals(""))&&(!TPerawat.getText().equals(""))){
                                if(Sequel.menyimpantf2("rawat_jl_pr","?,?,?,?,?,?,?,?,?,?,?,?","Tindakan paramedis",12,new String[]{
                                    ...
                                    //table bantuan parsial rwjpr
                                   if(Sequel.menyimpantf2("rawat_jl_pr_par","?,?,?,?,?,?,?,?,?,?,?,?","Tindakan paramedis",12,new String[]{
                                    TNoRw.getText(),tbTindakanPr.getValueAt(i,1).toString(),kdptg.getText(),
                                    Valid.SetTgl(DTPTgl.getSelectedItem()+""),kd_poli,"Ralan",tbTindakanPr.getValueAt(i,4).toString(),
                                    "Sudah",Valid.SetTgl(DTPTgl.getSelectedItem()+""),TNoNota.getText(),"Tind Perawat",DTPTgl.getSelectedItem().toString().substring(11,19)
                                  })==true) 
                                {
                                    tbTindakanPr.setValueAt(false,i,0);
                                }else{
                            ...
                            if(Sequel.mengedittf("rawat_jl_pr","tgl_perawatan=? and jam_rawat=? and no_rawat=? and kd_jenis_prw=?","stts_bayar='Sudah'",4,new String[]{
                              ...
                              if(Sequel.menyimpantf2("rawat_jl_pr_par","?,?,?,?,?,?,?,?,?,?,?,?","Tindakan paramedis",12,new String[]{
                                    TNoRw.getText(),tbTindakanPr.getValueAt(i,1).toString(),kdptg.getText(),
                                    Valid.SetTgl(DTPTgl.getSelectedItem()+""),kd_poli,"Ralan",tbTindakanPr.getValueAt(i,4).toString(),
                                    "Sudah",tbTindakanPr.getValueAt(i,11).toString(),TNoNota.getText(),"Tind Perawat",tbTindakanPr.getValueAt(i,12).toString()
                                  })==true) 
                            {
                                tbTindakanPr.setValueAt(false,i,0);
                            }else{
                        ...
                        if(tbTindakanDrPr.getValueAt(i,11).toString().equals("0000-00-00")){
                            if((!kdptg2.getText().equals(""))&&(!TPerawat2.getText().equals(""))&&(!KdDok2.getText().equals(""))&&(!TDokter2.getText().equals(""))){
                                if(Sequel.menyimpantf2("rawat_jl_drpr","?,?,?,?,?,?,?,?,?,?,?,?,?,?","Tindakan dokter",14,new String[]{
                                    ...
                                    //table bantuan parsial rwjdrpr
                                    if(Sequel.menyimpantf2("rawat_jl_drpr_par","?,?,?,?,?,?,?,?,?,?,?,?,?","Tindakan Dokter",13,new String[]{
                                    TNoRw.getText(),tbTindakanDrPr.getValueAt(i,1).toString(),KdDok2.getText(),kdptg2.getText(),
                                    Valid.SetTgl(DTPTgl.getSelectedItem()+""),kd_poli,"Ralan",tbTindakanDrPr.getValueAt(i,4).toString(),
                                    "Sudah",Valid.SetTgl(DTPTgl.getSelectedItem()+""),TNoNota.getText(),"Tind Dokter & Perawat",DTPTgl.getSelectedItem().toString().substring(11,19)
                                  })==true) 
                                {
                                    tbTindakanDrPr.setValueAt(false,i,0);
                                }else{
                            ...
                            if(Sequel.mengedittf("rawat_jl_drpr","tgl_perawatan=? and jam_rawat=? and no_rawat=? and kd_jenis_prw=?","stts_bayar='Sudah'",4,new String[]{
                             ...
                             if(Sequel.menyimpantf2("rawat_jl_drpr_par","?,?,?,?,?,?,?,?,?,?,?,?,?","Tindakan Dokter",13,new String[]{
                                    TNoRw.getText(),tbTindakanDrPr.getValueAt(i,1).toString(),KdDok2.getText(),kdptg2.getText(),
                                    Valid.SetTgl(DTPTgl.getSelectedItem()+""),kd_poli,"Ralan",tbTindakanDrPr.getValueAt(i,4).toString(),
                                    "Sudah", tbTindakanDrPr.getValueAt(i,11).toString(),TNoNota.getText(),"Tind Dokter & Perawat",tbTindakanDrPr.getValueAt(i,12).toString()
                                  })==true) 
                            {
                                tbTindakanDrPr.setValueAt(false,i,0);
                            }else{
                        ...
                        if(tbRadiologi.getValueAt(i,11).toString().equals("0000-00-00")){
                            if((!KdDokPerujukRad.getText().equals(""))&&(!TDokterPerujukRad.getText().equals(""))){
                                if(Sequel.menyimpantf2("permintaan_pemeriksaan_radiologi","?,?,?","Permintaan Radiologi",3,new String[]{
                                 ...
                                 if(Sequel.menyimpantf2("permintaan_pemeriksaan_radiologi_par","?,?,?,?,?,?,?,?,?,?,?","Permintaan Radiologi",11,new String[]{
                                    noorderradiologi,tbRadiologi.getValueAt(i,1).toString(),kd_poli,"Ralan",tbRadiologi.getValueAt(i,3).toString(),"Sudah",Valid.SetTgl(DTPTgl.getSelectedItem()+""),
                                     TNoNota.getText(),"Radiologi",TNoRw.getText(),KdDokRad.getText()
                                  })==true)
                                {
                                    tbRadiologi.setValueAt(false,i,0);
                                }else{
                            ...
                            if(Sequel.mengedittf("permintaan_pemeriksaan_radiologi","noorder=? and kd_jenis_prw=?","stts_bayar='Sudah'",2,new String[]{
                              ...
                              if(Sequel.menyimpantf2("permintaan_pemeriksaan_radiologi_par","?,?,?,?,?,?,?,?,?,?","Permintaan Radiologi",10,new String[]{
                                    tbRadiologi.getValueAt(i,13).toString(),tbRadiologi.getValueAt(i,1).toString(),kd_poli,"Ralan",tbRadiologi.getValueAt(i,3).toString(),"Sudah",Valid.SetTgl(DTPTgl.getSelectedItem()+""),
                                     TNoNota.getText(),"Radiologi",TNoRw.getText()
                                  })==true)
                            {
                                tbRadiologi.setValueAt(false,i,0);
                            }else{
                        ...
                        if(tbLaborat.getValueAt(i,11).toString().equals("0000-00-00")){
                            if((!KdDokPerujukLab.getText().equals(""))&&(!TDokterPerujukLab.getText().equals(""))){
                                if(Sequel.menyimpantf2("permintaan_pemeriksaan_lab","?,?,?","Permintaan Laborat",3,new String[]{
                                 ...
                                 if(Sequel.menyimpantf2("permintaan_pemeriksaan_lab_par","?,?,?,?,?,?,?,?,?,?,?","Permintaan Laborat",11,new String[]{
                                    noorderlaborat,tbLaborat.getValueAt(i,1).toString(),kd_poli,"Ralan",tbLaborat.getValueAt(i,3).toString(),"Sudah",Valid.SetTgl(DTPTgl.getSelectedItem()+""),
                                     TNoNota.getText(),"Lab PK",TNoRw.getText(),KdDokLabPK.getText()
                                  })==true)
                            ...
                            if(Sequel.mengedittf("permintaan_pemeriksaan_lab","noorder=? and kd_jenis_prw=?","stts_bayar='Sudah'",2,new String[]{
                             ...
                             if(Sequel.menyimpantf2("permintaan_pemeriksaan_lab_par","?,?,?,?,?,?,?,?,?,?","Permintaan Laborat",10,new String[]{
                                    tbLaborat.getValueAt(i,13).toString(),tbLaborat.getValueAt(i,1).toString(),kd_poli,"Ralan",tbLaborat.getValueAt(i,3).toString(),"Sudah",Valid.SetTgl(DTPTgl.getSelectedItem()+""),
                                     TNoNota.getText(),"Lab PA",TNoRw.getText()
                                  })==true)
                            {
                                tbLaborat.setValueAt(false,i,0);
                            }else{
                ...
                noorderlaboratpa="";
                if(jmllaboratpa>0){
                    noorderlaboratpa=Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(noorder,4),signed)),0) from permintaan_labpa where tgl_permintaan='"+Valid.SetTgl(DTPTgl.getSelectedItem()+"")+"' ","PA"+Valid.SetTgl(DTPTgl.getSelectedItem()+"").replaceAll("-",""),4);
                    if((!KdDokPerujukLab1.getText().equals(""))&&(!TDokterPerujukLab1.getText().equals(""))){
                        if(Sequel.menyimpantf("permintaan_labpa","?,?,?,?,?,?,?,?,?,'ralan',?,?,?,?,?,?,?,?,?,?","No.Permintaan",19,new String[]{
                            noorderlaboratpa,TNoRw.getText(),Valid.SetTgl(DTPTgl.getSelectedItem()+""),
                            DTPTgl.getSelectedItem().toString().substring(11,19), 
                            "0000-00-00","00:00:00","0000-00-00","00:00:00",KdDokPerujukLab1.getText(),"","",Valid.SetTgl(DTPTgl.getSelectedItem()+""),"","","","","0000-00-00","",""
                        })==false){
                            sukses=false;
                        }
                    }                        
                ...
                for(i=0;i<tbLaboratpa.getRowCount();i++){
                    if(tbLaboratpa.getValueAt(i,0).toString().equals("true")){
                        if(tbLaboratpa.getValueAt(i,11).toString().equals("0000-00-00")){
                            if((!KdDokPerujukLab1.getText().equals(""))&&(!TDokterPerujukLab1.getText().equals(""))){
                                if(Sequel.menyimpantf2("permintaan_pemeriksaan_labpa","?,?,?","Permintaan Laborat",3,new String[]{
                                    noorderlaboratpa,tbLaboratpa.getValueAt(i,1).toString(),"Sudah"
                                  })==true)
                                 if(Sequel.menyimpantf2("permintaan_pemeriksaan_labpa_par","?,?,?,?,?,?,?,?,?,?","Permintaan Laborat",10,new String[]{
                                    noorderlaboratpa,tbLaboratpa.getValueAt(i,1).toString(),kd_poli,"Ralan",tbLaboratpa.getValueAt(i,3).toString(),"Sudah",Valid.SetTgl(DTPTgl.getSelectedItem()+""),
                                     TNoNota.getText(),"Lab PA",TNoRw.getText()
                                  })==true)
                                
                                {
                                    tbLaboratpa.setValueAt(false,i,0);
                                }else{
                                    sukses=false;
                                }
                            }                                
                        }else{
                            if(Sequel.mengedittf("permintaan_pemeriksaan_labpa","noorder=? and kd_jenis_prw=?","stts_bayar='Sudah'",2,new String[]{
                                    tbLaboratpa.getValueAt(i,13).toString(),tbLaboratpa.getValueAt(i,1).toString()
                                })==true)
                             if(Sequel.menyimpantf2("permintaan_pemeriksaan_labpa_par","?,?,?,?,?,?,?,?,?,?","Permintaan Laborat",10,new String[]{
                                    tbLaboratpa.getValueAt(i,13).toString(),tbLaboratpa.getValueAt(i,1).toString(),kd_poli,"Ralan",tbLaboratpa.getValueAt(i,3).toString(),"Sudah",Valid.SetTgl(DTPTgl.getSelectedItem()+""),
                                     TNoNota.getText(),"Lab PA",TNoRw.getText()
                                  })==true)
                            {
                                tbLaboratpa.setValueAt(false,i,0);
                ...
                if(Sequel.cariInteger("select count(no_rawat) from permintaan_registrasi where no_rawat=? and kd_poli=?",TNoRw.getText(),kd_poli)==0){
                    if(chkPoli.isSelected()==true){
                        if(Sequel.menyimpantf2("permintaan_registrasi","?,?,?,?","registrasi",4,new String[]{
                                TNoRw.getText(),TBiaya.getText(),TNoNota.getText(),kd_poli
                            })==true){
                            chkPoli.setSelected(false);
                        }else{
                            sukses=false;
                 ...
                 itembayar=0;besarppn=0;
                    ...
                    for(r=0;r<row2;r++){
                        if(Valid.SetAngka(tbAkunBayar.getValueAt(r,2).toString())>0){
                            ...
                            if(countbayar>1){
                                 if(Sequel.menyimpantf("nota_jalan_par","?,?,?,?,?,?,?",7,new String[]{
                                        TNoRw.getText(),TNoNota.getText(),Valid.SetTgl(DTPTgl.getSelectedItem()+""),DTPTgl.getSelectedItem().toString().substring(11,19),tbAkunBayar.getValueAt(r,0).toString(),Double.toString(besarppn),Double.toString(itembayar)
...
//                    simpan billing
                    for(i=0;i<tbBilling.getRowCount();i++){  
                        ...
                        try {
                            ...
                            psbiling.setString(3,TNoNota.getText());
                            psbiling.setString(4,Valid.SetTgl(DTPTgl.getSelectedItem()+""));
                            psbiling.setString(5,tbBilling.getValueAt(i,0).toString());
                            psbiling.setString(6,tbBilling.getValueAt(i,1).toString().replaceAll("'",""));
                            psbiling.setString(7,tbBilling.getValueAt(i,2).toString());                    
                            try {                        
                                psbiling.setDouble(8,Valid.SetAngka(tbBilling.getValueAt(i,3).toString()));
                            } catch (Exception e) {
                                psbiling.setDouble(8,0);
                            }

                            try {
                                psbiling.setDouble(9,Valid.SetAngka(tbBilling.getValueAt(i,4).toString()));
                            } catch (Exception e) {
                            ...
                            try {
                                psbiling.setDouble(11,Valid.SetAngka(tbBilling.getValueAt(i,5).toString())); 
                            } catch (Exception e) {
                                psbiling.setDouble(11,0);
                            } 
                            
                            psbiling.setString(12,TtlSemua.getText());
                            
                            psbiling.setString(13,tbBilling.getValueAt(i,6).toString());
              ...
              JOptionPane.showMessageDialog(null,"Data Tesimpan");
               if(notaralan.equals("Yes")){
                 Valid.panggilUrl("billing/BillingParsial.php?petugas="+akses.getkode().replaceAll(" ","_")+"&tanggal="+DTPTgl.getSelectedItem().toString().replaceAll(" ","_")+"&no_nota="+TNoNota.getText());
                }
              Valid.tabelKosong(TabModeDetailLaborat);
...
//              tampilbilling();
    ...
    private void tampilhapus() {
        ...
        for(i=0;i<tbTindakanDrBayar.getRowCount();i++){
            if(tbTindakanDrBayar.getValueAt(i,0).toString().equals("true")){
                if(tbTindakanDrBayar.getValueAt(i,13).toString().equals("Sudah")){
        ...
        for(i=0;i<tbLaboratBayarpa.getRowCount();i++){
            if(tbLaboratBayarpa.getValueAt(i,0).toString().equals("true")){
                Jasa_Medik_Dokter_Laborat_Ralan=Jasa_Medik_Dokter_Laborat_Ralan+Double.parseDouble(tbLaboratBayarpa.getValueAt(i,7).toString());
                Jasa_Medik_Petugas_Laborat_Ralan=Jasa_Medik_Petugas_Laborat_Ralan+Double.parseDouble(tbLaboratBayarpa.getValueAt(i,8).toString());
                Kso_Laborat_Ralan=Kso_Laborat_Ralan+Double.parseDouble(tbLaboratBayarpa.getValueAt(i,9).toString());
                Persediaan_Laborat_Rawat_Jalan=Persediaan_Laborat_Rawat_Jalan+Double.parseDouble(tbLaboratBayarpa.getValueAt(i,5).toString());
                Jasa_Sarana_Laborat_Ralan=Jasa_Sarana_Laborat_Ralan+Double.parseDouble(tbLaboratBayarpa.getValueAt(i,4).toString());
                Jasa_Perujuk_Laborat_Ralan=Jasa_Perujuk_Laborat_Ralan+Double.parseDouble(tbLaboratBayarpa.getValueAt(i,6).toString());
                Jasa_Menejemen_Laborat_Ralan=Jasa_Menejemen_Laborat_Ralan+Double.parseDouble(tbLaboratBayarpa.getValueAt(i,10).toString());
            }
        }
        ...
        for(i=0;i<tbDetailLaboratBayar.getRowCount();i++){
         ...
         for(i=0;i<tbDetailLaboratBayarpa.getRowCount();i++){
            if(tbDetailLaboratBayarpa.getValueAt(i,0).toString().equals("true")){
                Jasa_Medik_Dokter_Laborat_Ralan=Jasa_Medik_Dokter_Laborat_Ralan+Double.parseDouble(tbDetailLaboratBayarpa.getValueAt(i,7).toString());
                Jasa_Medik_Petugas_Laborat_Ralan=Jasa_Medik_Petugas_Laborat_Ralan+Double.parseDouble(tbDetailLaboratBayarpa.getValueAt(i,8).toString());
                Kso_Laborat_Ralan=Kso_Laborat_Ralan+Double.parseDouble(tbDetailLaboratBayarpa.getValueAt(i,9).toString());
                Persediaan_Laborat_Rawat_Jalan=Persediaan_Laborat_Rawat_Jalan+Double.parseDouble(tbDetailLaboratBayarpa.getValueAt(i,5).toString());
                Jasa_Sarana_Laborat_Ralan=Jasa_Sarana_Laborat_Ralan+Double.parseDouble(tbDetailLaboratBayarpa.getValueAt(i,4).toString());
                Jasa_Perujuk_Laborat_Ralan=Jasa_Perujuk_Laborat_Ralan+Double.parseDouble(tbDetailLaboratBayarpa.getValueAt(i,6).toString());
                Jasa_Menejemen_Laborat_Ralan=Jasa_Menejemen_Laborat_Ralan+Double.parseDouble(tbDetailLaboratBayarpa.getValueAt(i,10).toString());
            }
        }
    ...
    private void isHitungHapus() {   
        ...
        for(i=0;i<z;i++){ 
         ...
         z=tbLaboratBayarpa.getRowCount();
        for(i=0;i<z;i++){ 
            if(tbLaboratBayarpa.getValueAt(i,0).toString().equals("true")){
                y=0;
                try {                
                    y=Double.parseDouble(tbLaboratBayarpa.getValueAt(i,3).toString());  
                } catch (Exception e) {
                    y=0; 
                }
                ttlLaboratpa=ttlLaboratpa+y;                                  
        ...
        for(i=0;i<z;i++){ 
         ...
         z=tbDetailLaboratBayarpa.getRowCount();
        for(i=0;i<z;i++){ 
            if(tbDetailLaboratBayarpa.getValueAt(i,0).toString().equals("true")){
                y=0;
                try {                
                    y=Double.parseDouble(tbDetailLaboratBayarpa.getValueAt(i,3).toString());  
                } catch (Exception e) {
                    y=0; 
                }
                ttlLaboratpa=ttlLaboratpa+y;                                  
        ...
        if(jawab==JOptionPane.YES_OPTION){
            try {
                ...
                sukses=true;
                        ...
                        if(Sequel.queryutf("delete from permintaan_registrasi where no_nota='"+TNoNota.getText()+"'")==true){
                ...
                for(i=0;i<tbTindakanDrBayar.getRowCount();i++){
                    if(tbTindakanDrBayar.getValueAt(i,0).toString().equals("false")){
                        if(tbTindakanDrBayar.getValueAt(i,13).toString().equals("Sudah")){
                            if(Sequel.queryutf("update rawat_jl_dr INNER JOIN rawat_jl_dr_par ON rawat_jl_dr.jam_rawat=rawat_jl_dr_par.jam_rawat set rawat_jl_dr.stts_bayar='Belum' where rawat_jl_dr_par.no_nota='"+TNoNota.getText()+"'")==true)
                            if(Sequel.queryutf("delete from rawat_jl_dr_par where no_nota='"+TNoNota.getText()+"'")==true){
                ...
                for(i=0;i<tbTindakanPrBayar.getRowCount();i++){
                    if(tbTindakanPrBayar.getValueAt(i,0).toString().equals("false")){
                        if(tbTindakanPrBayar.getValueAt(i,13).toString().equals("Sudah")){
                            if(Sequel.queryutf("update rawat_jl_pr INNER JOIN rawat_jl_pr_par ON rawat_jl_pr.jam_rawat=rawat_jl_pr_par.jam_rawat set rawat_jl_pr.stts_bayar='Belum' where rawat_jl_pr_par.no_nota='"+TNoNota.getText()+"'")==true)
                            if(Sequel.queryutf("delete from rawat_jl_pr_par where no_nota='"+TNoNota.getText()+"'")==true){
                ...
                for(i=0;i<tbTindakanDrPrBayar.getRowCount();i++){
                    if(tbTindakanDrPrBayar.getValueAt(i,0).toString().equals("false")){
                        if(tbTindakanDrPrBayar.getValueAt(i,13).toString().equals("Sudah")){
                            if(Sequel.queryutf("update rawat_jl_drpr INNER JOIN rawat_jl_drpr_par ON rawat_jl_drpr.jam_rawat=rawat_jl_drpr_par.jam_rawat set rawat_jl_drpr.stts_bayar='Belum' where rawat_jl_drpr_par.no_nota='"+TNoNota.getText()+"'")==true)
                            if(Sequel.queryutf("delete from rawat_jl_drpr_par where no_nota='"+TNoNota.getText()+"'")==true){
                ...
                for(i=0;i<tbRadiologiBayar.getRowCount();i++){
                    if(tbRadiologiBayar.getValueAt(i,0).toString().equals("false")){
                        if(Sequel.queryu2tf("update permintaan_pemeriksaan_radiologi set stts_bayar='Belum' where noorder=? and kd_jenis_prw=?",2,new String[]{
                            tbRadiologiBayar.getValueAt(i,13).toString(),tbRadiologiBayar.getValueAt(i,1).toString()
                          })==true)
                        if(Sequel.queryutf("delete from permintaan_pemeriksaan_radiologi_par where no_nota='"+TNoNota.getText()+"'")==true){
...
//                                Sequel.mengedit("permintaan_pemeriksaan_radiologi","noorder='"+tbRadiologiBayar.getValueAt(i,13).toString()+"'","stts_bayar='Belum'");
//                            }
                        }else{
                            sukses=false;
                        }
                ...
                for(i=0;i<tbLaboratBayar.getRowCount();i++){
                    if(tbLaboratBayar.getValueAt(i,0).toString().equals("false")){
                        if(Sequel.queryu2tf("update permintaan_pemeriksaan_lab set stts_bayar='Belum' where noorder=? and kd_jenis_prw=?",2,new String[]{
                            tbLaboratBayar.getValueAt(i,13).toString(),tbLaboratBayar.getValueAt(i,1).toString()
                          })==true)
                        if(Sequel.queryutf("delete from permintaan_pemeriksaan_lab_par where no_nota='"+TNoNota.getText()+"'")==true){
...
//                                 Sequel.mengedit("permintaan_pemeriksaan_lab","noorder='"+tbLaboratBayar.getValueAt(i,13).toString()+"'","stts_bayar='Belum'");
//                            }
                        }else{
                            sukses=false;
                        }
                ...
                for(i=0;i<tbLaboratBayarpa.getRowCount();i++){
                    if(tbLaboratBayarpa.getValueAt(i,0).toString().equals("false")){
                        if(Sequel.queryu2tf("update permintaan_pemeriksaan_labpa set stts_bayar='Belum' where noorder=? and kd_jenis_prw=?",2,new String[]{
                            tbLaboratBayarpa.getValueAt(i,13).toString(),tbLaboratBayarpa.getValueAt(i,1).toString()
                          })==true)
                        if(Sequel.queryutf("delete from permintaan_pemeriksaan_labpa_par where no_nota='"+TNoNota.getText()+"'")==true){
                           
//                            if((Sequel.cariInteger("select count(*) from permintaan_pemeriksaan_labpa where noorder=?",tbLaboratBayarpa.getValueAt(i,13).toString())==0)){
//                                 Sequel.mengedit("permintaan_pemeriksaan_labpa","noorder='"+tbLaboratBayarpa.getValueAt(i,13).toString()+"'","stts_bayar='Belum'");
//                            }
                        }else{
                            sukses=false;
                        }
...
//                }
            ...
            Sequel.AutoComitTrue();
                ...
                JOptionPane.showMessageDialog(null,"Maaf, gagal menghapus data. Data yang sama dimasukkan sebelumnya...!");
                    ...
                    Sequel.queryu2("delete from nota_jalan_par where no_nota='"+TNoNota.getText()+"'");
                    Sequel.queryu2("delete from billing_parsial where no_nota='"+TNoNota.getText()+"'");  
                if(sukses==true){
...
//                    Sequel.queryu2("delete from billing_parsial where no_nota='"+TNoNota.getText()+"'");
                    ...
                    Valid.tabelKosong(TabModeLaboratBayarPA);
                    Valid.tabelKosong(TabModeDetailLaboratBayar);
    ...
    private void tampilLaboratBayar() {
     ...
     private void tampilLaboratBayarpa() {
        try{  
            Valid.tabelKosong(TabModeLaboratBayarPA);
                pstindakan=koneksi.prepareStatement(
                    "select jns_perawatan_lab.kd_jenis_prw,jns_perawatan_lab.nm_perawatan,jns_perawatan_lab.total_byr,"+
                    ...
                    "jns_perawatan_lab.tarif_tindakan_dokter,jns_perawatan_lab.tarif_tindakan_petugas,"+
                    "jns_perawatan_lab.kso,jns_perawatan_lab.menejemen,permintaan_labpa.tgl_permintaan,"+
                    "permintaan_labpa.jam_permintaan,permintaan_labpa.noorder,permintaan_pemeriksaan_labpa.stts_bayar "+
                    "from jns_perawatan_lab inner join permintaan_labpa inner join permintaan_pemeriksaan_labpa "+
                    "on jns_perawatan_lab.kd_jenis_prw=permintaan_pemeriksaan_labpa.kd_jenis_prw and "+
                    "permintaan_labpa.noorder=permintaan_pemeriksaan_labpa.noorder where "+
                    "permintaan_labpa.no_rawat=? and permintaan_pemeriksaan_labpa.stts_bayar<>'Belum' order by jns_perawatan_lab.kd_jenis_prw");
                try {
                    pstindakan.setString(1,TNoRw.getText());
                    rstindakan=pstindakan.executeQuery();
                    while(rstindakan.next()){                
                        TabModeLaboratBayarPA.addRow(new Object[]{
                            false,rstindakan.getString(1),rstindakan.getString(2),rstindakan.getDouble(3),
                            rstindakan.getDouble(4),rstindakan.getDouble(5),rstindakan.getDouble(6),
                            rstindakan.getDouble(7),rstindakan.getDouble(8),rstindakan.getDouble(9),
                            rstindakan.getDouble(10),rstindakan.getString(11),rstindakan.getString(12),
    ...
    private void tampilObat(){
        try{  
            ...
            pstindakan=koneksi.prepareStatement(
                     "SELECT status_resep.no_resep,status_resep.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,status_resep.tgl_resep,status_resep.status,penjab.png_jawab,status_resep.petugas,status_resep.lokasi,status_resep.keterangan,status_resep.ket1 " +
            ...
            try {
                ...
                while(rstindakan.next()){                
                    TabModeObatBayar.addRow(new Object[]{
                        ...
                        rstindakan.getString(3),rstindakan.getDouble(4),rstindakan.getDouble(5),
                        rstindakan.getString(6),rstindakan.getString(7)
                    });
                }
            } catch (Exception e) {
                System.out.println("Notifikasi : "+e);
    ...
    private void autonomor(){
            Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(no_nota,4),signed)),0) from nota_jalan_par where tanggal='"+Valid.SetTgl(DTPTgl.getSelectedItem()+"").substring(0,10)+"' ",Valid.SetTgl(DTPTgl.getSelectedItem()+"").substring(0,10).replaceAll("-","/")+"/PAR/RJ",4,TNoNota);
    
    }
    
    private void getdata(){     
         if(tbBillingBayar.getSelectedRow()!= -1){
           TNoNota.setText(tbBillingBayar.getValueAt(tbBillingBayar.getSelectedRow(),0).toString());
           KdDokRad.setText(Sequel.cariIsi("SELECT dokter.kd_dokter FROM permintaan_pemeriksaan_radiologi_par INNER JOIN dokter ON permintaan_pemeriksaan_radiologi_par.kd_dokter=dokter.kd_dokter WHERE permintaan_pemeriksaan_radiologi_par.no_nota='"+TNoNota.getText()+"'"));
           TDokterRad.setText(Sequel.cariIsi("SELECT dokter.nm_dokter FROM permintaan_pemeriksaan_radiologi_par INNER JOIN dokter ON permintaan_pemeriksaan_radiologi_par.kd_dokter=dokter.kd_dokter WHERE permintaan_pemeriksaan_radiologi_par.no_nota='"+TNoNota.getText()+"'"));
           KdDokLabPK.setText(Sequel.cariIsi("SELECT dokter.kd_dokter FROM permintaan_pemeriksaan_lab_par INNER JOIN dokter ON permintaan_pemeriksaan_lab_par.kd_dokter=dokter.kd_dokter WHERE permintaan_pemeriksaan_lab_par.no_nota='"+TNoNota.getText()+"'"));
           TDokterLabPK.setText(Sequel.cariIsi("SELECT dokter.nm_dokter FROM permintaan_pemeriksaan_lab_par INNER JOIN dokter ON permintaan_pemeriksaan_lab_par.kd_dokter=dokter.kd_dokter WHERE permintaan_pemeriksaan_lab_par.no_nota='"+TNoNota.getText()+"'"));
         }
    }
    ...
    private void tampilbayar(){
       Valid.tabelKosong(tabModeBillingBayar);
        try{
            psbilingbayar=koneksi.prepareStatement("SELECT no_nota,tgl_byr,no,nm_perawatan,pemisah,biaya,jumlah,tambahan,totalbiaya FROM billing_parsial WHERE no_rawat=? ");
            try {
                psbilingbayar.setString(1,TNoRw.getText().trim());
                rsbilingbayar=psbilingbayar.executeQuery();
                while(rsbilingbayar.next()){
                    tabModeBillingBayar.addRow(new Object[]{rsbilingbayar.getString(1),rsbilingbayar.getString(2),rsbilingbayar.getString(3),rsbilingbayar.getString(4),
                                                            rsbilingbayar.getString(5),rsbilingbayar.getDouble(6),rsbilingbayar.getDouble(7),rsbilingbayar.getDouble(8),
                                                            rsbilingbayar.getDouble(9)});
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
            } finally{
                if(rsbilingbayar!=null){
                    rsbilingbayar.close();
                }
            }                
