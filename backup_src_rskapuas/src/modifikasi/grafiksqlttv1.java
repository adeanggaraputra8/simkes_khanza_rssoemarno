 ...
 * @author Via
 */
public class grafiksqlttv1 extends JDialog {
  ...
  public static CategoryDataset createDataset1(
      ...
      String kolom3,
      String kolom4,
      String kolom5) { // data grafik nilai K dan D
  ...
  private static JFreeChart createChart(
    ...
    renderer5.setBaseToolTipGenerator(
        new StandardCategoryToolTipGenerator("{0}: {1} = {2}", NumberFormat.getInstance()));
    renderer5.setSeriesPaint(0, Color.LIGHT_GRAY);
    renderer5.setSeriesPaint(1, new Color(204, 204, 0));
  ...
  private static final Logger LOG = Logger.getLogger(grafiksqlttv1.class.getName());
}
