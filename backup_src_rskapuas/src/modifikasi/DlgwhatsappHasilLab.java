 ...
 * @author dosen
 */
public final class DlgwhatsappHasilLab extends javax.swing.JDialog {
    ...
    private int i=0;
    private String uri="", Nohp="",file="",uri1="",tanggal="",jam="",token="",stringbalik="Hallo, Selamat ",respon="", requestJson,requestJson1, TOKEN="", URL_media="",URL="",catat="",rsk="",poli="",antrian="", tgl="",
            isi="Yang terhormat #nama# dengan Nomor Rekam Medik #norm# Berikut Kami Kirimkan Hasil Pemeriksaan Laboratorium Anda. Pesan WhatsApp ini dikirim otomatis oleh #rs#  Terima Kasih";
    

    /** Creates new form DlgPerawatan
     * @param parent
     * @param modal */
    public DlgwhatsappHasilLab(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        token = koneksiDB.TOKENWA();
        URL= koneksiDB.URLAPIWAAPI();
        URL_media = koneksiDB.URLAPIWAAPIMEDIA();
        Nohp= koneksiDB.NOHPRS();
        uri="http://rsud-soemarno.go.id/webapps/labor/pages/upload";
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Kirim Hasil Laboratorium Via WhatsApp ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 12), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TNoOrder.setEditable(false);
        TNoOrder.setHighlighter(null);
        TNoOrder.setName("TNoOrder"); // NOI18N
        TNoOrder.setPreferredSize(new java.awt.Dimension(130, 23));
        panelGlass11.add(TNoOrder);
        TNoOrder.setBounds(730, 10, 160, 23);

        jLabel7.setText("No.Order :");
        jLabel7.setName("jLabel7"); // NOI18N
        jLabel7.setPreferredSize(new java.awt.Dimension(70, 23));
        panelGlass11.add(jLabel7);
        jLabel7.setBounds(650, 10, 70, 23);
    ...
    private void BtnKirimWAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKirimWAActionPerformed
        ...
        }else if (Sequel.cariInteger("select count(gambar_lab.lokasi_gambar) from gambar_lab inner join permintaan_lab on permintaan_lab.noorder=gambar_lab.no_permintaan AND permintaan_lab.tgl_permintaan=gambar_lab.tgl_periksa AND permintaan_lab.jam_permintaan=gambar_lab.jam where gambar_lab.no_permintaan='"+TNoOrder.getText()+"' AND gambar_lab.tgl_periksa='"+tanggal+"' AND gambar_lab.jam='"+jam+"' AND lokasi_gambar LIKE '%jpeg%' or lokasi_gambar LIKE '%pdf%' ")>=1)        
             {
            //------------------------------kirim ke WA API------------------>
             try{   
        ...
        }else if (Sequel.cariInteger("select count(gambar_lab.lokasi_gambar) from gambar_lab inner join permintaan_lab on permintaan_lab.noorder=gambar_lab.no_permintaan AND permintaan_lab.tgl_permintaan=gambar_lab.tgl_periksa AND permintaan_lab.jam_permintaan=gambar_lab.jam where gambar_lab.no_permintaan='"+TNoOrder.getText()+"' AND gambar_lab.tgl_periksa='"+tanggal+"' AND gambar_lab.jam='"+jam+"' AND lokasi_gambar LIKE '%jpg%' or lokasi_gambar LIKE '%pdf%' ")>=1)        
             {
            //------------------------------kirim ke WA API------------------>
            try{   
...
//    }
    ...
    private widget.TextBox TNoOrder;
    ...
    public void setNoRm(String noorder,String norwt,String tanggal,String jam) {        
        try {
            TNoOrder.setText(noorder);
            TNoRw.setText(norwt);
            Sequel.cariIsi("select no_rkm_medis from reg_periksa where no_rawat=? ",TNoRM,TNoRw.getText());
            TUrl.setText(Sequel.cariIsi("select gambar_lab.lokasi_gambar from gambar_lab inner join permintaan_lab on permintaan_lab.noorder=gambar_lab.no_permintaan AND permintaan_lab.tgl_permintaan=gambar_lab.tgl_periksa AND permintaan_lab.jam_permintaan=gambar_lab.jam where gambar_lab.no_permintaan='"+TNoOrder.getText()+"' AND gambar_lab.tgl_periksa='"+tanggal+"' AND gambar_lab.jam='"+jam+"' "));
