 ...
 * @author dosen
 */
public final class DlgStatusObat extends javax.swing.JDialog {
     ...
     *@param parent
     *@param modal */
    public DlgStatusObat(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,2);
        setSize(628,674);

        Object[] row={"P","Kode Status","Status"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Status Obat, Alkes & BHP Medis ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 12), new java.awt.Color(130, 100, 100))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Kd.getText().trim().equals("")){
            Valid.textKosong(Kd,"Kode Status");
        }else if(Nm.getText().trim().equals("")){
            Valid.textKosong(Nm,"Status");
        }else{
            Sequel.menyimpan("status_barang","'"+Kd.getText()+"','"+Nm.getText()+"'","Kode Status");
            BtnCariActionPerformed(evt);
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for(i=0;i<tbKamar.getRowCount();i++){ 
            if(tbKamar.getValueAt(i,0).toString().equals("true")){
                Sequel.meghapus("status_barang","kode",tbKamar.getValueAt(i,1).toString());
            }
        } 
        BtnCariActionPerformed(evt);
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(Kd.getText().trim().equals("")){
            ...
            Valid.editTable(tabMode,"status_barang","kode","?","status=?,kode=?",3,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgStatusObat dialog = new DlgStatusObat(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{   
            ps=koneksi.prepareStatement("select kode,status "+
                    " from status_barang where  kode like ? or "+
                    " status like ? order by status ");
            try {                
    ...
    public void emptTeks() {
        ...
        Nm.setText("");
        Kd.requestFocus();        
        Valid.autoNomer("status_barang","S",2,Kd);
    }
