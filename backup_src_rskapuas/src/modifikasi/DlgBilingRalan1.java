 ...
 * @author perpustakaan
 */
public class DlgBilingRalan1 extends javax.swing.JDialog {
    ...
    private String nota_jalan="",dokterrujukan="",polirujukan="",status="",biaya="",tambahan="",totals="",kdptg="",nmptg="",kd_pj="",notaralan="",centangdokterralan="",
            ...
            sqlpscariralandokter="select jns_perawatan.nm_perawatan,rawat_jl_dr.biaya_rawat as total_byrdr,"+
                    ...
                    "rawat_jl_dr.no_rawat=? and rawat_jl_dr.stts_bayar=? group by jns_perawatan.nm_perawatan",
     ...
     * @param parent
     * @param modal */
    public DlgBilingRalan1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        MnKuitansiAmb = new javax.swing.JMenuItem();
        ...
        chkBelumBayar = new widget.CekBox();
        ...
        MnKuitansiAmb.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnKuitansiAmb.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnKuitansiAmb.setText("Kuitansi Ambulasn (JKN)");
        MnKuitansiAmb.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnKuitansiAmb.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnKuitansiAmb.setIconTextGap(5);
        MnKuitansiAmb.setName("MnKuitansiAmb"); // NOI18N
        MnKuitansiAmb.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnKuitansiAmbActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnKuitansiAmb);
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-03-2021 23:54:21" }));
        ...
        chkBelumBayar.setSelected(true);
        chkBelumBayar.setText("Belum Bayar");
        chkBelumBayar.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        chkBelumBayar.setName("chkBelumBayar"); // NOI18N
        chkBelumBayar.setOpaque(false);
        chkBelumBayar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                chkBelumBayarActionPerformed(evt);
            }
        });
        panelGlass1.add(chkBelumBayar);
...
private void MnHapusTagihanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnHapusTagihanActionPerformed
    try {
        ...
        if(i>0){
             ...
             if(sukses==true){
                 if(piutang>0){
                    sukses=jur.simpanJurnal(TNoRw.getText(),"U","PEMBATALAN PIUTANG PASIEN RAWAT JALAN, DIBATALKAN OLEH "+akses.getkode());    
                 }else if(piutang<=0){
                    sukses=jur.simpanJurnal(TNoRw.getText(),"U","PEMBATALAN PEMBAYARAN PASIEN RAWAT JALAN, DIBATALKAN OLEH "+akses.getkode());    
                 } 
             }
...
//                dlgrwjl.tampil();
    ...
    private void BtnCariBayarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariBayarActionPerformed
        if(chkBelumBayar.isSelected()==true){
            tampilAkunBayar();
        }else {
    ...
    private void MnKuitansiAmbActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnKuitansiAmbActionPerformed
        ...
        Valid.MyReportqry("rptkuitansiamb.jasper", "report", "::[ Kuitansi Pelayanan Rukukan Ambulan Pasien JKN ]::",
            " SELECT jns_perawatan.nm_perawatan,jns_perawatan.total_byrdrpr, pasien.nm_pasien FROM rawat_jl_drpr " +
            ...
            " WHERE reg_periksa.no_rawat='"+TNoRw.getText()+"' AND jns_perawatan.kd_jenis_prw IN ('RJ00020','RJ00021','RJ00022','RJ00023','RJ00024','RJ00025','RJ362','RJ363','RJ364','RJ365','RJ00026','RJ00027','RJ00028','RJ00029','RJ00030','RJ00031','RJ366','RJ367','RJ368','RJ369','RJ00039','RJ00040','RJ00041','RJ00042','RJ00046','RJ00047','RJ00048','RJ00049') ",param);
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_MnKuitansiAmbActionPerformed

    private void chkBelumBayarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkBelumBayarActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_chkBelumBayarActionPerformed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgBilingRalan1 dialog = new DlgBilingRalan1(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JMenuItem MnKuitansiAmb;
    ...
    private widget.CekBox chkBelumBayar;
    ...
    public void isRawat() {
        ...
        if(chkBelumBayar.isSelected()==true){
             ...
             isHitung(); 
             status="belum";
         }else if(chkBelumBayar.isSelected()==false){
    ...
    private void prosesCariRwJlDr() {
        try{  
            ...
            try {
                ...
                if(chkBelumBayar.isSelected()==true){
                    pscariralandokter.setString(2,"Belum");
                }else {
                    pscariralandokter.setString(2,"Sudah");
                }
            ...
            try {
                ...
                if(sukses==true){
                    ...
                    if(sukses==true){
                        ...
                        if(piutang>0){
                            sukses=jur.simpanJurnal(TNoRw.getText(),"U","PIUTANG PASIEN RAWAT JALAN, DIPOSTING OLEH "+akses.getkode());
                            if(bayar>0){
