 ...
 * @author dosen
 */
public class DlgAlasan extends javax.swing.JDialog {
    ...
    /** Creates new form DlgAlasan
     * @param parent
     * @param modal */
    public DlgAlasan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{"ID","Alasan Kontrol"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Alasan Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(130, 100, 100))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Nama.getText().trim().equals("")){
            Valid.textKosong(Nama,"alasan");
        }else{
            Sequel.menyimpan("alasan_pasien","'0','"+Nama.getText()+"'","alasan");
            tampil();
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Nama.getText().trim().equals("")){
            ...
            Sequel.meghapus("alasan_pasien","id",tbkecamatan.getValueAt(tbkecamatan.getSelectedRow(),0).toString());  
            tampil();
            emptTeks();
        }
    ...
    */
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select * from alasan_pasien where alasan like ? ");
            try {
