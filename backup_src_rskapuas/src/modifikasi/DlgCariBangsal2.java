 ...
 * @author dosen
 */
public final class DlgCariBangsal2 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariBangsal2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariBangsal2 dialog = new DlgCariBangsal2(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{   
            ...
            iyem="";
            ps=koneksi.prepareStatement("select * from bangsal where bangsal.status in ('1','2') order by bangsal.nm_bangsal");
            try {
                rs=ps.executeQuery();
                while(rs.next()){
