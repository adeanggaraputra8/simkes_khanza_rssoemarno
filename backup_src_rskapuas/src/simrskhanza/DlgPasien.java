...
public class DlgPasien extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        cmbHlm.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20", "100", "200", "300", "400", "500", "1000", "Semua" }));
        ...
        DTPDaftar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-11-2022" }));
        ...
        AlamatPj.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                AlamatPjActionPerformed(evt);
            }
        });
        ...
        AlamatPj.setBounds(500, 250, 377, 23);
        ...
        ChkAlamatPJ.setBackground(new java.awt.Color(153, 255, 255));
        ...
        ChkAlamatPJ.setBounds(880, 250, 40, 30);

        jLabel43.setText("Alamat P.J. :");
        jLabel43.setName("jLabel43"); // NOI18N
        FormInput.add(jLabel43);
        jLabel43.setBounds(402, 252, 90, 23);
        ...
        PanelAccor.setBackground(new java.awt.Color(102, 255, 102));
...
private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        }else if(TNoPeserta.getText().trim().equals("")||TNoPeserta.getText().trim().equals("-")){
           JOptionPane.showMessageDialog(null,"Maaf,,, Jika No.Peserta tidak ada silahkan di isi dengan angka 0");
            TNoPeserta.requestFocus();
        }else if(TKtp.getText().trim().equals("")||TKtp.getText().trim().equals("-")){
...
private void KabupatenMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_KabupatenMouseMoved
    ...
    private void MnKartu1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnKartu1ActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            Valid.MyReportqry("rptKartuBerobat5.jasper","report","::[ Kartu Periksa Pasien ]::","select * from pasien where pasien.no_rkm_medis='"+TNo.getText()+"' ");
            this.setCursor(Cursor.getDefaultCursor());
        }
    ...
    private void MnLaporanRM2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanRM2ActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            param.put("emailrs",akses.getemailrs());   
            param.put("logo",Sequel.cariGambar("select logo from setting")); 
            Valid.MyReportqry("rptRMPP.jasper","report","::[ Lembar Rawat Jalan ]::","select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "+
                   "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"+
                   "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"+
                   "pasien.pnd, pasien.keluarga, pasien.namakeluarga,penjab.png_jawab,pasien.pekerjaanpj,"+
                   "concat(pasien.alamatpj,', ',pasien.kelurahanpj,', ',pasien.kecamatanpj,', ',pasien.kabupatenpj,', ',pasien.propinsipj) as alamatpj from pasien "+
    ...
    private void AlamatPjActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AlamatPjActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_AlamatPjActionPerformed
