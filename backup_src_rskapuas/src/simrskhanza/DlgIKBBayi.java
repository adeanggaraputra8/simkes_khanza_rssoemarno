...
public class DlgIKBBayi extends javax.swing.JDialog {
    ...
    private Period p;
    private long p2;
    private DlgCetakSHK shk=new DlgCetakSHK(null,false);
    ...
    private String pengurutan="",bulan="",tahun="",awalantahun="",awalanbulan="",posisitahun="",
            ...
            krjs2="",umribu="",umrayah="",umrplpr="",umrs1="",umrs2="", bblr="";
    ...
    private void initComponents() {
        ...
        ppSuratSHK = new javax.swing.JMenuItem();
        ppBBLR = new javax.swing.JMenuItem();
        ...
        ppSuratSHK.setBackground(new java.awt.Color(255, 255, 254));
        ppSuratSHK.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppSuratSHK.setForeground(new java.awt.Color(50, 50, 50));
        ppSuratSHK.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppSuratSHK.setText("Cetak Buktii Pelayanan SHK");
        ppSuratSHK.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppSuratSHK.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppSuratSHK.setName("ppSuratSHK"); // NOI18N
        ppSuratSHK.setPreferredSize(new java.awt.Dimension(180, 30));
        ppSuratSHK.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppSuratSHKActionPerformed(evt);
            }
        });
        Popup.add(ppSuratSHK);

        ppBBLR.setBackground(new java.awt.Color(255, 255, 254));
        ppBBLR.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppBBLR.setForeground(new java.awt.Color(50, 50, 50));
        ppBBLR.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppBBLR.setText("Set BBLR < 2500");
        ppBBLR.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppBBLR.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppBBLR.setName("ppBBLR"); // NOI18N
        ppBBLR.setPreferredSize(new java.awt.Dimension(180, 30));
        ppBBLR.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppBBLRActionPerformed(evt);
            }
        });
        Popup.add(ppBBLR);
...
private void MnKartuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnKartuActionPerformed
    ...
    private void ppSuratSHKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppSuratSHKActionPerformed
       if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data sudah habis. Tidak ada data yang bisa anda print...!!!!");
            BtnBatal.requestFocus();
        }else if(tabMode.getRowCount()!=0){
    ...
    }//GEN-LAST:event_ppSuratSHKActionPerformed

    private void ppBBLRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBBLRActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem ppBBLR;
    ...
    private javax.swing.JMenuItem ppSuratSHK;
    ...
    public void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select pasien.no_rkm_medis, pasien.nm_pasien, pasien.jk, "+
                   ...
                   "on pasien.no_rkm_medis=pasien_bayi.no_rkm_medis and pasien_bayi.penolong=pegawai.nik "+
                   "and pasien.kd_kel=kelurahan.kd_kel and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab "+
                   "where "+jkelcari+tglcari+bblr+" pasien.no_rkm_medis like '%"+TCari.getText().trim()+"%' "+
                   "or "+jkelcari+tglcari+bblr+" pasien.nm_pasien like '%"+TCari.getText().trim()+"%' "+
                   "or "+jkelcari+tglcari+bblr+" pasien.tgl_lahir like '%"+TCari.getText().trim()+"%' "+
                   "or "+jkelcari+tglcari+bblr+" pasien.namakeluarga like '%"+TCari.getText().trim()+"%' "+
                   "or "+jkelcari+tglcari+bblr+" pasien.alamat like '%"+TCari.getText().trim()+"%' "+
                   "or "+jkelcari+tglcari+bblr+" pegawai.nama like '%"+TCari.getText().trim()+"%' "+
                   "or "+jkelcari+tglcari+bblr+" pasien_bayi.diagnosa like '%"+TCari.getText().trim()+"%' "+
                   "or "+jkelcari+tglcari+bblr+" pasien.nm_ibu like '%"+TCari.getText().trim()+"%' "+
                   "or "+jkelcari+tglcari+bblr+" pasien_bayi.proses_lahir like '%"+TCari.getText().trim()+"%' "+
                   "or "+jkelcari+tglcari+bblr+" pasien_bayi.penyulit_kehamilan like '%"+TCari.getText().trim()+"%' "+
                   "or "+jkelcari+tglcari+bblr+" pasien_bayi.ketuban like '%"+TCari.getText().trim()+"%'  order by pasien.no_rkm_medis desc");
            try {
                rs=ps.executeQuery();
                while(rs.next()){
