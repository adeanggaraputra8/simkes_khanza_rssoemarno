...
public class DlgCariPeriksaLab extends javax.swing.JDialog {
    ...
    public DlgCariPeriksaLab(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"No.Rawat","Pasien","Petugas","Tgl.Periksa","Jam Periksa","Dokter Perujuk","Penanggung Jawab","Status Verifikasi"};
    ...
    private void initComponents() {
        ...
        WindowVerifikasi = new javax.swing.JDialog();
        internalFrame7 = new widget.InternalFrame();
        BtnCloseIn6 = new widget.Button();
        BtnSimpan6 = new widget.Button();
        jLabel35 = new widget.Label();
        Kdnip = new widget.TextBox();
        ...
        WindowVerifikasi.setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        WindowVerifikasi.setName("WindowVerifikasi"); // NOI18N
        WindowVerifikasi.setUndecorated(true);
        WindowVerifikasi.setResizable(false);

        internalFrame7.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Verifikasi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel35.setText("Petugas Verif :");
        jLabel35.setName("jLabel35"); // NOI18N
        internalFrame7.add(jLabel35);
        jLabel35.setBounds(0, 25, 102, 23);

        Kdnip.setHighlighter(null);
        Kdnip.setName("Kdnip"); // NOI18N
        Kdnip.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KdnipKeyPressed(evt);
            }
        });
        internalFrame7.add(Kdnip);
        Kdnip.setBounds(106, 25, 60, 23);
        ...
        internalFrame7.add(NmPetugas);
        NmPetugas.setBounds(170, 25, 220, 23);

        WindowVerifikasi.getContentPane().add(internalFrame7, java.awt.BorderLayout.CENTER);
...
private void tbDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbDokterKeyPressed
   if(tabMode.getRowCount()!=0){
            if((evt.getKeyCode()==KeyEvent.VK_ENTER)||(evt.getKeyCode()==KeyEvent.VK_UP)||(evt.getKeyCode()==KeyEvent.VK_DOWN)){
                ...
                MnVerifikasiActionPerformed(null);
            }
        }
    ...
    private void BtnSimpan6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpan6ActionPerformed
            ...
            if(tbDokter.getValueAt(tbDokter.getSelectedRow(),7).toString().equals("")){
                Sequel.menyimpantf2("verifikasi_lab","?,?,?,?,?,?","Verifikasi Lab", 6,new String[]{
                    tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString(),tbDokter.getValueAt(tbDokter.getSelectedRow(),3).toString(),
                    tbDokter.getValueAt(tbDokter.getSelectedRow(),4).toString(),Kdnip.getText(),NmPetugas.getText(),"Terverifikasi"
                });
            }else{
                JOptionPane.showMessageDialog(null,"Data Telah terverif");
            }
            tampil();
            WindowVerifikasi.dispose();
    ...
    private void KdnipKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KdnipKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_KdnipKeyPressed
 ...
 this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        if(tabMode.getRowCount()==0){
            ...
            if(tbDokter.getValueAt(tbDokter.getSelectedRow(),7).toString().equals("")){
                Kdnip.setText(akses.getkode());
                NmPetugas.setText(Sequel.cariIsi("select nama from petugas where nip='"+Kdnip.getText()+"' "));
                WindowVerifikasi.setSize(400,124);
                WindowVerifikasi.setLocationRelativeTo(internalFrame1);
                WindowVerifikasi.setVisible(true);  
            }else{
                JOptionPane.showMessageDialog(null,"Maaf, Data telah Terverif...!!!!");     
            }         
        }
        this.setCursor(Cursor.getDefaultCursor());       
    ...
    */
    ...
    private javax.swing.JDialog WindowVerifikasi;
        ...
        try {
            ...
            if(NoRawat.getText().equals("")&&kdmem.getText().equals("")&&kdptg.getText().equals("")&&TCari.getText().equals("")&&nmpnj.getText().equals("")){
                ...
                ps=koneksi.prepareStatement(
                    ...
                    "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                    "inner join dokter on periksa_lab.kd_dokter=dokter.kd_dokter where periksa_lab.kategori='PK' and "+
                    "periksa_lab.tgl_periksa between ? and ? and periksa_lab.no_rawat like ? and reg_periksa.no_rkm_medis like ? and petugas.nip like ? and penjab.png_jawab like ? and "+
                    "(pasien.nm_pasien like ? or petugas.nama like ? or reg_periksa.no_rkm_medis like ?) group by concat(periksa_lab.no_rawat,periksa_lab.tgl_periksa,periksa_lab.jam) "+
                    "order by periksa_lab.tgl_periksa desc,periksa_lab.jam desc");
            }
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabMode.addRow(new Object[]{rs.getString("no_rawat"),rs.getString("no_rkm_medis")+" "+rs.getString("nm_pasien")+" ("+kamar+" : "+namakamar+")",
                                                ...
                                                Sequel.cariIsi("select dokter.nm_dokter from dokter where dokter.kd_dokter=?",rs.getString("dokter_perujuk")),rs.getString("nm_dokter"),Sequel.cariIsi("SELECT CONCAT(vl.status,' Oleh ',vl.nama) FROM verifikasi_lab vl WHERE vl.no_rawat='"+rs.getString("no_rawat")+"' and vl.tgl_periksa='"+rs.getString("tgl_periksa")+"' AND vl.jam='"+rs.getString("jam")+"' ") });
        ...
        try {
            ...
            if(NoRawat.getText().equals("")&&kdmem.getText().equals("")&&kdptg.getText().equals("")&&TCari.getText().equals("")&&nmpnj.getText().equals("")){
                ...
                ps=koneksi.prepareStatement(
                    ...
                    "periksa_lab.no_rawat=detail_periksa_lab.no_rawat and periksa_lab.kd_jenis_prw=detail_periksa_lab.kd_jenis_prw and periksa_lab.kd_jenis_prw=jns_perawatan_lab.kd_jenis_prw and "+
                    "periksa_lab.tgl_periksa=detail_periksa_lab.tgl_periksa and periksa_lab.jam=detail_periksa_lab.jam and periksa_lab.nip=petugas.nip and reg_periksa.kd_poli=poliklinik.kd_poli "+
                    "and reg_periksa.kd_pj=penjab.kd_pj where periksa_lab.kategori='PK' and periksa_lab.tgl_periksa between ? and ? and periksa_lab.no_rawat like ? and reg_periksa.no_rkm_medis like ? and petugas.nip like ? and penjab.png_jawab like ? and "+
        ...
        try {
            ...
            if(NoRawat.getText().equals("")&&kdmem.getText().equals("")&&kdptg.getText().equals("")&&TCari.getText().equals("")&&nmpnj.getText().equals("")){
                ...
                ps=koneksi.prepareStatement(
                    ...
                    "inner join jns_perawatan_lab on jns_perawatan_lab.kd_jenis_prw=periksa_lab.kd_jenis_prw "+
                    "inner join petugas on periksa_lab.nip=petugas.nip "+
                    "where periksa_lab.kategori='PK' and periksa_lab.no_rawat like ? and reg_periksa.no_rkm_medis like ? and petugas.nip like ? and periksa_lab.tgl_periksa between ? and ? and penjab.png_jawab like ? and "+
