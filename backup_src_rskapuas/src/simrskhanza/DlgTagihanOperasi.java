...
public class DlgTagihanOperasi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TKelasRawat = new widget.TextBox();
        ...
        TPasien.setBounds(265, 10, 390, 23);
        ...
        TPenjab.setBounds(660, 10, 140, 23);

        TKelasRawat.setEditable(false);
        TKelasRawat.setHighlighter(null);
        TKelasRawat.setName("TKelasRawat"); // NOI18N
        FormInput.add(TKelasRawat);
        TKelasRawat.setBounds(800, 10, 70, 23);
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
    ...
    */
    ...
    private widget.TextBox TKelasRawat;
    ...
    public void setNoRm(String norm,String nama,String posisi){
        ...
        TPenjab.setText(Sequel.cariIsi("select png_jawab from penjab where kd_pj='"+kd_pj+"' "));
        TKelasRawat.setText("Kelas "+Sequel.cariIsi("select klsrawat from bridging_sep where no_rawat='"+norm+"' "));        
        if(status.equals("Ranap")){
