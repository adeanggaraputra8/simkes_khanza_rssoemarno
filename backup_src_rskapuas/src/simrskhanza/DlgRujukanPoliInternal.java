...
public class DlgRujukanPoliInternal extends javax.swing.JDialog {
        ...
        poli.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(poli.getTable().getSelectedRow()!= -1){   
                    ...
                    kddokter.setText(Sequel.cariIsi("select dokter.kd_dokter from dokter inner join jadwal on jadwal.kd_dokter=dokter.kd_dokter where jadwal.kd_poli = '"+kdpoli.getText()+"' order by dokter.nm_dokter limit 1 "));
    ...
    private void initComponents() {
        ...
        TRujukInternal = new widget.TextBox();
        ...
        internalFrame1.setPreferredSize(new java.awt.Dimension(875, 378));
        ...
        TDiagnosa.setBounds(72, 75, 389, 23);

        jLabel4.setText("Diagnosa :");
        jLabel4.setName("jLabel4"); // NOI18N
        FormInput.add(jLabel4);
        jLabel4.setBounds(0, 75, 70, 23);

        jLabel5.setText("Alasan rujuk :");
        jLabel5.setName("jLabel5"); // NOI18N
        FormInput.add(jLabel5);
        jLabel5.setBounds(0, 105, 70, 23);

        TRujukInternal.setHighlighter(null);
        TRujukInternal.setName("TRujukInternal"); // NOI18N
        FormInput.add(TRujukInternal);
        TRujukInternal.setBounds(72, 105, 640, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TNoRM.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("rujukan_internal_poli","?,?,?","Rujukan Sama",3,new String[]{
                ...
                Sequel.queryu2("update pemeriksaan_ralan set evaluasi=concat(evaluasi,' ',?) where no_rawat=? and nip=?",3,new String[]{
                                            TRujukInternal.getText(),TNoRw.getText(),akses.getkode()
                });
                BtnKeluarActionPerformed(evt);
            }                      
        }  
    ...
    private void BtnDokterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokterActionPerformed
        if(kdpoli.getText().equals("")||TPoli.getText().equals("")){
            JOptionPane.showMessageDialog(null,"Pilih Poli Terlebih dahulu. . .");
        }else if (kddokter.getText().equals("")||TDokter.getText().equals("")&&!kdpoli.getText().equals("")||!TPoli.getText().equals("")){
    ...
    */
    ...
    private widget.TextBox TRujukInternal;
    ...
    public void setNoRm(String norw,String norm,String namapasien,int lebar,int tinggi) {
        ...
        this.lebar=lebar;
        this.tinggi=tinggi;
        TDiagnosa.setText(Sequel.cariIsi("select penilaian from pemeriksaan_ralan where no_rawat='"+TNoRw.getText()+"' and nip='"+akses.getkode()+"'"));
    }
