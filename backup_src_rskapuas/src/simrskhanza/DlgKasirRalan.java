...
import modifikasi.DlgJadwalFisioTerapi;
import modifikasi.DlgLaporanRL312;
...
public final class DlgKasirRalan extends javax.swing.JDialog {
    private final DefaultTableModel tabModekasir,tabModekasir2,tabmode4;
    private sekuel Sequel=new sekuel();
    private validasi Valid=new validasi();
    private Connection koneksi=koneksiDB.condb();
    private PreparedStatement ps,psotomatis,psotomatis2,pskasir,pscaripiutang,psrekening,psdx,pspd;
    private ResultSet rs,rsdx,rspd,rskasir,rsrekening;
    ...
    public DlgKasirRalan(java.awt.Frame parent, boolean modal) {
        ...
        tabModekasir=new DefaultTableModel(null,new String[]{
            ...
            "Poliklinik","No.SEP Pasien JKN","Alamat","Hubungan P.J.",
        ...
        tbKasirRalan2.setDefaultRenderer(Object.class, new WarnaTableKasirRalan());
    ...
    private void initComponents() {
        ...
        MnSurveilensPoliBedah = new javax.swing.JMenuItem();
        MnResumeRawatJalan1 = new javax.swing.JMenuItem();
        MnResumeRawatJalan2 = new javax.swing.JMenuItem();
        ...
        MnRekapRMRalan = new javax.swing.JMenuItem();
        ...
        MnProtokolTerapiSaraf = new javax.swing.JMenuItem();
        ...
        ppRL312 = new javax.swing.JMenuItem();
        ...
        MnJadwalFisio = new javax.swing.JMenuItem();
        ...
        ChkAllPasien = new widget.CekBox();
        ...
        MnCatatanPersalinan.setText("Catatn Persalinan");
        ...
        MnRMRawatJalan.add(MnPenilaianPreOp);
        ...
        MnRMRawatJalan.add(MnPenilaianPreAnestesi);
        ...
        MnRMRawatJalan.add(MnUjiFungsiKFR);
        ...
        MnRMRawatJalan.add(MnPenilaianMCU);
        ...
        MnRMRawatJalan.add(MnPenilaianRisikoJatuhDewasa);
        ...
        MnRMRawatJalan.add(MnPenilaianRisikoJatuhAnak);
        ...
        MnRMRawatJalan.add(MnPenilaianTambahanGeriatri);
        ...
        MnRMRawatJalan.add(MnKonselingFarmasi);
        ...
        MnRMRawatJalan.add(MnHemodialisa);
        ...
        MnRMRawatJalan.add(ppDeteksiDIniCorona);

        MnDataRM.add(MnRMRawatJalan);

        MnSurveilensPoliBedah.setBackground(new java.awt.Color(255, 255, 254));
        MnSurveilensPoliBedah.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnSurveilensPoliBedah.setForeground(new java.awt.Color(50, 50, 50));
        MnSurveilensPoliBedah.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnSurveilensPoliBedah.setText("Surveilens Hais Bedah");
        MnSurveilensPoliBedah.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnSurveilensPoliBedah.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnSurveilensPoliBedah.setName("MnSurveilensPoliBedah"); // NOI18N
        MnSurveilensPoliBedah.setPreferredSize(new java.awt.Dimension(190, 26));
        MnSurveilensPoliBedah.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnSurveilensPoliBedahActionPerformed(evt);
            }
        });
        MnDataRM.add(MnSurveilensPoliBedah);
        ...
        MnResumeRawatJalan1.setText("Resume Rawat Jalan");
        ...
        MnDataRM.add(MnResumeRawatJalan1);

        MnResumeRawatJalan2.setBackground(new java.awt.Color(255, 255, 254));
        MnResumeRawatJalan2.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnResumeRawatJalan2.setForeground(new java.awt.Color(50, 50, 50));
        MnResumeRawatJalan2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnResumeRawatJalan2.setText("Resume Fisioterapi");
        MnResumeRawatJalan2.setActionCommand("Resume Fisio PDF");
        MnResumeRawatJalan2.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnResumeRawatJalan2.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnResumeRawatJalan2.setName("MnResumeRawatJalan2"); // NOI18N
        MnResumeRawatJalan2.setPreferredSize(new java.awt.Dimension(190, 26));
        MnResumeRawatJalan2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnResumeRawatJalan2ActionPerformed(evt);
            }
        });
        MnDataRM.add(MnResumeRawatJalan2);
        ...
        MnRekapRMRalan.setBackground(new java.awt.Color(255, 255, 254));
        MnRekapRMRalan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnRekapRMRalan.setForeground(new java.awt.Color(50, 50, 50));
        MnRekapRMRalan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnRekapRMRalan.setText("Laporan RM Ralan");
        MnRekapRMRalan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnRekapRMRalan.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnRekapRMRalan.setName("MnRekapRMRalan"); // NOI18N
        MnRekapRMRalan.setPreferredSize(new java.awt.Dimension(220, 26));
        MnRekapRMRalan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnRekapRMRalanActionPerformed(evt);
            }
        });
        MnRekap.add(MnRekapRMRalan);
        ...
        MnProtokolTerapiSaraf.setBackground(new java.awt.Color(255, 255, 254));
        MnProtokolTerapiSaraf.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnProtokolTerapiSaraf.setForeground(new java.awt.Color(50, 50, 50));
        MnProtokolTerapiSaraf.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnProtokolTerapiSaraf.setText("Protokol Terapi Poli Saraf");
        MnProtokolTerapiSaraf.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnProtokolTerapiSaraf.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnProtokolTerapiSaraf.setName("MnProtokolTerapiSaraf"); // NOI18N
        MnProtokolTerapiSaraf.setPreferredSize(new java.awt.Dimension(250, 26));
        MnProtokolTerapiSaraf.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnProtokolTerapiSarafActionPerformed(evt);
            }
        });
        jMenu4.add(MnProtokolTerapiSaraf);
        ...
        ppRL312.setBackground(new java.awt.Color(255, 255, 254));
        ppRL312.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppRL312.setForeground(new java.awt.Color(50, 50, 50));
        ppRL312.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppRL312.setText("Input Laporan Kebidanan");
        ppRL312.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppRL312.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppRL312.setName("ppRL312"); // NOI18N
        ppRL312.setPreferredSize(new java.awt.Dimension(200, 26));
        ppRL312.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppRL312BtnPrintActionPerformed(evt);
            }
        });
        MenuInputData.add(ppRL312);
        ...
        MnJadwalFisio.setBackground(new java.awt.Color(255, 255, 254));
        MnJadwalFisio.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnJadwalFisio.setForeground(new java.awt.Color(50, 50, 50));
        MnJadwalFisio.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnJadwalFisio.setText("Penjadwalan Pasien Terapi");
        MnJadwalFisio.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnJadwalFisio.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnJadwalFisio.setName("MnJadwalFisio"); // NOI18N
        MnJadwalFisio.setPreferredSize(new java.awt.Dimension(250, 28));
        MnJadwalFisio.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnJadwalFisioActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnJadwalFisio);
        ...
        TglSakit1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-11-2025" }));
        ...
        TglSakit2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-11-2025" }));
        ...
        internalFrame9.setPreferredSize(new java.awt.Dimension(516, 402));
        ...
        internalFrame9.add(scrollPane2);
        ...
        panelGlass1.add(BtnCloseIn6);

        internalFrame9.add(panelGlass1);
        panelGlass1.setBounds(10, 360, 560, 34);

        WindowRiwayatSingkat.getContentPane().add(internalFrame9, java.awt.BorderLayout.CENTER);
        ...
        ChkAllPasien.setBorder(null);
        ChkAllPasien.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ChkAllPasien.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        ChkAllPasien.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        ChkAllPasien.setName("ChkAllPasien"); // NOI18N
        ChkAllPasien.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                ChkAllPasienItemStateChanged(evt);
            }
        });
        ChkAllPasien.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ChkAllPasienActionPerformed(evt);
            }
        });
        panelGlass7.add(ChkAllPasien);

        jLabel21.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel21.setText("All Pasien");
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-11-2025" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-11-2025" }));
    ...
    private void tbKasirRalanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbKasirRalanKeyPressed
        if(tabModekasir.getRowCount()!=0){
            ...
            if(evt.getKeyCode()==KeyEvent.VK_J){
                MnJadwalFisioActionPerformed(null);
               }
            ...
            if(evt.getKeyCode()==KeyEvent.VK_L){
                ppRL312BtnPrintActionPerformed(null);
               }
            ...
            if(evt.getKeyCode()==KeyEvent.VK_B){
               if(tabModekasir.getRowCount()==0){
                    ...
                    this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                    DlgBacaanThoraxTB aplikasi=new DlgBacaanThoraxTB(null,false);
                    aplikasi.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                    aplikasi.setLocationRelativeTo(internalFrame1);
                    aplikasi.setNoRm(TNoRw.getText(),"Ralan");
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                if(Sequel.cariInteger("select count(no_rawat) from kamar_inap where no_rawat=? and TIMESTAMPDIFF(MINUTE, CONCAT(tgl_masuk,' ',jam_masuk), NOW()) >= 360",TNoRw.getText())>0){
                    ...
                    if(akses.getkode()==tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),0).toString()||Sequel.cariInteger("select count(kd_dokter) from dokter where kd_dokter='"+akses.getkode()+"' and status='1' ")==0||tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),18).toString().equals("HDL")){
                        ...
                        //dlgrwjl2.setSize(this.getWidth(), this.getHeight());
                        dlgrwjl2.setLocationRelativeTo(internalFrame1);
//                        dlgrwjl2.setLocationRelativeTo(this);
//                        this.dispose();
...
//                        Sequel.queryu("update reg_periksa set kd_dokter='"+akses.getkode()+"' where no_rawat='"+TNoRw.getText()+"' and status_lanjut='Ralan' and kd_dokter in (select kd_dokter from dokter where kd_dokter='"+akses.getkode()+"' and status='1') ");
//                        Sequel.queryu("update rawat_jl_dr,dokter set rawat_jl_dr.kd_dokter='"+akses.getkode()+"' where rawat_jl_dr.no_rawat='"+TNoRw.getText()+"' and rawat_jl_dr.kd_dokter in (select kd_dokter from dokter where kd_dokter='"+akses.getkode()+"' and status='1') ");
//                        Sequel.queryu("update rawat_jl_drpr,dokter set rawat_jl_drpr.kd_dokter='"+akses.getkode()+"' where rawat_jl_drpr.no_rawat='"+TNoRw.getText()+"' and  rawat_jl_drpr.kd_dokter in (select kd_dokter from dokter where kd_dokter='"+akses.getkode()+"' and status='1') ");
                        Valid.editTable(tabModekasir,"reg_periksa","no_rawat",TNoRw," kd_dokter='"+akses.getkode()+"'");
                        Valid.editTable(tabModekasir,"rawat_jl_dr","no_rawat",TNoRw," kd_dokter='"+akses.getkode()+"'");
                        Valid.editTable(tabModekasir,"rawat_jl_drpr","no_rawat",TNoRw," kd_dokter='"+akses.getkode()+"'");
                        dlgrwjl2.isCek();
                        dlgrwjl2.emptTeks();
                        dlgrwjl2.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                        //dlgrwjl2.setSize(this.getWidth(), this.getHeight());
    ...
    private void MnMeninggalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnMeninggalActionPerformed
        if(TNoRw.getText().trim().equals("")){
            ...
            if(Sequel.cariInteger("select count(no_rawat) from kamar_inap where no_rawat=?",TNoRw.getText())>0){
                ...
                dlgPasienMati.setNoRm(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),2).toString(),TPasienCari.getText()); 
                dlgPasienMati.isCek();
        ...
        if(tabModekasir2.getRowCount()==0){
            ...
            if(tbKasirRalan2.getSelectedRow()!= -1){
                if(Sequel.cariInteger("select count(no_rawat) from kamar_inap where no_rawat=?",tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),10).toString())>0){
                    ...
                    //dlgrwjl2.SetPj(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),17).toString());
                    dlgrwjl2.setNoRm(TNoRwCari.getText(),DTPCari1.getDate(),DTPCari2.getDate());    
                    dlgrwjl2.setVisible(true);
//                    dlgrwjl2.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
//                    dlgrwjl2.setLocationRelativeTo(internalFrame1);
//                    dlgrwjl2.SetPoli(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),13).toString());
...
//                    dlgrwjl2.setVisible(true);
    ...
    private void MnPenjualan1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenjualan1ActionPerformed
        if(tabModekasir2.getRowCount()==0){
            ...
            if(Sequel.cariInteger("select count(no_rawat) from kamar_inap where no_rawat=?",TNoRwCari.getText())>0){
                JOptionPane.showMessageDialog(null,"Maaf, Pasien sudah masuk Kamar Inap. Gunakan billing Ranap..!!!");
            }else {
                DlgPenjualan penjualan=new DlgPenjualan(null,false);
                penjualan.isCek();
    ...
    private void MnCetakBebasNarkobaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakBebasNarkobaActionPerformed
        if(TPasienCari.getText().trim().equals("")){
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                ...
                resume.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                resume.setLocationRelativeTo(internalFrame1);
                resume.setNoRm(TNoRw.getText(),TNoRMCari.getText(),TPasienCari.getText(),kddokter.getText(),TDokter.getText(),DTPCari1.getDate(),DTPCari2.getDate());
                resume.tampil();
                resume.setVisible(true);
                this.setCursor(Cursor.getDefaultCursor());
            }
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabModekasir.getRowCount()==0){
            ...
            Valid.MyReportqry("rptKasirRalan.jasper","report","::[ Data Registrasi Periksa ]::",
                    ...
                    "reg_periksa.status_bayar,reg_periksa.status_poli,reg_periksa.kd_pj,reg_periksa.kd_poli,pasien.no_tlp,pasien.no_peserta,(SELECT group_concat(dp.kd_penyakit ORDER BY dp.prioritas asc SEPARATOR ', ') " +
                    "FROM diagnosa_pasien dp " +
                    "WHERE dp.no_rawat = reg_periksa.no_rawat " +
                    "AND dp.status='Ralan') AS diagnosa "+
    ...
    private void MnSEPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSEPActionPerformed
        if(tabModekasir.getRowCount()==0){
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                ...
                dlgki.isCek();
                dlgki.setNoRm2(TNoRw.getText(),Valid.SetTgl2(Tanggal.getText()),"2. Ralan","IGDK","Unit IGD/UGD",tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),0).toString(),TNoReg.getText());
...
//                }
    ...
    private void MnBayarObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnBayarObatActionPerformed
        if(TPasienCari.getText().trim().equals("")){
            ...
            bayar.setNoRm(TNoRw.getText(),TNoRMCari.getText(),TPasienCari.getText());
            bayar.setAlwaysOnTop(false);
            bayar.setVisible(true);
        }
    }//GEN-LAST:event_MnBayarObatActionPerformed

    private void MnJadwalFisioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnJadwalFisioActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        DlgJadwalFisioTerapi jadwalterapi=new DlgJadwalFisioTerapi(null,false);
        jadwalterapi.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
        jadwalterapi.emptTeks();
        jadwalterapi.setLocationRelativeTo(internalFrame1);
        jadwalterapi.setVisible(true);
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_MnJadwalFisioActionPerformed

    private void MnSurveilensPoliBedahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSurveilensPoliBedahActionPerformed
       if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data pasien sudah habis...!!!!");
            TNoRw.requestFocus();
        }else if(TPasienCari.getText().trim().equals("")){
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                DlgSurveilens resume=new DlgSurveilens(null,false);
                resume.setNoRw(TNoRwCari.getText(),Tanggal.getText());
                resume.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                resume.setLocationRelativeTo(internalFrame1);
                resume.setVisible(true);
                this.setCursor(Cursor.getDefaultCursor());
    ...
    }//GEN-LAST:event_MnSurveilensPoliBedahActionPerformed
    ...
    private void MnResumeRawatJalan1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnResumeRawatJalan1ActionPerformed
       if(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),18).toString().equals("MAT")){
            ...
            Map<String, Object> param = new HashMap<>(); 
                ...
                param.put("carapulang",Sequel.cariIsiBanyak("SELECT IF(stts='Sudah','Atas Persetujuan Dokter',IF(stts='Dirujuk','Rujuk',IF(stts='Dirawat','MRS',''))) FROM reg_periksa WHERE no_rawat='"+TNoRwCari.getText()+"' "));
                param.put("kontrol",Sequel.cariIsiBanyak("SELECT tgl_rencana FROM bridging_surat_kontrol_bpjs WHERE no_sep='"+nosep+"'"));
                 Valid.MyReport("rptBridgingResume1.jasper","report","::[ Cetak Resume ]::",param);
       }
                        ...
                        case "Resume Fisio Terapi":
                               this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                                ...
                                Map<String, Object> param = new HashMap<>(); 
                                    ...
                                    param.put("kontrol",Sequel.cariIsiBanyak("SELECT tgl_rencana FROM bridging_surat_kontrol_bpjs WHERE no_sep='"+nosep+"'"));
                                    param.put("pemeriksaandr",Sequel.cariIsiBanyak("SELECT pr.penilaian  FROM  pemeriksaan_ralan pr WHERE pr.nip in (SELECT d.kd_dokter  FROM dokter d) and pr.no_rawat ='"+TNoRwCari.getText()+"' ORDER  BY  pr.tgl_perawatan DESC, pr.jam_rawat desc limit 1"));
                                    param.put("pemeriksaanpr",Sequel.cariIsiBanyak("SELECT pr.penilaian  FROM  pemeriksaan_ralan pr WHERE pr.nip in (SELECT p.nip FROM petugas p) and pr.no_rawat ='"+TNoRwCari.getText()+"' ORDER  BY  pr.tgl_perawatan DESC, pr.jam_rawat desc limit 1"));
                                     Valid.MyReport("rptBridgingResume2.jasper","report","::[ Cetak Resume ]::",param);
                                    this.setCursor(Cursor.getDefaultCursor());
                        break;
//                        case "Resume Petugas Fisio":
//                            nosep=Sequel.cariIsi("SELECT no_sep FROM bridging_sep WHERE no_rawat='"+TNoRwCari.getText()+"' ");
...
//                                 param1.put("norawat",TNoRwCari.getText());
//                                 param1.put("pro1",Sequel.cariIsiBanyak("SELECT concat(b.kode,' ',a.deskripsi_panjang) FROM icd9 a INNER JOIN prosedur_pasien b ON a.kode=b.kode WHERE b.no_rawat='"+TNoRwCari.getText()+"' and b.prioritas='1'"));
//                                 param1.put("pro2",Sequel.cariIsiBanyak("SELECT concat(b.kode,' ',a.deskripsi_panjang) FROM icd9 a INNER JOIN prosedur_pasien b ON a.kode=b.kode WHERE b.no_rawat='"+TNoRwCari.getText()+"' and b.prioritas='2'"));    
//                                 param1.put("pro3",Sequel.cariIsiBanyak("SELECT concat(b.kode,' ',a.deskripsi_panjang) FROM icd9 a INNER JOIN prosedur_pasien b ON a.kode=b.kode WHERE b.no_rawat='"+TNoRwCari.getText()+"' and b.prioritas='3'")); 
//                                 param1.put("pro4",Sequel.cariIsiBanyak("SELECT concat(b.kode,' ',a.deskripsi_panjang) FROM icd9 a INNER JOIN prosedur_pasien b ON a.kode=b.kode WHERE b.no_rawat='"+TNoRwCari.getText()+"' and b.prioritas='4'")); 
//                                 param1.put("pro5",Sequel.cariIsiBanyak("SELECT concat(b.kode,' ',a.deskripsi_panjang) FROM icd9 a INNER JOIN prosedur_pasien b ON a.kode=b.kode WHERE b.no_rawat='"+TNoRwCari.getText()+"' and b.prioritas='5'")); 
//                                 param1.put("pro6",Sequel.cariIsiBanyak("SELECT concat(b.kode,' ',a.deskripsi_panjang) FROM icd9 a INNER JOIN prosedur_pasien b ON a.kode=b.kode WHERE b.no_rawat='"+TNoRwCari.getText()+"' and b.prioritas='6'")); 
//                                 param1.put("pro7",Sequel.cariIsiBanyak("SELECT concat(b.kode,' ',a.deskripsi_panjang) FROM icd9 a INNER JOIN prosedur_pasien b ON a.kode=b.kode WHERE b.no_rawat='"+TNoRwCari.getText()+"' and b.prioritas='7'")); 
//                                 param1.put("pro8",Sequel.cariIsiBanyak("SELECT concat(b.kode,' ',a.deskripsi_panjang) FROM icd9 a INNER JOIN prosedur_pasien b ON a.kode=b.kode WHERE b.no_rawat='"+TNoRwCari.getText()+"' and b.prioritas='8'"));
//                                 param1.put("ttlobat",Sequel.cariIsiBanyak("select if(sum(totalbiaya)='','0',sum(totalbiaya)) from billing where no_rawat='"+TNoRwCari.getText()+"' and status='Obat'"));
//                                 param1.put("tarifrs",Sequel.cariIsiBanyak("select if(sum(totalbiaya)='','0',sum(totalbiaya)) from billing where no_rawat='"+TNoRwCari.getText()+"' and status in ('Ralan Dokter','Ralan Paramedis','Ralan Dokter Paramedis')"));
//                                 param1.put("carapulang",Sequel.cariIsiBanyak("SELECT IF(stts='Sudah','Atas Persetujuan Dokter',IF(stts='Dirujuk','Rujuk',IF(stts='Dirawat','MRS',''))) FROM reg_periksa WHERE no_rawat='"+TNoRwCari.getText()+"' "));
//                                 param1.put("kontrol",Sequel.cariIsiBanyak("SELECT tgl_rencana FROM bridging_surat_kontrol_bpjs WHERE no_sep='"+nosep+"'"));
//                                 param1.put("subjekdr",Sequel.cariIsiBanyak("SELECT pr.keluhan from reg_periksa rp INNER JOIN pemeriksaan_ralan pr on pr.no_rawat=rp.no_rawat WHERE rp.kd_poli='IRM' and pr.nip in (SELECT d.kd_dokter  FROM dokter d) and rp.no_rkm_medis='"+TNoRMCari.getText()+"' ORDER  BY  pr.tgl_perawatan DESC, pr.jam_rawat desc limit 1"));
//                                 param1.put("objekdr",Sequel.cariIsiBanyak("SELECT pr.pemeriksaan from reg_periksa rp INNER JOIN pemeriksaan_ralan pr on pr.no_rawat=rp.no_rawat WHERE rp.kd_poli='IRM' and pr.nip in (SELECT d.kd_dokter  FROM dokter d) and rp.no_rkm_medis='"+TNoRMCari.getText()+"' ORDER  BY  pr.tgl_perawatan DESC, pr.jam_rawat desc limit 1"));
//                                 param1.put("pemeriksaandr",Sequel.cariIsiBanyak("SELECT pr.penilaian from reg_periksa rp INNER JOIN pemeriksaan_ralan pr on pr.no_rawat=rp.no_rawat WHERE rp.kd_poli='IRM' and pr.nip in (SELECT d.kd_dokter  FROM dokter d) and rp.no_rkm_medis='"+TNoRMCari.getText()+"' ORDER  BY  pr.tgl_perawatan DESC, pr.jam_rawat desc limit 1"));
//                                 param1.put("plandr",Sequel.cariIsiBanyak("SELECT pr.rtl from reg_periksa rp INNER JOIN pemeriksaan_ralan pr on pr.no_rawat=rp.no_rawat WHERE rp.kd_poli='IRM' and pr.nip in (SELECT d.kd_dokter  FROM dokter d) and rp.no_rkm_medis='"+TNoRMCari.getText()+"' ORDER  BY  pr.tgl_perawatan DESC, pr.jam_rawat desc limit 1"));
...
//                                 param1.put("pemeriksaanpr",Sequel.cariIsiBanyak("SELECT pr.penilaian  FROM  pemeriksaan_ralan pr WHERE pr.nip in (SELECT p.nip FROM petugas p) and pr.no_rawat ='"+TNoRwCari.getText()+"' ORDER  BY  pr.tgl_perawatan DESC, pr.jam_rawat desc limit 1"));
...
//                        break;
    ...
    }//GEN-LAST:event_MnResumeRawatJalan2ActionPerformed
    ...
    private void MnTampilDiagnosaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnTampilDiagnosaActionPerformed
        ...
        for(i=0;i<row;i++){
            try{
                ...
                dxralan="";
                try {
                    psdx.setString(1,tbKasirRalan.getValueAt(i,11).toString());
                ...
                tbKasirRalan.setValueAt(dxralan,i,7);
            } catch(Exception e){
                System.out.println("Notifikasi : "+e);
            }
         try{
    ...
    private void ppRL312BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppRL312BtnPrintActionPerformed
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data pasien sudah habis...!!!!");
            TNoRw.requestFocus();
        }else if(TPasienCari.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            DlgLaporanRL312 aplikasi=new DlgLaporanRL312(null,false);
            aplikasi.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            aplikasi.setLocationRelativeTo(internalFrame1);
            aplikasi.setNoRm(TNoRw.getText());
            aplikasi.setVisible(true);
            this.setCursor(Cursor.getDefaultCursor());
        } 
    }//GEN-LAST:event_ppRL312BtnPrintActionPerformed
    ...
    private void MnRekapRMRalanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRekapRMRalanActionPerformed
     if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TNoReg.requestFocus();
        }else{
            Valid.panggilUrl("billing/Laporanrmralan.php?tanggal1="+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"&tanggal2="+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"&usere="+koneksiDB.USERHYBRIDWEB()+"&passwordte="+koneksiDB.PASHYBRIDWEB());                       
        }
    }//GEN-LAST:event_MnRekapRMRalanActionPerformed

    private void ChkAllPasienItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_ChkAllPasienItemStateChanged
        if ((Sequel.cariInteger("select count(kd_dokter) from dokter where kd_dokter='"+akses.getkode()+"' ")>0)|| akses.getkode().equals("Admin Utama")){
            if (ChkAllPasien.isSelected()==true){
                CrPtg.setText("");
            ...
            ChkAllPasien.setSelected(false);
            ChkAllPasien.setVisible(false);
        }
    }//GEN-LAST:event_ChkAllPasienItemStateChanged

    private void ChkAllPasienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkAllPasienActionPerformed
        if ((Sequel.cariInteger("select count(kd_dokter) from dokter where kd_dokter='"+akses.getkode()+"' ")>0)|| akses.getkode().equals("Admin Utama")){
            if (ChkAllPasien.isSelected()==true){
                CrPtg.setText("");
                BtnSeek3.setVisible(true);
    ...
    }//GEN-LAST:event_ChkAllPasienActionPerformed

    private void tbKasirRalanKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbKasirRalanKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_tbKasirRalanKeyReleased

    private void MnProtokolTerapiSarafActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnProtokolTerapiSarafActionPerformed
     ...
     this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        ...
        param.put("logo2",Sequel.cariGambar("select logo from setting"));
        param.put("norawat",TNoRwCari.getText());
        param.put("uraianpenunjang",Sequel.cariIsiBanyak("SELECT pr.keluhan  FROM  pemeriksaan_ralan pr WHERE pr.nip in (SELECT p.nip FROM petugas p) and pr.no_rawat ='"+TNoRwCari.getText()+"' ORDER  BY  pr.tgl_perawatan DESC, pr.jam_rawat desc limit 1"));
        param.put("pemeriksaanpenunjang",Sequel.cariIsiBanyak("SELECT pr.pemeriksaan  FROM  pemeriksaan_ralan pr WHERE pr.nip in (SELECT p.nip FROM petugas p) and pr.no_rawat ='"+TNoRwCari.getText()+"' ORDER  BY  pr.tgl_perawatan DESC, pr.jam_rawat desc limit 1"));
        param.put("diagnosakerja",Sequel.cariIsiBanyak("SELECT pr.penilaian  FROM  pemeriksaan_ralan pr WHERE pr.nip in (SELECT d.kd_dokter  FROM dokter d) and pr.no_rawat ='"+TNoRwCari.getText()+"' ORDER  BY  pr.tgl_perawatan DESC, pr.jam_rawat desc limit 1"));
        param.put("terapi",Sequel.cariIsiBanyak("SELECT pr.rtl  FROM  pemeriksaan_ralan pr WHERE pr.nip in (SELECT d.kd_dokter  FROM dokter d) and pr.no_rawat ='"+TNoRwCari.getText()+"' ORDER  BY  pr.tgl_perawatan DESC, pr.jam_rawat desc limit 1"));
        Valid.MyReport("rptProtokolTerapi.jasper","report","::[ Cetak Lembar Protokol Terapi ]::",param);
                    
     this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_MnProtokolTerapiSarafActionPerformed
    ...
    private void ppSkriningManagerPelayananPasienBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppSkriningManagerPelayananPasienBtnPrintActionPerformed
        if(tabModekasir.getRowCount()==0){
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                ...
                aplikasi.isCek();
                aplikasi.tampil();
                aplikasi.setNoRm(TNoRwCari.getText(),DTPCari1.getDate());
                aplikasi.setVisible(true);
                this.setCursor(Cursor.getDefaultCursor());
            }
        }
                ...
                try {
                    ...
                    try {
                        ...
                        if(rs.next()){
                            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                            BPJSSuratKontrol form=new BPJSSuratKontrol(null,false);
                            form.setNoRm(tbkembali.getValueAt(tbkembali.getSelectedRow(), 4).toString(),rs.getString("no_sep"),rs.getString("no_kartu"),TNoRMCari.getText(),TPasienCari.getText(),rs.getString("tanggal_lahir"),rs.getString("jkel"),rs.getString("nmdiagnosaawal"));
                            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                            form.setLocationRelativeTo(internalFrame1);
                            form.setVisible(true);
                            this.setCursor(Cursor.getDefaultCursor());
    ...
    */
    ...
    private widget.CekBox ChkAllPasien;
    ...
    private javax.swing.JMenuItem MnJadwalFisio;
    ...
    private javax.swing.JMenuItem MnProtokolTerapiSaraf;
    ...
    private javax.swing.JMenuItem MnRekapRMRalan;
    ...
    private javax.swing.JMenuItem MnResumeRawatJalan2;
    ...
    private javax.swing.JMenuItem MnSurveilensPoliBedah;
    ...
    private javax.swing.JMenuItem ppRL312;
    ...
    private void tampilkasir() {     
        ...
        try{   
            ...
            pskasir=koneksi.prepareStatement("select reg_periksa.no_reg,reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.jam_reg,"+
                "reg_periksa.kd_dokter,dokter.nm_dokter,reg_periksa.no_rkm_medis,pasien.nm_pasien,poliklinik.nm_poli,"+
                "IF(bridging_sep.no_rawat=reg_periksa.no_rawat,bridging_sep.no_sep,'Non JKN') nosep,pasien.alamat,reg_periksa.hubunganpj,reg_periksa.biaya_reg,reg_periksa.stts,penjab.png_jawab,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur, "+
    ...
    public void isCek(){
       MnRawatJalan1.setEnabled(akses.gettindakan_ralan());
        ...
        if(akses.getkode().equals("Admin Utama")){
            ...
            MnRiwayatPerawatanICareNoKartu.setEnabled(true);
            MnRiwayatPerawatanICareNIK.setEnabled(true);
            
        }else{
            MnHapusData.setEnabled(false);
              MnRiwayatPerawatanICareNoKartu.setEnabled(false);
              MnRiwayatPerawatanICareNIK.setEnabled(false);
        } 
    ...
    private void tampilriwayat(){
        Valid.tabelKosong(tabmode4);   
           try {
                ps = koneksi.prepareStatement("SELECT pasien.nm_pasien,reg_periksa.tgl_registrasi, poliklinik.nm_poli,reg_periksa.status_lanjut,reg_periksa.no_rawat FROM pasien " +
                        "INNER JOIN reg_periksa ON reg_periksa.no_rkm_medis=pasien.no_rkm_medis " +
    ...
    private void tampilassesmen(){
        if(tbKasirRalan.getSelectedRow()!= -1){
            ...
            for(i=0;i<row;i++){
                try{
                    psdx=koneksi.prepareStatement("SELECT dp.penilaian  FROM  pemeriksaan_ralan dp WHERE  dp.no_rawat=? AND  dp.nip in (select kd_dokter from dokter) ");
                    dxralan="";
                    try {
                        psdx.setString(1,tbKasirRalan.getValueAt(i,11).toString());
                        rsdx=psdx.executeQuery();
                        while(rsdx.next()){
                            dxralan=rsdx.getString("penilaian");
                        }
                    } catch (Exception e) {
                        System.out.println("Notifikasi : "+e);
                    } finally{
                    ...
                    tbKasirRalan.setValueAt(dxralan,i,6);
                } catch(Exception e){
                    System.out.println("Notifikasi : "+e);
                }
            }
