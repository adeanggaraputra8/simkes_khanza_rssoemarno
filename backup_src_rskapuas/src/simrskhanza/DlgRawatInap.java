...
import fungsi.WarnaTablePemeriksaanInap;
...
public final class DlgRawatInap extends javax.swing.JDialog {
    ...
    public DlgRawatInap(java.awt.Frame parent, boolean modal) {
        ...
        for (i = 0; i < 25; i++) {
         ...
         try {
            ...
            if(prop.getProperty("AKTIFWARNASOAPI").equals("yes")){
                tbPemeriksaan.setDefaultRenderer(Object.class, new WarnaTablePemeriksaanInap());
            }else{
            ...
            public void windowClosed(WindowEvent e) {
                if(akses.getform().equals("DlgKamarInap")){
                    if(kamar2.getTable().getSelectedRow()!= -1){   
                        TkdKamar.setText(kamar2.getTable().getValueAt(kamar2.getTable().getSelectedRow(),1).toString());  
                        TkdBangsal.setText(kamar2.getTable().getValueAt(kamar2.getTable().getSelectedRow(),2).toString());
                        TnmBangsal.setText(kamar2.getTable().getValueAt(kamar2.getTable().getSelectedRow(),3).toString());
                    }  
                    BtnSeekBangsal.requestFocus();
                }
            }
            @Override
            public void windowIconified(WindowEvent e) {}
    ...
    private void initComponents() {
        ...
        MnTindakanOtomatis = new javax.swing.JMenuItem();
        MnGrafikTTV = new javax.swing.JMenuItem();
        jPopupMenu3 = new javax.swing.JPopupMenu();
        MnTindakanOtomatisPtgs = new javax.swing.JMenuItem();
        jPopupMenu4 = new javax.swing.JPopupMenu();
        MnTindakanOtomatisDrPtg = new javax.swing.JMenuItem();
        ...
        BtnSeekBangsal = new widget.Button();
        ...
        BtnPemberianInjeksi = new widget.Button();
        ...
        MnTindakanOtomatis.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnTindakanOtomatis.setForeground(new java.awt.Color(70, 70, 70));
        MnTindakanOtomatis.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnTindakanOtomatis.setText("Set Tindakan Otomatis Dr");
        MnTindakanOtomatis.setToolTipText("");
        MnTindakanOtomatis.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnTindakanOtomatis.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnTindakanOtomatis.setName("MnTindakanOtomatis"); // NOI18N
        MnTindakanOtomatis.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnTindakanOtomatisActionPerformed(evt);
            }
        });
        jPopupMenu2.add(MnTindakanOtomatis);

        MnGrafikTTV.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnGrafikTTV.setForeground(new java.awt.Color(70, 70, 70));
        MnGrafikTTV.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnGrafikTTV.setText("Grafik TTV");
        MnGrafikTTV.setToolTipText("");
        MnGrafikTTV.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnGrafikTTV.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnGrafikTTV.setName("MnGrafikTTV"); // NOI18N
        MnGrafikTTV.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnGrafikTTVActionPerformed(evt);
            }
        });
        jPopupMenu2.add(MnGrafikTTV);

        jPopupMenu3.setName("jPopupMenu3"); // NOI18N

        MnTindakanOtomatisPtgs.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnTindakanOtomatisPtgs.setForeground(new java.awt.Color(70, 70, 70));
        MnTindakanOtomatisPtgs.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnTindakanOtomatisPtgs.setText("Set Tindakan Otomatis Ptgs");
        MnTindakanOtomatisPtgs.setToolTipText("");
        MnTindakanOtomatisPtgs.setActionCommand("Set Tindakan Otomatis Petugas");
        MnTindakanOtomatisPtgs.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnTindakanOtomatisPtgs.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnTindakanOtomatisPtgs.setName("MnTindakanOtomatisPtgs"); // NOI18N
        MnTindakanOtomatisPtgs.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnTindakanOtomatisPtgsActionPerformed(evt);
            }
        });
        jPopupMenu3.add(MnTindakanOtomatisPtgs);

        jPopupMenu4.setName("jPopupMenu4"); // NOI18N

        MnTindakanOtomatisDrPtg.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnTindakanOtomatisDrPtg.setForeground(new java.awt.Color(70, 70, 70));
        MnTindakanOtomatisDrPtg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnTindakanOtomatisDrPtg.setText("Set Tindakan Otomatis Dr $ Ptgs");
        MnTindakanOtomatisDrPtg.setToolTipText("");
        MnTindakanOtomatisDrPtg.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnTindakanOtomatisDrPtg.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnTindakanOtomatisDrPtg.setName("MnTindakanOtomatisDrPtg"); // NOI18N
        MnTindakanOtomatisDrPtg.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnTindakanOtomatisDrPtgActionPerformed(evt);
            }
        });
        jPopupMenu4.add(MnTindakanOtomatisDrPtg);

        TkdBangsal.setEditable(false);
        TkdBangsal.setHighlighter(null);
        ...
        Scroll1.setComponentPopupMenu(jPopupMenu3);
        ...
        Scroll2.setComponentPopupMenu(jPopupMenu4);
        ...
        cmbKesadaran.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Compos Mentis", "Apatis", "Delirium", "Somnolence", "Sopor", "Coma" }));
        ...
        jLabel18.setText("Kamar/Bangsal :");
        jLabel18.setName("jLabel18"); // NOI18N
        FormInput.add(jLabel18);
        jLabel18.setBounds(940, 10, 80, 23);
        ...
        TkdKamar.setBounds(1030, 10, 70, 23);

        TnmBangsal.setEditable(false);
        TnmBangsal.setHighlighter(null);
        TnmBangsal.setName("TnmBangsal"); // NOI18N
        FormInput.add(TnmBangsal);
        TnmBangsal.setBounds(1100, 10, 170, 23);

        BtnSeekBangsal.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnSeekBangsal.setMnemonic('5');
        BtnSeekBangsal.setToolTipText("ALt+5");
        BtnSeekBangsal.setName("BtnSeekBangsal"); // NOI18N
        BtnSeekBangsal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnSeekBangsalActionPerformed(evt);
            }
        });
        FormInput.add(BtnSeekBangsal);
        BtnSeekBangsal.setBounds(1270, 10, 28, 23);
        ...
        BtnPemberianInjeksi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnPemberianInjeksi.setText("Pemberian Injeksi");
        BtnPemberianInjeksi.setFocusPainted(false);
        BtnPemberianInjeksi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnPemberianInjeksi.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnPemberianInjeksi.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnPemberianInjeksi.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnPemberianInjeksi.setName("BtnPemberianInjeksi"); // NOI18N
        BtnPemberianInjeksi.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnPemberianInjeksi.setRoundRect(false);
        BtnPemberianInjeksi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPemberianInjeksiActionPerformed(evt);
            }
        });
        FormMenu.add(BtnPemberianInjeksi);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        }else if(((TkdKamar.getText().trim().equals(""))||(TkdBangsal.getText().trim().equals(""))||(TnmBangsal.getText().trim().equals("")))){
            Valid.textKosong(TkdBangsal,"Bangsal");
            BtnSeekBangsal.requestFocus();
        }else{
                ...
                case 0:
                    if(KdDok.getText().trim().equals("")||TDokter.getText().trim().equals("")){
                        ...
                        if(Sequel.cariRegistrasi(TNoRw.getText().trim())>0){
                            ...
                            cektindakan=Sequel.cariInteger("select jumlah from batas_tindakan_ranap btr where btr.kode='"+TKdPrw.getText()+"' ");
                             if((Sequel.cariInteger("SELECT COUNT(rwjd.kd_jenis_prw) FROM rawat_inap_dr rwjd INNER JOIN batas_tindakan_ranap btr on btr.kode=rwjd.kd_jenis_prw where rwjd.kd_jenis_prw='"+TKdPrw.getText()+"' and rwjd.tgl_perawatan='"+Valid.SetTgl(DTPTgl.getSelectedItem()+"")+"' and rwjd.no_rawat='"+TNoRw.getText()+"' ")<cektindakan)&&!akses.getkode().equals("Admin Utama")) {                        
                                    ...
                                    if(Sequel.menyimpantf("rawat_inap_dr","?,?,?,?,?,?,?,?,?,?,?","Data",11,new String[]{
                                        ...
                                        //menyimpan ke bangsalnya
                                            Sequel.menyimpantf("rawat_inap_dr_bangsal","?,?,?,?,?,?,?,?,?,?,?,?,?","Data",13,new String[]{
                                            TNoRw.getText(),TKdPrw.getText(),KdDok.getText(),Valid.SetTgl(DTPTgl.getSelectedItem()+""),
                                            cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem(),
                                            BagianRS.getText(),Bhp.getText(),JmDokter.getText(),KSO.getText(),Menejemen.getText(),TTnd.getText(),TkdKamar.getText(),TkdBangsal.getText()
                                    });
                            ...
                            }else if (cektindakan==0 || akses.getkode().equals("Admin Utama")){
                                    Sequel.AutoComitFalse();
                                    sukses=true;
                                    if(Sequel.menyimpantf("rawat_inap_dr","?,?,?,?,?,?,?,?,?,?,?","Data",11,new String[]{
                                        TNoRw.getText(),TKdPrw.getText(),KdDok.getText(),Valid.SetTgl(DTPTgl.getSelectedItem()+""),
                              ...
                              JOptionPane.showMessageDialog(null, "Maaf, batas input tindakan melebihi aturan tarif perbup. . .!");
                               sukses=false;
                            }
                ...
                case 1:
                    if(kdptg.getText().trim().equals("")||TPerawat.getText().trim().equals("")){                              
                        ...
                        if(Sequel.cariRegistrasi(TNoRw.getText().trim())>0){
                          ...
                          cektindakan=Sequel.cariInteger("select jumlah from batas_tindakan_ranap btr where btr.kode='"+TKdPrwPetugas.getText()+"' ");
                          if((Sequel.cariInteger("SELECT COUNT(rwjd.kd_jenis_prw) FROM rawat_inap_pr rwjd INNER JOIN batas_tindakan_ranap btr on btr.kode=rwjd.kd_jenis_prw where rwjd.kd_jenis_prw='"+TKdPrwPetugas.getText()+"' and rwjd.tgl_perawatan='"+Valid.SetTgl(DTPTgl.getSelectedItem()+"")+"' and rwjd.no_rawat='"+TNoRw.getText()+"' ")<cektindakan)&&!akses.getkode().equals("Admin Utama")) {  
                              Sequel.AutoComitFalse();
                                sukses=true;
                                if(Sequel.menyimpantf("rawat_inap_pr","?,?,?,?,?,?,?,?,?,?,?","Data",11,new String[]{
                                    ...
                                    //menyinpan bangsal
                                        ...
                                        Sequel.menyimpantf("rawat_inap_pr_bangsal","?,?,?,?,?,?,?,?,?,?,?,?,?","Data",13,new String[]{
                                        TNoRw.getText(),TKdPrwPetugas.getText(),kdptg.getText(),Valid.SetTgl(DTPTgl.getSelectedItem()+""),
                                        cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem(),
                                        BagianRS.getText(),Bhp.getText(),JmPerawat.getText(),KSO.getText(),Menejemen.getText(),TTnd.getText(),TkdKamar.getText(),TkdBangsal.getText()
                                    });
                                    Sequel.queryu("delete from tampjurnal");    
                                    if(Valid.SetAngka(TTnd.getText())>0){
                                        Sequel.menyimpan("tampjurnal","'"+Suspen_Piutang_Tindakan_Ranap+"','Suspen Piutang Tindakan Ranap','"+TTnd.getText()+"','0'","debet=debet+'"+(TTnd.getText())+"'","kd_rek='"+Suspen_Piutang_Tindakan_Ranap+"'");  
                ...
                case 2:
                    if(KdDok2.getText().trim().equals("")||TDokter2.getText().trim().equals("")){                              
                        ...
                        if(Sequel.cariRegistrasi(TNoRw.getText().trim())>0){
                          ...
                          cektindakan=Sequel.cariInteger("select jumlah from batas_tindakan_ranap btr where btr.kode='"+TKdPrwDokterPetugas.getText()+"' ");
                          if((Sequel.cariInteger("SELECT COUNT(rwjd.kd_jenis_prw) FROM rawat_inap_drpr rwjd INNER JOIN batas_tindakan_ranap btr on btr.kode=rwjd.kd_jenis_prw where rwjd.kd_jenis_prw='"+TKdPrwDokterPetugas.getText()+"' and rwjd.tgl_perawatan='"+Valid.SetTgl(DTPTgl.getSelectedItem()+"")+"' and rwjd.no_rawat='"+TNoRw.getText()+"' ")<cektindakan)&&!akses.getkode().equals("Admin Utama")) {
                                  ...
                                  if(Sequel.menyimpantf("rawat_inap_drpr","?,?,?,?,?,?,?,?,?,?,?,?,?","Data",13,new String[]{
                                      ...
                                      //meyimpan bangsalnya
                                      Sequel.menyimpantf("rawat_inap_drpr_bangsal","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",15,new String[]{
                                      TNoRw.getText(),TKdPrwDokterPetugas.getText(),KdDok2.getText(),kdptg2.getText(),Valid.SetTgl(DTPTgl.getSelectedItem()+""),
                                      cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem(),
                                      BagianRS.getText(),Bhp.getText(),JmDokter.getText(),JmPerawat.getText(),KSO.getText(),Menejemen.getText(),TTnd.getText(),TkdKamar.getText(),TkdBangsal.getText()
                                  });
                                      Sequel.queryu("delete from tampjurnal");
                                      if(Valid.SetAngka(TTnd.getText())>0){
                                          Sequel.menyimpan("tampjurnal","'"+Suspen_Piutang_Tindakan_Ranap+"','Suspen Piutang Tindakan Ranap','"+TTnd.getText()+"','0'","debet=debet+'"+(TTnd.getText())+"'","kd_rek='"+Suspen_Piutang_Tindakan_Ranap+"'");  
                        ...
                        if(tbRawatDr.getValueAt(i,0).toString().equals("true")){
                            if(Sequel.cariRegistrasi(tbRawatDr.getValueAt(i,1).toString())>0){
                                ...
                                if(Sequel.queryutf("delete from rawat_inap_dr where no_rawat='"+tbRawatDr.getValueAt(i,1).toString()+
                                    ...
                                    Sequel.queryutf("delete from rawat_inap_dr_bangsal where no_rawat='"+tbRawatDr.getValueAt(i,1).toString()+
                                        "' and kd_jenis_prw='"+tbRawatDr.getValueAt(i,10)+
                                        "' and kd_dokter='"+tbRawatDr.getValueAt(i,5).toString()+
                                        "' and tgl_perawatan='"+tbRawatDr.getValueAt(i,7).toString()+
                        ...
                        if(tbRawatPr.getValueAt(i,0).toString().equals("true")){
                            if(Sequel.cariRegistrasi(tbRawatPr.getValueAt(i,1).toString())>0){
                                ...
                                if(Sequel.queryutf("delete from rawat_inap_pr where no_rawat='"+tbRawatPr.getValueAt(i,1).toString()+
                                    ...
                                    Sequel.queryutf("delete from rawat_inap_pr_bangsal where no_rawat='"+tbRawatPr.getValueAt(i,1).toString()+
                                        "' and kd_jenis_prw='"+tbRawatPr.getValueAt(i,10)+
                                        "' and nip='"+tbRawatPr.getValueAt(i,5).toString()+
                                        "' and tgl_perawatan='"+tbRawatPr.getValueAt(i,7).toString()+
                        ...
                        if(tbRawatDrPr.getValueAt(i,0).toString().equals("true")){
                            if(Sequel.cariRegistrasi(tbRawatDrPr.getValueAt(i,1).toString())>0){
                                ...
                                if(Sequel.queryutf("delete from rawat_inap_drpr where no_rawat='"+tbRawatDrPr.getValueAt(i,1).toString()+
                                    ...
                                    Sequel.queryutf("delete from rawat_inap_drpr_bangsal where no_rawat='"+tbRawatDrPr.getValueAt(i,1).toString()+
                                        "' and kd_jenis_prw='"+tbRawatDrPr.getValueAt(i,12)+
                                        "' and kd_dokter='"+tbRawatDrPr.getValueAt(i,5).toString()+
                                        "' and nip='"+tbRawatDrPr.getValueAt(i,7).toString()+
                                        "' and tgl_perawatan='"+tbRawatDrPr.getValueAt(i,9).toString()+
                        ...
                        if(tbRawatDr.getSelectedRow()>-1){
                            if(Sequel.cariRegistrasi(tbRawatDr.getValueAt(tbRawatDr.getSelectedRow(),1).toString())>0){
                                ...
                                if(Sequel.mengedittf("rawat_inap_dr","no_rawat='"+tbRawatDr.getValueAt(tbRawatDr.getSelectedRow(),1)+
                                    ...
                                    Sequel.mengedittf("rawat_inap_dr_bangsal","no_rawat='"+tbRawatDr.getValueAt(tbRawatDr.getSelectedRow(),1)+
                                        "' and kd_jenis_prw='"+tbRawatDr.getValueAt(tbRawatDr.getSelectedRow(),10)+  
                                        "' and kd_dokter='"+tbRawatDr.getValueAt(tbRawatDr.getSelectedRow(),5)+
                                        "' and tgl_perawatan='"+tbRawatDr.getValueAt(tbRawatDr.getSelectedRow(),7)+
                                        "' and jam_rawat='"+tbRawatDr.getValueAt(tbRawatDr.getSelectedRow(),8)+"'",
                                        ...
                                        "',bhp='"+Bhp.getText()+"',tarif_tindakandr='"+JmDokter.getText()+"',biaya_rawat='"+TTnd.getText()+
                                        "',tgl_perawatan='"+Valid.SetTgl(DTPTgl.getSelectedItem()+"")+"',jam_rawat='"+cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem()+"',"+
                                        "kso='"+KSO.getText()+"',menejemen='"+Menejemen.getText()+"',kd_kamar='"+TkdKamar.getText()+"',kd_bangsal='"+TkdBangsal.getText()+"' ");
                        ...
                        if(tbRawatPr.getSelectedRow()>-1){
                            if(Sequel.cariRegistrasi(tbRawatPr.getValueAt(tbRawatPr.getSelectedRow(),1).toString())>0){
                                ...
                                if(Sequel.mengedittf("rawat_inap_pr","no_rawat='"+tbRawatPr.getValueAt(tbRawatPr.getSelectedRow(),1)+
                                    ...
                                    Sequel.mengedittf("rawat_inap_pr_bangsal","no_rawat='"+tbRawatPr.getValueAt(tbRawatPr.getSelectedRow(),1)+
                                        "' and kd_jenis_prw='"+tbRawatPr.getValueAt(tbRawatPr.getSelectedRow(),10)+
                                        "' and nip='"+tbRawatPr.getValueAt(tbRawatPr.getSelectedRow(),5)+
                                        "' and tgl_perawatan='"+tbRawatPr.getValueAt(tbRawatPr.getSelectedRow(),7)+
                                        "' and jam_rawat='"+tbRawatPr.getValueAt(tbRawatPr.getSelectedRow(),8)+"'",
                        ...
                        if(tbRawatDrPr.getSelectedRow()>-1){
                            if(Sequel.cariRegistrasi(tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),1).toString())>0){
                                ...
                                if(Sequel.mengedittf("rawat_inap_drpr","no_rawat='"+tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),1)+
                                    ...
                                    Sequel.mengedittf("rawat_inap_drpr_bangsal","no_rawat='"+tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),1)+
                                        "' and kd_jenis_prw='"+tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),12)+
                                        "' and kd_dokter='"+tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),5)+
                                        "' and nip='"+tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),7)+
                                        "' and tgl_perawatan='"+tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),9)+
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void btnTindakanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTindakanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(Sequel.cariRegistrasi(TNoRw.getText())>0){
                ...
                perawatan.setKamar1(TkdKamar.getText());
                akses.setform("DlgRawatInap");
                perawatan.emptTeks();
                perawatan.isCek();
                perawatan.tampil();
    ...
    private void MnTindakanOtomatisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnTindakanOtomatisActionPerformed
        if(Sequel.cariRegistrasi(TNoRw.getText().trim())>0){
            JOptionPane.showMessageDialog(rootPane,"Data billing sudah terverifikasi.\nSilahkan hubungi bagian kasir/keuangan ..!!");
        }else if(KdDok.getText().trim().equals("")||TDokter.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih Dokter...!!!");
        }else if(Sequel.cariIsiAngka("SELECT COUNT(set_otomatis_tindakan_ranap.kd_bangsal) FROM set_otomatis_tindakan_ranap INNER JOIN kamar ON kamar.kd_bangsal=set_otomatis_tindakan_ranap.kd_bangsal INNER JOIN kamar_inap ON kamar_inap.kd_kamar=kamar.kd_kamar WHERE kamar_inap.no_rawat='"+TNoRw.getText()+"'")==0){
            JOptionPane.showMessageDialog(null,"Maaf, Tindakan Otomatis Belum Di mapping pada Bangsal...!!!");
        }else {

            if(Sequel.cariIsiAngka("select count(no_rawat) from rawat_inap_dr where "+
                "no_rawat='"+TNoRw.getText()+"' and tgl_perawatan='"+Valid.SetTgl(DTPTgl.getSelectedItem()+"")+"' ")==0){
            try {
                psotomatis=koneksi.prepareStatement(sqlpsotomatis);
                try {
                    psotomatis.setString(1,Sequel.cariIsi("SELECT kamar.kd_bangsal FROM kamar_inap INNER JOIN kamar ON kamar.kd_kamar=kamar_inap.kd_kamar WHERE kamar_inap.no_rawat=?",TNoRw.getText()));
                    ...
                    while(rskasir.next()){
                        ...
                        try {
                            ...
                            psotomatis2.setString(3,KdDok.getText());
                            psotomatis2.setString(4,Valid.SetTgl(DTPTgl.getSelectedItem()+""));
            ...
            JOptionPane.showMessageDialog(null, "Maaf, Cara Ini hanya bisa digunakan dalam 1 hari sekali.. !!");
        }
        }
    }//GEN-LAST:event_MnTindakanOtomatisActionPerformed

    private void MnTindakanOtomatisPtgsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnTindakanOtomatisPtgsActionPerformed
        if(Sequel.cariRegistrasi(TNoRw.getText().trim())>0){
            JOptionPane.showMessageDialog(rootPane,"Data billing sudah terverifikasi.\nSilahkan hubungi bagian kasir/keuangan ..!!");
        }else if(kdptg.getText().trim().equals("")||TPerawat.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih Petugas...!!!");
        }else if(Sequel.cariIsiAngka("SELECT COUNT(set_otomatis_tindakan_ranap_petugas.kd_bangsal) FROM set_otomatis_tindakan_ranap_petugas INNER JOIN kamar ON kamar.kd_bangsal=set_otomatis_tindakan_ranap_petugas.kd_bangsal INNER JOIN kamar_inap ON kamar_inap.kd_kamar=kamar.kd_kamar WHERE kamar_inap.no_rawat='"+TNoRw.getText()+"'")==0){
            JOptionPane.showMessageDialog(null,"Maaf, Tindakan Otomatis Belum Di mapping pada Bangsal...!!!");
        }else {

            if(Sequel.cariIsiAngka("select count(no_rawat) from rawat_inap_pr where "+
                "no_rawat='"+TNoRw.getText()+"' and tgl_perawatan='"+Valid.SetTgl(DTPTgl.getSelectedItem()+"")+"' ")==0){
            try {
                ...
                try {
                    ...
                    while(rskasir.next()){
                        ...
                        try {
                            psotomatis2.setString(1,TNoRw.getText());
                            psotomatis2.setString(2,rskasir.getString(1));
                            psotomatis2.setString(3,kdptg.getText());
                            psotomatis2.setString(4,Valid.SetTgl(DTPTgl.getSelectedItem()+""));
                            psotomatis2.setString(5,Sequel.cariIsi("select current_time()"));
                            psotomatis2.setDouble(6,rskasir.getDouble("material"));
                            psotomatis2.setDouble(7,rskasir.getDouble("bhp"));
    ...
    }//GEN-LAST:event_MnTindakanOtomatisPtgsActionPerformed

    private void MnTindakanOtomatisDrPtgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnTindakanOtomatisDrPtgActionPerformed
        if(Sequel.cariRegistrasi(TNoRw.getText().trim())>0){
            JOptionPane.showMessageDialog(rootPane,"Data billing sudah terverifikasi.\nSilahkan hubungi bagian kasir/keuangan ..!!");
        }else if(KdDok2.getText().trim().equals("")||TDokter2.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih Dokter...!!!");
        }else if(kdptg2.getText().trim().equals("")||TPerawat2.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih Petugas...!!!");
        }else if(Sequel.cariIsiAngka("SELECT COUNT(set_otomatis_tindakan_ranap_dokterpetugas.kd_bangsal) FROM set_otomatis_tindakan_ranap_dokterpetugas INNER JOIN kamar ON kamar.kd_bangsal=set_otomatis_tindakan_ranap_dokterpetugas.kd_bangsal INNER JOIN kamar_inap ON kamar_inap.kd_kamar=kamar.kd_kamar WHERE kamar_inap.no_rawat='"+TNoRw.getText()+"'")==0){
            JOptionPane.showMessageDialog(null,"Maaf, Tindakan Otomatis Belum Di mapping pada Bangsal...!!!");
        }else {

            if(Sequel.cariIsiAngka("select count(no_rawat) from rawat_inap_drpr where "+
                "no_rawat='"+TNoRw.getText()+"' and tgl_perawatan='"+Valid.SetTgl(DTPTgl.getSelectedItem()+"")+"' ")==0){
            try {
                ...
                try {
                    ...
                    while(rskasir.next()){
                        ...
                        try {
                            psotomatis2.setString(1,TNoRw.getText());
                            psotomatis2.setString(2,rskasir.getString(1));
                            psotomatis2.setString(3,KdDok2.getText());
                            psotomatis2.setString(4,kdptg2.getText());
                            psotomatis2.setString(5,Valid.SetTgl(DTPTgl.getSelectedItem()+""));
    ...
    }//GEN-LAST:event_MnTindakanOtomatisDrPtgActionPerformed

    private void BtnSeekBangsalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSeekBangsalActionPerformed
    ...
    }//GEN-LAST:event_BtnSeekBangsalActionPerformed

    private void MnGrafikTTVActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnGrafikTTVActionPerformed
           grafiksqlttv1 kas = new grafiksqlttv1("Grafik TTV Pasien " + TPasien.getText(),
                    "select DATE_FORMAT(tgl_perawatan , '%d/%m/%Y') as tgl,jam_rawat,COALESCE(NULLIF(replace(replace(suhu_tubuh,',','.'),' ',''), ''), '0') as suhu_tubuh,COALESCE(NULLIF(nadi, ''), '0') AS nadi,COALESCE(NULLIF(respirasi, ''), '0') AS respirasi,COALESCE(NULLIF(spo2, ''), '0') AS spo2,SUBSTRING_INDEX(replace(tensi, '-','0'), '/', 1) AS sistole,SUBSTRING_INDEX(replace(tensi, '-','0'), '/', -1) AS diastole from pemeriksaan_ranap where no_rawat='" + TNoRw.
    ...
    private void BtnPemberianInjeksiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPemberianInjeksiActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{            
            if(Sequel.cariRegistrasi(TNoRw.getText())>0){
                ...
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                RMDataPemberianObatInjeksi dlgrjk=new RMDataPemberianObatInjeksi(null,false);
                dlgrjk.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
                dlgrjk.setLocationRelativeTo(internalFrame1);
                dlgrjk.emptTeks();
                dlgrjk.isCek();
                dlgrjk.setNoRm(TNoRw.getText(),DTPCari1.getDate());
                dlgrjk.tampil();
                dlgrjk.setVisible(true);
                this.setCursor(Cursor.getDefaultCursor());
            }            
    ...
    */
    ...
    private widget.Button BtnPemberianInjeksi;
    ...
    private widget.Button BtnSeekBangsal;
    ...
    private javax.swing.JMenuItem MnGrafikTTV;
    private javax.swing.JMenuItem MnTindakanOtomatis;
    private javax.swing.JMenuItem MnTindakanOtomatisDrPtg;
    private javax.swing.JMenuItem MnTindakanOtomatisPtgs;
    ...
    private void getDataDr() {
        if(tbRawatDr.getSelectedRow()!= -1){
            ...
            TkdKamar.setText(Sequel.cariIsi("select ridr.kd_kamar from rawat_inap_dr_bangsal ridr INNER JOIN rawat_inap_dr ridrb ON ridr.no_rawat=ridrb.no_rawat AND ridr.tgl_perawatan=ridrb.tgl_perawatan AND ridr.jam_rawat=ridrb.jam_rawat  where ridr.no_rawat='"+tbRawatDr.getValueAt(tbRawatDr.getSelectedRow(),1).toString()+"' AND ridrb.tgl_perawatan='"+tbRawatDr.getValueAt(tbRawatDr.getSelectedRow(),7).toString()+"' AND ridrb.jam_rawat='"+tbRawatDr.getValueAt(tbRawatDr.getSelectedRow(),8).toString()+"' order by ridr.tgl_perawatan DESC, ridr.jam_rawat DESC limit 1 "));
    ...
    private void getDataPr() {
        if(tbRawatPr.getSelectedRow()!= -1){
            ...
            TkdKamar.setText(Sequel.cariIsi("select ridr.kd_kamar from rawat_inap_pr_bangsal ridr INNER JOIN rawat_inap_pr ridrb ON ridr.no_rawat=ridrb.no_rawat AND ridr.tgl_perawatan=ridrb.tgl_perawatan AND ridr.jam_rawat=ridrb.jam_rawat  where ridr.no_rawat='"+tbRawatPr.getValueAt(tbRawatPr.getSelectedRow(),1).toString()+"' AND ridrb.tgl_perawatan='"+tbRawatPr.getValueAt(tbRawatPr.getSelectedRow(),7).toString()+"' AND ridrb.jam_rawat='"+tbRawatPr.getValueAt(tbRawatPr.getSelectedRow(),8).toString()+"' order by ridr.tgl_perawatan DESC, ridr.jam_rawat DESC limit 1 "));
            TkdBangsal.setText(Sequel.cariIsi("select kd_bangsal from kamar where kd_kamar='"+TkdKamar.getText()+"' "));
            TnmBangsal.setText(Sequel.cariIsi("select nm_bangsal from bangsal where kd_bangsal='"+TkdBangsal.getText()+"' "));
            isJns();
        }
    ...
    private void getDataDrPr() {
        if(tbRawatDrPr.getSelectedRow()!= -1){
            ...
            TkdKamar.setText(Sequel.cariIsi("select ridr.kd_kamar from rawat_inap_drpr_bangsal ridr INNER JOIN rawat_inap_drpr ridrb ON ridr.no_rawat=ridrb.no_rawat AND ridr.tgl_perawatan=ridrb.tgl_perawatan AND ridr.jam_rawat=ridrb.jam_rawat  where ridr.no_rawat='"+tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),1).toString()+"' AND ridrb.tgl_perawatan='"+tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),9).toString()+"' AND ridrb.jam_rawat='"+tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),10).toString()+"' order by ridr.tgl_perawatan DESC, ridr.jam_rawat DESC limit 1 "));
            TkdBangsal.setText(Sequel.cariIsi("select kd_bangsal from kamar where kd_kamar='"+TkdKamar.getText()+"' "));
            TnmBangsal.setText(Sequel.cariIsi("select nm_bangsal from bangsal where kd_bangsal='"+TkdBangsal.getText()+"' "));
            isJns();
        }
    ...
    private void getDataPemeriksaan() {
        if(tbPemeriksaan.getSelectedRow()!= -1){
            if(akses.getkode().equals("Admin Utama")|| Sequel.cariInteger("select kd_dokter from dokter where kd_dokter='"+KdPeg.getText()+"' ")>0){
    ...
    public void setKamar1(String kdkamr) {
