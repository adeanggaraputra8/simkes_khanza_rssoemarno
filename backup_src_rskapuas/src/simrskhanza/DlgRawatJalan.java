...
public final class DlgRawatJalan extends javax.swing.JDialog {
    private final DefaultTableModel tabModeDr,tabModePr,tabModeDrPr,tabModeRiwayat,
    ...
    private int i=0,jmlparsial=0,jml=0,index=0,tinggi=0, z=0,cektindakan=0;
    ...
    public DlgRawatJalan(java.awt.Frame parent, boolean modal) {
        ...
        try {
            ...
            if(prop.getProperty("AKTIFWARNASOAPI").equals("yes")){
                tbPemeriksaan.setDefaultRenderer(Object.class, new WarnaTablePemeriksaan());
            }else{
        ...
        tbriwayat.setCellSelectionEnabled(true);
        tbriwayat.setRowSelectionAllowed(true);
        tbriwayat.setColumnSelectionAllowed(true);
...
//        });
    ...
    private void initComponents() {
        ...
        TNamaPegawai = new widget.TextBox();
        ...
        jLabel15.setBounds(604, 10, 40, 23);
        ...
        TAlergi.setBounds(653, 10, 220, 23);
        ...
        jLabel37.setText("Dilakukan Oleh :");
        jLabel37.setName("jLabel37"); // NOI18N
        panelGlass12.add(jLabel37);
        jLabel37.setBounds(910, 10, 80, 23);
        ...
        TNamaPegawai.setEditable(false);
        TNamaPegawai.setHighlighter(null);
        TNamaPegawai.setName("TNamaPegawai"); // NOI18N
        panelGlass12.add(TNamaPegawai);
        TNamaPegawai.setBounds(990, 10, 212, 23);
        ...
        Scroll1.setBounds(910, 40, 490, 200);
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-04-2026" }));
        ...
        BtnPermintaanRanap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnPermintaanRanap.setText("Permintaan/Pengantar Ranap");
        BtnPermintaanRanap.setFocusPainted(false);
        BtnPermintaanRanap.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnPermintaanRanap.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnPermintaanRanap.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnPermintaanRanap.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnPermintaanRanap.setName("BtnPermintaanRanap"); // NOI18N
        BtnPermintaanRanap.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnPermintaanRanap.setRoundRect(false);
        BtnPermintaanRanap.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPermintaanRanapActionPerformed(evt);
            }
        });
        FormMenu.add(BtnPermintaanRanap);
...
//                break;
    ...
    private void BtnKeluarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKeluarActionPerformed
        ...
        dokter.dispose();
        pasien.dispose();
        if(akses.getkode().equals("Admin Utama")||(Sequel.cariInteger("select count(kd_dokter) from dokter where kd_dokter = '"+akses.getkode()+"' "))>0){
                 String options[]={"Sudah Dilayani","Dirujuk","Abaikan"};     
         try {
             i=JOptionPane.showOptionDialog(null,"Pilih Cara Pulang Pasien","Konfirmasi",JOptionPane.YES_NO_CANCEL_OPTION,JOptionPane.QUESTION_MESSAGE,null,options,null);
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void BtnSKDPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSKDPActionPerformed
      if(TNoRw.getText().trim().equals("")){
            ...
            if(Sequel.cariInteger("select count(no_rawat) from kamar_inap where no_rawat=?",TNoRw.getText())>0){
                JOptionPane.showMessageDialog(null,"Maaf, Pasien sudah masuk Kamar Inap. Gunakan billing Ranap..!!!");
            }else if(Sequel.cariInteger("select no_sep,no_kartu,tanggal_lahir,jkel,nmdiagnosaawal from bridging_sep where no_rawat='"+TNoRw.getText()+"' ")>0) {
                   try {
    ...
    private void Btn5SoapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn5SoapActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            ...
            soapterakhir.setPoli(TNoRw.getText(),TNoRM.getText(),"Ralan");
...
//        }
    ...
    private void BtnPermintaanRanapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPermintaanRanapActionPerformed
          if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{      
            if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",TNoRw.getText())>0){
               ...
               this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                form.setLocationRelativeTo(internalFrame1);
                form.setNoRm(TNoRw.getText(),TNoRM.getText(),TPasien.getText(),TDokter.getText(),Sequel.cariIsi("SELECT png_jawab FROM penjab inner join reg_periksa on reg_periksa.kd_pj=penjab.kd_pj WHERE reg_periksa.no_rawat='"+TNoRw.getText()+"'"),Sequel.cariIsi("SELECT nm_poli FROM poliklinik inner join reg_periksa on reg_periksa.kd_poli=poliklnik.kd_poli WHERE reg_periksa.no_rawat='"+TNoRw.getText()+"'"),Sequel.cariIsi("SELECT no_tlp FROM pasien WHERE no_rkm_medis='"+TNoRM.getText()+"' "));
                form.setVisible(true);
                this.setCursor(Cursor.getDefaultCursor());
            }          
        }
    }//GEN-LAST:event_BtnPermintaanRanapActionPerformed
    ...
    private void tbriwayatMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbriwayatMouseClicked
         if(evt.getClickCount() == 2){
            ...
            int col = tbriwayat.getSelectedColumn();

            if(row != -1 && col != -1){

                String data = tbriwayat.getValueAt(row, col).toString();

                switch(col){
                    case 2: // Keluhan
                        appendText(TKeluhan, data);
                        break;
                    case 3: // Pemeriksaan
                        appendText(TPemeriksaan, data);
                        break;
                    case 4: // Penilaian
                        appendText(TPenilaian, data);
                        break;
                    case 5: // Plan
                        appendText(TindakLanjut, data);
                        break;
                    case 6: // Instruksi
                        appendText(TInstruksi, data);
                        break;
                    case 7: // Evaluasi
                        appendText(TEvaluasi, data);
                        break;
                }
            }
        }
    ...
    */
    ...
    private widget.TextBox TNamaPegawai;
    ...
    private void getDataPemeriksaan() {
        if(tbPemeriksaan.getSelectedRow()!= -1){
            ...
            TNamaPegawai.setText(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),24).toString());
        }
    }
...
//                break;
    ...
    private void SimpanPenangananDokter(){        
        try {
            ...
            Sequel.AutoComitFalse();
            sukses=true;
            ttljmdokter=0;ttlkso=0;ttlpendapatan=0;ttljasasarana=0;ttlbhp=0;ttlmenejemen=0;cektindakan=0;
            for(i=0;i<tbTindakan.getRowCount();i++){ 
                if(tbTindakan.getValueAt(i,0).toString().equals("true")){
                    cektindakan=Sequel.cariInteger("select jumlah from batas_tindakan_ralan btr where btr.kode='"+tbTindakan.getValueAt(i, 1).toString()+"' ");
                    if((Sequel.cariInteger("SELECT COUNT(rwjd.kd_jenis_prw) FROM rawat_jl_dr rwjd INNER JOIN batas_tindakan_ralan btr on btr.kode=rwjd.kd_jenis_prw where rwjd.kd_jenis_prw='"+tbTindakan.getValueAt(i, 1).toString()+"' and rwjd.no_rawat='"+TNoRw.getText()+"' ")<cektindakan)&&!akses.getkode().equals("Admin Utama")) {
    ...
    private void SimpanPenangananPetugas(){
        try {
            ...
            Sequel.AutoComitFalse();
            sukses=true;
            ttljmperawat=0;ttlkso=0;ttlpendapatan=0;ttljasasarana=0;ttlbhp=0;ttlmenejemen=0;cektindakan=0;
            for(i=0;i<tbTindakan2.getRowCount();i++){ 
                if(tbTindakan2.getValueAt(i,0).toString().equals("true")){  
                    cektindakan=Sequel.cariInteger("select jumlah from batas_tindakan_ralan btr where btr.kode='"+tbTindakan2.getValueAt(i, 1).toString()+"' ");
                    if((Sequel.cariInteger("SELECT COUNT(rwjd.kd_jenis_prw) FROM rawat_jl_pr rwjd INNER JOIN batas_tindakan_ralan btr on btr.kode=rwjd.kd_jenis_prw where rwjd.kd_jenis_prw='"+tbTindakan2.getValueAt(i, 1).toString()+"' and rwjd.no_rawat='"+TNoRw.getText()+"' ")<cektindakan)&&!akses.getkode().equals("Admin Utama")) {
    ...
    private void SimpanPenangananDokterPetugas(){        
        try {
            ...
            Sequel.AutoComitFalse();
            sukses=true;
            ttljmdokter=0;ttljmperawat=0;ttlkso=0;ttlpendapatan=0;ttljasasarana=0;ttlbhp=0;ttlmenejemen=0;cektindakan=0;
            for(i=0;i<tbTindakan3.getRowCount();i++){ 
                if(tbTindakan3.getValueAt(i,0).toString().equals("true")){  
                    cektindakan=Sequel.cariInteger("select jumlah from batas_tindakan_ralan btr where btr.kode='"+tbTindakan3.getValueAt(i, 1).toString()+"' ");
                    if((Sequel.cariInteger("SELECT COUNT(rwjd.kd_jenis_prw) FROM rawat_jl_drpr rwjd INNER JOIN batas_tindakan_ralan btr on btr.kode=rwjd.kd_jenis_prw where rwjd.kd_jenis_prw='"+tbTindakan3.getValueAt(i, 1).toString()+"' and rwjd.no_rawat='"+TNoRw.getText()+"' ")<cektindakan)&&!akses.getkode().equals("Admin Utama")) {
    ...
    private void tampilriwayat() {
         ...
         this.poli=Sequel.cariIsi("select kd_poli from reg_periksa where no_rawat='"+TNoRw.getText()+"' ");
            try{
                ps=koneksi.prepareStatement(
                        ...
                        "reg_periksa.no_rkm_medis=? and pemeriksaan_ralan.nip in (select kd_dokter from dokter) "+
        ...
        private void appendText(TextArea field, String data){
            String lama = field.getText().trim();

            if(lama.isEmpty()){
                field.setText(data);
            }else{
                // hindari duplikat
                if(!lama.contains(data)){
                    field.setText(lama + ", " + data);
                }
            }
        }
    }
