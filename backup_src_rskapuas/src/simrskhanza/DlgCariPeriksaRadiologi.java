...
public class DlgCariPeriksaRadiologi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ppKirimWAHasil = new javax.swing.JMenuItem();
        ppPeriksaRadiologi = new javax.swing.JMenuItem();
        ...
        ppKirimWAHasil.setBackground(new java.awt.Color(255, 255, 254));
        ppKirimWAHasil.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppKirimWAHasil.setForeground(new java.awt.Color(50, 50, 50));
        ppKirimWAHasil.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppKirimWAHasil.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppKirimWAHasil.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppKirimWAHasil.setLabel("Kirim Berkas Hasil Via WA");
        ppKirimWAHasil.setName("ppKirimWAHasil"); // NOI18N
        ppKirimWAHasil.setPreferredSize(new java.awt.Dimension(190, 26));
        ppKirimWAHasil.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppKirimWAHasilBtnPrintActionPerformed(evt);
            }
        });
        jPopupMenu1.add(ppKirimWAHasil);

        ppPeriksaRadiologi.setBackground(new java.awt.Color(255, 255, 254));
        ppPeriksaRadiologi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppPeriksaRadiologi.setForeground(new java.awt.Color(50, 50, 50));
        ppPeriksaRadiologi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppPeriksaRadiologi.setText("Cetak Periksa Radiologi");
        ppPeriksaRadiologi.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppPeriksaRadiologi.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppPeriksaRadiologi.setName("ppPeriksaRadiologi"); // NOI18N
        ppPeriksaRadiologi.setPreferredSize(new java.awt.Dimension(190, 26));
        ppPeriksaRadiologi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppPeriksaRadiologiBtnPrintActionPerformed(evt);
            }
        });
        jPopupMenu1.add(ppPeriksaRadiologi);
        ...
        panelGlass8.add(BtnCloseIn5);

        internalFrame6.add(panelGlass8, java.awt.BorderLayout.PAGE_END);
        ...
        Scroll6.setViewportView(HasilPeriksa1);

        internalFrame6.add(Scroll6, java.awt.BorderLayout.CENTER);
        ...
        jLabel18.setBounds(780, 10, 90, 23);

        nmpnj.setEditable(false);
        nmpnj.setName("nmpnj"); // NOI18N
        panelisi3.add(nmpnj);
        nmpnj.setBounds(870, 10, 140, 23);
        ...
        btnPenjab.setBounds(1010, 10, 28, 23);
...
private void tbDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbDokterKeyPressed
   if(tabMode.getRowCount()!=0){
    ...
    private void ppKirimWAHasilBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppKirimWAHasilBtnPrintActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data sudah habis...!!!!");
            TCari.requestFocus();
            ...
            DlgwhatsappHasilRad wahasil=new DlgwhatsappHasilRad (null,false);
            wahasil.setNoRm(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString(),
                tbDokter.getValueAt(tbDokter.getSelectedRow(),3).toString(),
                tbDokter.getValueAt(tbDokter.getSelectedRow(),4).toString());
            wahasil.setSize(this.getWidth()-20,this.getHeight()-20);
            wahasil.setLocationRelativeTo(this);
            wahasil.setVisible(true);
        }
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_ppKirimWAHasilBtnPrintActionPerformed
    ...
    private void BtnPrint2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint2ActionPerformed
        if(Kd2.getText().equals("")){
            ...
            param.put("kontakrs",akses.getkontakrs());
            param.put("emailrs",akses.getemailrs());
            param.put("hasil",HasilPeriksa1.getText());
    ...
    private void ppPeriksaRadiologiBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppPeriksaRadiologiBtnPrintActionPerformed
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data sudah habis. Tidak ada data yang bisa anda print...!!!!");
            BtnCari.requestFocus();
        }else{
            Map<String, Object> param6 = new HashMap<>();    
             param6.put("namars",akses.getnamars());
             param6.put("alamatrs",akses.getalamatrs());
             param6.put("kotars",akses.getkabupatenrs());
             param6.put("propinsirs",akses.getpropinsirs());
             param6.put("kontakrs",akses.getkontakrs());
             param6.put("emailrs",akses.getemailrs());   
             param6.put("logo",Sequel.cariGambar("select logo from setting")); 
             this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
             Valid.MyReportqry("rptDataPeriksaRadiologi1.jasper","report","::[ Data Periksa Radilogi ]::",
                        "SELECT rp.no_rawat,rp.no_rkm_medis,p.nm_pasien,pr.tgl_periksa,jpr.nm_perawatan " +
                        ...
                        "WHERE pr.tgl_periksa BETWEEN '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' and jpr.nm_perawatan LIKE '%"+TCari.getText().trim()+"%' ",param6);  
              this.setCursor(Cursor.getDefaultCursor());
        }
    }//GEN-LAST:event_ppPeriksaRadiologiBtnPrintActionPerformed
            ...
            if(Kd2.getText().equals("")||Petugas.getText().equals("")){
                ...
                try {
                    ...
                    try {
                        ...
                        while(rs5.next()){
                            HasilPeriksa1.setText(rs5.getString("hasil"));
                        }
                    } catch (Exception e) {
    ...
    */
    ...
    private javax.swing.JMenuItem ppKirimWAHasil;
    private javax.swing.JMenuItem ppPeriksaRadiologi;
    ...
    private void tampil() {
        try {
            ...
            if(NoRawat.getText().equals("")&&kdmem.getText().equals("")&&kdptg.getText().equals("")&&TCari.getText().equals("")&&nmpnj.getText().equals("")){
                ps=koneksi.prepareStatement(
                        "select periksa_radiologi.no_rawat,reg_periksa.no_rkm_medis,concat(pasien.nm_pasien,' (',pasien.jk,')') as nm_pasien,petugas.nama,periksa_radiologi.tgl_periksa,"+
                ...
                ps=koneksi.prepareStatement(
                        ...
                        "and petugas.nip like ? and penjab.png_jawab like ? and (pasien.nm_pasien like ? or petugas.nama like ? or reg_periksa.no_rkm_medis like ? or jns_perawatan_radiologi.nm_perawatan like ?  ) "+
