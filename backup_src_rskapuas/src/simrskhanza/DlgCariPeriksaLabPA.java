        ...
        try {
            ...
            if(NoRawat.getText().equals("")&&kdmem.getText().equals("")&&kdptg.getText().equals("")&&TCari.getText().equals("")&&nmpnj.getText().equals("")){
                ...
                ps=koneksi.prepareStatement(
                    ...
                    "inner join jns_perawatan_lab on periksa_lab.kd_jenis_prw=jns_perawatan_lab.kd_jenis_prw "+
                    "inner join dokter on periksa_lab.kd_dokter=dokter.kd_dokter where periksa_lab.kategori='PA' and "+
                    "periksa_lab.tgl_periksa between ? and ? and periksa_lab.no_rawat like ? and reg_periksa.no_rkm_medis like ? and petugas.nip like ? and penjab.png_jawab like ? "+
        ...
        try {
            ...
            if(NoRawat.getText().equals("")&&kdmem.getText().equals("")&&kdptg.getText().equals("")&&TCari.getText().equals("")&&nmpnj.getText().equals("")){
                ...
                ps=koneksi.prepareStatement(
                    ...
                    "inner join petugas on periksa_lab.nip=petugas.nip "+
                    "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                    "where periksa_lab.kategori='PA' and periksa_lab.no_rawat like ? and reg_periksa.no_rkm_medis like ? and petugas.nip like ? and periksa_lab.tgl_periksa between ? and ? and penjab.png_jawab like ? and "+
