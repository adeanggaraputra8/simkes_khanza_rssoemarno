...
import modifikasi.DlgAlasan;
import modifikasi.DlgTerapi_Pasien;
...
public class DlgSKDPBPJS extends javax.swing.JDialog {
    ...
    private DlgAlasan alasan=new DlgAlasan(null, false);
    private DlgTerapi_Pasien terapi=new DlgTerapi_Pasien(null, false);
    ...
    public DlgSKDPBPJS(java.awt.Frame parent, boolean modal) {
        ...
        alasan.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {}
            @Override
            public void windowClosing(WindowEvent e) {}
            @Override
            public void windowClosed(WindowEvent e) {
                if(alasan.getTable().getSelectedRow()!= -1){                    
                    Alasan1.setText(alasan.getTable().getValueAt(alasan.getTable().getSelectedRow(),1).toString());
                    alasan.requestFocus();
                }   
            }
            @Override
        ...
        terapi.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(terapi.getTable().getSelectedRow()!= -1){                    
                    Terapi.setText(terapi.getTable().getValueAt(terapi.getTable().getSelectedRow(),1).toString());
                    terapi.requestFocus();
                }   
            }
            @Override
    ...
    private void initComponents() {
        ...
        MnSurat.setForeground(new java.awt.Color(130, 100, 100));
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ SKDP BPJS ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 12), new java.awt.Color(130, 100, 100))); // NOI18N
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-04-2019" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-04-2019" }));
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-04-2019" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-04-2019" }));
        ...
        Status.setBounds(660, 10, 110, 23);
        ...
        BtnDokter.setBounds(350, 130, 28, 23);

        jLabel37.setText("Status :");
        jLabel37.setName("jLabel37"); // NOI18N
        FormInput.add(jLabel37);
        jLabel37.setBounds(590, 10, 60, 23);
        ...
        BtnPoli.setBounds(710, 130, 28, 23);
        ...
        Alasan1.setText("Keperluan pemantauan efek terapi");
        ...
        Alasan1.setBounds(96, 70, 250, 23);
        ...
        Alasan2.setBounds(470, 70, 266, 23);
        ...
        jLabel15.setBounds(201, 160, 80, 23);
        ...
        NoSurat.setBounds(285, 160, 90, 23);

        Diagnosa.setText("Z09.8");
        ...
        Diagnosa.setBounds(100, 40, 279, 23);
        ...
        Terapi.setText("Konseling lanjutan");
        ...
        Terapi.setBounds(474, 40, 230, 23);
        ...
        BtnAlasan.setBounds(350, 70, 28, 23);
        ...
        BtnTerapi.setBounds(710, 40, 28, 23);

        jLabel19.setText("No.Reg :");
        jLabel19.setName("jLabel19"); // NOI18N
        FormInput.add(jLabel19);
        jLabel19.setBounds(375, 160, 95, 23);

        TanggalSurat.setForeground(new java.awt.Color(50, 70, 50));
        TanggalSurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-04-2019 09:45:51" }));
        ...
        TanggalPeriksa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-04-2019 09:45:51" }));
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptSKDPBPJS.jasper","report","::[ Laporan Daftar SKDP BPJS ]::",
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    private void MnSuratActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSuratActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            if(tbObat.getSelectedRow()!= -1){
                ...
                Valid.MyReportqry("rptSKDP2.jasper","report","::[ Surat SKDP BPJS ]::",
                    "select * from temporary_booking_registrasi order by no asc",param); 
                this.setCursor(Cursor.getDefaultCursor());
            }else{
                JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih terlebih dulu data yang mau anda hapus...\n Klik data pada table untuk memilih data...!!!!");
    ...
    akses.setform("DlgSKDPBPJS");
    alasan.setSize(internalFrame1.getWidth()-40,internalFrame1.getHeight()-40);
    alasan.setLocationRelativeTo(internalFrame1);
    alasan.setVisible(true);   
    ...
    if(evt.getKeyCode()==KeyEvent.VK_SPACE){
      BtnAlasanActionPerformed(null);
    }else{
        Valid.pindah(evt,BtnTerapi,Alasan2);
    }       
    ...
    private void BtnTerapiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTerapiActionPerformed
     akses.setform("DlgSKDPBPJS");
     terapi.setSize(internalFrame1.getWidth()-40,internalFrame1.getHeight()-40);
    ...
    private void BtnTerapiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnTerapiKeyPressed
      if(evt.getKeyCode()==KeyEvent.VK_SPACE){
      BtnTerapiActionPerformed(null);
    }else{
        Valid.pindah(evt,Diagnosa,BtnAlasan);
    }     
