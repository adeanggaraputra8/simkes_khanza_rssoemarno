                        ...
                        try {
                            ...
                            while(rssep.next()){
                                tabMode.addRow(new Object[]{
                                    rssep.getString(1),rssep.getString(2),rssep.getString("nomr"),rssep.getString("nama_pasien"), rssep.getString(3),rssep.getString(4),
                                    ...
                                    rssep.getString(13),rssep.getString(14),rssep.getString(15),rssep.getString(16),
                                    rssep.getString("lakalantas"),rssep.getString("keterangankkl"),rssep.getString(19),rssep.getString(20),
                                    rssep.getString(21),rssep.getString(22),rssep.getString(23),rssep.getString("tglpulang"),
                                    rssep.getString("asal_rujukan"),rssep.getString("eksekutif"),rssep.getString("cob"),rssep.getString("peserta"),
                                    rssep.getString("notelep"),
