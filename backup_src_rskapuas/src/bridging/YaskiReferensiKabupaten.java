...
public final class YaskiReferensiKabupaten extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pencarian Data Referensi Kabupaten YASKI ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(70, 70, 70))); // NOI18N
        ...
        jLabel16.setText("Cari Kabupaten :");
    ...
    */
    ...
    public void tampil(String poli) {
        try {
            ...
            root = mapper.readTree(rest.exchange("https://dev.farizdotid.com/api/daerahindonesia/kota?id_provinsi="+KdProp.getText(), HttpMethod.GET, requestEntity, String.class).getBody());
                Valid.tabelKosong(tabMode);
                response = root.path("kota_kabupaten");
                if(response.isArray()){
                    i=1;
