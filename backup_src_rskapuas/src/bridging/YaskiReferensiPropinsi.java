...
public final class YaskiReferensiPropinsi extends javax.swing.JDialog {
   ...
   public void tampil(String poli) {
        try {
            ...
            if(Propinsi.getText().trim().equals("")){
                root = mapper.readTree(rest.exchange("https://dev.farizdotid.com/api/daerahindonesia/provinsi/", HttpMethod.GET, requestEntity, String.class).getBody());
                Valid.tabelKosong(tabMode);
                response = root.path("provinsi");
                if(response.isArray()){
                    i=1;
                ...
                root = mapper.readTree(rest.exchange("https://dev.farizdotid.com/api/daerahindonesia/provinsi/"+Propinsi.getText(), HttpMethod.GET, requestEntity, String.class).getBody());
                Valid.tabelKosong(tabMode);
                    i=1;
                        tabMode.addRow(new Object[]{
                            i+".",root.path("id").asText(),root.path("nama").asText()
                        });
            }
