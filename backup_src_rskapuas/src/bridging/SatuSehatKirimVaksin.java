...
public final class SatuSehatKirimVaksin extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-04-2026" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-04-2026" }));
    ...
    private void tampil() {
        ...
        try{
            ...
            if (ChkBelumTerkirim.isSelected() == true) {
                belumterkirim = " satu_sehat_immunization.id_immunization IS NULL and ";
            } else {
                belumterkirim = "";
            }
            ps=koneksi.prepareStatement(
                   ...
                   "where "+belumterkirim+" detail_pemberian_obat.no_batch<>'' and reg_periksa.tgl_registrasi between ? and ? "+
