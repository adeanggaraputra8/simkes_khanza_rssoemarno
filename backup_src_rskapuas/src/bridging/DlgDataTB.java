...
public final class DlgDataTB extends javax.swing.JDialog {
    ...
    //private DlgPropinsi_SITB propinsi=new DlgPropinsi_SITB(null,false);
    ...
    private String id_tb_03="",pasword="",kdwasor="",idrs="",URL="",requestJson="";
    ...
    private void initComponents() {
        ...
        PeriodeLaporan1 = new widget.ComboBox();
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "10-08-2021" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "10-08-2021" }));
        ...
        TanggalLaporan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "10-08-2021 01:54:08" }));
        ...
        TipeDiagnosis.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "1. Terkonfirmasi bakteriologis", "2. Terdiagnosis klinis" }));
        ...
        Lokasi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "1. Paru", "2. Ekstraparu" }));
        ...
        Riwayat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "1. Baru", "2. Kambuh", "3. Diobati setelah gagal", "4. Diobati Setelah Putus Berobat", "5. Lain-lain", "6. Riwayat Pengobatan Sebelumnya Tidak Diketahui", "7. Pindahan" }));
        ...
        MulaiBerobat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "10-08-2021" }));
        ...
        PaduanOAT.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PaduanOATActionPerformed(evt);
            }
        });
        ...
        PaduanOAT.setBounds(110, 280, 170, 23);
        ...
        SebelumPengobatanMikroskopis.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Neg", "1-9", "1+", "2+", "3+", "Tidak Dilakukan" }));
        ...
        SebelumPengobatanTesCepat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Neg", "Rif Sen", "Rif Res", "Rif Indet", "INVALID", "ERROR", "NO RESULT", "Tidak Dilakukan" }));
        ...
        SebelumPengobatanBiakan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                SebelumPengobatanBiakanActionPerformed(evt);
            }
        });
        ...
        PemeriksaanLaboratBulan2Mikroskopis.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Neg", "1-9", "1+", "2+", "3+", "Tidak Dilakukan" }));
        ...
        PemeriksaanLaboratBulan3Mikroskopis.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Neg", "1-9", "1+", "2+", "3+", "Tidak Dilakukan" }));
        ...
        PemeriksaanLaboratBulan5Mikroskopis.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Neg", "1-9", "1+", "2+", "3+", "Tidak Dilakukan" }));
        PemeriksaanLaboratBulan5Mikroskopis.setName("PemeriksaanLaboratBulan5Mikroskopis"); // NOI18N
        PemeriksaanLaboratBulan5Mikroskopis.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PemeriksaanLaboratBulan5MikroskopisActionPerformed(evt);
            }
        });
        ...
        PemeriksaanLaboratAkhirPengobatanMikroskopis.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Neg", "1-9", "1+", "2+", "3+", "Tidak Dilakukan" }));
        ...
        AkhirBerobat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "10-08-2021" }));
        ...
        HasilAkhirPengobatan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Sembuh", "Pengobatan Lengkap", "Lost To Follow Up", "Meninggal", "tidak dievaluasi" }));
        ...
        DianjurkanTesHIV.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "10-08-2021" }));
        ...
        TanggalTesHIV.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "10-08-2021" }));
        ...
        PeriodeLaporan1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "1=Januari - Maret", "2=April - Juni", "3=Juli - September", "4=Oktober - Desember" }));
        PeriodeLaporan1.setName("PeriodeLaporan1"); // NOI18N
        PeriodeLaporan1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PeriodeLaporan1ActionPerformed(evt);
            }
        });
        PeriodeLaporan1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PeriodeLaporan1KeyPressed(evt);
            }
        });
        FormInput.add(PeriodeLaporan1);
        PeriodeLaporan1.setBounds(103, 160, 163, 23);
        ...
        if(TNoRw.getText().trim().equals("")||TNoRM.getText().trim().equals("")){
            ...
            try {
                ...
                requestJson ="{" +
                    ...
                    "\"tipe_diagnosis\":\""+TipeDiagnosis.getSelectedItem().toString().replaceAll("1. Terkonfirmasi bakteriologis","1").toString().replaceAll("2. Terdiagnosis klinis","2")+"\"," +
                    "\"klasifikasi_lokasi_anatomi\":\""+Lokasi.getSelectedItem().toString().replaceAll("1. Paru","1").toString().replaceAll("2. Ekstraparu","2")+"\"," +
                    "\"klasifikasi_riwayat_pengobatan\":\""+Riwayat.getSelectedItem().toString().replaceAll("1. Baru","1").toString().replaceAll("2. Kambuh","2").toString().replaceAll("3. Diobati setelah gagal","3").toString().replaceAll("4. Diobati Setelah Putus Berobat","4").toString().replaceAll("5. Lain-lain","5").toString().replaceAll("6. Riwayat Pengobatan Sebelumnya Tidak Diketahui","6").toString().replaceAll("7. Pindahan","7")+"\"," +
                    "\"tanggal_mulai_pengobatan\":\""+Valid.SetTglSITB(MulaiBerobat.getSelectedItem()+"")+"\"," +
                    ...
                    "\"tanggal_hasil_akhir_pengobatan\":\""+Valid.SetTglSITB(AkhirBerobat.getSelectedItem()+"")+"\"," +
                    "\"hasil_akhir_pengobatan\":\""+HasilAkhirPengobatan.getSelectedItem()+"\"," +
                    "\"tgl_lahir\":\""+Valid.SetTglSITB(Valid.SetTgl3(Tanggal.getText()))+"\"," +
            ...
            if(Sequel.menyimpantf("data_tb","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",50,new String[]{
                    TNoRw.getText(),id_tb_03,PeriodeLaporan1.getSelectedItem().toString(),Valid.SetTgl(TanggalLaporan.getSelectedItem()+"")+" "+TanggalLaporan.getSelectedItem().toString().substring(11,19), 
    ...
    private void TanggalLaporanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TanggalLaporanKeyPressed
        Valid.pindah(evt,PaduanOAT,Rujukan);
    ...
    private void KdPropKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KdPropKeyPressed
        Valid.pindah(evt, KdKab,PaduanOAT);
    ...
    private void PemeriksaanLaboratBulan5MikroskopisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PemeriksaanLaboratBulan5MikroskopisActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_PemeriksaanLaboratBulan5MikroskopisActionPerformed

    private void PeriodeLaporan1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PeriodeLaporan1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_PeriodeLaporan1ActionPerformed

    private void PeriodeLaporan1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PeriodeLaporan1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_PeriodeLaporan1KeyPressed
    ...
    private void PaduanOATActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PaduanOATActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_PaduanOATActionPerformed
    ...
    private void SebelumPengobatanBiakanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SebelumPengobatanBiakanActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_SebelumPengobatanBiakanActionPerformed
    ...
    */
    ...
    private widget.ComboBox PeriodeLaporan1;
    ...
    public void emptTeks() {
        ...
        Kabupaten.setText("KABUPATEN");
        KdProp.setText("62");
        Propinsi.setText("Kalimantan Tengah");
