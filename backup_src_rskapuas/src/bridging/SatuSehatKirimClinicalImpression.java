    ...
    private void tampil() {
        ...
        try{
            ...
            if (ChkBelumTerkirim.isSelected() == true) {
                belumterkirim = " satu_sehat_clinicalimpression.id_clinicalimpression IS NULL and ";
            } else {
                belumterkirim = "";
            }
            ps=koneksi.prepareStatement(
                   ...
                   "and "+belumterkirim+" reg_periksa.tgl_registrasi between ? and ? "+
            ...
            ps=koneksi.prepareStatement(
                   ...
                   "and satu_sehat_clinicalimpression.status='Ranap' where "+belumterkirim+" pemeriksaan_ranap.penilaian<>'' and reg_periksa.tgl_registrasi between ? and ? "+
                   (TCari.getText().equals("")?"":"and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or "+
                   "pasien.nm_pasien like ? or pasien.no_ktp like ? or pegawai.no_ktp like ? or pegawai.nama like ? or "+
                   "reg_periksa.stts like ?)"));
            try {
