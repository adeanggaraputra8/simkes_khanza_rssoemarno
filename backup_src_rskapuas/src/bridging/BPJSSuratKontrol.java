...
public class BPJSSuratKontrol extends javax.swing.JDialog {
            ...
            public void windowClosed(WindowEvent e) {
                if(historiPelayanan.getTable().getSelectedRow()!= -1){         
                    if((historiPelayanan.getTable().getSelectedColumn()==6)||(historiPelayanan.getTable().getSelectedColumn()==7)){
                        NoSEP.setText(historiPelayanan.getTable().getValueAt(historiPelayanan.getTable().getSelectedRow(),historiPelayanan.getTable().getSelectedColumn()).toString());
                        Diagnosa.setText(historiPelayanan.getTable().getValueAt(historiPelayanan.getTable().getSelectedRow(),1).toString());
                        Valid.SetTgl(TanggalSurat,historiPelayanan.getTable().getValueAt(historiPelayanan.getTable().getSelectedRow(),11).toString());
                        KdPoli.setText(Sequel.cariIsi("select kdpolitujuan from bridging_sep where no_sep='"+NoSEP.getText()+"'"));
                        NmPoli.setText(Sequel.cariIsi("select nmpolitujuan from bridging_sep where no_sep='"+NoSEP.getText()+"'"));
                        KdDokter.setText(Sequel.cariIsi("select kddpjp from bridging_sep where no_sep='"+NoSEP.getText()+"'"));
                        NmDokter.setText(Sequel.cariIsi("select nmdpdjp from bridging_sep where no_sep='"+NoSEP.getText()+"'"));
                    }
                }  
                NoSEP.requestFocus();
            }
    ...
    private void initComponents() {
        ...
        infocektgl = new widget.TextArea();
        ...
        jLabel17.setBounds(470, 10, 65, 23);

        Diagnosa.setEditable(false);
        Diagnosa.setHighlighter(null);
        Diagnosa.setName("Diagnosa"); // NOI18N
        FormInput.add(Diagnosa);
        Diagnosa.setBounds(537, 10, 190, 23);
        ...
        btnRiwayat.setBounds(430, 10, 28, 23);

        jLabel18.setText("Tanggal Kontrol :");
        jLabel18.setName("jLabel18"); // NOI18N
        FormInput.add(jLabel18);
        jLabel18.setBounds(528, 70, 100, 23);

        infocektgl.setEditable(false);
        infocektgl.setBorder(null);
        infocektgl.setColumns(20);
        infocektgl.setForeground(new java.awt.Color(204, 0, 0));
        infocektgl.setRows(5);
        infocektgl.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        infocektgl.setName("infocektgl"); // NOI18N
        infocektgl.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                infocektglMouseClicked(evt);
            }
        });
        infocektgl.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                infocektglKeyPressed(evt);
            }
        });
        FormInput.add(infocektgl);
        infocektgl.setBounds(760, 10, 220, 80);

        jLabel19.setText("Status PRB :");
        jLabel19.setName("jLabel19"); // NOI18N
        FormInput.add(jLabel19);
        jLabel19.setBounds(0, 130, 90, 23);
        ...
        jLabel20.setText("Asesmen PRB :");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(0, 160, 90, 23);
        ...
        jLabel21.setBounds(0, 180, 100, 23);

        jLabel23.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel23.setText("HBA1C");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(60, 180, 50, 23);
        ...
        jLabel24.setBounds(163, 180, 40, 23);

        jLabel26.setText("Rerata TD Diastolik :");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(207, 210, 118, 23);
        ...
        jLabel27.setText("eGFR :");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(378, 180, 50, 23);
        ...
        jLabel28.setBounds(577, 180, 40, 23);
        ...
        jLabel29.setBounds(664, 180, 20, 23);
        ...
        jLabel30.setText("LDL :");
        jLabel30.setName("jLabel30"); // NOI18N
        FormInput.add(jLabel30);
        jLabel30.setBounds(487, 180, 40, 23);
        ...
        jLabel31.setText("Rerata TD Sistolik");
        jLabel31.setName("jLabel31"); // NOI18N
        FormInput.add(jLabel31);
        jLabel31.setBounds(60, 210, 110, 23);

        jLabel32.setText(":");
        jLabel32.setName("jLabel32"); // NOI18N
        FormInput.add(jLabel32);
        jLabel32.setBounds(0, 210, 154, 23);
        ...
        jLabel63.setBounds(0, 420, 88, 23);

        jLabel64.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel64.setText("Usia");
        jLabel64.setName("jLabel64"); // NOI18N
        FormInput.add(jLabel64);
        jLabel64.setBounds(60, 420, 50, 23);
        ...
        jLabel65.setText("Asam Urat :");
        jLabel65.setName("jLabel65"); // NOI18N
        FormInput.add(jLabel65);
        jLabel65.setBounds(145, 420, 80, 23);
        ...
        jLabel66.setText("RemisiSLE :");
        jLabel66.setName("jLabel66"); // NOI18N
        FormInput.add(jLabel66);
        jLabel66.setBounds(291, 420, 70, 23);

        jLabel67.setText("Hamil :");
        jLabel67.setName("jLabel67"); // NOI18N
        FormInput.add(jLabel67);
        jLabel67.setBounds(413, 420, 60, 23);
    ...
    private void MnAmbilSuratKontrolVCLAIMActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnAmbilSuratKontrolVCLAIMActionPerformed
        if (NoRawat.getText().equals("") || NoSEP.getText().equals("")) {
            ...
            try {
                ...
                headers.add("X-Signature",api.getHmac(utc));
                headers.add("user_key",koneksiDB.USERKEYAPIBPJS());
                URL = link+"/RencanaKontrol/ListRencanaKontrol/tglAwal/"+Valid.SetTgl(TanggalSurat.getSelectedItem() + "")+"/tglAkhir/"+Valid.SetTgl(TanggalSurat.getSelectedItem() + "")+"/filter/1";
                ...
                if (nameNode.path("code").asText().equals("200")) {
                    ...
                    if (response.path("list").isArray()) {
                        for (JsonNode list : response.path("list")) {
                           if (Sequel.cariInteger("select count(no_sep) from bridging_surat_kontrol_bpjs where no_sep= '"+NoSEP.getText()+"' ")>0) {
                             if (list.path("noSepAsalKontrol").asText().toLowerCase().contains(NoSEP.getText().toLowerCase())) {
                                  if(Sequel.mengedittf("bridging_surat_kontrol_bpjs","no_surat=?","tgl_surat=?,tgl_rencana=?",3,new String[]{
                                     list.path("tglTerbitKontrol").asText(),list.path("tglRencanaKontrol").asText(),list.path("noSuratKontrol").asText()
                                     })==true){
                                        Valid.SetTgl(DTPTanggalKontrol2, list.path("tglRencanaKontrol").asText());
                                        JOptionPane.showMessageDialog(rootPane, "Surat Rencana Kontrol dari VClaim berhasil update..!!");
                                        emptTeks();
                                        tampil();
                                  ...
                                  if (list.path("noSepAsalKontrol").asText().toLowerCase().contains(NoSEP.getText().toLowerCase())) {
                                    Sequel.menyimpan("bridging_surat_kontrol_bpjs",
                                        "'" + list.path("noSepAsalKontrol").asText() + "',"
...
//                    }
    ...
    private void infocektglMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_infocektglMouseClicked

    }//GEN-LAST:event_infocektglMouseClicked

    private void infocektglKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_infocektglKeyPressed
    ...
    */
    ...
    private widget.TextArea infocektgl;
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            NoKartu.setText(Sequel.cariIsi("select no_peserta from pasien where no_rkm_medis='"+tbObat.getValueAt(tbObat.getSelectedRow(),3).toString()+"' "));
            CekTglKontrol();
        }
    }
    ...
    public void setNoRm2(String norm, String nokartu, String jk, String norawat, String tgllahir,String nmpasien) {
        TCari.setText(norm);
        NoRawat.setText(norawat);
        NoRM.setText(norm);
    ...
    private void CekTglKontrol (){
        ...
        try {
                ...
                if (nameNode.path("code").asText().equals("200")) {
                    ...
                    if (response.path("tglRencanaKontrol").asText().toLowerCase().contains(tbObat.getValueAt(tbObat.getSelectedRow(),10).toString())) {
                                 infocektgl.setText("Tanggal Kontrol Sudah Sesuai... "+response.path("tglRencanaKontrol").asText());
                             }else{
                                  infocektgl.setText("Tanggal Kontrol Tidak Sesuai Silahkan Update data..."+response.path("tglRencanaKontrol").asText());
                             }
                } else {
                    JOptionPane.showMessageDialog(rootPane, "Notifikasi WS VClaim 2.0 : Kode " + nameNode.path("code").asText() + ", Pesan : " + nameNode.path("message").asText());
                }
