...
public final class DlgKunjunganRalan extends javax.swing.JDialog {
    ...
    private String setbaru="",setlama="",umurlk="",umurpr="",kddiangnosa="",diagnosa="",status="", dialog_simpan="";
    ...
    public DlgKunjunganRalan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{"No.","Lama","Baru","Nama Pasien","L","P","Status Pasien","Kode","Diagnosa","Dokter Jaga"}){
        ...
        tabmode3=new DefaultTableModel(null,new Object[]{"No.","Lama","Baru","Nama Pasien","L","P","Status Pasien","Kode","Diagnosa","Dokter Jaga"}){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
    ...
    private void initComponents() {
        ...
        TabRawat.addTab("Kunjungan IGD & Ponek", internalFrame4);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0 || tabMode2.getRowCount()==0 || tabmode3.getRowCount()==0){
            ...
            //TCari.requestFocus();
                ...
                for(int r=0;r<tabmode3.getRowCount();r++){ 
                    if(!table3.getValueAt(r,0).toString().contains(">>")){
                        Sequel.menyimpan("temporary","'0','"+
                                        ...
                                        tabmode3.getValueAt(r,7).toString()+"','"+
                                        tabmode3.getValueAt(r,8).toString()+"','"+
                                        tabmode3.getValueAt(r,9).toString()+"','','','','','','','','','','','','','','','','','','','','','','','','','','',''","Rekap Nota Pembayaran");
                    }                    
                }
            }
    ...
    private void ppExportToExcelBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppExportToExcelBtnPrintActionPerformed
        ...
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
         ...
         if(TabRawat.getSelectedIndex()==0){
           ...
           Valid.panggilUrl("billing/kunjunganralan.php?tanggal1="+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"&tanggal2="+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"&usere="+koneksiDB.USERHYBRIDWEB()+"&passwordte="+koneksiDB.PASHYBRIDWEB()); 
            this.setCursor(Cursor.getDefaultCursor());
        ...
        try{   
            ...
            if(nmpoli.getText().trim().equals("")&&nmdokter.getText().trim().equals("")&&nmpenjab.getText().trim().equals("")&&nmkabupaten.getText().trim().equals("")&&nmkecamatan.getText().trim().equals("")&&nmkelurahan.getText().trim().equals("")&&TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.stts_daftar,reg_periksa.stts," +
                        ...
                        "where reg_periksa.stts_daftar like '%"+status+"%' and reg_periksa.status_lanjut='Ralan' and reg_periksa.kd_poli NOT IN ('IGDK','PPN','LAB','RAD','PPT') and reg_periksa.tgl_registrasi between ? and ? order by reg_periksa.tgl_registrasi,reg_periksa.jam_reg");
            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.stts_daftar,reg_periksa.stts," +
                        "dokter.nm_dokter,reg_periksa.no_rkm_medis,pasien.nm_pasien,poliklinik.nm_poli,"+
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    ps2=koneksi.prepareStatement("select penyakit.kd_penyakit,penyakit.nm_penyakit from penyakit inner join diagnosa_pasien " +
                        ...
                        "where diagnosa_pasien.no_rawat=? AND diagnosa_pasien.kd_penyakit NOT LIKE 'Z%' order by prioritas asc limit 1");
                    try {
                    ...
                    tabMode.addRow(new Object[]{
                        i,setlama,setbaru,rs.getString("nm_pasien"),umurlk,umurpr,rs.getString("stts"),kddiangnosa,diagnosa,rs.getString("nm_dokter")
                    });                
                    i++;
                }
                if(i>=2){
        ...
        try{   
            ...
            if(nmpoli.getText().trim().equals("")&&nmdokter.getText().trim().equals("")&&nmpenjab.getText().trim().equals("")&&nmkabupaten.getText().trim().equals("")&&nmkecamatan.getText().trim().equals("")&&nmkelurahan.getText().trim().equals("")&&TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.kd_pj=penjab.kd_pj " +
                        "and reg_periksa.kd_poli=poliklinik.kd_poli and pasien.kd_kab=kabupaten.kd_kab and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kel=kelurahan.kd_kel " +
                        "where reg_periksa.stts_daftar like '%"+status+"%' and reg_periksa.status_lanjut='Ralan' and reg_periksa.kd_poli NOT IN ('IGDK','PPN','LAB','RAD','PPT') and reg_periksa.kd_poli NOT IN ('IGDK','PPN','LAB','RAD','PPT') and reg_periksa.stts<>'Batal' and reg_periksa.tgl_registrasi between ? and ? order by reg_periksa.tgl_registrasi,reg_periksa.jam_reg");
            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.stts_daftar,reg_periksa.stts," +
                        "dokter.nm_dokter,reg_periksa.no_rkm_medis,pasien.nm_pasien,poliklinik.nm_poli,"+
                        ...
                        "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.kd_pj=penjab.kd_pj " +
                        "and reg_periksa.kd_poli=poliklinik.kd_poli and pasien.kd_kab=kabupaten.kd_kab and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kel=kelurahan.kd_kel " +
                        "where reg_periksa.stts_daftar like '%"+status+"%' and reg_periksa.kd_poli NOT IN ('IGDK','PPN','LAB','RAD','PPT') and  reg_periksa.status_lanjut='Ralan' and reg_periksa.stts<>'Batal' and reg_periksa.tgl_registrasi between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and poliklinik.nm_poli like ? or " +
                        "reg_periksa.stts_daftar like '%"+status+"%' and reg_periksa.kd_poli NOT IN ('IGDK','PPN','LAB','RAD','PPT') and reg_periksa.status_lanjut='Ralan'  and reg_periksa.stts<>'Batal' and reg_periksa.tgl_registrasi between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and dokter.nm_dokter like ? or " +
                        "reg_periksa.stts_daftar like '%"+status+"%' and reg_periksa.kd_poli NOT IN ('IGDK','PPN','LAB','RAD','PPT') and reg_periksa.status_lanjut='Ralan' and reg_periksa.stts<>'Batal' and reg_periksa.tgl_registrasi between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and reg_periksa.no_rkm_medis like ? or " +
                        "reg_periksa.stts_daftar like '%"+status+"%' and reg_periksa.kd_poli NOT IN ('IGDK','PPN','LAB','RAD','PPT') and reg_periksa.status_lanjut='Ralan' and reg_periksa.stts<>'Batal' and reg_periksa.tgl_registrasi between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and pasien.nm_pasien like ? or " +
                        "reg_periksa.stts_daftar like '%"+status+"%' and reg_periksa.kd_poli NOT IN ('IGDK','PPN','LAB','RAD','PPT') and reg_periksa.status_lanjut='Ralan' and reg_periksa.stts<>'Batal' and reg_periksa.tgl_registrasi between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and pasien.alamat like ? "+
                        "order by reg_periksa.tgl_registrasi,reg_periksa.jam_reg");
        ...
        try{   
            ...
            if(nmpoli.getText().trim().equals("")&&nmdokter.getText().trim().equals("")&&nmpenjab.getText().trim().equals("")&&nmkabupaten.getText().trim().equals("")&&nmkecamatan.getText().trim().equals("")&&nmkelurahan.getText().trim().equals("")&&TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.kd_pj=penjab.kd_pj " +
                        "and reg_periksa.kd_poli=poliklinik.kd_poli and pasien.kd_kab=kabupaten.kd_kab and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kel=kelurahan.kd_kel " +
                        "where reg_periksa.stts_daftar like '%"+status+"%' and reg_periksa.status_lanjut='Ralan' and reg_periksa.kd_poli IN ('IGDK','PPN') and reg_periksa.tgl_registrasi between ? and ? order by reg_periksa.tgl_registrasi,reg_periksa.jam_reg");
            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.stts_daftar,reg_periksa.stts," +
                        "dokter.nm_dokter,reg_periksa.no_rkm_medis,pasien.nm_pasien,poliklinik.nm_poli,"+
                        ...
                        "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.kd_pj=penjab.kd_pj " +
                        "and reg_periksa.kd_poli=poliklinik.kd_poli and pasien.kd_kab=kabupaten.kd_kab and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kel=kelurahan.kd_kel " +
                        "where reg_periksa.stts_daftar like '%"+status+"%' and reg_periksa.status_lanjut='Ralan' and reg_periksa.kd_poli IN ('IGDK','PPN') and reg_periksa.kd_poli IN ('IGDK','PPN') and  reg_periksa.tgl_registrasi between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and poliklinik.nm_poli like ? or " +
                        "reg_periksa.stts_daftar like '%"+status+"%' and reg_periksa.status_lanjut='Ralan'  and reg_periksa.kd_poli IN ('IGDK','PPN') and reg_periksa.tgl_registrasi between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and dokter.nm_dokter like ? or " +
                        "reg_periksa.stts_daftar like '%"+status+"%' and reg_periksa.status_lanjut='Ralan'  and reg_periksa.kd_poli IN ('IGDK','PPN') and reg_periksa.tgl_registrasi between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and reg_periksa.no_rkm_medis like ? or " +
                        "reg_periksa.stts_daftar like '%"+status+"%' and reg_periksa.status_lanjut='Ralan' and reg_periksa.kd_poli IN ('IGDK','PPN') and reg_periksa.tgl_registrasi between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and pasien.nm_pasien like ? or " +
                        "reg_periksa.stts_daftar like '%"+status+"%' and reg_periksa.status_lanjut='Ralan'  and reg_periksa.kd_poli IN ('IGDK','PPN') and reg_periksa.tgl_registrasi between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and pasien.alamat like ? "+
                        "order by reg_periksa.tgl_registrasi,reg_periksa.jam_reg");
