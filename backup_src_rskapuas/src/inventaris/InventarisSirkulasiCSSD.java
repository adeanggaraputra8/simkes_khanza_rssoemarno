...
public class InventarisSirkulasiCSSD extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-07-2025 02:50:39" }));
        ...
        TglPinjam1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-07-2025" }));
        ...
        TglPinjam2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-07-2025" }));
    ...
    */
    ...
    public void isCek(){
        if(akses.getjml2()>=1){
            ...
            BtnIn.setEnabled(akses.getbarang_cssd());
            BtnOut.setEnabled(akses.getbarang_cssd());
            BtnSteril.setEnabled(akses.getbarang_cssd());
