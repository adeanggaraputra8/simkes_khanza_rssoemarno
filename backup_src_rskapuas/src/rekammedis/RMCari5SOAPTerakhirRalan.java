 ...
 * @author dosen
 */
public final class RMCari5SOAPTerakhirRalan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMCari5SOAPTerakhirRalan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMCari5SOAPTerakhirRalan dialog = new RMCari5SOAPTerakhirRalan(new javax.swing.JFrame(), true);
        ...
        if(Status.getSelectedIndex()==0){
            try{
                ps=koneksi.prepareStatement(
                        ...
                        "pemeriksaan_ralan.penilaian,pemeriksaan_ralan.rtl,pemeriksaan_ralan.instruksi "+
