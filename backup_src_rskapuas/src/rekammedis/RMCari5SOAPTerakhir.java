...
public final class RMCari5SOAPTerakhir extends javax.swing.JDialog {
    ...
    private String norm="",nip="",norw="",poli="";
    private int z=0;
    ...
    private void initComponents() {
        ...
        ChkPoli.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ChkPoli.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        ChkPoli.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        ChkPoli.setName("ChkPoli"); // NOI18N
        ChkPoli.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                ChkPoliItemStateChanged(evt);
            }
        });
    ...
    private void ChkPoliItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_ChkPoliItemStateChanged
            if (ChkPoli.isSelected()==true){
                tampil2();
            } else {
                tampil();
    ...
    }//GEN-LAST:event_ChkPoliItemStateChanged
    ...
    */
        ...
        if(Status.getSelectedIndex()==0){
            try{
                ps=koneksi.prepareStatement(
                        ...
                        "pemeriksaan_ralan.penilaian,pemeriksaan_ralan.rtl,pemeriksaan_ralan.instruksi,pemeriksaan_ralan.evaluasi "+
                        "from pemeriksaan_ralan inner join reg_periksa on pemeriksaan_ralan.no_rawat=reg_periksa.no_rawat where "+
                        "reg_periksa.no_rkm_medis=? and reg_periksa.kd_poli=? and pemeriksaan_ralan.nip in (select kd_dokter from dokter) and "+
                        "(pemeriksaan_ralan.keluhan like ? or pemeriksaan_ralan.pemeriksaan like ?) "+
                        "order by pemeriksaan_ralan.tgl_perawatan desc,pemeriksaan_ralan.jam_rawat desc limit 5");
                try{
                    ps.setString(1,norm);
    ...
    public void setPoli(String norw,String norm,String status){
        this.norw=norw;
        this.poli=Sequel.cariIsi("select kd_poli from reg_periksa where no_rawat='"+norw+"' ");
        this.norm=norm;
        Status.setSelectedItem(status);
        tampil();
    }
