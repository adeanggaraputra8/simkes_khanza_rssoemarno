...
public final class RMRekonsiliasiObat extends javax.swing.JDialog {
    ...
    public RMRekonsiliasiObat(java.awt.Frame parent, boolean modal) {
        ...
        DlgTambahObatRekonsiliasi.setSize(660,163);
    ...
    private void initComponents() {
        ...
        panelBiasa2.add(btnobat);
        btnobat.setBounds(620, 10, 28, 23);
    ...
    private void btnobatKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnobatKeyPressed
        Valid.pindah(evt,NamaObat,BtnSimpan);
    ...
    */
    ...
    public void isCek(){        
        ...
        btnobat.setEnabled(akses.getobat());
        if(akses.getjml2()>=1){
            KodePetugas.setEditable(false);
