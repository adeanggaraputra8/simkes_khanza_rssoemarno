...
public final class RMPenilaianFisioterapi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-11-2024 02:50:49" }));
        ...
        BtnKFR.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/tasksgroup.png"))); // NOI18N
        BtnKFR.setMnemonic('M');
        BtnKFR.setText("Asesmen KFR");
        BtnKFR.setToolTipText("Alt+M");
        BtnKFR.setName("BtnKFR"); // NOI18N
        BtnKFR.setPreferredSize(new java.awt.Dimension(130, 30));
        BtnKFR.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnKFRActionPerformed(evt);
            }
        });
        BtnKFR.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnKFRKeyPressed(evt);
            }
        });
        panelGlass9.add(BtnKFR);
        ...
        TPasien1.setBounds(336, 10, 240, 23);

        Tanggal.setForeground(new java.awt.Color(50, 70, 50));
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-11-2024" }));
        ...
        jLabel27.setText("Dokter Sp.RM :");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput1.add(jLabel27);
        jLabel27.setBounds(400, 40, 80, 23);
        ...
        jLabel13.setBounds(625, 10, 60, 23);
        ...
        jLabel14.setBounds(0, 70, 125, 23);
        ...
        FormInput1.add(DiagnosisFungsional);
        ...
        jLabel44.setText("Diagnosis Medis :");
        jLabel44.setName("jLabel44"); // NOI18N
        FormInput1.add(jLabel44);
        jLabel44.setBounds(0, 100, 125, 23);
        ...
        FormInput1.add(DiagnosisMedis);
        DiagnosisMedis.setBounds(129, 100, 660, 23);

        jLabel45.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel45.setText("INSTRUMEN UJI FUNGSI/PROSEDUR KFR :");
        jLabel45.setName("jLabel45"); // NOI18N
        FormInput1.add(jLabel45);
        jLabel45.setBounds(15, 130, 219, 23);

        jLabel46.setText("Hasil Yang Didapat :");
        jLabel46.setName("jLabel46"); // NOI18N
        FormInput1.add(jLabel46);
        jLabel46.setBounds(0, 150, 135, 23);
        ...
        FormInput1.add(HasilYangDidapat);
        HasilYangDidapat.setBounds(139, 150, 650, 23);

        jLabel63.setText("Kesimpulan :");
        jLabel63.setName("jLabel63"); // NOI18N
        FormInput1.add(jLabel63);
        jLabel63.setBounds(0, 180, 135, 23);
        ...
        FormInput1.add(Kesimpulan);
        Kesimpulan.setBounds(139, 180, 650, 23);

        jLabel64.setText("Rekomendasi :");
        jLabel64.setName("jLabel64"); // NOI18N
        FormInput1.add(jLabel64);
        jLabel64.setBounds(0, 210, 135, 23);
        ...
        FormInput1.add(Rekomendasi);
        Rekomendasi.setBounds(139, 210, 650, 23);

        jLabel65.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel65.setText("Diagnosis Fungsional");
        jLabel65.setName("jLabel65"); // NOI18N
        FormInput1.add(jLabel65);
        jLabel65.setBounds(15, 70, 125, 23);

        PanelInput.add(FormInput1, java.awt.BorderLayout.CENTER);
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-11-2024" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-11-2024" }));
        ...
        jLabel68.setPreferredSize(new java.awt.Dimension(90, 23));
        panelGlass10.add(jLabel68);

        TCari1.setName("TCari1"); // NOI18N
        TCari1.setPreferredSize(new java.awt.Dimension(320, 23));
        ...
        TabRawat.addTab("Uji Fungsi KFR", internalFrame4);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        switch (TabRawat.getSelectedIndex()) {
                ...
                if(TNoRM.getText().trim().equals("")){
                   ...
                   if(Sequel.menyimpantf("penilaian_fisioterapi","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",43,new String[]{
                            ...
                            KdPetugas.getText()
                             ...
                             if(Sequel.cariInteger("select no_rawat from penilaian_medis_ralan_rehab_medik where no_rawat='"+TNoRw.getText()+"'")==0){
                                  u=JOptionPane.showConfirmDialog(rootPane, "Apakah langsung disimpan ke penilaian KFR?","Konfirmasi",JOptionPane.YES_NO_OPTION);
                                   if(u==JOptionPane.YES_OPTION) 
                                   {
                                        Sequel.menyimpantf("penilaian_medis_ralan_rehab_medik","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",48,new String[]{
                                        TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),Sequel.cariIsi("select kd_dokterfisio from set_pjlab"),Informasi.getSelectedItem().toString(),"-",
                                        KeluhanUtama.getText(),RiwayatPenyakitSekarang.getText(),RiwayatPenyakitDahulu.getText(),"-","Compos Mentis","Tidak Nyeri","0",TD.getText(),
                                        HR.getText(),Suhu.getText(),RR.getText(),"","Normal","-","Normal","-",
                                        "Normal","-","Normal","-","Normal","-",
                                        "Normal",PemeriksaanMuscu.getText()+" ,Pengukuran :"+PengukuranMuscu.getText(),"Pemeriksaan Neuromuscular :"+PemeriksaanNeuro.getText()+" ,Pemeriksaan Cardiopulmonal :"+PemeriksaanCardio.getText()+" ,Pemeriksaan Integument :"+PemeriksaanInte.getText()+" ,Pengukuran Neuromuscular :"+PengukuranNeuro.getText()+" ,Pengukuran Cardiopulmonal :"+PengukuranCardio.getText()+" Pengukuran Integument :"+PengukuranInte.getText(),
                                        "Tidak Berisiko","Tidak Berisiko Malnutrisi","Tidak Perlu Bantuan",
                                        Diagnosis.getText(),"-",Penunjang.getText(),Rencana.getText(),"","","","Keterangan Fisik :"+KetFisik.getText(),"",
            ...
            case 2:
                   if(TNoRw1.getText().trim().equals("")||TPasien1.getText().trim().equals("")){
                        ...
                        if(Sequel.menyimpantf("uji_fungsi_kfr","?,?,?,?,?,?,?,?","Data",8,new String[]{
                            TNoRw1.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+"")+" "+Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),
                ...
                if(tabMode1.getRowCount()==0){
                    ...
                    if(TCari1.getText().trim().equals("")){
                        Valid.MyReportqry("rptUjiFungsiKFR.jasper","report","::[ Data Uji Fugsi/Prosedur KFR ]::",
                            ...
                            "uji_fungsi_kfr.tanggal between '"+Valid.SetTgl(DTPCari3.getSelectedItem()+"")+" 00:00:00' and '"+Valid.SetTgl(DTPCari4.getSelectedItem()+"")+" 23:59:59' order by uji_fungsi_kfr.tanggal ",param);
                    }else{
                        Valid.MyReportqry("rptUjiFungsiKFR.jasper","report","::[ Data Uji Fugsi/Prosedur KFR ]::",
                            "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,reg_periksa.sttsumur,"+
                            "pasien.jk,uji_fungsi_kfr.tanggal,uji_fungsi_kfr.diagnosis_fungsional,uji_fungsi_kfr.diagnosis_medis,uji_fungsi_kfr.hasil_didapat,"+
                            ...
                            "where uji_fungsi_kfr.tanggal between '"+Valid.SetTgl(DTPCari3.getSelectedItem()+"")+" 00:00:00' and '"+Valid.SetTgl(DTPCari4.getSelectedItem()+"")+" 23:59:59' and "+
                            "(reg_periksa.no_rawat like '%"+TCari1.getText().trim()+"%' or pasien.no_rkm_medis like '%"+TCari1.getText().trim()+"%' or pasien.nm_pasien like '%"+TCari1.getText().trim()+"%' or "+
                            "uji_fungsi_kfr.kd_dokter like '%"+TCari1.getText().trim()+"%' or dokter.nm_dokter like '%"+TCari1.getText().trim()+"%') order by uji_fungsi_kfr.tanggal ",param);
                    }  
                }
                this.setCursor(Cursor.getDefaultCursor());
            break;
    ...
    private void TNoRw1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TNoRw1KeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
            ...
            Valid.pindah(evt,TCari1,Tanggal);
        }
    ...
    private void MnUjiFungsiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnUjiFungsiActionPerformed
        if(tbObat1.getSelectedRow()>-1){
            ...
            param.put("emailrs",akses.getemailrs());
            param.put("logo",Sequel.cariGambar("select setting.logo from setting"));
            finger=Sequel.cariIsi("select sha1(sidikjari.sidikjari) from sidikjari inner join pegawai on pegawai.id=sidikjari.id where pegawai.nik=?",tbObat1.getValueAt(tbObat1.getSelectedRow(),12).toString());
            param.put("finger","Dikeluarkan di "+akses.getnamars()+", Kabupaten/Kota "+akses.getkabupatenrs()+"\nDitandatangani secara elektronik oleh "+tbObat1.getValueAt(tbObat1.getSelectedRow(),13).toString()+"\nID "+(finger.equals("")?tbObat1.getValueAt(tbObat1.getSelectedRow(),12).toString():finger)+"\n"+Tanggal.getSelectedItem());
            Valid.MyReportqry("rptCetakUjiFungsiKFR.jasper","report","::[ Formulir/Lembar Uji Fungsi/Prosedur KFR ]::",
                ...
                "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join dokter on uji_fungsi_kfr.kd_dokter=dokter.kd_dokter where reg_periksa.no_rawat='"+tbObat1.getValueAt(tbObat1.getSelectedRow(),0).toString()+"'",param);
        }
    }//GEN-LAST:event_MnUjiFungsiActionPerformed

    private void BtnKFRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKFRActionPerformed
    ...
    }//GEN-LAST:event_BtnKFRActionPerformed

    private void BtnKFRKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnKFRKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnKFRKeyPressed
    ...
    */
        ...
        try {
            ...
            try {
                ...
                if(rs.next()){
                    ...
                    DTPCari3.setDate(rs.getDate("tgl_registrasi"));
                    JK.setText(rs.getString("jk"));
    ...
    public void isCek(){
        ...
        BtnEdit.setEnabled(akses.getpenilaian_fisioterapi());
        BtnKFR.setEnabled(akses.getpenilaian_medis_ralan_rehab_medik());
        if(akses.getjml2()>=1){
            KdPetugas.setEditable(false);
    ...
    public void emptTekskfr() {
     ...
     private void hapuskfr() {
        if(Sequel.queryu2tf("delete from uji_fungsi_kfr where no_rawat=?",1,new String[]{
            ...
            tabMode1.removeRow(tbObat1.getSelectedRow());
     ...
     public void tampilkfr() {
        Valid.tabelKosong(tabMode1);
        try{
            if(TCari1.getText().toString().trim().equals("")){
                ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,reg_periksa.sttsumur,"+
                    "pasien.jk,uji_fungsi_kfr.tanggal,uji_fungsi_kfr.diagnosis_fungsional,uji_fungsi_kfr.diagnosis_medis,uji_fungsi_kfr.hasil_didapat,"+
                    "uji_fungsi_kfr.kesimpulan,uji_fungsi_kfr.rekomedasi,uji_fungsi_kfr.kd_dokter,dokter.nm_dokter,date_format(pasien.tgl_lahir,'%d-%m-%Y') as lahir "+
            ...
            try {
                if(TCari1.getText().toString().trim().equals("")){
                    ps.setString(1,Valid.SetTgl(DTPCari3.getSelectedItem()+"")+" 00:00:00");
                    ps.setString(2,Valid.SetTgl(DTPCari4.getSelectedItem()+"")+" 23:59:59");
                }else{
                    ps.setString(1,Valid.SetTgl(DTPCari3.getSelectedItem()+"")+" 00:00:00");
                    ps.setString(2,Valid.SetTgl(DTPCari4.getSelectedItem()+"")+" 23:59:59");
                    ps.setString(3,"%"+TCari1.getText()+"%");
                    ps.setString(4,"%"+TCari1.getText()+"%");
                    ps.setString(5,"%"+TCari1.getText()+"%");
                    ps.setString(6,"%"+TCari1.getText()+"%");
                    ps.setString(7,"%"+TCari1.getText()+"%");
                }
