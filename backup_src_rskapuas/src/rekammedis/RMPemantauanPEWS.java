...
public final class RMPemantauanPEWS extends javax.swing.JDialog {
    ...
    public RMPemantauanPEWS(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Rawat","No.R.M.","Nama Pasien","Umur","JK","Tanggal","Skor Keadaan Umum","Skor 1","Skor Kardio Vaskular","Skor 2",
            "Skor Respirasi","Skor 3","Ttl.Skor","Kesimpulan","NIP","Petugas","Tgl.Lahir"
        }){
    ...
    private void initComponents() {
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-05-2024" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-05-2024" }));
        ...
        cmbSkor1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Interaksi Biasa", "Somnolen", "Iritabel", "Letargi, Gelisah, Penurunan respon terhadap nyeri" }));
        ...
        jLabel17.setText("2.  Kardio Vaskular");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(80, 110, 160, 23);

        cmbSkor2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak Sianosis atau pengisian kapiler < 2 detik", "Tampak pucat atau pengisian kapiler = 2 detik", "Tampak Sianotik atau pengisian kapiler > 2 detik ATAU Takikardi > 20 x diatas parameter HR sesuai usia/menit", "Sianotik atau pengisian kapiler > 5 detik ATAU Takikardi > 30 x diatas parameter HR atau sesuai usia/ menit ATAU Bradikardi" }));
        ...
        jLabel23.setText("3.  Respirasi");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(80, 140, 160, 23);

        cmbSkor3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Respirasi dalam batas normal", "Tapikneu > 10 x diatas parameter RR sesuai usia/menit ATAU Retraksi otot bantu nafas ATAU Oksigenasi >= 3 Liter/Menit", "Tapikneu > 20 x diatas parameter RR sesuai usia/menit Retrasi >> ATAU Oksigenasi >= 6 Liter/Menit", "Bradipneu > 5 x dibawah parameter RR atau sesuai usia/menit dengan Retraksi ATAU merintih ATAU Oksigenasi >= 8 Liter/Menit" }));
    ...
    */
    ...
    private void isCombo1(){
        if(cmbSkor1.getSelectedItem().equals("Somnolen")){
            Skor1.setBackground(Color.YELLOW);
            Skor1.setForeground(Color.GREEN);
            Skor1.setText("1");
        }else if(cmbSkor1.getSelectedItem().equals("Iritabel")){
            Skor1.setBackground(Color.ORANGE);
            Skor1.setForeground(Color.WHITE);
            Skor1.setText("2");
        }else if(cmbSkor1.getSelectedItem().equals("Letargi, Gelisah, Penurunan respon terhadap nyeri")){
    ...
    private void isCombo2(){
        if(cmbSkor2.getSelectedItem().equals("Tampak pucat atau pengisian kapiler = 2 detik")){
            Skor2.setBackground(Color.YELLOW);
            Skor2.setForeground(Color.GREEN);
            Skor2.setText("1");
        }else if(cmbSkor2.getSelectedItem().equals("Tampak Sianotik atau pengisian kapiler > 2 detik ATAU Takikardi > 20 x diatas parameter HR sesuai usia/menit")){
            Skor2.setBackground(Color.ORANGE);
            Skor2.setForeground(Color.WHITE);
            Skor2.setText("2");
        }else if(cmbSkor2.getSelectedItem().equals("Sianotik atau pengisian kapiler > 5 detik ATAU Takikardi > 30 x diatas parameter HR atau sesuai usia/ menit ATAU Bradikardi")){
    ...
    private void isCombo3(){
        if(cmbSkor3.getSelectedItem().equals("Tapikneu > 10 x diatas parameter RR sesuai usia/menit ATAU Retraksi otot bantu nafas ATAU Oksigenasi >= 3 Liter/Menit")){
            Skor3.setBackground(Color.YELLOW);
            Skor3.setForeground(Color.GREEN);
            Skor3.setText("1");
        }else if(cmbSkor3.getSelectedItem().equals("Tapikneu > 20 x diatas parameter RR sesuai usia/menit Retrasi >> ATAU Oksigenasi >= 6 Liter/Menit")){
            Skor3.setBackground(Color.ORANGE);
            Skor3.setForeground(Color.WHITE);
            Skor3.setText("2");
        }else if(cmbSkor3.getSelectedItem().equals("Bradipneu > 5 x dibawah parameter RR atau sesuai usia/menit dengan Retraksi ATAU merintih ATAU Oksigenasi >= 8 Liter/Menit")){
    ...
    private void isHitung(){
        if(Integer.parseInt(TotalSkor.getText())>=5){
            ParameterSkor.setText("Ada perubahan yang signifikan, monitoring setiap 1 jam, segera konsul ke DPJP, Aktivasi Tim Code Blue");
        }else if(Integer.parseInt(TotalSkor.getText())>=3){
            ParameterSkor.setText("Ada perubahan kondisi pasien, lakukan evaluasi setiap 2 jam, lapor ke dokter jaga, konsul ke DPJP");
...
//            ParameterSkor.setText("Pasien dalam kondisi stabil, lakukan evaluasi setiap 8 jam");
        }else if(Integer.parseInt(TotalSkor.getText())>=0){
            ParameterSkor.setText("Pasien dalam kondisi stabil, lakukan evaluasi setiap 8 jam");
        }
    }
