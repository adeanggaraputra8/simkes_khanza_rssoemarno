...
import modifikasi.RMCariPemeriksaanFisik;
...
public final class RMDataResumePasienRanap extends javax.swing.JDialog {
    ...
    private RMCariPemeriksaanFisik caripemeriksaan1=new RMCariPemeriksaanFisik(null,false);
    ...
    public RMDataResumePasienRanap(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Diagnosa Sekunder 4","ICD10 Sek 4",
            "Prosedur Utama","ICD9 Utama","Prosedur Sekunder 1","ICD9 Sek1","Prosedur Sekunder 2",
            "ICD9 Sek2","Prosedur Sekunder 3","ICD9 Sek3",
            "Alergi Obat","Diet","Hasil Lab Yang Belum Selesai (Pending)",
            ...
            "Diagnosa Sekunder 5","ICD10 Sek 5","Diagnosa Sekunder 6","ICD10 Sek 6","Diagnosa Sekunder 7","ICD10 Sek 7","Diagnosa Sekunder 8","ICD10 Sek 8","Diagnosa Sekunder 9","ICD10 Sek 9","Diagnosa Sekunder 10","ICD10 Sek 10",
            "Prosedur Sekunder 4","ICD9 Sek4","Prosedur Sekunder 5","ICD9 Sek5","Prosedur Sekunder 6","ICD9 Sek6","Prosedur Sekunder 7","ICD9 Sek7","Prosedur Sekunder 8","ICD9 Sek8","Prosedur Sekunder 9","ICD9 Sek9","Prosedur Sekunder 10","ICD9 Sek10"
        }){
        ...
        DiagnosaSekunder5.setDocument(new batasInput((int)80).getKata(DiagnosaSekunder5));
        DiagnosaSekunder6.setDocument(new batasInput((int)80).getKata(DiagnosaSekunder6));
        DiagnosaSekunder7.setDocument(new batasInput((int)80).getKata(DiagnosaSekunder7));
        DiagnosaSekunder8.setDocument(new batasInput((int)80).getKata(DiagnosaSekunder8));
        DiagnosaSekunder9.setDocument(new batasInput((int)80).getKata(DiagnosaSekunder9));
        DiagnosaSekunder10.setDocument(new batasInput((int)80).getKata(DiagnosaSekunder10));
        ...
        ProsedurSekunder4.setDocument(new batasInput((int)80).getKata(ProsedurSekunder4));
        ProsedurSekunder5.setDocument(new batasInput((int)80).getKata(ProsedurSekunder5));
        ProsedurSekunder6.setDocument(new batasInput((int)80).getKata(ProsedurSekunder6));
        ProsedurSekunder7.setDocument(new batasInput((int)80).getKata(ProsedurSekunder7));
        ProsedurSekunder8.setDocument(new batasInput((int)80).getKata(ProsedurSekunder8));
        ProsedurSekunder9.setDocument(new batasInput((int)80).getKata(ProsedurSekunder9));
        ProsedurSekunder10.setDocument(new batasInput((int)80).getKata(ProsedurSekunder10));
        ...
        KodeDiagnosaSekunder8.setDocument(new batasInput((int)10).getKata(KodeDiagnosaSekunder8));
        KodeDiagnosaSekunder9.setDocument(new batasInput((int)10).getKata(KodeDiagnosaSekunder9));
        KodeDiagnosaSekunder10.setDocument(new batasInput((int)10).getKata(KodeDiagnosaSekunder10));
        ...
        KodeProsedurSekunder7.setDocument(new batasInput((int)8).getKata(KodeProsedurSekunder7));
        KodeProsedurSekunder8.setDocument(new batasInput((int)8).getKata(KodeProsedurSekunder8));
        KodeProsedurSekunder9.setDocument(new batasInput((int)8).getKata(KodeProsedurSekunder9));
        KodeProsedurSekunder10.setDocument(new batasInput((int)8).getKata(KodeProsedurSekunder10));
        ...
        caripemeriksaan1.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {}
            @Override
            public void windowClosing(WindowEvent e) {}
            @Override
            public void windowClosed(WindowEvent e) {
                if(caripemeriksaan1.getTable().getSelectedRow()!= -1){
                    JalannyaPenyakit.append(caripemeriksaan1.getTable().getValueAt(caripemeriksaan1.getTable().getSelectedRow(),2).toString()+", "+caripemeriksaan1.getTable().getValueAt(caripemeriksaan1.getTable().getSelectedRow(),3).toString()+", ");
    ...
    private void initComponents() {
        ...
        DiagnosaSekunder9 = new widget.TextBox();
        KodeDiagnosaSekunder9 = new widget.TextBox();
        jLabel48 = new widget.Label();
        DiagnosaSekunder10 = new widget.TextBox();
        KodeDiagnosaSekunder10 = new widget.TextBox();
        ...
        ProsedurSekunder7 = new widget.TextBox();
        jLabel52 = new widget.Label();
        KodeProsedurSekunder7 = new widget.TextBox();
        jLabel53 = new widget.Label();
        ProsedurSekunder8 = new widget.TextBox();
        KodeProsedurSekunder8 = new widget.TextBox();
        ProsedurSekunder9 = new widget.TextBox();
        KodeProsedurSekunder9 = new widget.TextBox();
        jLabel54 = new widget.Label();
        jLabel55 = new widget.Label();
        ProsedurSekunder10 = new widget.TextBox();
        KodeProsedurSekunder10 = new widget.TextBox();
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(100, 1234));
        ...
        jLabel37.setBounds(390, 1110, 70, 23);
        ...
        CaraKeluar.setBounds(460, 1110, 205, 23);

        jLabel36.setText("Keadaan Pulang :");
        jLabel36.setName("jLabel36"); // NOI18N
        FormInput.add(jLabel36);
        jLabel36.setBounds(10, 1110, 100, 23);
        ...
        Keadaan.setBounds(120, 1110, 130, 23);
        ...
        jLabel38.setBounds(10, 910, 100, 23);
        ...
        Alergi.setBounds(120, 910, 681, 23);

        jLabel39.setText("Diet :");
        jLabel39.setName("jLabel39"); // NOI18N
        FormInput.add(jLabel39);
        jLabel39.setBounds(10, 940, 100, 23);
        ...
        KetKeluar.setBounds(670, 1110, 125, 23);

        jLabel40.setText("Hasil Lab Yang Belum Selesai (Pending) :");
        jLabel40.setName("jLabel40"); // NOI18N
        FormInput.add(jLabel40);
        jLabel40.setBounds(10, 990, 230, 23);
        ...
        BtnDokter17.setBounds(210, 1020, 28, 23);
        ...
        scrollPane8.setBounds(120, 940, 681, 50);

        jLabel41.setText("Instruksi/Anjuran Dan Edukasi (Follow Up) :");
        jLabel41.setName("jLabel41"); // NOI18N
        FormInput.add(jLabel41);
        jLabel41.setBounds(10, 1050, 230, 23);
        ...
        scrollPane9.setBounds(250, 1050, 551, 50);
        ...
        KetKeadaanPulang.setBounds(250, 1110, 130, 23);

        jLabel42.setText("Dilanjutkan :");
        jLabel42.setName("jLabel42"); // NOI18N
        FormInput.add(jLabel42);
        jLabel42.setBounds(10, 1140, 100, 23);
        ...
        DIlanjutkan.setBounds(120, 1140, 130, 23);
        ...
        BtnDokter18.setBounds(80, 960, 28, 23);
        ...
        scrollPane10.setBounds(250, 990, 551, 50);
        ...
        scrollPane11.setBounds(120, 1170, 681, 50);
        ...
        BtnDokter19.setBounds(80, 1190, 28, 23);
        ...
        DiagnosaSekunder2.setBounds(150, 640, 220, 23);
        ...
        DiagnosaUtama.setBounds(150, 580, 220, 23);
        ...
        DiagnosaSekunder3.setBounds(150, 670, 220, 23);
        ...
        DiagnosaSekunder4.setBounds(150, 700, 220, 23);

        jLabel29.setText("Prosedur :");
        jLabel29.setName("jLabel29"); // NOI18N
        FormInput.add(jLabel29);
        jLabel29.setBounds(480, 560, 97, 23);
        ...
        DiagnosaSekunder1.setBounds(150, 610, 220, 23);

        jLabel31.setText("Kode ICD 9 :");
        jLabel31.setName("jLabel31"); // NOI18N
        FormInput.add(jLabel31);
        jLabel31.setBounds(660, 560, 210, 23);
        ...
        KodeDiagnosaUtama.setBounds(370, 580, 75, 23);
        ...
        KodeDiagnosaSekunder1.setBounds(370, 610, 75, 23);
        ...
        KodeDiagnosaSekunder2.setBounds(370, 640, 75, 23);
        ...
        KodeDiagnosaSekunder3.setBounds(370, 670, 75, 23);
        ...
        KodeDiagnosaSekunder4.setBounds(370, 700, 75, 23);

        jLabel32.setText("Prosedur Utama :");
        jLabel32.setName("jLabel32"); // NOI18N
        FormInput.add(jLabel32);
        jLabel32.setBounds(440, 580, 145, 23);
        ...
        ProsedurUtama.setBounds(590, 580, 220, 23);
        ...
        KodeProsedurUtama.setBounds(810, 580, 75, 23);
        ...
        ProsedurSekunder1.setBounds(590, 610, 220, 23);

        jLabel33.setText("Prosedur Sekunder 1 :");
        jLabel33.setName("jLabel33"); // NOI18N
        FormInput.add(jLabel33);
        jLabel33.setBounds(440, 610, 145, 23);
        ...
        KodeProsedurSekunder1.setBounds(810, 610, 75, 23);

        jLabel34.setText("Prosedur Sekunder 2 :");
        jLabel34.setName("jLabel34"); // NOI18N
        FormInput.add(jLabel34);
        jLabel34.setBounds(440, 640, 145, 23);
        ...
        ProsedurSekunder2.setBounds(590, 640, 220, 23);
        ...
        KodeProsedurSekunder2.setBounds(810, 640, 75, 23);
        ...
        KodeProsedurSekunder3.setBounds(810, 670, 75, 23);
        ...
        ProsedurSekunder3.setBounds(590, 670, 220, 23);

        jLabel35.setText("Prosedur Sekunder 3 :");
        jLabel35.setName("jLabel35"); // NOI18N
        FormInput.add(jLabel35);
        jLabel35.setBounds(440, 670, 145, 23);

        jLabel43.setText("Diagnosa Sekunder 5 :");
        ...
        DiagnosaSekunder5.setBounds(150, 730, 220, 23);
        ...
        KodeDiagnosaSekunder5.setBounds(370, 730, 75, 23);

        jLabel44.setText("Diagnosa Sekunder 6 :");
        ...
        DiagnosaSekunder6.setBounds(150, 760, 220, 23);
        ...
        KodeDiagnosaSekunder6.setBounds(370, 760, 75, 23);

        jLabel45.setText("Diagnosa Sekunder 7 :");
        ...
        DiagnosaSekunder7.setBounds(150, 790, 220, 23);
        ...
        KodeDiagnosaSekunder7.setBounds(370, 790, 75, 23);

        jLabel46.setText("Diagnosa Sekunder 8 :");
        ...
        FormInput.add(DiagnosaSekunder8);
        DiagnosaSekunder8.setBounds(150, 820, 220, 23);
        ...
        FormInput.add(KodeDiagnosaSekunder8);
        KodeDiagnosaSekunder8.setBounds(370, 820, 75, 23);

        jLabel47.setText("Diagnosa Sekunder 9 :");
        jLabel47.setName("jLabel47"); // NOI18N
        FormInput.add(jLabel47);
        jLabel47.setBounds(0, 850, 145, 23);

        DiagnosaSekunder9.setHighlighter(null);
        DiagnosaSekunder9.setName("DiagnosaSekunder9"); // NOI18N
        DiagnosaSekunder9.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                DiagnosaSekunder9KeyPressed(evt);
            }
        });
        FormInput.add(DiagnosaSekunder9);
        DiagnosaSekunder9.setBounds(150, 850, 220, 23);

        KodeDiagnosaSekunder9.setHighlighter(null);
        KodeDiagnosaSekunder9.setName("KodeDiagnosaSekunder9"); // NOI18N
        KodeDiagnosaSekunder9.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KodeDiagnosaSekunder9KeyPressed(evt);
            }
        });
        FormInput.add(KodeDiagnosaSekunder9);
        KodeDiagnosaSekunder9.setBounds(370, 850, 75, 23);

        jLabel48.setText("Diagnosa Sekunder 10 :");
        jLabel48.setName("jLabel48"); // NOI18N
        FormInput.add(jLabel48);
        jLabel48.setBounds(0, 880, 145, 23);

        DiagnosaSekunder10.setHighlighter(null);
        DiagnosaSekunder10.setName("DiagnosaSekunder10"); // NOI18N
        DiagnosaSekunder10.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                DiagnosaSekunder10KeyPressed(evt);
            }
        });
        FormInput.add(DiagnosaSekunder10);
        DiagnosaSekunder10.setBounds(150, 880, 220, 23);

        KodeDiagnosaSekunder10.setHighlighter(null);
        KodeDiagnosaSekunder10.setName("KodeDiagnosaSekunder10"); // NOI18N
        KodeDiagnosaSekunder10.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KodeDiagnosaSekunder10KeyPressed(evt);
            }
        });
        FormInput.add(KodeDiagnosaSekunder10);
        KodeDiagnosaSekunder10.setBounds(370, 880, 75, 23);

        jLabel49.setText("Prosedur Sekunder 4 :");
        jLabel49.setName("jLabel49"); // NOI18N
        FormInput.add(jLabel49);
        jLabel49.setBounds(440, 700, 145, 23);
        ...
        FormInput.add(ProsedurSekunder4);
        ProsedurSekunder4.setBounds(590, 700, 220, 23);
        ...
        FormInput.add(KodeProsedurSekunder4);
        KodeProsedurSekunder4.setBounds(810, 700, 75, 23);

        jLabel50.setText("Prosedur Sekunder 5 :");
        jLabel50.setName("jLabel50"); // NOI18N
        FormInput.add(jLabel50);
        jLabel50.setBounds(440, 730, 145, 23);
        ...
        FormInput.add(ProsedurSekunder5);
        ProsedurSekunder5.setBounds(590, 730, 220, 23);
        ...
        FormInput.add(KodeProsedurSekunder5);
        KodeProsedurSekunder5.setBounds(810, 730, 75, 23);
        ...
        FormInput.add(ProsedurSekunder6);
        ProsedurSekunder6.setBounds(590, 760, 220, 23);

        jLabel51.setText("Prosedur Sekunder 6 :");
        jLabel51.setName("jLabel51"); // NOI18N
        FormInput.add(jLabel51);
        jLabel51.setBounds(440, 760, 145, 23);
        ...
        FormInput.add(KodeProsedurSekunder6);
        KodeProsedurSekunder6.setBounds(810, 760, 75, 23);

        ProsedurSekunder7.setHighlighter(null);
        ProsedurSekunder7.setName("ProsedurSekunder7"); // NOI18N
        ProsedurSekunder7.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                ProsedurSekunder7KeyPressed(evt);
            }
        });
        FormInput.add(ProsedurSekunder7);
        ProsedurSekunder7.setBounds(590, 790, 220, 23);

        jLabel52.setText("Prosedur Sekunder 7 :");
        jLabel52.setName("jLabel52"); // NOI18N
        FormInput.add(jLabel52);
        jLabel52.setBounds(440, 790, 145, 23);

        KodeProsedurSekunder7.setHighlighter(null);
        KodeProsedurSekunder7.setName("KodeProsedurSekunder7"); // NOI18N
        KodeProsedurSekunder7.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KodeProsedurSekunder7KeyPressed(evt);
            }
        });
        FormInput.add(KodeProsedurSekunder7);
        KodeProsedurSekunder7.setBounds(810, 790, 75, 23);

        jLabel53.setText("Prosedur Sekunder 8 :");
        jLabel53.setName("jLabel53"); // NOI18N
        FormInput.add(jLabel53);
        jLabel53.setBounds(440, 820, 145, 23);

        ProsedurSekunder8.setHighlighter(null);
        ProsedurSekunder8.setName("ProsedurSekunder8"); // NOI18N
        ProsedurSekunder8.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                ProsedurSekunder8KeyPressed(evt);
            }
        });
        FormInput.add(ProsedurSekunder8);
        ProsedurSekunder8.setBounds(590, 820, 220, 23);

        KodeProsedurSekunder8.setHighlighter(null);
        KodeProsedurSekunder8.setName("KodeProsedurSekunder8"); // NOI18N
        KodeProsedurSekunder8.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KodeProsedurSekunder8KeyPressed(evt);
            }
        });
        FormInput.add(KodeProsedurSekunder8);
        KodeProsedurSekunder8.setBounds(810, 820, 75, 23);

        ProsedurSekunder9.setHighlighter(null);
        ProsedurSekunder9.setName("ProsedurSekunder9"); // NOI18N
        ProsedurSekunder9.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                ProsedurSekunder9KeyPressed(evt);
            }
        });
        FormInput.add(ProsedurSekunder9);
        ProsedurSekunder9.setBounds(590, 850, 220, 23);

        KodeProsedurSekunder9.setHighlighter(null);
        KodeProsedurSekunder9.setName("KodeProsedurSekunder9"); // NOI18N
        KodeProsedurSekunder9.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KodeProsedurSekunder9KeyPressed(evt);
            }
        });
        FormInput.add(KodeProsedurSekunder9);
        KodeProsedurSekunder9.setBounds(810, 850, 75, 23);

        jLabel54.setText("Prosedur Sekunder 9 :");
        jLabel54.setName("jLabel54"); // NOI18N
        FormInput.add(jLabel54);
        jLabel54.setBounds(440, 850, 145, 23);

        jLabel55.setText("Prosedur Sekunder 10 :");
        jLabel55.setName("jLabel55"); // NOI18N
        FormInput.add(jLabel55);
        jLabel55.setBounds(440, 880, 145, 23);

        ProsedurSekunder10.setHighlighter(null);
        ProsedurSekunder10.setName("ProsedurSekunder10"); // NOI18N
        ProsedurSekunder10.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                ProsedurSekunder10KeyPressed(evt);
            }
        });
        FormInput.add(ProsedurSekunder10);
        ProsedurSekunder10.setBounds(590, 880, 220, 23);

        KodeProsedurSekunder10.setHighlighter(null);
        KodeProsedurSekunder10.setName("KodeProsedurSekunder10"); // NOI18N
        KodeProsedurSekunder10.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KodeProsedurSekunder10KeyPressed(evt);
            }
        });
        FormInput.add(KodeProsedurSekunder10);
        KodeProsedurSekunder10.setBounds(810, 880, 75, 23);

        jLabel56.setText("Diagnosa Akhir :");
        jLabel56.setName("jLabel56"); // NOI18N
        FormInput.add(jLabel56);
        jLabel56.setBounds(0, 560, 97, 23);

        jLabel57.setText("Kode ICD :");
        jLabel57.setName("jLabel57"); // NOI18N
        FormInput.add(jLabel57);
        jLabel57.setBounds(230, 560, 210, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().equals("")||TNoRM.getText().equals("")||TPasien.getText().equals("")){
            ...
            if(Sequel.menyimpantf("resume_pasien_ranap","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",67,new String[]{
                    ...
                    DiagnosaSekunder5.getText(),KodeDiagnosaSekunder5.getText(),DiagnosaSekunder6.getText(),KodeDiagnosaSekunder6.getText(),DiagnosaSekunder7.getText(),KodeDiagnosaSekunder7.getText(),DiagnosaSekunder8.getText(),KodeDiagnosaSekunder8.getText(),
                    DiagnosaSekunder9.getText(),KodeDiagnosaSekunder9.getText(),DiagnosaSekunder10.getText(),KodeDiagnosaSekunder10.getText(),
                    ...
                    KodeProsedurSekunder3.getText(),ProsedurSekunder4.getText(),KodeProsedurSekunder4.getText(),
                    ProsedurSekunder5.getText(),KodeProsedurSekunder5.getText(),ProsedurSekunder6.getText(),KodeProsedurSekunder6.getText(),ProsedurSekunder7.getText(),KodeProsedurSekunder7.getText(),
                    ProsedurSekunder8.getText(),KodeProsedurSekunder8.getText(),ProsedurSekunder9.getText(),KodeProsedurSekunder9.getText(),ProsedurSekunder10.getText(),KodeProsedurSekunder10.getText(),
                    Alergi.getText(),Diet.getText(),LabBelum.getText(),Edukasi.getText(),CaraKeluar.getSelectedItem().toString(),KetKeluar.getText(),
                    ...
                    tabMode.addRow(new String[]{
                        ...
                        ProsedurSekunder3.getText(),KodeProsedurSekunder3.getText(),ProsedurSekunder4.getText(),KodeProsedurSekunder4.getText(),
                        ProsedurSekunder5.getText(),KodeProsedurSekunder5.getText(),ProsedurSekunder6.getText(),KodeProsedurSekunder6.getText(),ProsedurSekunder7.getText(),KodeProsedurSekunder7.getText(),
                        ProsedurSekunder8.getText(),KodeProsedurSekunder8.getText(),ProsedurSekunder9.getText(),KodeProsedurSekunder9.getText(),ProsedurSekunder10.getText(),KodeProsedurSekunder10.getText(),
                        Alergi.getText(),Diet.getText(),LabBelum.getText(),Edukasi.getText(),Keadaan.getSelectedItem().toString(),
    ...
    private void MnLaporanResumeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResumeActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportPDF("rptLaporanResumeRanap.jasper","report","::[ Laporan Resume Pasien ]::",param);
        }
    ...
    private void KodeProsedurSekunder3KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KodeProsedurSekunder3KeyPressed
        Valid.pindah(evt,ProsedurSekunder3,ObatSelamaDiRS);
    ...
    private void DiagnosaSekunder9KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DiagnosaSekunder9KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_DiagnosaSekunder9KeyPressed

    private void KodeDiagnosaSekunder9KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KodeDiagnosaSekunder9KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_KodeDiagnosaSekunder9KeyPressed

    private void DiagnosaSekunder10KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DiagnosaSekunder10KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_DiagnosaSekunder10KeyPressed

    private void KodeDiagnosaSekunder10KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KodeDiagnosaSekunder10KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_KodeDiagnosaSekunder10KeyPressed
    ...
    private void ProsedurSekunder7KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ProsedurSekunder7KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_ProsedurSekunder7KeyPressed

    private void KodeProsedurSekunder7KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KodeProsedurSekunder7KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_KodeProsedurSekunder7KeyPressed

    private void ProsedurSekunder8KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ProsedurSekunder8KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_ProsedurSekunder8KeyPressed

    private void KodeProsedurSekunder8KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KodeProsedurSekunder8KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_KodeProsedurSekunder8KeyPressed

    private void ProsedurSekunder9KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ProsedurSekunder9KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_ProsedurSekunder9KeyPressed

    private void KodeProsedurSekunder9KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KodeProsedurSekunder9KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_KodeProsedurSekunder9KeyPressed

    private void ProsedurSekunder10KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ProsedurSekunder10KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_ProsedurSekunder10KeyPressed

    private void KodeProsedurSekunder10KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KodeProsedurSekunder10KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_KodeProsedurSekunder10KeyPressed

    private void BtnDokter6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokter6ActionPerformed
        if(TNoRw.getText().equals("")&&TNoRM.getText().equals("")){
            JOptionPane.showMessageDialog(null,"Pasien masih kosong...!!!");
        }else{
            caripemeriksaan1.setNoRawat(TNoRw.getText());
            caripemeriksaan1.tampil();
            caripemeriksaan1.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            caripemeriksaan1.setLocationRelativeTo(internalFrame1);
            caripemeriksaan1.setVisible(true);
        }
    ...
    */
    ...
    private widget.TextBox DiagnosaSekunder10;
    ...
    private widget.TextBox DiagnosaSekunder9;
    ...
    private widget.TextBox KodeDiagnosaSekunder10;
    ...
    private widget.TextBox KodeDiagnosaSekunder9;
    ...
    private widget.TextBox KodeProsedurSekunder10;
    ...
    private widget.TextBox KodeProsedurSekunder7;
    private widget.TextBox KodeProsedurSekunder8;
    private widget.TextBox KodeProsedurSekunder9;
    ...
    private widget.TextBox ProsedurSekunder10;
    ...
    private widget.TextBox ProsedurSekunder7;
    private widget.TextBox ProsedurSekunder8;
    private widget.TextBox ProsedurSekunder9;
    ...
    public void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    ...
                    "resume_pasien_ranap.diagnosa_utama,resume_pasien_ranap.kd_diagnosa_utama,resume_pasien_ranap.diagnosa_sekunder,resume_pasien_ranap.kd_diagnosa_sekunder,resume_pasien_ranap.diagnosa_sekunder2,"+
                    "resume_pasien_ranap.kd_diagnosa_sekunder2,resume_pasien_ranap.diagnosa_sekunder3,resume_pasien_ranap.kd_diagnosa_sekunder3,resume_pasien_ranap.diagnosa_sekunder4,"+
                    "resume_pasien_ranap.kd_diagnosa_sekunder4,resume_pasien_ranap.diagnosa_sekunder5,resume_pasien_ranap.kd_diagnosa_sekunder5,resume_pasien_ranap.diagnosa_sekunder6,resume_pasien_ranap.kd_diagnosa_sekunder6,resume_pasien_ranap.diagnosa_sekunder7,resume_pasien_ranap.kd_diagnosa_sekunder7,resume_pasien_ranap.diagnosa_sekunder8,resume_pasien_ranap.kd_diagnosa_sekunder8,resume_pasien_ranap.diagnosa_sekunder9,resume_pasien_ranap.kd_diagnosa_sekunder9,resume_pasien_ranap.diagnosa_sekunder10,resume_pasien_ranap.kd_diagnosa_sekunder10,resume_pasien_ranap.prosedur_utama,resume_pasien_ranap.kd_prosedur_utama,resume_pasien_ranap.prosedur_sekunder,resume_pasien_ranap.kd_prosedur_sekunder,"+
                    "resume_pasien_ranap.prosedur_sekunder2,resume_pasien_ranap.kd_prosedur_sekunder2,resume_pasien_ranap.prosedur_sekunder3,resume_pasien_ranap.kd_prosedur_sekunder3,resume_pasien_ranap.prosedur_sekunder4,resume_pasien_ranap.kd_prosedur_sekunder4,resume_pasien_ranap.prosedur_sekunder5,resume_pasien_ranap.kd_prosedur_sekunder5,resume_pasien_ranap.prosedur_sekunder6,resume_pasien_ranap.kd_prosedur_sekunder6,resume_pasien_ranap.prosedur_sekunder7,resume_pasien_ranap.kd_prosedur_sekunder7,resume_pasien_ranap.prosedur_sekunder8,resume_pasien_ranap.kd_prosedur_sekunder8,resume_pasien_ranap.prosedur_sekunder9,resume_pasien_ranap.kd_prosedur_sekunder9,resume_pasien_ranap.prosedur_sekunder10,resume_pasien_ranap.kd_prosedur_sekunder10,resume_pasien_ranap.alergi,"+
                    "resume_pasien_ranap.diet,resume_pasien_ranap.lab_belum,resume_pasien_ranap.edukasi,resume_pasien_ranap.cara_keluar,resume_pasien_ranap.ket_keluar,resume_pasien_ranap.keadaan,"+
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("obat_pulang"),rs.getString("kd_pj"),rs.getString("png_jawab"),rs.getString("diagnosa_sekunder5"),rs.getString("kd_diagnosa_sekunder5"),rs.getString("diagnosa_sekunder6"),
                        rs.getString("kd_diagnosa_sekunder6"),rs.getString("diagnosa_sekunder7"),rs.getString("kd_diagnosa_sekunder7"),rs.getString("diagnosa_sekunder8"),rs.getString("kd_diagnosa_sekunder8"),rs.getString("diagnosa_sekunder9"),
                        rs.getString("kd_diagnosa_sekunder9"),rs.getString("diagnosa_sekunder10"),rs.getString("kd_diagnosa_sekunder10"),rs.getString("prosedur_sekunder4"),
                        rs.getString("kd_prosedur_sekunder4"),rs.getString("prosedur_sekunder5"),rs.getString("kd_prosedur_sekunder5"),rs.getString("prosedur_sekunder6"),
                        rs.getString("kd_prosedur_sekunder6"),rs.getString("prosedur_sekunder7"),rs.getString("kd_prosedur_sekunder7"),rs.getString("prosedur_sekunder8"),
                        rs.getString("kd_prosedur_sekunder8"),rs.getString("prosedur_sekunder9"),rs.getString("kd_prosedur_sekunder9"),rs.getString("prosedur_sekunder10"),
                        rs.getString("kd_prosedur_sekunder10")
                    });
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
    ...
    public void emptTeks() {
        ...
        DiagnosaSekunder8.setText("");
        DiagnosaSekunder9.setText("");
        DiagnosaSekunder10.setText("");
        KodeDiagnosaSekunder5.setText("");
        KodeDiagnosaSekunder6.setText("");
        KodeDiagnosaSekunder7.setText("");
        KodeDiagnosaSekunder8.setText("");
        KodeDiagnosaSekunder9.setText("");
        KodeDiagnosaSekunder10.setText("");
        ProsedurSekunder4.setText("");
        ProsedurSekunder5.setText("");
        ProsedurSekunder6.setText("");
        ProsedurSekunder7.setText("");
        ProsedurSekunder8.setText("");
        ProsedurSekunder9.setText("");
        ProsedurSekunder10.setText("");
        KodeProsedurSekunder4.setText("");
        KodeProsedurSekunder5.setText("");
        KodeProsedurSekunder6.setText("");
        KodeProsedurSekunder7.setText("");
        KodeProsedurSekunder8.setText("");
        KodeProsedurSekunder9.setText("");
        KodeProsedurSekunder10.setText("");
    } 
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            DiagnosaSekunder5.setText(tbObat.getValueAt(tbObat.getSelectedRow(),54).toString());  
            KodeDiagnosaSekunder5.setText(tbObat.getValueAt(tbObat.getSelectedRow(),55).toString());  
            DiagnosaSekunder6.setText(tbObat.getValueAt(tbObat.getSelectedRow(),56).toString());  
            KodeDiagnosaSekunder6.setText(tbObat.getValueAt(tbObat.getSelectedRow(),57).toString());  
            DiagnosaSekunder7.setText(tbObat.getValueAt(tbObat.getSelectedRow(),58).toString());  
            KodeDiagnosaSekunder7.setText(tbObat.getValueAt(tbObat.getSelectedRow(),59).toString());  
            DiagnosaSekunder8.setText(tbObat.getValueAt(tbObat.getSelectedRow(),60).toString());  
            KodeDiagnosaSekunder8.setText(tbObat.getValueAt(tbObat.getSelectedRow(),61).toString());
            DiagnosaSekunder9.setText(tbObat.getValueAt(tbObat.getSelectedRow(),62).toString());  
            KodeDiagnosaSekunder9.setText(tbObat.getValueAt(tbObat.getSelectedRow(),63).toString());  
            DiagnosaSekunder10.setText(tbObat.getValueAt(tbObat.getSelectedRow(),64).toString());  
            KodeDiagnosaSekunder10.setText(tbObat.getValueAt(tbObat.getSelectedRow(),65).toString());
            ProsedurSekunder4.setText(tbObat.getValueAt(tbObat.getSelectedRow(),66).toString());  
            KodeProsedurSekunder4.setText(tbObat.getValueAt(tbObat.getSelectedRow(),67).toString());  
            ProsedurSekunder5.setText(tbObat.getValueAt(tbObat.getSelectedRow(),68).toString());  
            KodeProsedurSekunder5.setText(tbObat.getValueAt(tbObat.getSelectedRow(),69).toString());  
            ProsedurSekunder6.setText(tbObat.getValueAt(tbObat.getSelectedRow(),70).toString());  
            KodeProsedurSekunder6.setText(tbObat.getValueAt(tbObat.getSelectedRow(),71).toString());  
            ProsedurSekunder7.setText(tbObat.getValueAt(tbObat.getSelectedRow(),72).toString());  
            KodeProsedurSekunder7.setText(tbObat.getValueAt(tbObat.getSelectedRow(),73).toString());  
            ProsedurSekunder8.setText(tbObat.getValueAt(tbObat.getSelectedRow(),74).toString());  
            KodeProsedurSekunder8.setText(tbObat.getValueAt(tbObat.getSelectedRow(),75).toString());  
            ProsedurSekunder9.setText(tbObat.getValueAt(tbObat.getSelectedRow(),76).toString());  
            KodeProsedurSekunder9.setText(tbObat.getValueAt(tbObat.getSelectedRow(),77).toString());
            ProsedurSekunder10.setText(tbObat.getValueAt(tbObat.getSelectedRow(),78).toString());  
            KodeProsedurSekunder10.setText(tbObat.getValueAt(tbObat.getSelectedRow(),79).toString());  
        }
    }
        ...
        try {
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    if(rs.getInt("prioritas")==9){
                        KodeDiagnosaSekunder8.setText(rs.getString("kd_penyakit"));
                        DiagnosaSekunder8.setText(rs.getString("nm_penyakit"));
                    }
                    if(rs.getInt("prioritas")==10){
                        KodeDiagnosaSekunder9.setText(rs.getString("kd_penyakit"));
                        DiagnosaSekunder9.setText(rs.getString("nm_penyakit"));
                    }
                    if(rs.getInt("prioritas")==11){
                        KodeDiagnosaSekunder10.setText(rs.getString("kd_penyakit"));
                        DiagnosaSekunder10.setText(rs.getString("nm_penyakit"));
                    }
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
        ...
        try {
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    if(rs.getInt("prioritas")==5){
                        KodeProsedurSekunder4.setText(rs.getString("kode"));
                        ProsedurSekunder4.setText(rs.getString("deskripsi_panjang"));
                    }
                    
                    if(rs.getInt("prioritas")==6){
                        KodeProsedurSekunder5.setText(rs.getString("kode"));
                        ProsedurSekunder5.setText(rs.getString("deskripsi_panjang"));
                    }
                    
                    if(rs.getInt("prioritas")==7){
                        KodeProsedurSekunder6.setText(rs.getString("kode"));
                        ProsedurSekunder6.setText(rs.getString("deskripsi_panjang"));
                    }
                    
                    if(rs.getInt("prioritas")==8){
                        KodeProsedurSekunder7.setText(rs.getString("kode"));
                        ProsedurSekunder7.setText(rs.getString("deskripsi_panjang"));
                    }
                    
                     if(rs.getInt("prioritas")==9){
                        KodeProsedurSekunder8.setText(rs.getString("kode"));
                        ProsedurSekunder8.setText(rs.getString("deskripsi_panjang"));
                    }
                    
                    if(rs.getInt("prioritas")==10){
                        KodeProsedurSekunder9.setText(rs.getString("kode"));
                        ProsedurSekunder9.setText(rs.getString("deskripsi_panjang"));
                    }
                    
                    if(rs.getInt("prioritas")==11){
                        KodeProsedurSekunder10.setText(rs.getString("kode"));
                        ProsedurSekunder10.setText(rs.getString("deskripsi_panjang"));
                    }
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
    ...
    private void ganti() {
        if(Sequel.mengedittf("resume_pasien_ranap","no_rawat=?","no_rawat=?,kd_dokter=?,diagnosa_awal=?,alasan=?,keluhan_utama=?,pemeriksaan_fisik=?,jalannya_penyakit=?,pemeriksaan_penunjang=?,"+
                ...
                "diagnosa_sekunder3=?,kd_diagnosa_sekunder3=?,diagnosa_sekunder4=?,kd_diagnosa_sekunder4=?,diagnosa_sekunder5=?,kd_diagnosa_sekunder5=?,diagnosa_sekunder6=?,diagnosa_sekunder7=?,kd_diagnosa_sekunder7=?,diagnosa_sekunder8=?,kd_diagnosa_sekunder8=?,diagnosa_sekunder9=?,kd_diagnosa_sekunder9=?,diagnosa_sekunder10=?,kd_diagnosa_sekunder10=?,prosedur_utama=?,kd_prosedur_utama=?,prosedur_sekunder=?,kd_prosedur_sekunder=?,"+
                "prosedur_sekunder2=?,kd_prosedur_sekunder2=?,prosedur_sekunder3=?,kd_prosedur_sekunder3=?,prosedur_sekunder4=?,kd_prosedur_sekunder4=?,prosedur_sekunder5=?,kd_prosedur_sekunder5=?,prosedur_sekunder6=?,kd_prosedur_sekunder6=?,prosedur_sekunder7=?,kd_prosedur_sekunder7=?,prosedur_sekunder8=?,kd_prosedur_sekunder8=?,prosedur_sekunder9=?,kd_prosedur_sekunder9=?,prosedur_sekunder10=?,kd_prosedur_sekunder10=?,alergi=?,diet=?,lab_belum=?,edukasi=?,cara_keluar=?,ket_keluar=?,keadaan=?,"+
                "ket_keadaan=?,dilanjutkan=?,ket_dilanjutkan=?,kontrol=?,obat_pulang=?",67,new String[]{
                TNoRw.getText(),KodeDokter.getText(),DiagnosaAwal.getText(),Alasan.getText(),KeluhanUtama.getText(),PemeriksaanFisik.getText(),JalannyaPenyakit.getText(),
                PemeriksaanRad.getText(),HasilLaborat.getText(),TindakanSelamaDiRS.getText(),ObatSelamaDiRS.getText(),DiagnosaUtama.getText(),KodeDiagnosaUtama.getText(),
                DiagnosaSekunder1.getText(),KodeDiagnosaSekunder1.getText(),DiagnosaSekunder2.getText(),KodeDiagnosaSekunder2.getText(),DiagnosaSekunder3.getText(),
                KodeDiagnosaSekunder3.getText(),DiagnosaSekunder4.getText(),KodeDiagnosaSekunder4.getText(),DiagnosaSekunder5.getText(),KodeProsedurSekunder5.getText(),DiagnosaSekunder6.getText(),KodeDiagnosaSekunder6.getText(),DiagnosaSekunder7.getText(),KodeProsedurSekunder7.getText(),DiagnosaSekunder8.getText(),KodeDiagnosaSekunder8.getText(),DiagnosaSekunder9.getText(),KodeProsedurSekunder9.getText(),DiagnosaSekunder10.getText(),KodeProsedurSekunder10.getText(),
                ProsedurUtama.getText(),KodeProsedurUtama.getText(),
                ProsedurSekunder1.getText(),KodeProsedurSekunder1.getText(),ProsedurSekunder2.getText(),KodeProsedurSekunder2.getText(),ProsedurSekunder3.getText(), 
                KodeProsedurSekunder3.getText(),ProsedurSekunder4.getText(),KodeProsedurSekunder4.getText(),ProsedurSekunder5.getText(),KodeProsedurSekunder5.getText(),ProsedurSekunder6.getText(),KodeProsedurSekunder6.getText(),ProsedurSekunder7.getText(),KodeProsedurSekunder7.getText(),ProsedurSekunder8.getText(),KodeProsedurSekunder8.getText(),ProsedurSekunder9.getText(),KodeProsedurSekunder9.getText(),ProsedurSekunder10.getText(),KodeProsedurSekunder10.getText(),
                Alergi.getText(),Diet.getText(),LabBelum.getText(),Edukasi.getText(),CaraKeluar.getSelectedItem().toString(),KetKeluar.getText(),
                Keadaan.getSelectedItem().toString(),KetKeadaanPulang.getText(),DIlanjutkan.getSelectedItem().toString(),KetDilanjutkan.getText(),
                Valid.SetTgl(Kontrol.getSelectedItem()+"")+" "+Kontrol.getSelectedItem().toString().substring(11,19),ObatPulang.getText(),
                tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
                   ...
                   tbObat.setValueAt(DiagnosaSekunder5.getText(),tbObat.getSelectedRow(),54);
                   tbObat.setValueAt(KodeDiagnosaSekunder5.getText(),tbObat.getSelectedRow(),55);
                   tbObat.setValueAt(DiagnosaSekunder6.getText(),tbObat.getSelectedRow(),56);
                   tbObat.setValueAt(KodeDiagnosaSekunder6.getText(),tbObat.getSelectedRow(),57);
                   tbObat.setValueAt(DiagnosaSekunder7.getText(),tbObat.getSelectedRow(),58);
                   tbObat.setValueAt(KodeDiagnosaSekunder7.getText(),tbObat.getSelectedRow(),59);
                   tbObat.setValueAt(DiagnosaSekunder8.getText(),tbObat.getSelectedRow(),60);
                   tbObat.setValueAt(KodeDiagnosaSekunder8.getText(),tbObat.getSelectedRow(),61);
                   tbObat.setValueAt(DiagnosaSekunder9.getText(),tbObat.getSelectedRow(),62);
                   tbObat.setValueAt(KodeDiagnosaSekunder9.getText(),tbObat.getSelectedRow(),63);
                   tbObat.setValueAt(DiagnosaSekunder10.getText(),tbObat.getSelectedRow(),64);
                   tbObat.setValueAt(KodeDiagnosaSekunder10.getText(),tbObat.getSelectedRow(),65);
                   tbObat.setValueAt(ProsedurSekunder4.getText(),tbObat.getSelectedRow(),66);
                   tbObat.setValueAt(KodeProsedurSekunder4.getText(),tbObat.getSelectedRow(),67);
                   tbObat.setValueAt(ProsedurSekunder5.getText(),tbObat.getSelectedRow(),68);
                   tbObat.setValueAt(KodeProsedurSekunder5.getText(),tbObat.getSelectedRow(),69);
                   tbObat.setValueAt(ProsedurSekunder6.getText(),tbObat.getSelectedRow(),70);
                   tbObat.setValueAt(KodeProsedurSekunder6.getText(),tbObat.getSelectedRow(),71);
                   tbObat.setValueAt(ProsedurSekunder7.getText(),tbObat.getSelectedRow(),72);
                   tbObat.setValueAt(KodeProsedurSekunder7.getText(),tbObat.getSelectedRow(),73);
                   tbObat.setValueAt(ProsedurSekunder8.getText(),tbObat.getSelectedRow(),74);
                   tbObat.setValueAt(KodeProsedurSekunder8.getText(),tbObat.getSelectedRow(),75);
                   tbObat.setValueAt(ProsedurSekunder9.getText(),tbObat.getSelectedRow(),76);
                   tbObat.setValueAt(KodeProsedurSekunder9.getText(),tbObat.getSelectedRow(),77);
                   tbObat.setValueAt(ProsedurSekunder10.getText(),tbObat.getSelectedRow(),78);
                   tbObat.setValueAt(KodeProsedurSekunder10.getText(),tbObat.getSelectedRow(),79);
                   emptTeks();
            }
    }
