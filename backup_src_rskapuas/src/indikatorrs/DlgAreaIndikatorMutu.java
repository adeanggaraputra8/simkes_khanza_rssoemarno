 ...
 * @author dosen
 */
public class DlgAreaIndikatorMutu extends javax.swing.JDialog {
    ...
    private DlgCariPegawai pegawai = new DlgCariPegawai(null, true);
     ...
     * @param modal
     */
    public DlgAreaIndikatorMutu(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        Object[] row = {"ID Ruang", "Nama Ruang", "Kode PJ", "Nama Penanggung Jawab"};
        ...
        pegawai.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(pegawai.getTable().getSelectedRow()!= -1){   
                        KdPegawai.setText(pegawai.tbKamar.getValueAt(pegawai.tbKamar.getSelectedRow(),0).toString());
                        NmPegawai.setText(pegawai.tbKamar.getValueAt(pegawai.tbKamar.getSelectedRow(),1).toString());
                    }
    ...
    private void initComponents() {
        ...
        jLabel5.setBounds(530, 10, 50, 23);

        NmPegawai.setName("NmPegawai"); // NOI18N
        NmPegawai.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                NmPegawaiKeyPressed(evt);
            }
        });
        panelGlass7.add(NmPegawai);
        NmPegawai.setBounds(680, 10, 230, 23);
        ...
        panelGlass7.add(KdPegawai);
        KdPegawai.setBounds(580, 10, 100, 23);
        ...
        panelGlass7.add(btnPengarang);
        btnPengarang.setBounds(920, 10, 25, 20);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        } else if (KdPegawai.getText().trim().equals("")) {
            Valid.textKosong(KdPegawai, "Pegawai");
        } else {
            Sequel.menyimpan("indikatormutu_areamutu", "'" + TKd.getText() + "','" + TNm.getText() + "','" + KdPegawai.getText() + "'", "ID Ruang");
            tampil();
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode, TKd, "indikatormutu_areamutu", "id_ruang");
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().equals("")) {
            ...
            Sequel.mengedit("indikatormutu_areamutu", "id_ruang=?", "id_ruang=?,nama_ruang=?,kd_petugas=?", 4, new String[]{
                TKd.getText(), TNm.getText(), KdPegawai.getText(), tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(), 0).toString()
            });
    ...
    private void NmPegawaiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NmPegawaiKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_NmPegawaiKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgAreaIndikatorMutu dialog = new DlgAreaIndikatorMutu(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select indikatormutu_areamutu.id_ruang, indikatormutu_areamutu.nama_ruang,indikatormutu_areamutu.kd_petugas, pegawai.nama from indikatormutu_areamutu join pegawai on indikatormutu_areamutu.kd_petugas=pegawai.nik where indikatormutu_areamutu.id_ruang like ? "
                    + "or indikatormutu_areamutu.nama_ruang like ? order by indikatormutu_areamutu.nama_ruang");
            try {
    ...
    public void emptTeks() {
        ...
        TCari.setText("");
        TKd.requestFocus();
        Valid.autoNomer(tabMode, "ARM", 3, TKd);
        KdPegawai.setText("");
        NmPegawai.setText("");
        TKd.requestFocus();
    }
    ...
    private void getData() {
        if (tbSpesialis.getSelectedRow() != -1) {
            ...
            KdPegawai.setText(tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(), 2).toString());
            NmPegawai.setText(tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(), 3).toString());
        }
    }
    ...
    public void isCek() {
        ...
        BtnEdit.setEnabled(akses.getdata_HAIs());
    }
}
