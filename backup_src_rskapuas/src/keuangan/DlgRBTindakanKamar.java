...
public class DlgRBTindakanKamar extends javax.swing.JDialog {
    ...
    public DlgRBTindakanKamar(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"No.","Bangsal","Tgl.Masuk","Tgl.Keluar","Cara Bayar","Obt+Emb+Tsl","Laborat","Paket Tindakan","Tambahan","Potongan","Registrasi","Radiologi","Kamar","Total","No. Kunjungan","Status Kepulangan"};
    ...
    */
    ...
    private void prosesCari() {            
        try{   
           ...
           psbangsal=koneksi.prepareStatement("select kd_bangsal,nm_bangsal from bangsal where status='1' and  kd_bangsal like ?");
           try {
                ...
                while(rsbangsal.next()){
                    ...
                    pspasien=koneksi.prepareStatement(
                       "select kamar_inap.no_rawat,pasien.nm_pasien,penjab.png_jawab,kamar_inap.kd_kamar,kamar_inap.tgl_masuk,kamar_inap.tgl_keluar, kamar_inap.stts_pulang "+
                        ...
                        while(rspasien.next()){
                            ...
                            tabMode.addRow(new Object[]{
                                ...
                                Valid.SetAngka(radiologi),Valid.SetAngka(kamar),Valid.SetAngka(obat+obatlangsung+laborat+
                                        detaillaborat+jm+jm2+jm3+operasi+tambahan-potongan+registrasi+radiologi+kamar),rspasien.getString("no_rawat"),rspasien.getString("stts_pulang")
                            });
                            a++;
                        }
                    } catch (Exception e) {
