...
public class DlgBilingRanap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-01-2025 13:23:40" }));
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
            ...
            try{
                ...
                if(i>0){                       
                    ...
                    if(i==1){
                        ...
                        //Valid.convert2pdf("billing/LaporanBilling2.php?petugas="+akses.getkode().replaceAll(" ","_")+"&ttl="+ttl+"&tanggal="+DTPTgl.getSelectedItem().toString().replaceAll(" ","_")+"&usere="+koneksiDB.USERHYBRIDWEB()+"&passwordte="+koneksiDB.PASHYBRIDWEB(), TNoRw.getText());
                    }else if(i==2){
    ...
    private void MnKuitansiAmbActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnKuitansiAmbActionPerformed
        ...
        Valid.MyReportqry("rptkuitansiamb1.jasper", "report", "::[ Kuitansi Pelayanan Rukukan Ambulan Pasien JKN ]::",
            " SELECT jns_perawatan_inap.nm_perawatan,jns_perawatan_inap.total_byrdrpr, pasien.nm_pasien FROM rawat_inap_drpr " +
