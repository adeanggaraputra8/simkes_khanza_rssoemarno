...
import modifikasi.DlgPemabatasanTidankanRalan;
...
public final class DlgJnsPerawatanRalan extends javax.swing.JDialog {
    ...
    private int i=0;
    //public DlgPemabatasanTidankanRalan tindakan=new DlgPemabatasanTidankanRalan(null,false);
    ...
    private void initComponents() {
        ...
        MnPembatasanTindakan = new javax.swing.JMenuItem();
        ...
        MnPembatasanTindakan.setBackground(new java.awt.Color(255, 255, 254));
        MnPembatasanTindakan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnPembatasanTindakan.setForeground(new java.awt.Color(50, 50, 50));
        MnPembatasanTindakan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnPembatasanTindakan.setText("Mapping Batas Tindakan");
        MnPembatasanTindakan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnPembatasanTindakan.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnPembatasanTindakan.setName("MnPembatasanTindakan"); // NOI18N
        MnPembatasanTindakan.setPreferredSize(new java.awt.Dimension(200, 28));
        MnPembatasanTindakan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnPembatasanTindakanActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnPembatasanTindakan);
...
private void BtnPenjabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPenjabActionPerformed
    ...
    private void MnPembatasanTindakanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPembatasanTindakanActionPerformed
        DlgPemabatasanTidankanRalan tindakan=new DlgPemabatasanTidankanRalan(null,false);
        tindakan.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
        tindakan.setLocationRelativeTo(internalFrame1);
        tindakan.setVisible(true);   
    }//GEN-LAST:event_MnPembatasanTindakanActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnPembatasanTindakan;
