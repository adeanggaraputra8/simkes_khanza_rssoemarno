...
public final class DlgCariPerawatanRanap extends javax.swing.JDialog {
    ...
    private PreparedStatement psinputrawatdr,psinputrawatpr,psinputrawatdrpr,psinputrawatdrbangsal,psinputrawatprbangsal,psinputrawatdrprbangsal,
    ...
    private void initComponents() {
        ...
        BtnSeekBangsal.setBounds(1150, 10, 28, 23);
                                ...
                                try {
                                    switch (pilihtable) {
                                        case "rawat_inap_dr":
                                            ...
                                            if(sukses==true){
                                                psinputrawatdrbangsal=koneksi.prepareStatement("insert into rawat_inap_dr_bangsal values(?,?,?,?,?,?,?,?,?,?,?,?,?)");
                                            try {
                                                psinputrawatdrbangsal.setString(1,TNoRw.getText());
                                                psinputrawatdrbangsal.setString(2,tbKamar.getValueAt(i,1).toString());
                                                psinputrawatdrbangsal.setString(3,kddokter.getText());
                                                psinputrawatdrbangsal.setString(4,Valid.SetTgl(DTPTgl.getSelectedItem()+""));
                                                psinputrawatdrbangsal.setString(5,cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem());
                                                psinputrawatdrbangsal.setString(6,tbKamar.getValueAt(i,5).toString());
                                                psinputrawatdrbangsal.setString(7,tbKamar.getValueAt(i,6).toString());
                                                psinputrawatdrbangsal.setString(8,tbKamar.getValueAt(i,7).toString());
                                                psinputrawatdrbangsal.setString(9,tbKamar.getValueAt(i,9).toString());
                                                psinputrawatdrbangsal.setString(10,tbKamar.getValueAt(i,10).toString());
                                                psinputrawatdrbangsal.setString(11,tbKamar.getValueAt(i,4).toString());
                                                psinputrawatdrbangsal.setString(12,TkdKamar.getText());
                                                psinputrawatdrbangsal.setString(13,TkdBangsal.getText());
                                                psinputrawatdrbangsal.executeUpdate();
                                            } catch (Exception e) {
                                                sukses=false;
                                                System.out.println("Notifikasi : "+e);
                                            } finally{
                                                if(psinputrawatdrbangsal != null){
                                                    psinputrawatdrbangsal.close();
                                                }
                                            }
                                        ...
                                        case "rawat_inap_pr":
                                            ...
                                            if(sukses==true){
                                                 ...
                                                 psinputrawatprbangsal=koneksi.prepareStatement("insert into rawat_inap_pr_bangsal values(?,?,?,?,?,?,?,?,?,?,?,?,?)");
                                                    try {
                                                        psinputrawatprbangsal.setString(1,TNoRw.getText());
                                                        psinputrawatprbangsal.setString(2,tbKamar.getValueAt(i,1).toString());
                                                        psinputrawatprbangsal.setString(3,kddokter.getText());
                                                        psinputrawatprbangsal.setString(4,Valid.SetTgl(DTPTgl.getSelectedItem()+""));
                                                        psinputrawatprbangsal.setString(5,cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem());
                                                        psinputrawatprbangsal.setString(6,tbKamar.getValueAt(i,5).toString());
                                                        psinputrawatprbangsal.setString(7,tbKamar.getValueAt(i,6).toString());
                                                        psinputrawatprbangsal.setString(8,tbKamar.getValueAt(i,8).toString());
                                                        psinputrawatprbangsal.setString(9,tbKamar.getValueAt(i,9).toString());
                                                        psinputrawatprbangsal.setString(10,tbKamar.getValueAt(i,10).toString());
                                                        psinputrawatprbangsal.setString(11,tbKamar.getValueAt(i,4).toString());
                                                        psinputrawatprbangsal.setString(12,TkdKamar.getText());
                                                        psinputrawatprbangsal.setString(13,TkdBangsal.getText());
                                                        psinputrawatprbangsal.executeUpdate();
                                                    } catch (Exception e) {
                                                        sukses=false;
                                                        System.out.println("Notifikasi : "+e);
                                                    } finally{
                                                        if(psinputrawatprbangsal != null){
                                                            psinputrawatprbangsal.close();
                                                        }
                                                    }
                                        ...
                                        case "rawat_inap_drpr":
                                            ...
                                            if(sukses==true){
                                                  ...
                                                  psinputrawatdrprbangsal=koneksi.prepareStatement("insert into rawat_inap_drpr_bangsal values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
                                                    try {
                                                        psinputrawatdrprbangsal.setString(1,TNoRw.getText());
                                                        psinputrawatdrprbangsal.setString(2,tbKamar.getValueAt(i,1).toString());
                                                        psinputrawatdrprbangsal.setString(3,kddokter.getText());
                                                        psinputrawatdrprbangsal.setString(4,KdPtg2.getText());
                                                        psinputrawatdrprbangsal.setString(5,Valid.SetTgl(DTPTgl.getSelectedItem()+""));
                                                        psinputrawatdrprbangsal.setString(6,cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem());
                                                        psinputrawatdrprbangsal.setString(7,tbKamar.getValueAt(i,5).toString());
                                                        psinputrawatdrprbangsal.setString(8,tbKamar.getValueAt(i,6).toString());
                                                        psinputrawatdrprbangsal.setString(9,tbKamar.getValueAt(i,7).toString());
                                                        psinputrawatdrprbangsal.setString(10,tbKamar.getValueAt(i,8).toString());
                                                        psinputrawatdrprbangsal.setString(11,tbKamar.getValueAt(i,9).toString());
                                                        psinputrawatdrprbangsal.setString(12,tbKamar.getValueAt(i,10).toString());
                                                        psinputrawatdrprbangsal.setString(13,tbKamar.getValueAt(i,4).toString());
                                                        psinputrawatdrprbangsal.setString(14,TkdKamar.getText());
                                                        psinputrawatdrprbangsal.setString(15,TkdBangsal.getText());
                                                        psinputrawatdrprbangsal.executeUpdate();
                                                    } catch (Exception e) {
                                                        sukses=false;
                                                        System.out.println("Notifikasi : "+e);
                                                    } finally{
                                                        if(psinputrawatdrprbangsal != null){
                                                            psinputrawatdrprbangsal.close();
                                                        }
                                                    }
