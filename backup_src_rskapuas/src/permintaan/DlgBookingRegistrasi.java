...
public class DlgBookingRegistrasi extends javax.swing.JDialog {
    ...
    public DlgBookingRegistrasi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                ...
                "Nama Dokter","Kode Poli","Nama Poli","No.Booking","Nama PJ","Alamat PJ",
                "kelurahanpj","kecamatanpj","kabupatenpj","propinsipj","Hubungan","Bayar",
                "Tahun","Bulan","Hari","Asal Booking","Status","Kd PJ","Cara Bayar","No.Telp/HP","Jenis Kunjungan"
            }){
    ...
    private void initComponents() {
        ...
        NoReg2.setHighlighter(null);
        NoReg2.setName("NoReg2"); // NOI18N
        NoReg2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                NoReg2KeyPressed(evt);
            }
        });
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-04-2023" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-04-2023" }));
        ...
        TanggalBooking.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-04-2023 03:55:57" }));
        ...
        TanggalPeriksa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-04-2023 03:55:57" }));
        ...
        JnsPasien.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "Kirkes", "Haji", "Katarak" }));
        JnsPasien.setName("JnsPasien"); // NOI18N
        JnsPasien.setOpaque(false);
        ...
        JnsPasien.setBounds(830, 10, 90, 23);
        ...
        jLabel27.setBounds(730, 10, 86, 23);
  ...
  isForm();                
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        for(i=0;i<tbObat.getRowCount();i++){ 
         ...
         switch (URUTNOREG) {
            case "poli":
                Valid.autoNomer3("select ifnull(MAX(CONVERT(no_reg,signed)),0) from reg_periksa where kd_poli='"+tbObat.getValueAt(i,8).toString()+"' and tgl_registrasi='"+tbObat.getValueAt(i,5).toString()+"'","",3,NoReg2);
                break;
            case "dokter":
                Valid.autoNomer3("select ifnull(MAX(CONVERT(no_reg,signed)),0) from reg_periksa where kd_dokter='"+tbObat.getValueAt(i,6).toString()+"' and tgl_registrasi='"+tbObat.getValueAt(i,5).toString()+"'","",3,NoReg2);
                break;
            case "dokter + poli":             
                Valid.autoNomer3("select ifnull(MAX(CONVERT(no_reg,signed)),0) from reg_periksa where kd_dokter='"+tbObat.getValueAt(i,6).toString()+"' and kd_poli='"+tbObat.getValueAt(i,8).toString()+"' and tgl_registrasi='"+tbObat.getValueAt(i,5).toString()+"'","",3,NoReg2);
                break;
            default:
                Valid.autoNomer3("select ifnull(MAX(CONVERT(no_reg,signed)),0) from reg_periksa where kd_dokter='"+tbObat.getValueAt(i,6).toString()+"' and tgl_registrasi='"+tbObat.getValueAt(i,5).toString()+"'","",3,NoReg2);
                break;
                ...
                if(Sequel.menyimpantf2("reg_periksa","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",19,new String[]{
                    NoReg2.getText(),no_rawat,tbObat.getValueAt(i,5).toString(),jam(),
                    ...
                    Sequel.menyimpan("ket_pasien1","'"+no_rawat+"','"+tbObat.getValueAt(i,27).toString()+"' ","jenis_kunjungan");
                }
            }
        }
        tampil();
    ...
    private void ppKirimWAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppKirimWAActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            Dlgwhatsapp wa=new Dlgwhatsapp(null,true);
            wa.setNoRm(tbObat.getValueAt(tbObat.getSelectedRow(),3).toString());
            wa.setNoWA(tbObat.getValueAt(tbObat.getSelectedRow(),26).toString());
            //wa.TglPeriksa(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString());
            wa.setSize(720,330);
            wa.setLocationRelativeTo(internalFrame1);
            wa.setVisible(true);
            this.setCursor(Cursor.getDefaultCursor());
    ...
    private void NoReg2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NoReg2KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_NoReg2KeyPressed
    ...
    */
    ...
    private void tampil() {     
        ...
        try {
            ps=koneksi.prepareStatement(
                    ...
                    "(TIMESTAMPDIFF(MONTH, pasien.tgl_lahir, CURDATE()) - ((TIMESTAMPDIFF(MONTH, pasien.tgl_lahir, CURDATE()) div 12) * 12)) as bulan, "+
                    "TIMESTAMPDIFF(DAY, DATE_ADD(DATE_ADD(pasien.tgl_lahir,INTERVAL TIMESTAMPDIFF(YEAR, pasien.tgl_lahir, CURDATE()) YEAR), INTERVAL TIMESTAMPDIFF(MONTH, pasien.tgl_lahir, CURDATE()) - ((TIMESTAMPDIFF(MONTH, pasien.tgl_lahir, CURDATE()) div 12) * 12) MONTH), CURDATE()) as hari, "+
                    "booking_registrasi.limit_reg,booking_registrasi.status,booking_registrasi.kd_pj,penjab.png_jawab,booking_registrasi.jenis_kunjungan "+
                    "from booking_registrasi inner join pasien on booking_registrasi.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join dokter on booking_registrasi.kd_dokter=dokter.kd_dokter "+
                    "inner join poliklinik on booking_registrasi.kd_poli=poliklinik.kd_poli "+
                    "inner join penjab on booking_registrasi.kd_pj=penjab.kd_pj "+
    ...
    private void isNomer1(){
        switch (URUTNOREG) {
            case "poli":
                Valid.autoNomer3("select ifnull(MAX(CONVERT(no_reg,signed)),0) from reg_periksa where kd_poli='"+KdPoli.getText()+"' and tgl_registrasi='"+Valid.SetTgl(TanggalPeriksa.getSelectedItem()+"")+"'","",3,NoReg2);
                break;
            case "dokter":
                Valid.autoNomer3("select ifnull(MAX(CONVERT(no_reg,signed)),0) from reg_periksa where kd_dokter='"+KdDokter.getText()+"' and tgl_registrasi='"+Valid.SetTgl(TanggalPeriksa.getSelectedItem()+"")+"'","",3,NoReg2);
                break;
            case "dokter + poli":             
                Valid.autoNomer3("select ifnull(MAX(CONVERT(no_reg,signed)),0) from reg_periksa where kd_dokter='"+KdDokter.getText()+"' and kd_poli='"+KdPoli.getText()+"' and tgl_registrasi='"+Valid.SetTgl(TanggalPeriksa.getSelectedItem()+"")+"'","",3,NoReg2);
                break;
            default:
                Valid.autoNomer3("select ifnull(MAX(CONVERT(no_reg,signed)),0) from reg_periksa where kd_dokter='"+KdDokter.getText()+"' and tgl_registrasi='"+Valid.SetTgl(TanggalPeriksa.getSelectedItem()+"")+"'","",3,NoReg2);
                break;
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){            
            ...
            JnsPasien.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),27).toString());
            isNomer1();
        }
    }
    ...
    private void isBooking() {
        if(Sequel.menyimpantf("booking_registrasi","?,?,?,?,?,?,?,?,?,?,?,?","Pasien dan Tanggal",12,new String[]{
             ...
             "Belum",JnsPasien.getSelectedItem().toString()
           })==true){
            emptTeks();
            tampil();
        } 
