...
public final class DlgPermintaanLaboratorium extends javax.swing.JDialog {
    ...
    private PreparedStatement pstindakan,pstampil,ps,psresep,
            psset_tarif;
    private ResultSet rstindakan,rstampil,rsset_tarif,rs,rsobat;
    ...
    private String aktifkanparsial="no",norawatibu="",kelas="",kamar,namakamar,cara_bayar_lab="Yes",kelas_lab="Yes",status="",la="",ld="",pa="",pd="",finger="",RESEPRAJALKEPLAN="no",resep="",infoklinis="",infotambahan="";
    ...
    private void initComponents() {
        ...
        BtnCekPermintaan = new widget.Button();
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "28-04-2024" }));
        ...
        BtnCekPermintaan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/peminjaman.png"))); // NOI18N
        BtnCekPermintaan.setMnemonic('K');
        BtnCekPermintaan.setText("Lihat Permintaan");
        BtnCekPermintaan.setToolTipText("Alt+K");
        BtnCekPermintaan.setName("BtnCekPermintaan"); // NOI18N
        BtnCekPermintaan.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnCekPermintaan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnCekPermintaanActionPerformed(evt);
            }
        });
        BtnCekPermintaan.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnCekPermintaanKeyPressed(evt);
            }
        });
        PanelInput.add(BtnCekPermintaan);
        BtnCekPermintaan.setBounds(780, 10, 140, 30);
        ...
        Scroll.setPreferredSize(new java.awt.Dimension(440, 402));
        ...
        panelGlass11.setPreferredSize(new java.awt.Dimension(127, 300));
        ...
        jLabel6.setBounds(4, 270, 110, 23);
        ...
        TCari.setBounds(117, 270, 623, 23);
        ...
        BtnCari2.setBounds(744, 270, 28, 23);
        ...
        Scroll1.setBounds(85, 35, 687, 230);
        ...
        TanggalPA.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "28-04-2024" }));
        ...
        TanggalBahan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "28-04-2024" }));
...
private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
   ...
   try{
    ...
    private void BtnCekPermintaanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCekPermintaanActionPerformed
           this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            DlgCariPermintaanLab dlgrwjl=new DlgCariPermintaanLab(null,false);
            dlgrwjl.isCek();
            dlgrwjl.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            dlgrwjl.setLocationRelativeTo(internalFrame1);
            dlgrwjl.CekData(TNoRw.getText(),NmPerujuk.getText(),Sequel.cariIsi("select p.nm_poli from poliklinik p inner join reg_periksa rp on rp.kd_poli=p.kd_poli where rp.no_rawat='"+TNoRw.getText()+"' "));    
            dlgrwjl.setVisible(true);
            this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_BtnCekPermintaanActionPerformed

    private void BtnCekPermintaanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCekPermintaanKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnCekPermintaanKeyPressed
    ...
    */
    ...
    private widget.Button BtnCekPermintaan;
                ...
                if(tbTarifPK.getValueAt(i2,0).toString().equals("true")){
                    ...
                    try {
                        ...
                        while(rstampil.next()){
                            ...
                            if(rstampil.getString("kd_jenis_prw").toLowerCase().contains("pak")){
                                tabMode.addRow(new Object[]{
                        ...
                        if(jml>0){
                            try {
                                ...
                                try {
                                    ...
                                    ps.setString(2,KodePerujuk.getText());
                                    rs=ps.executeQuery();
                                    if(rs.next()){
                                        resep="\n Permintaan Lab : \n";
                                        infoklinis="Informasi Klinis Lab : \n"+DiagnosisKlinis.getText();
                                        infotambahan="\n Informasi Tambahan Lab : \n"+InformasiTambahan.getText();
                                        psresep=koneksi.prepareStatement(
                                               "SELECT jpl.nm_perawatan,pl.informasi_tambahan,pl.diagnosa_klinis FROM permintaan_pemeriksaan_lab ppl INNER JOIN jns_perawatan_lab jpl ON jpl.kd_jenis_prw=ppl.kd_jenis_prw INNER JOIN permintaan_lab pl on pl.noorder=ppl.noorder WHERE ppl.noorder=? ");
                                        try {
                                            psresep.setString(1,TNoPermintaanPK.getText());
                                            rsobat=psresep.executeQuery();
                                            while(rsobat.next()){
                                                resep=resep+rsobat.getString("nm_perawatan")+"\n";
                                            }
                                        } catch (Exception e) {
                                            System.out.println("Notif : "+e);
                                        } finally{
                                        ...
                                        Sequel.queryu2("update pemeriksaan_ralan set instruksi=concat(instruksi,' ',?) where no_rawat=? and tgl_perawatan=? and jam_rawat=? and nip=?",5,new String[]{
                                            resep+infoklinis+infotambahan,TNoRw.getText(),rs.getString("tgl_perawatan"),rs.getString("jam_rawat"),KodePerujuk.getText()
                                        });
                                    }
                                } catch (Exception e) {
                                    System.out.println("Notif : "+e);
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    if(rs.next()){
                                        ...
                                        infotambahan="\n Informasi Tambahan Lab : \n"+InformasiTambahan.getText();
                                        psresep=koneksi.prepareStatement(
                                               "SELECT jpl.nm_perawatan,pl.informasi_tambahan,pl.diagnosa_klinis FROM permintaan_pemeriksaan_labpa ppl INNER JOIN jns_perawatan_lab jpl ON jpl.kd_jenis_prw=ppl.kd_jenis_prw INNER JOIN permintaan_labpa pl on pl.noorder=ppl.noorder WHERE ppl.noorder=? ");
                                        try {
                                            psresep.setString(1,TNoPermintaanPA.getText());
                                            rsobat=psresep.executeQuery();
                                            while(rsobat.next()){
                                                resep=resep+rsobat.getString("nm_perawatan")+"\n";
                                            }
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    if(rs.next()){
                                        ...
                                        infotambahan="\n Informasi Tambahan Lab : \n"+InformasiTambahan.getText();
                                        psresep=koneksi.prepareStatement(
                                               "SELECT jpl.nm_perawatan,pl.informasi_tambahan,pl.diagnosa_klinis FROM permintaan_pemeriksaan_labmb ppl INNER JOIN jns_perawatan_lab jpl ON jpl.kd_jenis_prw=ppl.kd_jenis_prw INNER JOIN permintaan_labmb pl on pl.noorder=ppl.noorder WHERE ppl.noorder=? ");
                                        try {
                                            psresep.setString(1,TNoPermintaanMB.getText());
                                            rsobat=psresep.executeQuery();
                                            while(rsobat.next()){
                                                resep=resep+rsobat.getString("nm_perawatan")+"\n";
                                            }
