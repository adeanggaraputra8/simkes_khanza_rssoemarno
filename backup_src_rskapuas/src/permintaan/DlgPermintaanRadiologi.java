...
public final class DlgPermintaanRadiologi extends javax.swing.JDialog {
    ...
    private PreparedStatement psset_tarif,pspemeriksaan,ps,psresep;
    private ResultSet rs,rsset_tarif,rsobat;
    private boolean[] pilih; 
    private String[] kode,nama;
    private int jml=0,i=0,index=0,jmlparsial=0;
    private String kelas_radiologi="Yes",kelas="",cara_bayar_radiologi="Yes",kamar,namakamar,status="",infoklinis="",infotambahan="",RESEPRAJALKEPLAN="no",resep="",
    ...
    private void initComponents() {
        ...
        BtnCekPermintaan.setBounds(640, 10, 140, 30);
...
private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
    ...
    private void BtnCekPermintaanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCekPermintaanActionPerformed
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            DlgCariPermintaanRadiologi dlgrwjl=new DlgCariPermintaanRadiologi(null,false);
            dlgrwjl.isCek();
                ...
                try {
                    ...
                    try {
                        ...
                        if(rs.next()){
                            ...
                            infoklinis="Informasi Klinis Radiologi : \n"+DiagnosisKlinis.getText();
                            infotambahan="\n Informasi Tambahan Radiologi : \n"+InformasiTambahan.getText();
                            psresep=koneksi.prepareStatement(
                                   "SELECT jpl.nm_perawatan,pl.informasi_tambahan,pl.diagnosa_klinis FROM permintaan_pemeriksaan_radiologi ppl INNER JOIN jns_perawatan_radiologi jpl ON jpl.kd_jenis_prw=ppl.kd_jenis_prw INNER JOIN permintaan_radiologi pl on pl.noorder=ppl.noorder WHERE ppl.noorder=? ");
                            try {
                                psresep.setString(1,TNoPermintaan.getText());
